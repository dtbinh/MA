...
\section{Spring-mass-damper systems}
...
\begin{pmatrix}\frac{\partial V_{kg}}{\partial H_b^0}\\ \frac{\partial V_{kg}}{\partial H_b^v} \\ \frac{\partial V_{kg}}{\partial P_b^b}\end{pmatrix}+
\begin{pmatrix}0 & 0 & 0\\ 0 & -H_b^v Ad_{H_0^b} & 0 \\ 0 & D_b Ad_{H_0^b} & I_6 \end{pmatrix}\begin{pmatrix} 0 \\ T_v^0 \\ W_{b}^b\end{pmatrix} \\
%&\begin{pmatrix}T_b^0 = \begin{pmatrix}0 & Ad_{H_b^0}\end{pmatrix}
%\begin{pmatrix}\frac{\partial V_{kg}}{\partial H_b^0} \\ \frac{\partial V_{kg}}{\partial P_b^b}\end{pmatrix}
\end{aligned}
\end{eqnarray}
