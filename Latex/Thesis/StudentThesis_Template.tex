...
\begin{equation}
M_o \ddot{x}_o + C_o \dot{x}_o + g_o = h_{ext} + h^\Sigma
\end{equation}
...
\end{equation}
$ M_i, D_i, K_i(x_i^d,x_i) $ are the desired inertia, damping and stiffness representations of the i-th manipulator.
