...
\begin{groupplot}[
	...
	\addplot[red,] table {../plotdata/DIPCctrans_errPos.txt};\label{plots:errPos}
	\coordinate (top) at (rel axis cs:0,1);% coordinate at top of the first plot
	\nextgroupplot
	\addplot[blue,] table {../plotdata/DIPCcrot_errOrient.txt};\label{plots:errOrient}
...
\begin{groupplot}[
	...
	\addplot[red,] table {../plotdata/DIPCctrans_errVeloc.txt};\label{plots:errVeloc}
	\coordinate (top) at (rel axis cs:0,1);% coordinate at top of the first plot
	\nextgroupplot
	\addplot[blue,] table {../plotdata/DIPCcrot_errAngVel.txt};\label{plots:errAngVel}
	\coordinate (bot) at (rel axis cs:1,0);% coordinate at bottom of the last plot
  \end{groupplot}
  % legend
  \path (top|-current bounding box.north)--
...
\begin{groupplot}[
	...
	\addplot[red,] table {../plotdata/DIPCctrans_Internal wrench_tx.txt}; 
	\addplot[blue,] table {../plotdata/DIPCctrans_Internal wrench_ty.txt}; 
	\addplot[green,] table {../plotdata/DIPCctrans_Internal wrench_rz.txt};	
	\coordinate (top) at (rel axis cs:0,1);% coordinate at top of the first plot
	\nextgroupplot[xlabel={$t$[s]}] 
	\addplot[red,] table {../plotdata/DIPCcrot_Internal wrench_tx.txt};\label{plots:forceix}
	\addplot[blue,] table {../plotdata/DIPCcrot_Internal wrench_ty.txt};\label{plots:forceiy} 
	\addplot[green,] table {../plotdata/DIPCcrot_Internal wrench_rz.txt};\label{plots:torqueiz}	
	\coordinate (bot) at (rel axis cs:1,0);% coordinate at bottom of the last plot
  \end{groupplot}
  % legend
  \path (top|-current bounding box.north)--
