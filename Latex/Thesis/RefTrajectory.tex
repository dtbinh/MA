...
\begin{groupplot}[
    ...
    \nextgroupplot 
	\addplot[red,] table 								{/home/mangerer/MAgit/MA/Latex/plotdata/ReferenceTrajectory.txt};\label{plots:RefTran}
	\coordinate (top) at (rel axis cs:0,1);% coordinate at top of the first plot
	\nextgroupplot
	\addplot[blue,] table {/home/mangerer/MAgit/MA/Latex/plotdata/ReferenceTrajectory.txt};\label{plots:RefRot}
