...
static void initialize_c3_Model1angular(SFc3_Model1angularInstanceStruct
  *chartInstance);
static void initialize_params_c3_Model1angular(SFc3_Model1angularInstanceStruct *
  chartInstance);
static void enable_c3_Model1angular(SFc3_Model1angularInstanceStruct
  *chartInstance);
static void disable_c3_Model1angular(SFc3_Model1angularInstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_Model1angular
  (SFc3_Model1angularInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_Model1angular
  (SFc3_Model1angularInstanceStruct *chartInstance);
static void set_sim_state_c3_Model1angular(SFc3_Model1angularInstanceStruct
  *chartInstance, const mxArray *c3_st);
static void finalize_c3_Model1angular(SFc3_Model1angularInstanceStruct
  *chartInstance);
static void sf_gateway_c3_Model1angular(SFc3_Model1angularInstanceStruct
  *chartInstance);
static void mdl_start_c3_Model1angular(SFc3_Model1angularInstanceStruct
  *chartInstance);
static void c3_chartstep_c3_Model1angular(SFc3_Model1angularInstanceStruct
  *chartInstance);
static void initSimStructsc3_Model1angular(SFc3_Model1angularInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_Model1angularInstanceStruct *chartInstance,
  const mxArray *c3_b_b, const char_T *c3_identifier, real_T c3_y[12]);
static void c3_b_emlrt_marshallIn(SFc3_Model1angularInstanceStruct
...
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_c_emlrt_marshallIn(SFc3_Model1angularInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[6]);
...
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_d_emlrt_marshallIn(SFc3_Model1angularInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static real_T c3_eml_xdotu(SFc3_Model1angularInstanceStruct *chartInstance,
  real_T c3_x[3], real_T c3_y[3]);
static const mxArray *c3_e_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_e_emlrt_marshallIn(SFc3_Model1angularInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_f_emlrt_marshallIn(SFc3_Model1angularInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_Model1angular, const char_T
  *c3_identifier);
static uint8_T c3_g_emlrt_marshallIn(SFc3_Model1angularInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_Model1angularInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc3_Model1angularInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_Model1angular = 0U;
}
  ...
  (SFc3_Model1angularInstanceStruct *chartInstance)
{
  ...
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_Model1angular;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_Model1angular = c3_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
     "is_active_c3_Model1angular");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_Model1angular(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_Model1angular(chartInstance);
  ...
  *chartInstance)
{
  ...
  for (c3_i32 = 0; c3_i32 < 3; c3_i32++) {
    c3_b_b[c3_i32] = c3_c_b[c3_i32] - c3_e_b[c3_i32];
  }
  ...
  for (c3_i34 = 0; c3_i34 < 3; c3_i34++) {
    c3_b_b[c3_i34 + 6] = c3_g_b[c3_i34] - c3_i_b[c3_i34];
  }
  ...
  for (c3_i36 = 0; c3_i36 < 12; c3_i36++) {
    (*chartInstance->c3_b)[c3_i36] = c3_b_b[c3_i36];
  }
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_Model1angularInstanceStruct *chartInstance;
  chartInstance = (SFc3_Model1angularInstanceStruct *)chartInstanceVoid;
  c3_mxArrayOutData = NULL;
  for (c3_i37 = 0; c3_i37 < 12; c3_i37++) {
    c3_b_inData[c3_i37] = (*(real_T (*)[12])c3_inData)[c3_i37];
  }
  ...
  real_T c3_y[12])
{
  ...
  int32_T c3_i39;
  (void)chartInstance;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv2, 1, 0, 0U, 1, 0U, 1, 12);
  for (c3_i39 = 0; c3_i39 < 12; c3_i39++) {
    c3_y[c3_i39] = c3_dv2[c3_i39];
  }
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  for (c3_i40 = 0; c3_i40 < 12; c3_i40++) {
    (*(real_T (*)[12])c3_outData)[c3_i40] = c3_y[c3_i40];
  }
  ...
  *c3_inData)
{
  ...
  for (c3_i41 = 0; c3_i41 < 6; c3_i41++) {
    c3_b_inData[c3_i41] = (*(real_T (*)[6])c3_inData)[c3_i41];
  }
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  for (c3_i44 = 0; c3_i44 < 6; c3_i44++) {
    (*(real_T (*)[6])c3_outData)[c3_i44] = c3_y[c3_i44];
  }
  ...
  *c3_inData)
{
  ...
  chartInstance = (SFc3_Model1angularInstanceStruct *)chartInstanceVoid;
  c3_mxArrayOutData = NULL;
  for (c3_i45 = 0; c3_i45 < 18; c3_i45++) {
    c3_b_inData[c3_i45] = (*(real_T (*)[18])c3_inData)[c3_i45];
  }

  for (c3_i46 = 0; c3_i46 < 18; c3_i46++) {
...
const mxArray *sf_c3_Model1angular_get_eml_resolved_functions_info(void)
{
  ...
  *c3_identifier)
{
  ...
  c3_y = c3_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_Model1angular), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_Model1angular);
  return c3_y;
}
...
static void init_simulink_io_address(SFc3_Model1angularInstanceStruct
  *chartInstance)
{
  chartInstance->c3_dx = (real_T (*)[18])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c3_b = (real_T (*)[12])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
void sf_c3_Model1angular_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1120794329U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1193128470U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4058332971U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(145357308U);
}

mxArray* sf_c3_Model1angular_get_post_codegen_info(void);
mxArray *sf_c3_Model1angular_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("vzVEzOXfN8gfQjq5xGHwZF");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c3_Model1angular_get_post_codegen_info();
...
mxArray *sf_c3_Model1angular_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_Model1angular_jit_fallback_info(void)
{
...
mxArray *sf_c3_Model1angular_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_Model1angular(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"b\",},{M[8],M[0],T\"is_active_c3_Model1angular\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_Model1angular_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_Model1angularInstanceStruct *)
...
{
  return "YSYjhN9Bdi4ZskpaslZJZH";
}

static void sf_opaque_initialize_c3_Model1angular(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_Model1angularInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_Model1angular((SFc3_Model1angularInstanceStruct*)
    chartInstanceVar);
  initialize_c3_Model1angular((SFc3_Model1angularInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_Model1angular(void *chartInstanceVar)
{
  enable_c3_Model1angular((SFc3_Model1angularInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_Model1angular(void *chartInstanceVar)
{
  disable_c3_Model1angular((SFc3_Model1angularInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_Model1angular(void *chartInstanceVar)
{
  sf_gateway_c3_Model1angular((SFc3_Model1angularInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c3_Model1angular(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c3_Model1angular((SFc3_Model1angularInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_Model1angular(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c3_Model1angular((SFc3_Model1angularInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c3_Model1angular(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_Model1angularInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_Model1angular((SFc3_Model1angularInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_Model1angular((SFc3_Model1angularInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_Model1angular(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_Model1angular(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2404525948U));
  ssSetChecksum1(S,(1851001045U));
  ssSetChecksum2(S,(986683672U));
  ssSetChecksum3(S,(2228098633U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_Model1angular(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_Model1angular(SimStruct *S)
{
  SFc3_Model1angularInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_Model1angularInstanceStruct *)utMalloc(sizeof
    (SFc3_Model1angularInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_Model1angularInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_Model1angular;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_Model1angular;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_Model1angular;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_Model1angular;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_Model1angular;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_Model1angular;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_Model1angular;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_Model1angular;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_Model1angular;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_Model1angular;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_Model1angular;
...
void c3_Model1angular_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Model1angular(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Model1angular(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Model1angular(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_Model1angular_method_dispatcher.\n"
