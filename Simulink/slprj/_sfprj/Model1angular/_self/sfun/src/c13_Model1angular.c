...
static void initialize_c13_Model1angular(SFc13_Model1angularInstanceStruct
  *chartInstance);
static void initialize_params_c13_Model1angular
  (SFc13_Model1angularInstanceStruct *chartInstance);
static void enable_c13_Model1angular(SFc13_Model1angularInstanceStruct
  *chartInstance);
static void disable_c13_Model1angular(SFc13_Model1angularInstanceStruct
  *chartInstance);
static void c13_update_debugger_state_c13_Model1angular
  (SFc13_Model1angularInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_Model1angular
  (SFc13_Model1angularInstanceStruct *chartInstance);
static void set_sim_state_c13_Model1angular(SFc13_Model1angularInstanceStruct
  *chartInstance, const mxArray *c13_st);
static void finalize_c13_Model1angular(SFc13_Model1angularInstanceStruct
  *chartInstance);
static void sf_gateway_c13_Model1angular(SFc13_Model1angularInstanceStruct
  *chartInstance);
static void mdl_start_c13_Model1angular(SFc13_Model1angularInstanceStruct
  *chartInstance);
static void initSimStructsc13_Model1angular(SFc13_Model1angularInstanceStruct
  *chartInstance);
...
static const mxArray *c13_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static void c13_emlrt_marshallIn(SFc13_Model1angularInstanceStruct
  *chartInstance, const mxArray *c13_b_rot, const char_T *c13_identifier, real_T
  c13_y[6]);
static void c13_b_emlrt_marshallIn(SFc13_Model1angularInstanceStruct
...
static const mxArray *c13_b_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static real_T c13_c_emlrt_marshallIn(SFc13_Model1angularInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
...
static real_T c13_eml_xdotu(SFc13_Model1angularInstanceStruct *chartInstance,
  real_T c13_x[3], real_T c13_y[3]);
static const mxArray *c13_c_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static int32_T c13_d_emlrt_marshallIn(SFc13_Model1angularInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void c13_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData);
static uint8_T c13_e_emlrt_marshallIn(SFc13_Model1angularInstanceStruct
  *chartInstance, const mxArray *c13_b_is_active_c13_Model1angular, const char_T
  *c13_identifier);
static uint8_T c13_f_emlrt_marshallIn(SFc13_Model1angularInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void init_dsm_address_info(SFc13_Model1angularInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc13_Model1angularInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_Model1angular = 0U;
}
  ...
  (SFc13_Model1angularInstanceStruct *chartInstance)
{
  ...
  c13_hoistedGlobal = chartInstance->c13_is_active_c13_Model1angular;
  ...
  *chartInstance, const mxArray *c13_st)
{
  ...
  chartInstance->c13_is_active_c13_Model1angular = c13_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c13_u, 1)),
     "is_active_c13_Model1angular");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_Model1angular(chartInstance);
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c13_b_r, 3U, c13_sf_marshallOut,
    c13_sf_marshallIn);
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_Model1angularInstanceStruct *chartInstance;
  chartInstance = (SFc13_Model1angularInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c13_Model1angular_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId)
{
  ...
  int32_T c13_i27;
  (void)chartInstance;
  sf_mex_import(c13_parentId, sf_mex_dup(c13_u), &c13_i27, 1, 6, 0U, 0, 0U, 0);
  c13_y = c13_i27;
  sf_mex_destroy(&c13_u);
  return c13_y;
}
  ...
  *c13_identifier)
{
  ...
  c13_y = c13_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_Model1angular), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_Model1angular);
  return c13_y;
}
...
void sf_c13_Model1angular_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2758472296U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2815029070U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(924618544U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1809452574U);
}

mxArray* sf_c13_Model1angular_get_post_codegen_info(void);
mxArray *sf_c13_Model1angular_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("TpJYDlqnZAksw2imsglcJH");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c13_Model1angular_get_post_codegen_info();
...
mxArray *sf_c13_Model1angular_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c13_Model1angular_jit_fallback_info(void)
{
...
mxArray *sf_c13_Model1angular_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c13_Model1angular(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"rot\",},{M[8],M[0],T\"is_active_c13_Model1angular\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_Model1angular_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc13_Model1angularInstanceStruct *)
...
{
  return "IMcJtTOCVxop0MIpJrKp1D";
}

static void sf_opaque_initialize_c13_Model1angular(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_Model1angularInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c13_Model1angular((SFc13_Model1angularInstanceStruct*)
    chartInstanceVar);
  initialize_c13_Model1angular((SFc13_Model1angularInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c13_Model1angular(void *chartInstanceVar)
{
  enable_c13_Model1angular((SFc13_Model1angularInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_Model1angular(void *chartInstanceVar)
{
  disable_c13_Model1angular((SFc13_Model1angularInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c13_Model1angular(void *chartInstanceVar)
{
  sf_gateway_c13_Model1angular((SFc13_Model1angularInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c13_Model1angular(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c13_Model1angular((SFc13_Model1angularInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c13_Model1angular(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c13_Model1angular((SFc13_Model1angularInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c13_Model1angular(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_Model1angularInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c13_Model1angular((SFc13_Model1angularInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc13_Model1angular((SFc13_Model1angularInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_Model1angular(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c13_Model1angular(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1741358827U));
  ssSetChecksum1(S,(386969232U));
  ssSetChecksum2(S,(1573028587U));
  ssSetChecksum3(S,(246909226U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c13_Model1angular(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_Model1angular(SimStruct *S)
{
  SFc13_Model1angularInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc13_Model1angularInstanceStruct *)utMalloc(sizeof
    (SFc13_Model1angularInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_Model1angularInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c13_Model1angular;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_Model1angular;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c13_Model1angular;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c13_Model1angular;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c13_Model1angular;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_Model1angular;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_Model1angular;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_Model1angular;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_Model1angular;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_Model1angular;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c13_Model1angular;
...
void c13_Model1angular_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_Model1angular(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_Model1angular(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_Model1angular(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_Model1angular_method_dispatcher.\n"
