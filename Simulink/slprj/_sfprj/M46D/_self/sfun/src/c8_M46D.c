...
static void initialize_c8_M46D(SFc8_M46DInstanceStruct *chartInstance);
static void initialize_params_c8_M46D(SFc8_M46DInstanceStruct *chartInstance);
static void enable_c8_M46D(SFc8_M46DInstanceStruct *chartInstance);
static void disable_c8_M46D(SFc8_M46DInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_M46D(SFc8_M46DInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c8_M46D(SFc8_M46DInstanceStruct
  *chartInstance);
static void set_sim_state_c8_M46D(SFc8_M46DInstanceStruct *chartInstance, const
  mxArray *c8_st);
static void finalize_c8_M46D(SFc8_M46DInstanceStruct *chartInstance);
static void sf_gateway_c8_M46D(SFc8_M46DInstanceStruct *chartInstance);
static void mdl_start_c8_M46D(SFc8_M46DInstanceStruct *chartInstance);
static void initSimStructsc8_M46D(SFc8_M46DInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber, uint32_T c8_instanceNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_M46DInstanceStruct *chartInstance, const
  mxArray *c8_b_Cf, const char_T *c8_identifier, real_T c8_y[6]);
static void c8_b_emlrt_marshallIn(SFc8_M46DInstanceStruct *chartInstance, const
  mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[6]);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_c_emlrt_marshallIn(SFc8_M46DInstanceStruct *chartInstance,
...
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_d_emlrt_marshallIn(SFc8_M46DInstanceStruct *chartInstance, const
...
static const mxArray *c8_e_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_e_emlrt_marshallIn(SFc8_M46DInstanceStruct *chartInstance, const
...
static void c8_eml_scalar_eg(SFc8_M46DInstanceStruct *chartInstance);
static void c8_eml_xgemm(SFc8_M46DInstanceStruct *chartInstance, real_T c8_A[9],
  real_T c8_B[3], real_T c8_C[3], real_T c8_b_C[3]);
static const mxArray *c8_f_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_f_emlrt_marshallIn(SFc8_M46DInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_g_emlrt_marshallIn(SFc8_M46DInstanceStruct *chartInstance,
  const mxArray *c8_b_is_active_c8_M46D, const char_T *c8_identifier);
static uint8_T c8_h_emlrt_marshallIn(SFc8_M46DInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_eml_xgemm(SFc8_M46DInstanceStruct *chartInstance, real_T c8_A[9],
  real_T c8_B[3], real_T c8_C[3]);
static void init_dsm_address_info(SFc8_M46DInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc8_M46DInstanceStruct *chartInstance);
...
static void initialize_c8_M46D(SFc8_M46DInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_M46D = 0U;
}
  ...
  *chartInstance)
{
  ...
  c8_hoistedGlobal = chartInstance->c8_is_active_c8_M46D;
  ...
  mxArray *c8_st)
{
  ...
  chartInstance->c8_is_active_c8_M46D = c8_g_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c8_u, 1)), "is_active_c8_M46D");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_M46D(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  real_T c8_u[6];
  const mxArray *c8_y = NULL;
  SFc8_M46DInstanceStruct *chartInstance;
  chartInstance = (SFc8_M46DInstanceStruct *)chartInstanceVoid;
  ...
  *c8_inData)
{
  ...
  for (c8_i19 = 0; c8_i19 < 30; c8_i19++) {
    c8_b_inData[c8_i19] = (*(real_T (*)[30])c8_inData)[c8_i19];
  }

  for (c8_i20 = 0; c8_i20 < 30; c8_i20++) {
...
const mxArray *sf_c8_M46D_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c8_b_is_active_c8_M46D, const char_T *c8_identifier)
{
  ...
  c8_thisId.fIdentifier = c8_identifier;
  c8_thisId.fParent = NULL;
  c8_y = c8_h_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_b_is_active_c8_M46D),
    &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_M46D);
  return c8_y;
}
...
static void init_simulink_io_address(SFc8_M46DInstanceStruct *chartInstance)
{
  chartInstance->c8_dx = (real_T (*)[30])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
...
void sf_c8_M46D_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3375528400U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3417909976U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2828975022U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1896235593U);
}

mxArray* sf_c8_M46D_get_post_codegen_info(void);
mxArray *sf_c8_M46D_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("4Cb1TPEEQGYA0sRdmTiE0G");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c8_M46D_get_post_codegen_info();
...
mxArray *sf_c8_M46D_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_M46D_jit_fallback_info(void)
{
...
mxArray *sf_c8_M46D_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c8_M46D(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Cf\",},{M[8],M[0],T\"is_active_c8_M46D\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_M46D_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc8_M46DInstanceStruct *) chartInfo->chartInstance;
...
{
  return "BQBP4dIyN6TCcgjthns89E";
}

static void sf_opaque_initialize_c8_M46D(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_M46DInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c8_M46D((SFc8_M46DInstanceStruct*) chartInstanceVar);
  initialize_c8_M46D((SFc8_M46DInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_M46D(void *chartInstanceVar)
{
  enable_c8_M46D((SFc8_M46DInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_M46D(void *chartInstanceVar)
{
  disable_c8_M46D((SFc8_M46DInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_M46D(void *chartInstanceVar)
{
  sf_gateway_c8_M46D((SFc8_M46DInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c8_M46D(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c8_M46D((SFc8_M46DInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c8_M46D(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c8_M46D((SFc8_M46DInstanceStruct*)chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c8_M46D(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_M46DInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c8_M46D((SFc8_M46DInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_M46D((SFc8_M46DInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_M46D(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c8_M46D((SFc8_M46DInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_M46D(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2173397865U));
  ssSetChecksum1(S,(384979531U));
  ssSetChecksum2(S,(1456647708U));
  ssSetChecksum3(S,(3060484261U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c8_M46D(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_M46D(SimStruct *S)
{
  SFc8_M46DInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc8_M46DInstanceStruct *)utMalloc(sizeof
    (SFc8_M46DInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_M46DInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c8_M46D;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c8_M46D;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c8_M46D;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_M46D;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_M46D;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c8_M46D;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c8_M46D;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c8_M46D;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_M46D;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_M46D;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c8_M46D;
...
void c8_M46D_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_M46D(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_M46D(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_M46D_method_dispatcher.\n"
