...
static const char * c19_debug_family_names[5] = { "nargin", "nargout", "dx_d",
  "r", "rot" };

/* Function Declarations */
static void initialize_c19_M46D(SFc19_M46DInstanceStruct *chartInstance);
static void initialize_params_c19_M46D(SFc19_M46DInstanceStruct *chartInstance);
static void enable_c19_M46D(SFc19_M46DInstanceStruct *chartInstance);
static void disable_c19_M46D(SFc19_M46DInstanceStruct *chartInstance);
static void c19_update_debugger_state_c19_M46D(SFc19_M46DInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c19_M46D(SFc19_M46DInstanceStruct
  *chartInstance);
static void set_sim_state_c19_M46D(SFc19_M46DInstanceStruct *chartInstance,
  const mxArray *c19_st);
static void finalize_c19_M46D(SFc19_M46DInstanceStruct *chartInstance);
static void sf_gateway_c19_M46D(SFc19_M46DInstanceStruct *chartInstance);
static void mdl_start_c19_M46D(SFc19_M46DInstanceStruct *chartInstance);
static void initSimStructsc19_M46D(SFc19_M46DInstanceStruct *chartInstance);
...
static const mxArray *c19_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static void c19_emlrt_marshallIn(SFc19_M46DInstanceStruct *chartInstance, const
  mxArray *c19_b_rot, const char_T *c19_identifier, real_T c19_y[6]);
static void c19_b_emlrt_marshallIn(SFc19_M46DInstanceStruct *chartInstance,
...
static const mxArray *c19_b_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static void c19_c_emlrt_marshallIn(SFc19_M46DInstanceStruct *chartInstance,
...
static const mxArray *c19_c_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static real_T c19_d_emlrt_marshallIn(SFc19_M46DInstanceStruct *chartInstance,
...
static real_T c19_eml_xdotu(SFc19_M46DInstanceStruct *chartInstance, real_T
  c19_x[3], real_T c19_y[3]);
static const mxArray *c19_d_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static int32_T c19_e_emlrt_marshallIn(SFc19_M46DInstanceStruct *chartInstance,
  const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void c19_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c19_mxArrayInData, const char_T *c19_varName, void *c19_outData);
static uint8_T c19_f_emlrt_marshallIn(SFc19_M46DInstanceStruct *chartInstance,
  const mxArray *c19_b_is_active_c19_M46D, const char_T *c19_identifier);
static uint8_T c19_g_emlrt_marshallIn(SFc19_M46DInstanceStruct *chartInstance,
  const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void init_dsm_address_info(SFc19_M46DInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc19_M46DInstanceStruct *chartInstance);
...
static void initialize_c19_M46D(SFc19_M46DInstanceStruct *chartInstance)
{
  ...
  chartInstance->c19_is_active_c19_M46D = 0U;
}
...
static void initialize_params_c19_M46D(SFc19_M46DInstanceStruct *chartInstance)
{
  ...
  for (c19_i0 = 0; c19_i0 < 12; c19_i0++) {
    chartInstance->c19_r[c19_i0] = c19_dv0[c19_i0];
  }
}
  ...
  *chartInstance)
{
  ...
  for (c19_i1 = 0; c19_i1 < 6; c19_i1++) {
    c19_u[c19_i1] = (*chartInstance->c19_rot)[c19_i1];
  }

  c19_b_y = NULL;
  sf_mex_assign(&c19_b_y, sf_mex_create("y", c19_u, 0, 0U, 1U, 0U, 1, 6), false);
  sf_mex_setcell(c19_y, 0, c19_b_y);
  c19_hoistedGlobal = chartInstance->c19_is_active_c19_M46D;
  ...
  const mxArray *c19_st)
{
  ...
  for (c19_i2 = 0; c19_i2 < 6; c19_i2++) {
    (*chartInstance->c19_rot)[c19_i2] = c19_dv1[c19_i2];
  }

  chartInstance->c19_is_active_c19_M46D = c19_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c19_u, 1)), "is_active_c19_M46D");
  sf_mex_destroy(&c19_u);
  c19_update_debugger_state_c19_M46D(chartInstance);
...
static void sf_gateway_c19_M46D(SFc19_M46DInstanceStruct *chartInstance)
{
  ...
  for (c19_i3 = 0; c19_i3 < 6; c19_i3++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c19_dx_d)[c19_i3], 0U);
  }

  chartInstance->c19_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 17U, chartInstance->c19_sfEvent);
  for (c19_i4 = 0; c19_i4 < 6; c19_i4++) {
    c19_b_dx_d[c19_i4] = (*chartInstance->c19_dx_d)[c19_i4];
  }

  for (c19_i5 = 0; c19_i5 < 12; c19_i5++) {
    c19_b_r[c19_i5] = chartInstance->c19_r[c19_i5];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c19_nargout, 1U, c19_c_sf_marshallOut,
    c19_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c19_b_dx_d, 2U, c19_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c19_b_r, 3U, c19_b_sf_marshallOut,
    c19_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c19_b_rot, 4U, c19_sf_marshallOut,
    c19_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c19_sfEvent, 2);
  for (c19_i6 = 0; c19_i6 < 3; c19_i6++) {
    c19_a[c19_i6] = c19_b_dx_d[c19_i6 + 3];
  }

  for (c19_i7 = 0; c19_i7 < 3; c19_i7++) {
    c19_b[c19_i7] = c19_b_r[c19_i7 + 9];
  }

  for (c19_i8 = 0; c19_i8 < 3; c19_i8++) {
    c19_b_a[c19_i8] = c19_a[c19_i8];
  }

  for (c19_i9 = 0; c19_i9 < 3; c19_i9++) {
    c19_b_b[c19_i9] = c19_b[c19_i9];
  }

  c19_y = c19_eml_xdotu(chartInstance, c19_b_a, c19_b_b);
  c19_c_a = c19_y;
  for (c19_i10 = 0; c19_i10 < 3; c19_i10++) {
    c19_b[c19_i10] = c19_b_dx_d[c19_i10 + 3];
  }

  for (c19_i11 = 0; c19_i11 < 3; c19_i11++) {
    c19_b[c19_i11] *= c19_c_a;
  }

  for (c19_i12 = 0; c19_i12 < 3; c19_i12++) {
    c19_a[c19_i12] = c19_b_dx_d[c19_i12 + 3];
  }

  for (c19_i13 = 0; c19_i13 < 3; c19_i13++) {
    c19_c_b[c19_i13] = c19_b_dx_d[c19_i13 + 3];
  }

  for (c19_i14 = 0; c19_i14 < 3; c19_i14++) {
    c19_d_a[c19_i14] = c19_a[c19_i14];
  }

  for (c19_i15 = 0; c19_i15 < 3; c19_i15++) {
    c19_d_b[c19_i15] = c19_c_b[c19_i15];
  }

  c19_b_y = c19_eml_xdotu(chartInstance, c19_d_a, c19_d_b);
  c19_e_a = c19_b_y;
  for (c19_i16 = 0; c19_i16 < 3; c19_i16++) {
    c19_c_b[c19_i16] = c19_b_r[c19_i16 + 9];
  }

  for (c19_i17 = 0; c19_i17 < 3; c19_i17++) {
    c19_c_b[c19_i17] *= c19_e_a;
  }

  for (c19_i18 = 0; c19_i18 < 3; c19_i18++) {
    c19_b_rot[c19_i18] = c19_b[c19_i18] - c19_c_b[c19_i18];
  }

  for (c19_i19 = 0; c19_i19 < 3; c19_i19++) {
    c19_b_rot[c19_i19 + 3] = 0.0;
  }

  _SFD_EML_CALL(0U, chartInstance->c19_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c19_i20 = 0; c19_i20 < 6; c19_i20++) {
    (*chartInstance->c19_rot)[c19_i20] = c19_b_rot[c19_i20];
  }
  ...
  for (c19_i21 = 0; c19_i21 < 6; c19_i21++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c19_rot)[c19_i21], 1U);
  }

  for (c19_i22 = 0; c19_i22 < 12; c19_i22++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c19_r[c19_i22], 2U);
  }
}
  ...
  *c19_inData)
{
  ...
  real_T c19_u[6];
  const mxArray *c19_y = NULL;
  SFc19_M46DInstanceStruct *chartInstance;
  chartInstance = (SFc19_M46DInstanceStruct *)chartInstanceVoid;
  ...
  mxArray *c19_b_rot, const char_T *c19_identifier, real_T c19_y[6])
{
  ...
  c19_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c19_b_rot), &c19_thisId,
    c19_y);
  sf_mex_destroy(&c19_b_rot);
}
  ...
  const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId, real_T c19_y[6])
{
  ...
  int32_T c19_i25;
  (void)chartInstance;
  sf_mex_import(c19_parentId, sf_mex_dup(c19_u), c19_dv2, 1, 0, 0U, 1, 0U, 1, 6);
  for (c19_i25 = 0; c19_i25 < 6; c19_i25++) {
    c19_y[c19_i25] = c19_dv2[c19_i25];
  }
  ...
  *c19_mxArrayInData, const char_T *c19_varName, void *c19_outData)
{
  ...
  SFc19_M46DInstanceStruct *chartInstance;
  chartInstance = (SFc19_M46DInstanceStruct *)chartInstanceVoid;
  c19_b_rot = sf_mex_dup(c19_mxArrayInData);
  ...
  *c19_inData)
{
  ...
  chartInstance = (SFc19_M46DInstanceStruct *)chartInstanceVoid;
  c19_mxArrayOutData = NULL;
  for (c19_i27 = 0; c19_i27 < 12; c19_i27++) {
    c19_b_inData[c19_i27] = (*(real_T (*)[12])c19_inData)[c19_i27];
  }

  for (c19_i28 = 0; c19_i28 < 12; c19_i28++) {
  ...
  const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId, real_T c19_y[12])
{
  ...
  int32_T c19_i29;
  (void)chartInstance;
  sf_mex_import(c19_parentId, sf_mex_dup(c19_u), c19_dv3, 1, 0, 0U, 1, 0U, 1, 12);
  for (c19_i29 = 0; c19_i29 < 12; c19_i29++) {
    c19_y[c19_i29] = c19_dv3[c19_i29];
  }
  ...
  *c19_mxArrayInData, const char_T *c19_varName, void *c19_outData)
{
  ...
  SFc19_M46DInstanceStruct *chartInstance;
  chartInstance = (SFc19_M46DInstanceStruct *)chartInstanceVoid;
  c19_b_r = sf_mex_dup(c19_mxArrayInData);
  c19_identifier = c19_varName;
  c19_thisId.fIdentifier = c19_identifier;
  c19_thisId.fParent = NULL;
  c19_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c19_b_r), &c19_thisId, c19_y);
  sf_mex_destroy(&c19_b_r);
  for (c19_i30 = 0; c19_i30 < 12; c19_i30++) {
    (*(real_T (*)[12])c19_outData)[c19_i30] = c19_y[c19_i30];
  }
...
const mxArray *sf_c19_M46D_get_eml_resolved_functions_info(void)
{
  const mxArray *c19_nameCaptureInfo = NULL;
  c19_nameCaptureInfo = NULL;
  sf_mex_assign(&c19_nameCaptureInfo, sf_mex_createstruct("structure", 2, 26, 1),
                false);
...
static void c19_info_helper(const mxArray **c19_info)
{
  ...
  sf_mex_addfield(*c19_info, c19_b_emlrt_marshallOut(1372608360U), "fileTimeLo",
                  "fileTimeLo", 16);
  sf_mex_addfield(*c19_info, c19_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 16);
  sf_mex_addfield(*c19_info, c19_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 20);
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut("isfi"), "name", "name", 20);
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut("coder.internal.indexInt"),
  ...
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 22);
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut("intmax"), "name", "name", 22);
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 24);
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut("intmin"), "name", "name", 24);
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 24);
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut(
  ...
  c19_x[3], real_T c19_y[3])
{
  ...
  for (c19_k = 1; c19_k < 4; c19_k++) {
    ...
    c19_d += c19_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
      "", (real_T)c19_b_k), 1, 3, 1, 0) - 1] * c19_y[_SFD_EML_ARRAY_BOUNDS_CHECK
      ("", (int32_T)_SFD_INTEGER_CHECK("", (real_T)c19_b_k), 1, 3, 1, 0) - 1];
  }
  ...
  const mxArray *c19_b_is_active_c19_M46D, const char_T *c19_identifier)
{
  ...
  c19_y = c19_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c19_b_is_active_c19_M46D), &c19_thisId);
  sf_mex_destroy(&c19_b_is_active_c19_M46D);
  return c19_y;
}
...
static void init_simulink_io_address(SFc19_M46DInstanceStruct *chartInstance)
{
  chartInstance->c19_dx_d = (real_T (*)[6])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c19_rot = (real_T (*)[6])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
void sf_c19_M46D_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3734755060U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1637383532U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3138188935U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2430044262U);
}

mxArray* sf_c19_M46D_get_post_codegen_info(void);
mxArray *sf_c19_M46D_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("V5imeNNhX9kgxKSYh5F4ED");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c19_M46D_get_post_codegen_info();
...
mxArray *sf_c19_M46D_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c19_M46D_jit_fallback_info(void)
{
...
mxArray *sf_c19_M46D_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c19_M46D(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"rot\",},{M[8],M[0],T\"is_active_c19_M46D\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c19_M46D_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc19_M46DInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(0U, *chartInstance->c19_dx_d);
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c19_rot);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c19_r);
      }
    } else {
...
{
  return "lL4A590OcsEbKAjq1rJDQB";
}

static void sf_opaque_initialize_c19_M46D(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc19_M46DInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c19_M46D((SFc19_M46DInstanceStruct*) chartInstanceVar);
  initialize_c19_M46D((SFc19_M46DInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c19_M46D(void *chartInstanceVar)
{
  enable_c19_M46D((SFc19_M46DInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c19_M46D(void *chartInstanceVar)
{
  disable_c19_M46D((SFc19_M46DInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c19_M46D(void *chartInstanceVar)
{
  sf_gateway_c19_M46D((SFc19_M46DInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c19_M46D(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c19_M46D((SFc19_M46DInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c19_M46D(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c19_M46D((SFc19_M46DInstanceStruct*)chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c19_M46D(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc19_M46DInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c19_M46D((SFc19_M46DInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc19_M46D((SFc19_M46DInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c19_M46D(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c19_M46D((SFc19_M46DInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c19_M46D(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1853770851U));
  ssSetChecksum1(S,(995013862U));
  ssSetChecksum2(S,(397269587U));
  ssSetChecksum3(S,(2875013243U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c19_M46D(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c19_M46D(SimStruct *S)
{
  SFc19_M46DInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc19_M46DInstanceStruct *)utMalloc(sizeof
    (SFc19_M46DInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc19_M46DInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c19_M46D;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c19_M46D;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c19_M46D;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c19_M46D;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c19_M46D;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c19_M46D;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c19_M46D;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c19_M46D;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c19_M46D;
  chartInstance->chartInfo.mdlStart = mdlStart_c19_M46D;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c19_M46D;
...
void c19_M46D_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c19_M46D(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c19_M46D(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c19_M46D_method_dispatcher.\n"
