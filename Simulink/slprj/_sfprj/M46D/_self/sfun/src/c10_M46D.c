...
static void initialize_c10_M46D(SFc10_M46DInstanceStruct *chartInstance);
static void initialize_params_c10_M46D(SFc10_M46DInstanceStruct *chartInstance);
static void enable_c10_M46D(SFc10_M46DInstanceStruct *chartInstance);
static void disable_c10_M46D(SFc10_M46DInstanceStruct *chartInstance);
static void c10_update_debugger_state_c10_M46D(SFc10_M46DInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c10_M46D(SFc10_M46DInstanceStruct
  *chartInstance);
static void set_sim_state_c10_M46D(SFc10_M46DInstanceStruct *chartInstance,
  const mxArray *c10_st);
static void finalize_c10_M46D(SFc10_M46DInstanceStruct *chartInstance);
static void sf_gateway_c10_M46D(SFc10_M46DInstanceStruct *chartInstance);
static void mdl_start_c10_M46D(SFc10_M46DInstanceStruct *chartInstance);
static void c10_chartstep_c10_M46D(SFc10_M46DInstanceStruct *chartInstance);
static void initSimStructsc10_M46D(SFc10_M46DInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber, uint32_T c10_instanceNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_emlrt_marshallIn(SFc10_M46DInstanceStruct *chartInstance, const
  mxArray *c10_b_rot, const char_T *c10_identifier, real_T c10_y[30]);
static void c10_b_emlrt_marshallIn(SFc10_M46DInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId, real_T c10_y[30]);
static void c10_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_b_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_c_emlrt_marshallIn(SFc10_M46DInstanceStruct *chartInstance,
...
static const mxArray *c10_c_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_d_emlrt_marshallIn(SFc10_M46DInstanceStruct *chartInstance,
...
static const mxArray *c10_d_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_e_emlrt_marshallIn(SFc10_M46DInstanceStruct *chartInstance,
...
static const mxArray *c10_e_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_f_emlrt_marshallIn(SFc10_M46DInstanceStruct *chartInstance,
...
static void c10_eml_scalar_eg(SFc10_M46DInstanceStruct *chartInstance);
static void c10_eml_xgemm(SFc10_M46DInstanceStruct *chartInstance, real_T c10_A
  [9], real_T c10_B[3], real_T c10_C[3], real_T c10_b_C[3]);
static const mxArray *c10_f_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_g_emlrt_marshallIn(SFc10_M46DInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static uint8_T c10_h_emlrt_marshallIn(SFc10_M46DInstanceStruct *chartInstance,
  const mxArray *c10_b_is_active_c10_M46D, const char_T *c10_identifier);
static uint8_T c10_i_emlrt_marshallIn(SFc10_M46DInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_b_eml_xgemm(SFc10_M46DInstanceStruct *chartInstance, real_T
  c10_A[9], real_T c10_B[3], real_T c10_C[3]);
static void init_dsm_address_info(SFc10_M46DInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc10_M46DInstanceStruct *chartInstance);
...
static void initialize_c10_M46D(SFc10_M46DInstanceStruct *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_M46D = 0U;
}
  ...
  *chartInstance)
{
  ...
  for (c10_i1 = 0; c10_i1 < 30; c10_i1++) {
    c10_u[c10_i1] = (*chartInstance->c10_rot)[c10_i1];
  }

  c10_b_y = NULL;
  sf_mex_assign(&c10_b_y, sf_mex_create("y", c10_u, 0, 0U, 1U, 0U, 1, 30), false);
  sf_mex_setcell(c10_y, 0, c10_b_y);
  c10_hoistedGlobal = chartInstance->c10_is_active_c10_M46D;
  ...
  const mxArray *c10_st)
{
  ...
  c10_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 0)),
                       "rot", c10_dv1);
  for (c10_i2 = 0; c10_i2 < 30; c10_i2++) {
    (*chartInstance->c10_rot)[c10_i2] = c10_dv1[c10_i2];
  }

  chartInstance->c10_is_active_c10_M46D = c10_h_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c10_u, 1)), "is_active_c10_M46D");
  sf_mex_destroy(&c10_u);
  c10_update_debugger_state_c10_M46D(chartInstance);
...
static void sf_gateway_c10_M46D(SFc10_M46DInstanceStruct *chartInstance)
{
  ...
  for (c10_i3 = 0; c10_i3 < 30; c10_i3++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c10_dx)[c10_i3], 0U);
  }

  chartInstance->c10_sfEvent = CALL_EVENT;
  c10_chartstep_c10_M46D(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_M46DMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c10_i4 = 0; c10_i4 < 30; c10_i4++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c10_rot)[c10_i4], 1U);
  }

  for (c10_i5 = 0; c10_i5 < 12; c10_i5++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c10_r[c10_i5], 2U);
  }
}
...
static void c10_chartstep_c10_M46D(SFc10_M46DInstanceStruct *chartInstance)
{
  ...
  for (c10_i6 = 0; c10_i6 < 30; c10_i6++) {
    c10_b_dx[c10_i6] = (*chartInstance->c10_dx)[c10_i6];
  }

  for (c10_i7 = 0; c10_i7 < 12; c10_i7++) {
    c10_b_r[c10_i7] = chartInstance->c10_r[c10_i7];
  }
  ...
  for (c10_i8 = 0; c10_i8 < 3; c10_i8++) {
    c10_x[c10_i8] = c10_b_dx[c10_i8 + 3];
  }
  ...
  for (c10_i9 = 0; c10_i9 < 9; c10_i9++) {
    c10_a[c10_i9] = c10_X[c10_i9];
  }

  for (c10_i10 = 0; c10_i10 < 3; c10_i10++) {
    c10_b[c10_i10] = c10_b_r[c10_i10];
  }
  ...
  for (c10_i15 = 0; c10_i15 < 9; c10_i15++) {
    c10_a[c10_i15] = c10_b_X[c10_i15];
  }

  for (c10_i16 = 0; c10_i16 < 3; c10_i16++) {
    c10_b[c10_i16] = c10_b_r[c10_i16 + 3];
  }
  ...
  for (c10_i18 = 0; c10_i18 < 9; c10_i18++) {
    c10_c_a[c10_i18] = c10_a[c10_i18];
  }

  for (c10_i19 = 0; c10_i19 < 3; c10_i19++) {
    c10_c_b[c10_i19] = c10_b[c10_i19];
  }

  c10_b_eml_xgemm(chartInstance, c10_c_a, c10_c_b, c10_b_y);
  for (c10_i20 = 0; c10_i20 < 3; c10_i20++) {
    c10_c_x[c10_i20] = c10_b_dx[c10_i20 + 3];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 4U, 4U, c10_b_debug_family_names,
    c10_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_d_nargin, 0U, c10_c_sf_marshallOut,
    c10_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_d_nargout, 1U, c10_c_sf_marshallOut,
    c10_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c10_c_x, 2U, c10_e_sf_marshallOut,
    c10_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c10_c_X, 3U, c10_d_sf_marshallOut,
    c10_d_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  _SFD_SCRIPT_CALL(0U, chartInstance->c10_sfEvent, 3);
  c10_c_X[0] = 0.0;
  ...
  _SFD_SCRIPT_CALL(0U, chartInstance->c10_sfEvent, -3);
  _SFD_SYMBOL_SCOPE_POP();
  for (c10_i21 = 0; c10_i21 < 9; c10_i21++) {
    c10_a[c10_i21] = c10_c_X[c10_i21];
  }

  for (c10_i22 = 0; c10_i22 < 3; c10_i22++) {
    c10_b[c10_i22] = c10_b_r[c10_i22 + 6];
  }
  ...
  for (c10_i24 = 0; c10_i24 < 9; c10_i24++) {
    c10_d_a[c10_i24] = c10_a[c10_i24];
  }

  for (c10_i25 = 0; c10_i25 < 3; c10_i25++) {
    c10_d_b[c10_i25] = c10_b[c10_i25];
  }

  c10_b_eml_xgemm(chartInstance, c10_d_a, c10_d_b, c10_c_y);
  for (c10_i26 = 0; c10_i26 < 3; c10_i26++) {
    c10_d_x[c10_i26] = c10_b_dx[c10_i26 + 3];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 4U, 4U, c10_b_debug_family_names,
    c10_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_e_nargin, 0U, c10_c_sf_marshallOut,
    c10_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_e_nargout, 1U, c10_c_sf_marshallOut,
    c10_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c10_d_x, 2U, c10_e_sf_marshallOut,
    c10_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c10_d_X, 3U, c10_d_sf_marshallOut,
    c10_d_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  _SFD_SCRIPT_CALL(0U, chartInstance->c10_sfEvent, 3);
  c10_d_X[0] = 0.0;
  ...
  for (c10_i27 = 0; c10_i27 < 9; c10_i27++) {
    c10_a[c10_i27] = c10_d_X[c10_i27];
  }

  for (c10_i28 = 0; c10_i28 < 3; c10_i28++) {
    c10_b[c10_i28] = c10_b_r[c10_i28 + 9];
  }
  ...
  for (c10_i30 = 0; c10_i30 < 9; c10_i30++) {
    c10_e_a[c10_i30] = c10_a[c10_i30];
  }

  for (c10_i31 = 0; c10_i31 < 3; c10_i31++) {
    c10_e_b[c10_i31] = c10_b[c10_i31];
  }

  c10_b_eml_xgemm(chartInstance, c10_e_a, c10_e_b, c10_d_y);
  for (c10_i32 = 0; c10_i32 < 6; c10_i32++) {
    c10_b_rot[c10_i32] = 0.0;
  }

  for (c10_i33 = 0; c10_i33 < 3; c10_i33++) {
    c10_b_rot[c10_i33 + 6] = c10_y[c10_i33];
  }

  for (c10_i34 = 0; c10_i34 < 3; c10_i34++) {
    c10_b_rot[c10_i34 + 9] = 0.0;
  }

  for (c10_i35 = 0; c10_i35 < 3; c10_i35++) {
    c10_b_rot[c10_i35 + 12] = c10_b_y[c10_i35];
  }

  for (c10_i36 = 0; c10_i36 < 3; c10_i36++) {
    c10_b_rot[c10_i36 + 15] = 0.0;
  }

  for (c10_i37 = 0; c10_i37 < 3; c10_i37++) {
    c10_b_rot[c10_i37 + 18] = c10_c_y[c10_i37];
  }

  for (c10_i38 = 0; c10_i38 < 3; c10_i38++) {
    c10_b_rot[c10_i38 + 21] = 0.0;
  }

  for (c10_i39 = 0; c10_i39 < 3; c10_i39++) {
    c10_b_rot[c10_i39 + 24] = c10_d_y[c10_i39];
  }

  for (c10_i40 = 0; c10_i40 < 3; c10_i40++) {
    c10_b_rot[c10_i40 + 27] = 0.0;
  }

  _SFD_EML_CALL(0U, chartInstance->c10_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c10_i41 = 0; c10_i41 < 30; c10_i41++) {
    (*chartInstance->c10_rot)[c10_i41] = c10_b_rot[c10_i41];
  }
  ...
  *c10_inData)
{
  ...
  int32_T c10_i42;
  real_T c10_b_inData[30];
  int32_T c10_i43;
  real_T c10_u[30];
  const mxArray *c10_y = NULL;
  SFc10_M46DInstanceStruct *chartInstance;
  chartInstance = (SFc10_M46DInstanceStruct *)chartInstanceVoid;
  c10_mxArrayOutData = NULL;
  for (c10_i42 = 0; c10_i42 < 30; c10_i42++) {
    c10_b_inData[c10_i42] = (*(real_T (*)[30])c10_inData)[c10_i42];
  }

  for (c10_i43 = 0; c10_i43 < 30; c10_i43++) {
    c10_u[c10_i43] = c10_b_inData[c10_i43];
  }

  c10_y = NULL;
  sf_mex_assign(&c10_y, sf_mex_create("y", c10_u, 0, 0U, 1U, 0U, 1, 30), false);
  ...
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId, real_T c10_y[30])
{
  ...
  int32_T c10_i44;
  (void)chartInstance;
  sf_mex_import(c10_parentId, sf_mex_dup(c10_u), c10_dv2, 1, 0, 0U, 1, 0U, 1, 30);
  for (c10_i44 = 0; c10_i44 < 30; c10_i44++) {
    c10_y[c10_i44] = c10_dv2[c10_i44];
  }
  ...
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData)
{
  ...
  c10_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c10_b_rot), &c10_thisId,
    c10_y);
  sf_mex_destroy(&c10_b_rot);
  for (c10_i45 = 0; c10_i45 < 30; c10_i45++) {
    (*(real_T (*)[30])c10_outData)[c10_i45] = c10_y[c10_i45];
  }
  ...
  *c10_inData)
{
  ...
  chartInstance = (SFc10_M46DInstanceStruct *)chartInstanceVoid;
  c10_mxArrayOutData = NULL;
  for (c10_i46 = 0; c10_i46 < 12; c10_i46++) {
    c10_b_inData[c10_i46] = (*(real_T (*)[12])c10_inData)[c10_i46];
  }

  for (c10_i47 = 0; c10_i47 < 12; c10_i47++) {
  ...
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId, real_T c10_y[12])
{
  ...
  int32_T c10_i48;
  (void)chartInstance;
  sf_mex_import(c10_parentId, sf_mex_dup(c10_u), c10_dv3, 1, 0, 0U, 1, 0U, 1, 12);
  for (c10_i48 = 0; c10_i48 < 12; c10_i48++) {
    c10_y[c10_i48] = c10_dv3[c10_i48];
  }
  ...
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData)
{
  ...
  for (c10_i49 = 0; c10_i49 < 12; c10_i49++) {
    (*(real_T (*)[12])c10_outData)[c10_i49] = c10_y[c10_i49];
  }
  ...
  *c10_inData)
{
  ...
  for (c10_i51 = 0; c10_i51 < 3; c10_i51++) {
    for (c10_i52 = 0; c10_i52 < 3; c10_i52++) {
      c10_b_inData[c10_i52 + c10_i50] = (*(real_T (*)[9])c10_inData)[c10_i52 +
        c10_i50];
    }
  ...
  for (c10_i54 = 0; c10_i54 < 3; c10_i54++) {
    for (c10_i55 = 0; c10_i55 < 3; c10_i55++) {
      c10_u[c10_i55 + c10_i53] = c10_b_inData[c10_i55 + c10_i53];
    }
  ...
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData)
{
  ...
  for (c10_i58 = 0; c10_i58 < 3; c10_i58++) {
    for (c10_i59 = 0; c10_i59 < 3; c10_i59++) {
      (*(real_T (*)[9])c10_outData)[c10_i59 + c10_i57] = c10_y[c10_i59 + c10_i57];
    }
  ...
  *c10_inData)
{
  ...
  for (c10_i60 = 0; c10_i60 < 3; c10_i60++) {
    c10_b_inData[c10_i60] = (*(real_T (*)[3])c10_inData)[c10_i60];
  }
  ...
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData)
{
  ...
  for (c10_i63 = 0; c10_i63 < 3; c10_i63++) {
    (*(real_T (*)[3])c10_outData)[c10_i63] = c10_y[c10_i63];
  }

  sf_mex_destroy(&c10_mxArrayInData);
}

const mxArray *sf_c10_M46D_get_eml_resolved_functions_info(void)
{
  ...
  [9], real_T c10_B[3], real_T c10_C[3], real_T c10_b_C[3])
{
  ...
  for (c10_i64 = 0; c10_i64 < 3; c10_i64++) {
    c10_b_C[c10_i64] = c10_C[c10_i64];
  }

  for (c10_i65 = 0; c10_i65 < 9; c10_i65++) {
    c10_b_A[c10_i65] = c10_A[c10_i65];
  }

  for (c10_i66 = 0; c10_i66 < 3; c10_i66++) {
    c10_b_B[c10_i66] = c10_B[c10_i66];
  }
  ...
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId)
{
  ...
  int32_T c10_i67;
  (void)chartInstance;
  sf_mex_import(c10_parentId, sf_mex_dup(c10_u), &c10_i67, 1, 6, 0U, 0, 0U, 0);
  c10_y = c10_i67;
  sf_mex_destroy(&c10_u);
  return c10_y;
}
  ...
  const mxArray *c10_b_is_active_c10_M46D, const char_T *c10_identifier)
{
  ...
  c10_y = c10_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c10_b_is_active_c10_M46D), &c10_thisId);
  sf_mex_destroy(&c10_b_is_active_c10_M46D);
  return c10_y;
}
  ...
  c10_A[9], real_T c10_B[3], real_T c10_C[3])
{
  ...
  for (c10_i68 = 0; c10_i68 < 3; c10_i68++) {
    ...
    for (c10_i70 = 0; c10_i70 < 3; c10_i70++) {
      c10_C[c10_i68] += c10_A[c10_i69 + c10_i68] * c10_B[c10_i70];
      c10_i69 += 3;
    }
  }
}
...
static void init_simulink_io_address(SFc10_M46DInstanceStruct *chartInstance)
{
  chartInstance->c10_dx = (real_T (*)[30])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c10_rot = (real_T (*)[30])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
void sf_c10_M46D_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3361477584U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1600765576U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1875520203U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(781744382U);
}

mxArray* sf_c10_M46D_get_post_codegen_info(void);
mxArray *sf_c10_M46D_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Z3TMwZHwjxBjlmwxRpOan");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c10_M46D_get_post_codegen_info();
...
mxArray *sf_c10_M46D_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c10_M46D_jit_fallback_info(void)
{
...
mxArray *sf_c10_M46D_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c10_M46D(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"rot\",},{M[8],M[0],T\"is_active_c10_M46D\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_M46D_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc10_M46DInstanceStruct *) chartInfo->chartInstance;
...
{
  return "r3xjw1VeSki3xWsidfZqED";
}

static void sf_opaque_initialize_c10_M46D(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_M46DInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c10_M46D((SFc10_M46DInstanceStruct*) chartInstanceVar);
  initialize_c10_M46D((SFc10_M46DInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c10_M46D(void *chartInstanceVar)
{
  enable_c10_M46D((SFc10_M46DInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_M46D(void *chartInstanceVar)
{
  disable_c10_M46D((SFc10_M46DInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c10_M46D(void *chartInstanceVar)
{
  sf_gateway_c10_M46D((SFc10_M46DInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c10_M46D(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c10_M46D((SFc10_M46DInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c10_M46D(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c10_M46D((SFc10_M46DInstanceStruct*)chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c10_M46D(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_M46DInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c10_M46D((SFc10_M46DInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc10_M46D((SFc10_M46DInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_M46D(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c10_M46D((SFc10_M46DInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c10_M46D(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(248631588U));
  ssSetChecksum1(S,(1366913855U));
  ssSetChecksum2(S,(2658738552U));
  ssSetChecksum3(S,(1257512912U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c10_M46D(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_M46D(SimStruct *S)
{
  SFc10_M46DInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc10_M46DInstanceStruct *)utMalloc(sizeof
    (SFc10_M46DInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_M46DInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c10_M46D;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c10_M46D;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c10_M46D;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_M46D;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_M46D;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c10_M46D;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c10_M46D;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c10_M46D;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_M46D;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_M46D;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c10_M46D;
...
void c10_M46D_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_M46D(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_M46D(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_M46D_method_dispatcher.\n"
