...
static void initialize_c7_M46D(SFc7_M46DInstanceStruct *chartInstance);
static void initialize_params_c7_M46D(SFc7_M46DInstanceStruct *chartInstance);
static void enable_c7_M46D(SFc7_M46DInstanceStruct *chartInstance);
static void disable_c7_M46D(SFc7_M46DInstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_M46D(SFc7_M46DInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c7_M46D(SFc7_M46DInstanceStruct
  *chartInstance);
static void set_sim_state_c7_M46D(SFc7_M46DInstanceStruct *chartInstance, const
  mxArray *c7_st);
static void finalize_c7_M46D(SFc7_M46DInstanceStruct *chartInstance);
static void sf_gateway_c7_M46D(SFc7_M46DInstanceStruct *chartInstance);
static void mdl_start_c7_M46D(SFc7_M46DInstanceStruct *chartInstance);
static void c7_chartstep_c7_M46D(SFc7_M46DInstanceStruct *chartInstance);
static void initSimStructsc7_M46D(SFc7_M46DInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber, uint32_T c7_instanceNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static void c7_emlrt_marshallIn(SFc7_M46DInstanceStruct *chartInstance, const
  mxArray *c7_b_rot, const char_T *c7_identifier, real_T c7_y[30]);
static void c7_b_emlrt_marshallIn(SFc7_M46DInstanceStruct *chartInstance, const
  mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId, real_T c7_y[30]);
static void c7_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_b_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_c_emlrt_marshallIn(SFc7_M46DInstanceStruct *chartInstance, const
  mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId, real_T c7_y[12]);
static void c7_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_c_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static real_T c7_d_emlrt_marshallIn(SFc7_M46DInstanceStruct *chartInstance,
...
static real_T c7_eml_xdotu(SFc7_M46DInstanceStruct *chartInstance, real_T c7_x[3],
  real_T c7_y[3]);
static const mxArray *c7_d_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_e_emlrt_marshallIn(SFc7_M46DInstanceStruct *chartInstance,
  const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint8_T c7_f_emlrt_marshallIn(SFc7_M46DInstanceStruct *chartInstance,
  const mxArray *c7_b_is_active_c7_M46D, const char_T *c7_identifier);
static uint8_T c7_g_emlrt_marshallIn(SFc7_M46DInstanceStruct *chartInstance,
  const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void init_dsm_address_info(SFc7_M46DInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc7_M46DInstanceStruct *chartInstance);
...
static void initialize_c7_M46D(SFc7_M46DInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_M46D = 0U;
}
  ...
  *chartInstance)
{
  ...
  for (c7_i1 = 0; c7_i1 < 30; c7_i1++) {
    c7_u[c7_i1] = (*chartInstance->c7_rot)[c7_i1];
  }

  c7_b_y = NULL;
  sf_mex_assign(&c7_b_y, sf_mex_create("y", c7_u, 0, 0U, 1U, 0U, 1, 30), false);
  sf_mex_setcell(c7_y, 0, c7_b_y);
  c7_hoistedGlobal = chartInstance->c7_is_active_c7_M46D;
  ...
  mxArray *c7_st)
{
  ...
  chartInstance->c7_is_active_c7_M46D = c7_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c7_u, 1)), "is_active_c7_M46D");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_M46D(chartInstance);
...
static void sf_gateway_c7_M46D(SFc7_M46DInstanceStruct *chartInstance)
{
  ...
  for (c7_i3 = 0; c7_i3 < 30; c7_i3++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c7_dx)[c7_i3], 0U);
  }

  chartInstance->c7_sfEvent = CALL_EVENT;
  c7_chartstep_c7_M46D(chartInstance);
...
static void c7_chartstep_c7_M46D(SFc7_M46DInstanceStruct *chartInstance)
{
  ...
  for (c7_i32 = 0; c7_i32 < 3; c7_i32++) {
    c7_a[c7_i32] = c7_b_dx[c7_i32 + 3];
  }

  for (c7_i33 = 0; c7_i33 < 3; c7_i33++) {
    c7_i_b[c7_i33] = c7_b_r[c7_i33 + 6];
  }

  for (c7_i34 = 0; c7_i34 < 3; c7_i34++) {
    c7_j_a[c7_i34] = c7_a[c7_i34];
  }

  for (c7_i35 = 0; c7_i35 < 3; c7_i35++) {
    c7_j_b[c7_i35] = c7_i_b[c7_i35];
  }

  c7_e_y = c7_eml_xdotu(chartInstance, c7_j_a, c7_j_b);
  c7_k_a = c7_e_y;
  for (c7_i36 = 0; c7_i36 < 3; c7_i36++) {
    c7_i_b[c7_i36] = c7_b_dx[c7_i36 + 3];
  }

  for (c7_i37 = 0; c7_i37 < 3; c7_i37++) {
    c7_i_b[c7_i37] *= c7_k_a;
  }

  for (c7_i38 = 0; c7_i38 < 3; c7_i38++) {
    c7_a[c7_i38] = c7_b_dx[c7_i38 + 3];
  }

  for (c7_i39 = 0; c7_i39 < 3; c7_i39++) {
    c7_k_b[c7_i39] = c7_b_dx[c7_i39 + 3];
  }

  for (c7_i40 = 0; c7_i40 < 3; c7_i40++) {
    c7_l_a[c7_i40] = c7_a[c7_i40];
  }

  for (c7_i41 = 0; c7_i41 < 3; c7_i41++) {
    c7_l_b[c7_i41] = c7_k_b[c7_i41];
  }

  c7_f_y = c7_eml_xdotu(chartInstance, c7_l_a, c7_l_b);
  c7_m_a = c7_f_y;
  for (c7_i42 = 0; c7_i42 < 3; c7_i42++) {
    c7_k_b[c7_i42] = c7_b_r[c7_i42 + 6];
  }

  for (c7_i43 = 0; c7_i43 < 3; c7_i43++) {
    c7_k_b[c7_i43] *= c7_m_a;
  }

  for (c7_i44 = 0; c7_i44 < 3; c7_i44++) {
    c7_a[c7_i44] = c7_b_dx[c7_i44 + 3];
  }

  for (c7_i45 = 0; c7_i45 < 3; c7_i45++) {
    c7_m_b[c7_i45] = c7_b_r[c7_i45 + 9];
  }

  for (c7_i46 = 0; c7_i46 < 3; c7_i46++) {
    c7_n_a[c7_i46] = c7_a[c7_i46];
  }

  for (c7_i47 = 0; c7_i47 < 3; c7_i47++) {
    c7_n_b[c7_i47] = c7_m_b[c7_i47];
  }

  c7_g_y = c7_eml_xdotu(chartInstance, c7_n_a, c7_n_b);
  c7_o_a = c7_g_y;
  for (c7_i48 = 0; c7_i48 < 3; c7_i48++) {
    c7_m_b[c7_i48] = c7_b_dx[c7_i48 + 3];
  }

  for (c7_i49 = 0; c7_i49 < 3; c7_i49++) {
    c7_m_b[c7_i49] *= c7_o_a;
  }

  for (c7_i50 = 0; c7_i50 < 3; c7_i50++) {
    c7_a[c7_i50] = c7_b_dx[c7_i50 + 3];
  }

  for (c7_i51 = 0; c7_i51 < 3; c7_i51++) {
    c7_o_b[c7_i51] = c7_b_dx[c7_i51 + 3];
  }

  for (c7_i52 = 0; c7_i52 < 3; c7_i52++) {
    c7_p_a[c7_i52] = c7_a[c7_i52];
  }

  for (c7_i53 = 0; c7_i53 < 3; c7_i53++) {
    c7_p_b[c7_i53] = c7_o_b[c7_i53];
  }

  c7_h_y = c7_eml_xdotu(chartInstance, c7_p_a, c7_p_b);
  c7_q_a = c7_h_y;
  for (c7_i54 = 0; c7_i54 < 3; c7_i54++) {
    c7_o_b[c7_i54] = c7_b_r[c7_i54 + 9];
  }

  for (c7_i55 = 0; c7_i55 < 3; c7_i55++) {
    c7_o_b[c7_i55] *= c7_q_a;
  }
  ...
  for (c7_i57 = 0; c7_i57 < 3; c7_i57++) {
    c7_b_rot[c7_i57 + 6] = c7_b[c7_i57] - c7_c_b[c7_i57];
  }

  for (c7_i58 = 0; c7_i58 < 3; c7_i58++) {
    c7_b_rot[c7_i58 + 9] = 0.0;
  }

  for (c7_i59 = 0; c7_i59 < 3; c7_i59++) {
    c7_b_rot[c7_i59 + 12] = c7_e_b[c7_i59] - c7_g_b[c7_i59];
  }

  for (c7_i60 = 0; c7_i60 < 3; c7_i60++) {
    c7_b_rot[c7_i60 + 15] = 0.0;
  }

  for (c7_i61 = 0; c7_i61 < 3; c7_i61++) {
    c7_b_rot[c7_i61 + 18] = c7_i_b[c7_i61] - c7_k_b[c7_i61];
  }

  for (c7_i62 = 0; c7_i62 < 3; c7_i62++) {
    c7_b_rot[c7_i62 + 21] = 0.0;
  }

  for (c7_i63 = 0; c7_i63 < 3; c7_i63++) {
    c7_b_rot[c7_i63 + 24] = c7_m_b[c7_i63] - c7_o_b[c7_i63];
  }

  for (c7_i64 = 0; c7_i64 < 3; c7_i64++) {
    c7_b_rot[c7_i64 + 27] = 0.0;
  }

  _SFD_EML_CALL(0U, chartInstance->c7_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c7_i65 = 0; c7_i65 < 30; c7_i65++) {
    (*chartInstance->c7_rot)[c7_i65] = c7_b_rot[c7_i65];
  }
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  real_T c7_u[30];
  const mxArray *c7_y = NULL;
  SFc7_M46DInstanceStruct *chartInstance;
  chartInstance = (SFc7_M46DInstanceStruct *)chartInstanceVoid;
  c7_mxArrayOutData = NULL;
  for (c7_i66 = 0; c7_i66 < 30; c7_i66++) {
    c7_b_inData[c7_i66] = (*(real_T (*)[30])c7_inData)[c7_i66];
  }

  for (c7_i67 = 0; c7_i67 < 30; c7_i67++) {
    c7_u[c7_i67] = c7_b_inData[c7_i67];
  }
  ...
  mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId, real_T c7_y[30])
{
  ...
  int32_T c7_i68;
  (void)chartInstance;
  sf_mex_import(c7_parentId, sf_mex_dup(c7_u), c7_dv2, 1, 0, 0U, 1, 0U, 1, 30);
  for (c7_i68 = 0; c7_i68 < 30; c7_i68++) {
    c7_y[c7_i68] = c7_dv2[c7_i68];
  }
  ...
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData)
{
  ...
  for (c7_i69 = 0; c7_i69 < 30; c7_i69++) {
    (*(real_T (*)[30])c7_outData)[c7_i69] = c7_y[c7_i69];
  }
  ...
  *c7_inData)
{
  ...
  chartInstance = (SFc7_M46DInstanceStruct *)chartInstanceVoid;
  c7_mxArrayOutData = NULL;
  for (c7_i70 = 0; c7_i70 < 12; c7_i70++) {
    c7_b_inData[c7_i70] = (*(real_T (*)[12])c7_inData)[c7_i70];
  }

  for (c7_i71 = 0; c7_i71 < 12; c7_i71++) {
    c7_u[c7_i71] = c7_b_inData[c7_i71];
  }
  ...
  mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId, real_T c7_y[12])
{
  ...
  int32_T c7_i72;
  (void)chartInstance;
  sf_mex_import(c7_parentId, sf_mex_dup(c7_u), c7_dv3, 1, 0, 0U, 1, 0U, 1, 12);
  for (c7_i72 = 0; c7_i72 < 12; c7_i72++) {
    c7_y[c7_i72] = c7_dv3[c7_i72];
  }
  ...
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData)
{
  ...
  for (c7_i73 = 0; c7_i73 < 12; c7_i73++) {
    (*(real_T (*)[12])c7_outData)[c7_i73] = c7_y[c7_i73];
  }
...
const mxArray *sf_c7_M46D_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId)
{
  ...
  int32_T c7_i74;
  (void)chartInstance;
  sf_mex_import(c7_parentId, sf_mex_dup(c7_u), &c7_i74, 1, 6, 0U, 0, 0U, 0);
  c7_y = c7_i74;
  sf_mex_destroy(&c7_u);
  return c7_y;
}
  ...
  const mxArray *c7_b_is_active_c7_M46D, const char_T *c7_identifier)
{
  ...
  c7_thisId.fIdentifier = c7_identifier;
  c7_thisId.fParent = NULL;
  c7_y = c7_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c7_b_is_active_c7_M46D),
    &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_M46D);
  return c7_y;
}
...
static void init_simulink_io_address(SFc7_M46DInstanceStruct *chartInstance)
{
  chartInstance->c7_dx = (real_T (*)[30])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c7_rot = (real_T (*)[30])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
void sf_c7_M46D_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3511559200U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2663250938U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3847694088U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1780932712U);
}

mxArray* sf_c7_M46D_get_post_codegen_info(void);
mxArray *sf_c7_M46D_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("1pbh7rb7UMl7ER9bMXh8iF");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c7_M46D_get_post_codegen_info();
...
mxArray *sf_c7_M46D_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c7_M46D_jit_fallback_info(void)
{
...
mxArray *sf_c7_M46D_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c7_M46D(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"rot\",},{M[8],M[0],T\"is_active_c7_M46D\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_M46D_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc7_M46DInstanceStruct *) chartInfo->chartInstance;
...
{
  return "WFdkRj7uzauAK0vgKbQzJE";
}

static void sf_opaque_initialize_c7_M46D(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_M46DInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c7_M46D((SFc7_M46DInstanceStruct*) chartInstanceVar);
  initialize_c7_M46D((SFc7_M46DInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_M46D(void *chartInstanceVar)
{
  enable_c7_M46D((SFc7_M46DInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c7_M46D(void *chartInstanceVar)
{
  disable_c7_M46D((SFc7_M46DInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c7_M46D(void *chartInstanceVar)
{
  sf_gateway_c7_M46D((SFc7_M46DInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c7_M46D(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c7_M46D((SFc7_M46DInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c7_M46D(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c7_M46D((SFc7_M46DInstanceStruct*)chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c7_M46D(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_M46DInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c7_M46D((SFc7_M46DInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc7_M46D((SFc7_M46DInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_M46D(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c7_M46D((SFc7_M46DInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c7_M46D(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2708704097U));
  ssSetChecksum1(S,(1330035970U));
  ssSetChecksum2(S,(3936299799U));
  ssSetChecksum3(S,(971895958U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c7_M46D(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_M46D(SimStruct *S)
{
  SFc7_M46DInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc7_M46DInstanceStruct *)utMalloc(sizeof
    (SFc7_M46DInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_M46DInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c7_M46D;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c7_M46D;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c7_M46D;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_M46D;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c7_M46D;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c7_M46D;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c7_M46D;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c7_M46D;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_M46D;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_M46D;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c7_M46D;
...
void c7_M46D_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_M46D(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_M46D(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_M46D_method_dispatcher.\n"
