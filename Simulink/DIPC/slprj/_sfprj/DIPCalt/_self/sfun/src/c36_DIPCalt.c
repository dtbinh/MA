...
static void initialize_c36_DIPCalt(SFc36_DIPCaltInstanceStruct *chartInstance);
static void initialize_params_c36_DIPCalt(SFc36_DIPCaltInstanceStruct
  *chartInstance);
static void enable_c36_DIPCalt(SFc36_DIPCaltInstanceStruct *chartInstance);
static void disable_c36_DIPCalt(SFc36_DIPCaltInstanceStruct *chartInstance);
static void c36_update_debugger_state_c36_DIPCalt(SFc36_DIPCaltInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c36_DIPCalt(SFc36_DIPCaltInstanceStruct
  *chartInstance);
static void set_sim_state_c36_DIPCalt(SFc36_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c36_st);
static void finalize_c36_DIPCalt(SFc36_DIPCaltInstanceStruct *chartInstance);
static void sf_gateway_c36_DIPCalt(SFc36_DIPCaltInstanceStruct *chartInstance);
static void mdl_start_c36_DIPCalt(SFc36_DIPCaltInstanceStruct *chartInstance);
static void initSimStructsc36_DIPCalt(SFc36_DIPCaltInstanceStruct *chartInstance);
static void c36_quatrot(SFc36_DIPCaltInstanceStruct *chartInstance, real_T
  c36_q[4], real_T c36_b_r[3], real_T c36_rw[3]);
...
static const mxArray *c36_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_emlrt_marshallIn(SFc36_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c36_b_G, const char_T *c36_identifier, real_T c36_y[144]);
static void c36_b_emlrt_marshallIn(SFc36_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId, real_T c36_y[144]);
...
static const mxArray *c36_c_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_c_emlrt_marshallIn(SFc36_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId, real_T c36_y[12]);
...
static const mxArray *c36_d_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static real_T c36_d_emlrt_marshallIn(SFc36_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c36_e_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_e_emlrt_marshallIn(SFc36_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c36_f_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_f_emlrt_marshallIn(SFc36_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c36_g_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_g_emlrt_marshallIn(SFc36_DIPCaltInstanceStruct *chartInstance,
...
static void c36_eye(SFc36_DIPCaltInstanceStruct *chartInstance, real_T c36_I[9]);
static void c36_quatmultiply(SFc36_DIPCaltInstanceStruct *chartInstance, real_T
  c36_q[4], real_T c36_b_r[4], real_T c36_qout[4]);
static const mxArray *c36_h_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static int32_T c36_h_emlrt_marshallIn(SFc36_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void c36_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData);
static uint8_T c36_i_emlrt_marshallIn(SFc36_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c36_b_is_active_c36_DIPCalt, const char_T *c36_identifier);
static uint8_T c36_j_emlrt_marshallIn(SFc36_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void init_dsm_address_info(SFc36_DIPCaltInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc36_DIPCaltInstanceStruct *chartInstance);
...
static void initialize_c36_DIPCalt(SFc36_DIPCaltInstanceStruct *chartInstance)
{
  ...
  chartInstance->c36_is_active_c36_DIPCalt = 0U;
}
  ...
  *chartInstance)
{
  ...
  sf_mex_import_named("r", sf_mex_get_sfun_param(chartInstance->S, 0, 0),
                      c36_dv0, 0, 0, 0U, 1, 0U, 1, 12);
  for (c36_i0 = 0; c36_i0 < 12; c36_i0++) {
  ...
  *chartInstance)
{
  ...
  for (c36_i1 = 0; c36_i1 < 144; c36_i1++) {
    c36_u[c36_i1] = (*chartInstance->c36_G)[c36_i1];
  }

  c36_b_y = NULL;
  sf_mex_assign(&c36_b_y, sf_mex_create("y", c36_u, 0, 0U, 1U, 0U, 2, 6, 24),
                false);
  sf_mex_setcell(c36_y, 0, c36_b_y);
  c36_hoistedGlobal = chartInstance->c36_is_active_c36_DIPCalt;
  ...
  const mxArray *c36_st)
{
  ...
  chartInstance->c36_is_active_c36_DIPCalt = c36_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c36_u, 1)),
     "is_active_c36_DIPCalt");
  sf_mex_destroy(&c36_u);
  c36_update_debugger_state_c36_DIPCalt(chartInstance);
...
static void sf_gateway_c36_DIPCalt(SFc36_DIPCaltInstanceStruct *chartInstance)
{
  ...
  int32_T c36_i14;
  real_T c36_h_x[3];
  real_T c36_d_nargin = 1.0;
  real_T c36_d_nargout = 1.0;
  real_T c36_c_X[9];
  int32_T c36_i15;
  real_T c36_i_x[4];
  int32_T c36_i16;
  ...
  int32_T c36_i17;
  real_T c36_j_x[3];
  real_T c36_e_nargin = 1.0;
  real_T c36_e_nargout = 1.0;
  real_T c36_d_X[9];
  real_T c36_dv6[9];
  real_T c36_dv7[9];
  real_T c36_dv8[9];
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 18U, chartInstance->c36_sfEvent);
  for (c36_i3 = 0; c36_i3 < 12; c36_i3++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c36_r[c36_i3], 0U);
  }

  chartInstance->c36_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 18U, chartInstance->c36_sfEvent);
  for (c36_i4 = 0; c36_i4 < 12; c36_i4++) {
    c36_b_r[c36_i4] = chartInstance->c36_r[c36_i4];
  }

  for (c36_i5 = 0; c36_i5 < 28; c36_i5++) {
  ...
  for (c36_i12 = 0; c36_i12 < 4; c36_i12++) {
    c36_g_x[c36_i12] = c36_b_x[c36_i12 + 3];
  }

  for (c36_i13 = 0; c36_i13 < 3; c36_i13++) {
    c36_e_r[c36_i13] = c36_b_r[c36_i13 + 6];
  }

  c36_quatrot(chartInstance, c36_g_x, c36_e_r, c36_dv4);
  for (c36_i14 = 0; c36_i14 < 3; c36_i14++) {
    c36_h_x[c36_i14] = c36_dv4[c36_i14];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 4U, 4U, c36_c_debug_family_names,
    c36_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c36_d_nargin, 0U, c36_d_sf_marshallOut,
    c36_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c36_d_nargout, 1U, c36_d_sf_marshallOut,
    c36_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c36_h_x, 2U, c36_e_sf_marshallOut,
    c36_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c36_c_X, 3U, c36_g_sf_marshallOut,
    c36_f_sf_marshallIn);
  CV_SCRIPT_FCN(1, 0);
  _SFD_SCRIPT_CALL(1U, chartInstance->c36_sfEvent, 3);
  c36_c_X[0] = 0.0;
  ...
  for (c36_i15 = 0; c36_i15 < 4; c36_i15++) {
    c36_i_x[c36_i15] = c36_b_x[c36_i15 + 3];
  }

  for (c36_i16 = 0; c36_i16 < 3; c36_i16++) {
    c36_f_r[c36_i16] = c36_b_r[c36_i16 + 9];
  }

  c36_quatrot(chartInstance, c36_i_x, c36_f_r, c36_dv5);
  for (c36_i17 = 0; c36_i17 < 3; c36_i17++) {
    c36_j_x[c36_i17] = c36_dv5[c36_i17];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 4U, 4U, c36_c_debug_family_names,
    c36_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c36_e_nargin, 0U, c36_d_sf_marshallOut,
    c36_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c36_e_nargout, 1U, c36_d_sf_marshallOut,
    c36_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c36_j_x, 2U, c36_e_sf_marshallOut,
    c36_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c36_d_X, 3U, c36_g_sf_marshallOut,
    c36_f_sf_marshallIn);
  CV_SCRIPT_FCN(1, 0);
  _SFD_SCRIPT_CALL(1U, chartInstance->c36_sfEvent, 3);
  c36_d_X[0] = 0.0;
  ...
  c36_eye(chartInstance, c36_dv8);
  c36_eye(chartInstance, c36_dv9);
  c36_eye(chartInstance, c36_dv10);
  c36_eye(chartInstance, c36_dv11);
  c36_eye(chartInstance, c36_dv12);
  c36_eye(chartInstance, c36_dv13);
  c36_i18 = 0;
  c36_i19 = 0;
  for (c36_i20 = 0; c36_i20 < 3; c36_i20++) {
    for (c36_i21 = 0; c36_i21 < 3; c36_i21++) {
      c36_b_G[c36_i21 + c36_i18] = c36_dv6[c36_i21 + c36_i19];
    }
  ...
  for (c36_i23 = 0; c36_i23 < 3; c36_i23++) {
    for (c36_i24 = 0; c36_i24 < 3; c36_i24++) {
      c36_b_G[(c36_i24 + c36_i22) + 18] = 0.0;
    }
  ...
  for (c36_i27 = 0; c36_i27 < 3; c36_i27++) {
    for (c36_i28 = 0; c36_i28 < 3; c36_i28++) {
      c36_b_G[(c36_i28 + c36_i25) + 36] = c36_dv7[c36_i28 + c36_i26];
    }
  ...
  c36_i29 = 0;
  for (c36_i30 = 0; c36_i30 < 3; c36_i30++) {
    for (c36_i31 = 0; c36_i31 < 3; c36_i31++) {
      c36_b_G[(c36_i31 + c36_i29) + 54] = 0.0;
    }
  ...
  for (c36_i34 = 0; c36_i34 < 3; c36_i34++) {
    for (c36_i35 = 0; c36_i35 < 3; c36_i35++) {
      c36_b_G[(c36_i35 + c36_i32) + 72] = c36_dv8[c36_i35 + c36_i33];
    }
  ...
  for (c36_i37 = 0; c36_i37 < 3; c36_i37++) {
    for (c36_i38 = 0; c36_i38 < 3; c36_i38++) {
      c36_b_G[(c36_i38 + c36_i36) + 90] = 0.0;
    }
  ...
  for (c36_i41 = 0; c36_i41 < 3; c36_i41++) {
    for (c36_i42 = 0; c36_i42 < 3; c36_i42++) {
      c36_b_G[(c36_i42 + c36_i39) + 108] = c36_dv9[c36_i42 + c36_i40];
    }
  ...
  for (c36_i44 = 0; c36_i44 < 3; c36_i44++) {
    for (c36_i45 = 0; c36_i45 < 3; c36_i45++) {
      c36_b_G[(c36_i45 + c36_i43) + 126] = 0.0;
    }
  ...
  c36_i46 = 0;
  c36_i47 = 0;
  for (c36_i48 = 0; c36_i48 < 3; c36_i48++) {
    for (c36_i49 = 0; c36_i49 < 3; c36_i49++) {
      c36_b_G[(c36_i49 + c36_i46) + 3] = c36_X[c36_i49 + c36_i47];
    }
  ...
  c36_i50 = 0;
  c36_i51 = 0;
  for (c36_i52 = 0; c36_i52 < 3; c36_i52++) {
    for (c36_i53 = 0; c36_i53 < 3; c36_i53++) {
      c36_b_G[(c36_i53 + c36_i50) + 21] = c36_dv10[c36_i53 + c36_i51];
    }
  ...
  for (c36_i56 = 0; c36_i56 < 3; c36_i56++) {
    for (c36_i57 = 0; c36_i57 < 3; c36_i57++) {
      c36_b_G[(c36_i57 + c36_i54) + 39] = c36_b_X[c36_i57 + c36_i55];
    }
  ...
  for (c36_i60 = 0; c36_i60 < 3; c36_i60++) {
    for (c36_i61 = 0; c36_i61 < 3; c36_i61++) {
      c36_b_G[(c36_i61 + c36_i58) + 57] = c36_dv11[c36_i61 + c36_i59];
    }
  ...
  for (c36_i64 = 0; c36_i64 < 3; c36_i64++) {
    for (c36_i65 = 0; c36_i65 < 3; c36_i65++) {
      c36_b_G[(c36_i65 + c36_i62) + 75] = c36_c_X[c36_i65 + c36_i63];
    }
  ...
  for (c36_i68 = 0; c36_i68 < 3; c36_i68++) {
    for (c36_i69 = 0; c36_i69 < 3; c36_i69++) {
      c36_b_G[(c36_i69 + c36_i66) + 93] = c36_dv12[c36_i69 + c36_i67];
    }
  ...
  c36_i70 = 0;
  c36_i71 = 0;
  for (c36_i72 = 0; c36_i72 < 3; c36_i72++) {
    for (c36_i73 = 0; c36_i73 < 3; c36_i73++) {
      c36_b_G[(c36_i73 + c36_i70) + 111] = c36_d_X[c36_i73 + c36_i71];
    }
  ...
  c36_i74 = 0;
  c36_i75 = 0;
  for (c36_i76 = 0; c36_i76 < 3; c36_i76++) {
    for (c36_i77 = 0; c36_i77 < 3; c36_i77++) {
      c36_b_G[(c36_i77 + c36_i74) + 129] = c36_dv13[c36_i77 + c36_i75];
    }
  ...
  _SFD_EML_CALL(0U, chartInstance->c36_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c36_i78 = 0; c36_i78 < 144; c36_i78++) {
    (*chartInstance->c36_G)[c36_i78] = c36_b_G[c36_i78];
  }

  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 18U, chartInstance->c36_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_DIPCaltMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c36_i79 = 0; c36_i79 < 144; c36_i79++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c36_G)[c36_i79], 1U);
  }

  for (c36_i80 = 0; c36_i80 < 28; c36_i80++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c36_x)[c36_i80], 2U);
  }
}
  ...
  c36_q[4], real_T c36_b_r[3], real_T c36_rw[3])
{
  ...
  for (c36_i81 = 0; c36_i81 < 4; c36_i81++) {
    c36_b_q[c36_i81] = c36_q[c36_i81];
  }
  ...
  c36_dv14[0] = 0.0;
  for (c36_i82 = 0; c36_i82 < 3; c36_i82++) {
    c36_dv14[c36_i82 + 1] = c36_b_r[c36_i82];
  }

  for (c36_i83 = 0; c36_i83 < 4; c36_i83++) {
    c36_c_q[c36_i83] = c36_b_q[c36_i83];
  }

  c36_quatmultiply(chartInstance, c36_dv14, c36_c_q, c36_dv15);
  for (c36_i84 = 0; c36_i84 < 4; c36_i84++) {
    c36_d_q[c36_i84] = c36_q[c36_i84];
  }

  for (c36_i85 = 0; c36_i85 < 4; c36_i85++) {
    c36_dv16[c36_i85] = c36_dv15[c36_i85];
  }

  c36_quatmultiply(chartInstance, c36_d_q, c36_dv16, c36_b_q);
  for (c36_i86 = 0; c36_i86 < 4; c36_i86++) {
    c36_rwq[c36_i86] = c36_b_q[c36_i86];
  }

  _SFD_SCRIPT_CALL(0U, chartInstance->c36_sfEvent, 5);
  for (c36_i87 = 0; c36_i87 < 3; c36_i87++) {
    c36_rw[c36_i87] = c36_rwq[c36_i87 + 1];
  }
  ...
  *c36_inData)
{
  ...
  real_T c36_u[144];
  const mxArray *c36_y = NULL;
  SFc36_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc36_DIPCaltInstanceStruct *)chartInstanceVoid;
  c36_mxArrayOutData = NULL;
  c36_i88 = 0;
  for (c36_i89 = 0; c36_i89 < 24; c36_i89++) {
    for (c36_i90 = 0; c36_i90 < 6; c36_i90++) {
      c36_b_inData[c36_i90 + c36_i88] = (*(real_T (*)[144])c36_inData)[c36_i90 +
        c36_i88];
    }
  ...
  c36_i91 = 0;
  for (c36_i92 = 0; c36_i92 < 24; c36_i92++) {
    for (c36_i93 = 0; c36_i93 < 6; c36_i93++) {
      c36_u[c36_i93 + c36_i91] = c36_b_inData[c36_i93 + c36_i91];
    }
  ...
  c36_y = NULL;
  sf_mex_assign(&c36_y, sf_mex_create("y", c36_u, 0, 0U, 1U, 0U, 2, 6, 24),
                false);
  ...
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId, real_T c36_y[144])
{
  ...
  int32_T c36_i94;
  (void)chartInstance;
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), c36_dv17, 1, 0, 0U, 1, 0U, 2, 6,
                24);
  for (c36_i94 = 0; c36_i94 < 144; c36_i94++) {
    c36_y[c36_i94] = c36_dv17[c36_i94];
  }
  ...
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData)
{
  ...
  sf_mex_destroy(&c36_b_G);
  c36_i95 = 0;
  for (c36_i96 = 0; c36_i96 < 24; c36_i96++) {
    for (c36_i97 = 0; c36_i97 < 6; c36_i97++) {
      (*(real_T (*)[144])c36_outData)[c36_i97 + c36_i95] = c36_y[c36_i97 +
        c36_i95];
    }
  ...
  *c36_inData)
{
  ...
  chartInstance = (SFc36_DIPCaltInstanceStruct *)chartInstanceVoid;
  c36_mxArrayOutData = NULL;
  for (c36_i98 = 0; c36_i98 < 28; c36_i98++) {
    c36_b_inData[c36_i98] = (*(real_T (*)[28])c36_inData)[c36_i98];
  }

  for (c36_i99 = 0; c36_i99 < 28; c36_i99++) {
    c36_u[c36_i99] = c36_b_inData[c36_i99];
  }

  c36_y = NULL;
  sf_mex_assign(&c36_y, sf_mex_create("y", c36_u, 0, 0U, 1U, 0U, 1, 28), false);
  sf_mex_assign(&c36_mxArrayOutData, c36_y, false);
  return c36_mxArrayOutData;
}
  ...
  *c36_inData)
{
  ...
  chartInstance = (SFc36_DIPCaltInstanceStruct *)chartInstanceVoid;
  c36_mxArrayOutData = NULL;
  for (c36_i100 = 0; c36_i100 < 12; c36_i100++) {
    c36_b_inData[c36_i100] = (*(real_T (*)[12])c36_inData)[c36_i100];
  }

  for (c36_i101 = 0; c36_i101 < 12; c36_i101++) {
    c36_u[c36_i101] = c36_b_inData[c36_i101];
  }
  ...
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId, real_T c36_y[12])
{
  ...
  int32_T c36_i102;
  (void)chartInstance;
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), c36_dv18, 1, 0, 0U, 1, 0U, 1,
                12);
  for (c36_i102 = 0; c36_i102 < 12; c36_i102++) {
    c36_y[c36_i102] = c36_dv18[c36_i102];
  }
  ...
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData)
{
  ...
  for (c36_i103 = 0; c36_i103 < 12; c36_i103++) {
    (*(real_T (*)[12])c36_outData)[c36_i103] = c36_y[c36_i103];
  }
  ...
  *c36_inData)
{
  ...
  for (c36_i104 = 0; c36_i104 < 3; c36_i104++) {
    c36_b_inData[c36_i104] = (*(real_T (*)[3])c36_inData)[c36_i104];
  }

  for (c36_i105 = 0; c36_i105 < 3; c36_i105++) {
    c36_u[c36_i105] = c36_b_inData[c36_i105];
  }
  ...
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId, real_T c36_y[3])
{
  ...
  int32_T c36_i106;
  (void)chartInstance;
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), c36_dv19, 1, 0, 0U, 1, 0U, 1, 3);
  for (c36_i106 = 0; c36_i106 < 3; c36_i106++) {
    c36_y[c36_i106] = c36_dv19[c36_i106];
  }
  ...
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData)
{
  ...
  for (c36_i107 = 0; c36_i107 < 3; c36_i107++) {
    (*(real_T (*)[3])c36_outData)[c36_i107] = c36_y[c36_i107];
  }
  ...
  *c36_inData)
{
  ...
  chartInstance = (SFc36_DIPCaltInstanceStruct *)chartInstanceVoid;
  c36_mxArrayOutData = NULL;
  for (c36_i108 = 0; c36_i108 < 4; c36_i108++) {
    c36_b_inData[c36_i108] = (*(real_T (*)[4])c36_inData)[c36_i108];
  }

  for (c36_i109 = 0; c36_i109 < 4; c36_i109++) {
    c36_u[c36_i109] = c36_b_inData[c36_i109];
  }
  ...
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId, real_T c36_y[4])
{
  ...
  int32_T c36_i110;
  (void)chartInstance;
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), c36_dv20, 1, 0, 0U, 1, 0U, 1, 4);
  for (c36_i110 = 0; c36_i110 < 4; c36_i110++) {
    c36_y[c36_i110] = c36_dv20[c36_i110];
  }
  ...
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData)
{
  ...
  for (c36_i111 = 0; c36_i111 < 4; c36_i111++) {
    (*(real_T (*)[4])c36_outData)[c36_i111] = c36_y[c36_i111];
  }
  ...
  *c36_inData)
{
  ...
  for (c36_i113 = 0; c36_i113 < 3; c36_i113++) {
    for (c36_i114 = 0; c36_i114 < 3; c36_i114++) {
      c36_b_inData[c36_i114 + c36_i112] = (*(real_T (*)[9])c36_inData)[c36_i114
        + c36_i112];
    }
  ...
  for (c36_i116 = 0; c36_i116 < 3; c36_i116++) {
    for (c36_i117 = 0; c36_i117 < 3; c36_i117++) {
      c36_u[c36_i117 + c36_i115] = c36_b_inData[c36_i117 + c36_i115];
    }
  ...
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId, real_T c36_y[9])
{
  ...
  int32_T c36_i118;
  (void)chartInstance;
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), c36_dv21, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c36_i118 = 0; c36_i118 < 9; c36_i118++) {
    c36_y[c36_i118] = c36_dv21[c36_i118];
  }
  ...
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData)
{
  ...
  for (c36_i120 = 0; c36_i120 < 3; c36_i120++) {
    for (c36_i121 = 0; c36_i121 < 3; c36_i121++) {
      (*(real_T (*)[9])c36_outData)[c36_i121 + c36_i119] = c36_y[c36_i121 +
        c36_i119];
    }
...
const mxArray *sf_c36_DIPCalt_get_eml_resolved_functions_info(void)
{
...
static void c36_info_helper(const mxArray **c36_info)
{
  ...
  sf_mex_addfield(*c36_info, c36_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPC/quatrot.m"), "resolved",
                  "resolved", 21);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(1446631716U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c36_info, c36_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPC/skew_sm.m"), "resolved",
                  "resolved", 33);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(1445505143U), "fileTimeLo",
                  "fileTimeLo", 33);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 33);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "mFileTimeLo",
...
static void c36_eye(SFc36_DIPCaltInstanceStruct *chartInstance, real_T c36_I[9])
{
  ...
  int32_T c36_b_k;
  (void)chartInstance;
  for (c36_i122 = 0; c36_i122 < 9; c36_i122++) {
    c36_I[c36_i122] = 0.0;
  }
  ...
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId)
{
  ...
  int32_T c36_i123;
  (void)chartInstance;
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), &c36_i123, 1, 6, 0U, 0, 0U, 0);
  c36_y = c36_i123;
  sf_mex_destroy(&c36_u);
  return c36_y;
}
  ...
  const mxArray *c36_b_is_active_c36_DIPCalt, const char_T *c36_identifier)
{
  ...
  c36_y = c36_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c36_b_is_active_c36_DIPCalt), &c36_thisId);
  sf_mex_destroy(&c36_b_is_active_c36_DIPCalt);
  return c36_y;
}
...
static void init_simulink_io_address(SFc36_DIPCaltInstanceStruct *chartInstance)
{
  chartInstance->c36_G = (real_T (*)[144])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c36_x = (real_T (*)[28])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
}
...
void sf_c36_DIPCalt_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c36_DIPCalt_get_post_codegen_info(void);
mxArray *sf_c36_DIPCalt_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c36_DIPCalt_get_post_codegen_info();
...
mxArray *sf_c36_DIPCalt_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c36_DIPCalt_jit_fallback_info(void)
{
...
mxArray *sf_c36_DIPCalt_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c36_DIPCalt(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"G\",},{M[8],M[0],T\"is_active_c36_DIPCalt\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c36_DIPCalt_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc36_DIPCaltInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c36_DIPCalt(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc36_DIPCaltInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c36_DIPCalt((SFc36_DIPCaltInstanceStruct*) chartInstanceVar);
  initialize_c36_DIPCalt((SFc36_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c36_DIPCalt(void *chartInstanceVar)
{
  enable_c36_DIPCalt((SFc36_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c36_DIPCalt(void *chartInstanceVar)
{
  disable_c36_DIPCalt((SFc36_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c36_DIPCalt(void *chartInstanceVar)
{
  sf_gateway_c36_DIPCalt((SFc36_DIPCaltInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c36_DIPCalt(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c36_DIPCalt((SFc36_DIPCaltInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c36_DIPCalt(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c36_DIPCalt((SFc36_DIPCaltInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c36_DIPCalt(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc36_DIPCaltInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c36_DIPCalt((SFc36_DIPCaltInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc36_DIPCalt((SFc36_DIPCaltInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c36_DIPCalt(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c36_DIPCalt((SFc36_DIPCaltInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c36_DIPCalt(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4136022639U));
  ssSetChecksum1(S,(4289242652U));
  ssSetChecksum2(S,(3176962102U));
  ssSetChecksum3(S,(4004088606U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c36_DIPCalt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c36_DIPCalt(SimStruct *S)
{
  SFc36_DIPCaltInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc36_DIPCaltInstanceStruct *)utMalloc(sizeof
    (SFc36_DIPCaltInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc36_DIPCaltInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c36_DIPCalt;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c36_DIPCalt;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c36_DIPCalt;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c36_DIPCalt;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c36_DIPCalt;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c36_DIPCalt;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c36_DIPCalt;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c36_DIPCalt;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c36_DIPCalt;
  chartInstance->chartInfo.mdlStart = mdlStart_c36_DIPCalt;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c36_DIPCalt;
...
void c36_DIPCalt_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c36_DIPCalt(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c36_DIPCalt(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c36_DIPCalt(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c36_DIPCalt_method_dispatcher.\n"
