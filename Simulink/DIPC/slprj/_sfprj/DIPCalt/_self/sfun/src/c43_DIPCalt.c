...
static void initialize_c43_DIPCalt(SFc43_DIPCaltInstanceStruct *chartInstance);
static void initialize_params_c43_DIPCalt(SFc43_DIPCaltInstanceStruct
  *chartInstance);
static void enable_c43_DIPCalt(SFc43_DIPCaltInstanceStruct *chartInstance);
static void disable_c43_DIPCalt(SFc43_DIPCaltInstanceStruct *chartInstance);
static void c43_update_debugger_state_c43_DIPCalt(SFc43_DIPCaltInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c43_DIPCalt(SFc43_DIPCaltInstanceStruct
  *chartInstance);
static void set_sim_state_c43_DIPCalt(SFc43_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c43_st);
static void finalize_c43_DIPCalt(SFc43_DIPCaltInstanceStruct *chartInstance);
static void sf_gateway_c43_DIPCalt(SFc43_DIPCaltInstanceStruct *chartInstance);
static void mdl_start_c43_DIPCalt(SFc43_DIPCaltInstanceStruct *chartInstance);
static void initSimStructsc43_DIPCalt(SFc43_DIPCaltInstanceStruct *chartInstance);
static void c43_quatrot(SFc43_DIPCaltInstanceStruct *chartInstance, real_T
  c43_q[4], real_T c43_r[3], real_T c43_rw[3]);
...
static const mxArray *c43_sf_marshallOut(void *chartInstanceVoid, void
  *c43_inData);
static void c43_emlrt_marshallIn(SFc43_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c43_b_h_int, const char_T *c43_identifier, real_T c43_y[24]);
static void c43_b_emlrt_marshallIn(SFc43_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c43_u, const emlrtMsgIdentifier *c43_parentId, real_T c43_y[24]);
...
static const mxArray *c43_c_sf_marshallOut(void *chartInstanceVoid, void
  *c43_inData);
static real_T c43_c_emlrt_marshallIn(SFc43_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c43_d_sf_marshallOut(void *chartInstanceVoid, void
  *c43_inData);
static void c43_d_emlrt_marshallIn(SFc43_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c43_e_sf_marshallOut(void *chartInstanceVoid, void
  *c43_inData);
static void c43_e_emlrt_marshallIn(SFc43_DIPCaltInstanceStruct *chartInstance,
...
static void c43_quatmultiply(SFc43_DIPCaltInstanceStruct *chartInstance, real_T
  c43_q[4], real_T c43_r[4], real_T c43_qout[4]);
static const mxArray *c43_f_sf_marshallOut(void *chartInstanceVoid, void
  *c43_inData);
static int32_T c43_f_emlrt_marshallIn(SFc43_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c43_u, const emlrtMsgIdentifier *c43_parentId);
static void c43_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c43_mxArrayInData, const char_T *c43_varName, void *c43_outData);
static uint8_T c43_g_emlrt_marshallIn(SFc43_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c43_b_is_active_c43_DIPCalt, const char_T *c43_identifier);
static uint8_T c43_h_emlrt_marshallIn(SFc43_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c43_u, const emlrtMsgIdentifier *c43_parentId);
static void init_dsm_address_info(SFc43_DIPCaltInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc43_DIPCaltInstanceStruct *chartInstance);
...
static void initialize_c43_DIPCalt(SFc43_DIPCaltInstanceStruct *chartInstance)
{
  ...
  chartInstance->c43_is_active_c43_DIPCalt = 0U;
}
  ...
  *chartInstance)
{
  ...
  c43_hoistedGlobal = chartInstance->c43_is_active_c43_DIPCalt;
  ...
  const mxArray *c43_st)
{
  ...
  chartInstance->c43_is_active_c43_DIPCalt = c43_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c43_u, 1)),
     "is_active_c43_DIPCalt");
  sf_mex_destroy(&c43_u);
  c43_update_debugger_state_c43_DIPCalt(chartInstance);
...
static void sf_gateway_c43_DIPCalt(SFc43_DIPCaltInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 20U, chartInstance->c43_sfEvent);
  ...
  chartInstance->c43_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 20U, chartInstance->c43_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 20U, chartInstance->c43_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *c43_inData)
{
  ...
  real_T c43_u[24];
  const mxArray *c43_y = NULL;
  SFc43_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc43_DIPCaltInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c43_DIPCalt_get_eml_resolved_functions_info(void)
{
...
static void c43_info_helper(const mxArray **c43_info)
{
  ...
  sf_mex_addfield(*c43_info, c43_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPC/quatrot.m"), "resolved",
                  "resolved", 1);
  sf_mex_addfield(*c43_info, c43_b_emlrt_marshallOut(1446631716U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c43_info, c43_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c43_info, c43_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  const mxArray *c43_b_is_active_c43_DIPCalt, const char_T *c43_identifier)
{
  ...
  c43_y = c43_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c43_b_is_active_c43_DIPCalt), &c43_thisId);
  sf_mex_destroy(&c43_b_is_active_c43_DIPCalt);
  return c43_y;
}
...
void sf_c43_DIPCalt_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c43_DIPCalt_get_post_codegen_info(void);
mxArray *sf_c43_DIPCalt_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c43_DIPCalt_get_post_codegen_info();
...
mxArray *sf_c43_DIPCalt_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c43_DIPCalt_jit_fallback_info(void)
{
...
mxArray *sf_c43_DIPCalt_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c43_DIPCalt(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"h_int\",},{M[8],M[0],T\"is_active_c43_DIPCalt\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c43_DIPCalt_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc43_DIPCaltInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c43_DIPCalt(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc43_DIPCaltInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c43_DIPCalt((SFc43_DIPCaltInstanceStruct*) chartInstanceVar);
  initialize_c43_DIPCalt((SFc43_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c43_DIPCalt(void *chartInstanceVar)
{
  enable_c43_DIPCalt((SFc43_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c43_DIPCalt(void *chartInstanceVar)
{
  disable_c43_DIPCalt((SFc43_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c43_DIPCalt(void *chartInstanceVar)
{
  sf_gateway_c43_DIPCalt((SFc43_DIPCaltInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c43_DIPCalt(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c43_DIPCalt((SFc43_DIPCaltInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c43_DIPCalt(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c43_DIPCalt((SFc43_DIPCaltInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c43_DIPCalt(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc43_DIPCaltInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c43_DIPCalt((SFc43_DIPCaltInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc43_DIPCalt((SFc43_DIPCaltInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c43_DIPCalt(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c43_DIPCalt((SFc43_DIPCaltInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c43_DIPCalt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2227526660U));
  ssSetChecksum1(S,(220572579U));
  ssSetChecksum2(S,(1380011559U));
  ssSetChecksum3(S,(1209601165U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c43_DIPCalt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c43_DIPCalt(SimStruct *S)
{
  SFc43_DIPCaltInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc43_DIPCaltInstanceStruct *)utMalloc(sizeof
    (SFc43_DIPCaltInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc43_DIPCaltInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c43_DIPCalt;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c43_DIPCalt;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c43_DIPCalt;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c43_DIPCalt;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c43_DIPCalt;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c43_DIPCalt;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c43_DIPCalt;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c43_DIPCalt;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c43_DIPCalt;
  chartInstance->chartInfo.mdlStart = mdlStart_c43_DIPCalt;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c43_DIPCalt;
...
void c43_DIPCalt_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c43_DIPCalt(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c43_DIPCalt(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c43_DIPCalt(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c43_DIPCalt_method_dispatcher.\n"
