...
static const char * c12_debug_family_names[5] = { "nargin", "nargout", "rv", "x",
  "G" };

static const char * c12_b_debug_family_names[6] = { "rwq", "nargin", "nargout",
  "q", "r", "rw" };

static const char * c12_c_debug_family_names[4] = { "nargin", "nargout", "x",
  "X" };

/* Function Declarations */
static void initialize_c12_DIPCalt(SFc12_DIPCaltInstanceStruct *chartInstance);
static void initialize_params_c12_DIPCalt(SFc12_DIPCaltInstanceStruct
  *chartInstance);
static void enable_c12_DIPCalt(SFc12_DIPCaltInstanceStruct *chartInstance);
static void disable_c12_DIPCalt(SFc12_DIPCaltInstanceStruct *chartInstance);
static void c12_update_debugger_state_c12_DIPCalt(SFc12_DIPCaltInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c12_DIPCalt(SFc12_DIPCaltInstanceStruct
  *chartInstance);
static void set_sim_state_c12_DIPCalt(SFc12_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c12_st);
static void finalize_c12_DIPCalt(SFc12_DIPCaltInstanceStruct *chartInstance);
static void sf_gateway_c12_DIPCalt(SFc12_DIPCaltInstanceStruct *chartInstance);
static void mdl_start_c12_DIPCalt(SFc12_DIPCaltInstanceStruct *chartInstance);
static void initSimStructsc12_DIPCalt(SFc12_DIPCaltInstanceStruct *chartInstance);
static void c12_quatrot(SFc12_DIPCaltInstanceStruct *chartInstance, real_T
  c12_q[4], real_T c12_r[3], real_T c12_rw[3]);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber, uint32_T c12_instanceNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_emlrt_marshallIn(SFc12_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c12_b_G, const char_T *c12_identifier, real_T c12_y[144]);
static void c12_b_emlrt_marshallIn(SFc12_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[144]);
...
static const mxArray *c12_c_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_c_emlrt_marshallIn(SFc12_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[12]);
static void c12_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static const mxArray *c12_d_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_d_emlrt_marshallIn(SFc12_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c12_e_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_e_emlrt_marshallIn(SFc12_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c12_f_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_f_emlrt_marshallIn(SFc12_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[4]);
...
static const mxArray *c12_g_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_g_emlrt_marshallIn(SFc12_DIPCaltInstanceStruct *chartInstance,
...
static void c12_eye(SFc12_DIPCaltInstanceStruct *chartInstance, real_T c12_I[9]);
static void c12_quatmultiply(SFc12_DIPCaltInstanceStruct *chartInstance, real_T
  c12_q[4], real_T c12_r[4], real_T c12_qout[4]);
static const mxArray *c12_h_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_h_emlrt_marshallIn(SFc12_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static uint8_T c12_i_emlrt_marshallIn(SFc12_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c12_b_is_active_c12_DIPCalt, const char_T *c12_identifier);
static uint8_T c12_j_emlrt_marshallIn(SFc12_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void init_dsm_address_info(SFc12_DIPCaltInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc12_DIPCaltInstanceStruct *chartInstance);
...
static void initialize_c12_DIPCalt(SFc12_DIPCaltInstanceStruct *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_DIPCalt = 0U;
}
  ...
  *chartInstance)
{
  ...
  sf_mex_import_named("rv", sf_mex_get_sfun_param(chartInstance->S, 0, 0),
                      c12_dv0, 0, 0, 0U, 1, 0U, 1, 12);
  for (c12_i0 = 0; c12_i0 < 12; c12_i0++) {
    chartInstance->c12_rv[c12_i0] = c12_dv0[c12_i0];
  }
}
  ...
  *chartInstance)
{
  ...
  for (c12_i1 = 0; c12_i1 < 144; c12_i1++) {
    c12_u[c12_i1] = (*chartInstance->c12_G)[c12_i1];
  }

  c12_b_y = NULL;
  sf_mex_assign(&c12_b_y, sf_mex_create("y", c12_u, 0, 0U, 1U, 0U, 2, 6, 24),
                false);
  sf_mex_setcell(c12_y, 0, c12_b_y);
  c12_hoistedGlobal = chartInstance->c12_is_active_c12_DIPCalt;
  ...
  const mxArray *c12_st)
{
  ...
  c12_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 0)), "G",
                       c12_dv1);
  for (c12_i2 = 0; c12_i2 < 144; c12_i2++) {
    (*chartInstance->c12_G)[c12_i2] = c12_dv1[c12_i2];
  }

  chartInstance->c12_is_active_c12_DIPCalt = c12_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 1)),
     "is_active_c12_DIPCalt");
  sf_mex_destroy(&c12_u);
  c12_update_debugger_state_c12_DIPCalt(chartInstance);
...
static void sf_gateway_c12_DIPCalt(SFc12_DIPCaltInstanceStruct *chartInstance)
{
  ...
  for (c12_i3 = 0; c12_i3 < 12; c12_i3++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c12_rv[c12_i3], 0U);
  }

  chartInstance->c12_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 11U, chartInstance->c12_sfEvent);
  for (c12_i4 = 0; c12_i4 < 12; c12_i4++) {
    c12_b_rv[c12_i4] = chartInstance->c12_rv[c12_i4];
  }

  for (c12_i5 = 0; c12_i5 < 7; c12_i5++) {
    c12_b_x[c12_i5] = (*chartInstance->c12_x)[c12_i5];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_nargout, 1U, c12_d_sf_marshallOut,
    c12_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_b_rv, 2U, c12_c_sf_marshallOut,
    c12_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c12_b_x, 3U, c12_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_b_G, 4U, c12_sf_marshallOut,
    c12_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c12_sfEvent, 2);
  for (c12_i6 = 0; c12_i6 < 4; c12_i6++) {
    c12_c_x[c12_i6] = c12_b_x[c12_i6 + 3];
  }

  for (c12_i7 = 0; c12_i7 < 3; c12_i7++) {
    c12_c_rv[c12_i7] = c12_b_rv[c12_i7];
  }

  c12_quatrot(chartInstance, c12_c_x, c12_c_rv, c12_dv2);
  for (c12_i8 = 0; c12_i8 < 3; c12_i8++) {
    c12_d_x[c12_i8] = c12_dv2[c12_i8];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 4U, 4U, c12_c_debug_family_names,
    c12_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_b_nargin, 0U, c12_d_sf_marshallOut,
    c12_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_b_nargout, 1U, c12_d_sf_marshallOut,
    c12_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_d_x, 2U, c12_e_sf_marshallOut,
    c12_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_X, 3U, c12_g_sf_marshallOut,
    c12_f_sf_marshallIn);
  CV_SCRIPT_FCN(1, 0);
  ...
  for (c12_i9 = 0; c12_i9 < 4; c12_i9++) {
    c12_e_x[c12_i9] = c12_b_x[c12_i9 + 3];
  }

  for (c12_i10 = 0; c12_i10 < 3; c12_i10++) {
    c12_d_rv[c12_i10] = c12_b_rv[c12_i10 + 3];
  }

  c12_quatrot(chartInstance, c12_e_x, c12_d_rv, c12_dv3);
  for (c12_i11 = 0; c12_i11 < 3; c12_i11++) {
    c12_f_x[c12_i11] = c12_dv3[c12_i11];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 4U, 4U, c12_c_debug_family_names,
    c12_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_c_nargin, 0U, c12_d_sf_marshallOut,
    c12_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_c_nargout, 1U, c12_d_sf_marshallOut,
    c12_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_f_x, 2U, c12_e_sf_marshallOut,
    c12_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_b_X, 3U, c12_g_sf_marshallOut,
    c12_f_sf_marshallIn);
  CV_SCRIPT_FCN(1, 0);
  _SFD_SCRIPT_CALL(1U, chartInstance->c12_sfEvent, 3);
  c12_b_X[0] = 0.0;
  ...
  for (c12_i12 = 0; c12_i12 < 4; c12_i12++) {
    c12_g_x[c12_i12] = c12_b_x[c12_i12 + 3];
  }

  for (c12_i13 = 0; c12_i13 < 3; c12_i13++) {
    c12_e_rv[c12_i13] = c12_b_rv[c12_i13 + 6];
  }

  c12_quatrot(chartInstance, c12_g_x, c12_e_rv, c12_dv4);
  for (c12_i14 = 0; c12_i14 < 3; c12_i14++) {
    c12_h_x[c12_i14] = c12_dv4[c12_i14];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 4U, 4U, c12_c_debug_family_names,
    c12_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_d_nargin, 0U, c12_d_sf_marshallOut,
    c12_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_d_nargout, 1U, c12_d_sf_marshallOut,
    c12_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_h_x, 2U, c12_e_sf_marshallOut,
    c12_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_c_X, 3U, c12_g_sf_marshallOut,
    c12_f_sf_marshallIn);
  CV_SCRIPT_FCN(1, 0);
  _SFD_SCRIPT_CALL(1U, chartInstance->c12_sfEvent, 3);
  c12_c_X[0] = 0.0;
  ...
  for (c12_i15 = 0; c12_i15 < 4; c12_i15++) {
    c12_i_x[c12_i15] = c12_b_x[c12_i15 + 3];
  }

  for (c12_i16 = 0; c12_i16 < 3; c12_i16++) {
    c12_f_rv[c12_i16] = c12_b_rv[c12_i16 + 9];
  }

  c12_quatrot(chartInstance, c12_i_x, c12_f_rv, c12_dv5);
  for (c12_i17 = 0; c12_i17 < 3; c12_i17++) {
    c12_j_x[c12_i17] = c12_dv5[c12_i17];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 4U, 4U, c12_c_debug_family_names,
    c12_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_e_nargin, 0U, c12_d_sf_marshallOut,
    c12_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_e_nargout, 1U, c12_d_sf_marshallOut,
    c12_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_j_x, 2U, c12_e_sf_marshallOut,
    c12_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_d_X, 3U, c12_g_sf_marshallOut,
    c12_f_sf_marshallIn);
  CV_SCRIPT_FCN(1, 0);
  _SFD_SCRIPT_CALL(1U, chartInstance->c12_sfEvent, 3);
  c12_d_X[0] = 0.0;
  ...
  _SFD_SCRIPT_CALL(1U, chartInstance->c12_sfEvent, -3);
  _SFD_SYMBOL_SCOPE_POP();
  c12_eye(chartInstance, c12_dv6);
  c12_eye(chartInstance, c12_dv7);
  c12_eye(chartInstance, c12_dv8);
  c12_eye(chartInstance, c12_dv9);
  c12_eye(chartInstance, c12_dv10);
  c12_eye(chartInstance, c12_dv11);
  c12_eye(chartInstance, c12_dv12);
  c12_eye(chartInstance, c12_dv13);
  c12_i18 = 0;
  c12_i19 = 0;
  for (c12_i20 = 0; c12_i20 < 3; c12_i20++) {
    for (c12_i21 = 0; c12_i21 < 3; c12_i21++) {
      c12_b_G[c12_i21 + c12_i18] = c12_dv6[c12_i21 + c12_i19];
    }
  ...
  for (c12_i23 = 0; c12_i23 < 3; c12_i23++) {
    for (c12_i24 = 0; c12_i24 < 3; c12_i24++) {
      c12_b_G[(c12_i24 + c12_i22) + 18] = 0.0;
    }
  ...
  for (c12_i27 = 0; c12_i27 < 3; c12_i27++) {
    for (c12_i28 = 0; c12_i28 < 3; c12_i28++) {
      c12_b_G[(c12_i28 + c12_i25) + 36] = c12_dv7[c12_i28 + c12_i26];
    }
  ...
  for (c12_i30 = 0; c12_i30 < 3; c12_i30++) {
    for (c12_i31 = 0; c12_i31 < 3; c12_i31++) {
      c12_b_G[(c12_i31 + c12_i29) + 54] = 0.0;
    }
  ...
  for (c12_i34 = 0; c12_i34 < 3; c12_i34++) {
    for (c12_i35 = 0; c12_i35 < 3; c12_i35++) {
      c12_b_G[(c12_i35 + c12_i32) + 72] = c12_dv8[c12_i35 + c12_i33];
    }
  ...
  for (c12_i37 = 0; c12_i37 < 3; c12_i37++) {
    for (c12_i38 = 0; c12_i38 < 3; c12_i38++) {
      c12_b_G[(c12_i38 + c12_i36) + 90] = 0.0;
    }
  ...
  for (c12_i41 = 0; c12_i41 < 3; c12_i41++) {
    for (c12_i42 = 0; c12_i42 < 3; c12_i42++) {
      c12_b_G[(c12_i42 + c12_i39) + 108] = c12_dv9[c12_i42 + c12_i40];
    }
  ...
  for (c12_i44 = 0; c12_i44 < 3; c12_i44++) {
    for (c12_i45 = 0; c12_i45 < 3; c12_i45++) {
      c12_b_G[(c12_i45 + c12_i43) + 126] = 0.0;
    }
  ...
  for (c12_i48 = 0; c12_i48 < 3; c12_i48++) {
    for (c12_i49 = 0; c12_i49 < 3; c12_i49++) {
      c12_b_G[(c12_i49 + c12_i46) + 3] = c12_X[c12_i49 + c12_i47];
    }
  ...
  for (c12_i52 = 0; c12_i52 < 3; c12_i52++) {
    for (c12_i53 = 0; c12_i53 < 3; c12_i53++) {
      c12_b_G[(c12_i53 + c12_i50) + 21] = c12_dv10[c12_i53 + c12_i51];
    }
  ...
  for (c12_i56 = 0; c12_i56 < 3; c12_i56++) {
    for (c12_i57 = 0; c12_i57 < 3; c12_i57++) {
      c12_b_G[(c12_i57 + c12_i54) + 39] = c12_b_X[c12_i57 + c12_i55];
    }
  ...
  for (c12_i60 = 0; c12_i60 < 3; c12_i60++) {
    for (c12_i61 = 0; c12_i61 < 3; c12_i61++) {
      c12_b_G[(c12_i61 + c12_i58) + 57] = c12_dv11[c12_i61 + c12_i59];
    }
  ...
  c12_i62 = 0;
  c12_i63 = 0;
  for (c12_i64 = 0; c12_i64 < 3; c12_i64++) {
    for (c12_i65 = 0; c12_i65 < 3; c12_i65++) {
      c12_b_G[(c12_i65 + c12_i62) + 75] = c12_c_X[c12_i65 + c12_i63];
    }
  ...
  c12_i66 = 0;
  c12_i67 = 0;
  for (c12_i68 = 0; c12_i68 < 3; c12_i68++) {
    for (c12_i69 = 0; c12_i69 < 3; c12_i69++) {
      c12_b_G[(c12_i69 + c12_i66) + 93] = c12_dv12[c12_i69 + c12_i67];
    }
  ...
  c12_i70 = 0;
  c12_i71 = 0;
  for (c12_i72 = 0; c12_i72 < 3; c12_i72++) {
    for (c12_i73 = 0; c12_i73 < 3; c12_i73++) {
      c12_b_G[(c12_i73 + c12_i70) + 111] = c12_d_X[c12_i73 + c12_i71];
    }
  ...
  c12_i74 = 0;
  c12_i75 = 0;
  for (c12_i76 = 0; c12_i76 < 3; c12_i76++) {
    for (c12_i77 = 0; c12_i77 < 3; c12_i77++) {
      c12_b_G[(c12_i77 + c12_i74) + 129] = c12_dv13[c12_i77 + c12_i75];
    }
  ...
  _SFD_EML_CALL(0U, chartInstance->c12_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c12_i78 = 0; c12_i78 < 144; c12_i78++) {
    (*chartInstance->c12_G)[c12_i78] = c12_b_G[c12_i78];
  }
  ...
  for (c12_i79 = 0; c12_i79 < 144; c12_i79++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c12_G)[c12_i79], 1U);
  }

  for (c12_i80 = 0; c12_i80 < 7; c12_i80++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c12_x)[c12_i80], 2U);
  }
}
  ...
  c12_q[4], real_T c12_r[3], real_T c12_rw[3])
{
  ...
  int32_T c12_i86;
  int32_T c12_i87;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 6U, 6U, c12_b_debug_family_names,
    c12_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_rwq, 0U, c12_f_sf_marshallOut,
    c12_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_nargin, 1U, c12_d_sf_marshallOut,
    c12_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_nargout, 2U, c12_d_sf_marshallOut,
    c12_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_q, 3U, c12_f_sf_marshallOut,
    c12_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_r, 4U, c12_e_sf_marshallOut,
    c12_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_rw, 5U, c12_e_sf_marshallOut,
    c12_d_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  _SFD_SCRIPT_CALL(0U, chartInstance->c12_sfEvent, 4);
  for (c12_i81 = 0; c12_i81 < 4; c12_i81++) {
    c12_b_q[c12_i81] = c12_q[c12_i81];
  }

  for (c12_k = 0; c12_k < 3; c12_k++) {
    c12_b_k = 2.0 + (real_T)c12_k;
    c12_b_q[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      c12_b_k), 1, 4, 1, 0) - 1] = -c12_b_q[_SFD_EML_ARRAY_BOUNDS_CHECK("",
      (int32_T)_SFD_INTEGER_CHECK("", c12_b_k), 1, 4, 1, 0) - 1];
  }

  c12_dv14[0] = 0.0;
  for (c12_i82 = 0; c12_i82 < 3; c12_i82++) {
    c12_dv14[c12_i82 + 1] = c12_r[c12_i82];
  }

  for (c12_i83 = 0; c12_i83 < 4; c12_i83++) {
    c12_c_q[c12_i83] = c12_b_q[c12_i83];
  }

  c12_quatmultiply(chartInstance, c12_dv14, c12_c_q, c12_dv15);
  for (c12_i84 = 0; c12_i84 < 4; c12_i84++) {
    c12_d_q[c12_i84] = c12_q[c12_i84];
  }

  for (c12_i85 = 0; c12_i85 < 4; c12_i85++) {
    c12_dv16[c12_i85] = c12_dv15[c12_i85];
  }

  c12_quatmultiply(chartInstance, c12_d_q, c12_dv16, c12_b_q);
  for (c12_i86 = 0; c12_i86 < 4; c12_i86++) {
    c12_rwq[c12_i86] = c12_b_q[c12_i86];
  }

  _SFD_SCRIPT_CALL(0U, chartInstance->c12_sfEvent, 5);
  for (c12_i87 = 0; c12_i87 < 3; c12_i87++) {
    c12_rw[c12_i87] = c12_rwq[c12_i87 + 1];
  }
  ...
  *c12_inData)
{
  ...
  real_T c12_u[144];
  const mxArray *c12_y = NULL;
  SFc12_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc12_DIPCaltInstanceStruct *)chartInstanceVoid;
  c12_mxArrayOutData = NULL;
  c12_i88 = 0;
  for (c12_i89 = 0; c12_i89 < 24; c12_i89++) {
    for (c12_i90 = 0; c12_i90 < 6; c12_i90++) {
      c12_b_inData[c12_i90 + c12_i88] = (*(real_T (*)[144])c12_inData)[c12_i90 +
        c12_i88];
    }
  ...
  c12_i91 = 0;
  for (c12_i92 = 0; c12_i92 < 24; c12_i92++) {
    for (c12_i93 = 0; c12_i93 < 6; c12_i93++) {
      c12_u[c12_i93 + c12_i91] = c12_b_inData[c12_i93 + c12_i91];
    }
  ...
  c12_y = NULL;
  sf_mex_assign(&c12_y, sf_mex_create("y", c12_u, 0, 0U, 1U, 0U, 2, 6, 24),
                false);
  ...
  const mxArray *c12_b_G, const char_T *c12_identifier, real_T c12_y[144])
{
  ...
  c12_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c12_b_G), &c12_thisId, c12_y);
  sf_mex_destroy(&c12_b_G);
}
  ...
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[144])
{
  ...
  int32_T c12_i94;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), c12_dv17, 1, 0, 0U, 1, 0U, 2, 6,
                24);
  for (c12_i94 = 0; c12_i94 < 144; c12_i94++) {
    c12_y[c12_i94] = c12_dv17[c12_i94];
  }
  ...
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData)
{
  ...
  SFc12_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc12_DIPCaltInstanceStruct *)chartInstanceVoid;
  c12_b_G = sf_mex_dup(c12_mxArrayInData);
  ...
  sf_mex_destroy(&c12_b_G);
  c12_i95 = 0;
  for (c12_i96 = 0; c12_i96 < 24; c12_i96++) {
    for (c12_i97 = 0; c12_i97 < 6; c12_i97++) {
      (*(real_T (*)[144])c12_outData)[c12_i97 + c12_i95] = c12_y[c12_i97 +
        c12_i95];
    }
  ...
  *c12_inData)
{
  ...
  chartInstance = (SFc12_DIPCaltInstanceStruct *)chartInstanceVoid;
  c12_mxArrayOutData = NULL;
  for (c12_i98 = 0; c12_i98 < 7; c12_i98++) {
    c12_b_inData[c12_i98] = (*(real_T (*)[7])c12_inData)[c12_i98];
  }

  for (c12_i99 = 0; c12_i99 < 7; c12_i99++) {
    c12_u[c12_i99] = c12_b_inData[c12_i99];
  }
  ...
  *c12_inData)
{
  ...
  chartInstance = (SFc12_DIPCaltInstanceStruct *)chartInstanceVoid;
  c12_mxArrayOutData = NULL;
  for (c12_i100 = 0; c12_i100 < 12; c12_i100++) {
    c12_b_inData[c12_i100] = (*(real_T (*)[12])c12_inData)[c12_i100];
  }

  for (c12_i101 = 0; c12_i101 < 12; c12_i101++) {
    c12_u[c12_i101] = c12_b_inData[c12_i101];
  }

  c12_y = NULL;
  sf_mex_assign(&c12_y, sf_mex_create("y", c12_u, 0, 0U, 1U, 0U, 1, 12), false);
  sf_mex_assign(&c12_mxArrayOutData, c12_y, false);
  return c12_mxArrayOutData;
}
  ...
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[12])
{
  ...
  int32_T c12_i102;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), c12_dv18, 1, 0, 0U, 1, 0U, 1,
                12);
  for (c12_i102 = 0; c12_i102 < 12; c12_i102++) {
    c12_y[c12_i102] = c12_dv18[c12_i102];
  }
  ...
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData)
{
  ...
  SFc12_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc12_DIPCaltInstanceStruct *)chartInstanceVoid;
  c12_b_rv = sf_mex_dup(c12_mxArrayInData);
  c12_identifier = c12_varName;
  c12_thisId.fIdentifier = c12_identifier;
  c12_thisId.fParent = NULL;
  c12_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c12_b_rv), &c12_thisId, c12_y);
  sf_mex_destroy(&c12_b_rv);
  for (c12_i103 = 0; c12_i103 < 12; c12_i103++) {
    (*(real_T (*)[12])c12_outData)[c12_i103] = c12_y[c12_i103];
  }
  ...
  *c12_inData)
{
  ...
  chartInstance = (SFc12_DIPCaltInstanceStruct *)chartInstanceVoid;
  c12_mxArrayOutData = NULL;
  for (c12_i104 = 0; c12_i104 < 3; c12_i104++) {
    c12_b_inData[c12_i104] = (*(real_T (*)[3])c12_inData)[c12_i104];
  }

  for (c12_i105 = 0; c12_i105 < 3; c12_i105++) {
    c12_u[c12_i105] = c12_b_inData[c12_i105];
  }
  ...
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[3])
{
  ...
  int32_T c12_i106;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), c12_dv19, 1, 0, 0U, 1, 0U, 1, 3);
  for (c12_i106 = 0; c12_i106 < 3; c12_i106++) {
    c12_y[c12_i106] = c12_dv19[c12_i106];
  }
  ...
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData)
{
  ...
  SFc12_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc12_DIPCaltInstanceStruct *)chartInstanceVoid;
  c12_rw = sf_mex_dup(c12_mxArrayInData);
  c12_identifier = c12_varName;
  c12_thisId.fIdentifier = c12_identifier;
  c12_thisId.fParent = NULL;
  c12_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c12_rw), &c12_thisId, c12_y);
  sf_mex_destroy(&c12_rw);
  for (c12_i107 = 0; c12_i107 < 3; c12_i107++) {
    (*(real_T (*)[3])c12_outData)[c12_i107] = c12_y[c12_i107];
  }
  ...
  *c12_inData)
{
  ...
  chartInstance = (SFc12_DIPCaltInstanceStruct *)chartInstanceVoid;
  c12_mxArrayOutData = NULL;
  for (c12_i108 = 0; c12_i108 < 4; c12_i108++) {
    c12_b_inData[c12_i108] = (*(real_T (*)[4])c12_inData)[c12_i108];
  }

  for (c12_i109 = 0; c12_i109 < 4; c12_i109++) {
    c12_u[c12_i109] = c12_b_inData[c12_i109];
  }
  ...
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[4])
{
  ...
  int32_T c12_i110;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), c12_dv20, 1, 0, 0U, 1, 0U, 1, 4);
  for (c12_i110 = 0; c12_i110 < 4; c12_i110++) {
    c12_y[c12_i110] = c12_dv20[c12_i110];
  }
  ...
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData)
{
  ...
  c12_thisId.fIdentifier = c12_identifier;
  c12_thisId.fParent = NULL;
  c12_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c12_q), &c12_thisId, c12_y);
  sf_mex_destroy(&c12_q);
  for (c12_i111 = 0; c12_i111 < 4; c12_i111++) {
    (*(real_T (*)[4])c12_outData)[c12_i111] = c12_y[c12_i111];
  }
  ...
  *c12_inData)
{
  ...
  c12_mxArrayOutData = NULL;
  c12_i112 = 0;
  for (c12_i113 = 0; c12_i113 < 3; c12_i113++) {
    for (c12_i114 = 0; c12_i114 < 3; c12_i114++) {
      c12_b_inData[c12_i114 + c12_i112] = (*(real_T (*)[9])c12_inData)[c12_i114
        + c12_i112];
    }
  ...
  c12_i115 = 0;
  for (c12_i116 = 0; c12_i116 < 3; c12_i116++) {
    for (c12_i117 = 0; c12_i117 < 3; c12_i117++) {
      c12_u[c12_i117 + c12_i115] = c12_b_inData[c12_i117 + c12_i115];
    }
  ...
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[9])
{
  ...
  int32_T c12_i118;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), c12_dv21, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c12_i118 = 0; c12_i118 < 9; c12_i118++) {
    c12_y[c12_i118] = c12_dv21[c12_i118];
  }
  ...
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData)
{
  ...
  c12_thisId.fIdentifier = c12_identifier;
  c12_thisId.fParent = NULL;
  c12_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c12_X), &c12_thisId, c12_y);
  sf_mex_destroy(&c12_X);
  c12_i119 = 0;
  for (c12_i120 = 0; c12_i120 < 3; c12_i120++) {
    for (c12_i121 = 0; c12_i121 < 3; c12_i121++) {
      (*(real_T (*)[9])c12_outData)[c12_i121 + c12_i119] = c12_y[c12_i121 +
        c12_i119];
    }
...
const mxArray *sf_c12_DIPCalt_get_eml_resolved_functions_info(void)
{
  const mxArray *c12_nameCaptureInfo = NULL;
  c12_nameCaptureInfo = NULL;
  sf_mex_assign(&c12_nameCaptureInfo, sf_mex_createstruct("structure", 2, 34, 1),
                false);
...
static void c12_info_helper(const mxArray **c12_info)
{
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eye.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1406838348U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m"),
                  "resolved", "resolved", 1);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1368208230U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m"), "resolved",
                  "resolved", 3);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1363739056U), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 3);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_integer_class.m"),
                  "resolved", "resolved", 5);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1286843982U), "fileTimeLo",
                  "fileTimeLo", 5);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 5);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
                  "resolved", 6);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1362287082U), "fileTimeLo",
                  "fileTimeLo", 6);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 6);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m!isinbounds"),
                  "context", "context", 8);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("intmin"), "name", "name", 8);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 8);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1326753522U), "fileTimeLo",
                  "fileTimeLo", 10);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 10);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1326753196U), "fileTimeLo",
                  "fileTimeLo", 12);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 12);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/indexIntRelop.m!is_signed_indexIntClass"),
                  "context", "context", 13);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("intmin"), "name", "name", 13);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 13);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmin.m"), "resolved",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m"),
                  "context", "context", 15);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("intmax"), "name", "name", 15);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 15);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1397282622U), "fileTimeLo",
                  "fileTimeLo", 16);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 16);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 17);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("isfi"), "name", "name", 17);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("coder.internal.indexInt"),
                  "dominantType", "dominantType", 17);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/fixedpoint/isfi.m"), "resolved",
                  "resolved", 17);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1346535558U), "fileTimeLo",
                  "fileTimeLo", 17);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 17);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/fixedpoint/isnumerictype.m"), "resolved",
                  "resolved", 18);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1398900798U), "fileTimeLo",
                  "fileTimeLo", 18);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 18);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 19);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("intmax"), "name", "name", 19);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 19);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 20);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("intmin"), "name", "name", 20);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmin.m"), "resolved",
  ...
  sf_mex_addfield(*c12_info, sf_mex_duplicatearraysafe(&c12_lhs20), "lhs", "lhs",
                  20);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(""), "context", "context", 21);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("quatrot"), "name", "name",
                  21);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 21);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPC/quatrot.m"), "resolved",
                  "resolved", 21);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1446631716U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPC/quatrot.m"), "context",
                  "context", 22);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("quatconj"), "name", "name",
                  22);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/aeroblks/eml/quatconj.p"), "resolved", "resolved",
                  22);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1410808258U), "fileTimeLo",
                  "fileTimeLo", 22);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 22);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPC/quatrot.m"), "context",
                  "context", 23);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("quatmultiply"), "name",
                  "name", 23);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 23);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/aeroblks/eml/quatmultiply.p"), "context",
                  "context", 24);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("max"), "name", "name", 24);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 24);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/max.m"), "resolved",
                  "resolved", 24);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1311280516U), "fileTimeLo",
                  "fileTimeLo", 24);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 24);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1378321184U), "fileTimeLo",
                  "fileTimeLo", 25);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 25);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("skew_sm"), "name", "name",
                  33);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 33);
  sf_mex_addfield(*c12_info, c12_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPC/skew_sm.m"), "resolved",
                  "resolved", 33);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1445505143U), "fileTimeLo",
                  "fileTimeLo", 33);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 33);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
...
static void c12_eye(SFc12_DIPCaltInstanceStruct *chartInstance, real_T c12_I[9])
{
  ...
  int32_T c12_b_k;
  (void)chartInstance;
  for (c12_i122 = 0; c12_i122 < 9; c12_i122++) {
    c12_I[c12_i122] = 0.0;
  }
  ...
  for (c12_k = 1; c12_k < 4; c12_k++) {
    ...
    c12_I[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
             (real_T)c12_b_k), 1, 3, 1, 0) + 3 * (_SFD_EML_ARRAY_BOUNDS_CHECK("",
             (int32_T)_SFD_INTEGER_CHECK("", (real_T)c12_b_k), 1, 3, 2, 0) - 1))
      - 1] = 1.0;
  }
}
  ...
  c12_q[4], real_T c12_r[4], real_T c12_qout[4])
{
  ...
  c12_r3 = c12_r[2];
  c12_r4 = c12_r[3];
  c12_qout[0] = ((c12_q1 * c12_r1 - c12_q2 * c12_r2) - c12_q3 * c12_r3) - c12_q4
    * c12_r4;
  c12_qout[1] = (c12_q1 * c12_r2 + c12_r1 * c12_q2) + (c12_q3 * c12_r4 - c12_q4 *
    c12_r3);
  c12_qout[2] = (c12_q1 * c12_r3 + c12_r1 * c12_q3) + (c12_q4 * c12_r2 - c12_q2 *
    c12_r4);
  c12_qout[3] = (c12_q1 * c12_r4 + c12_r1 * c12_q4) + (c12_q2 * c12_r3 - c12_q3 *
    c12_r2);
}
  ...
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId)
{
  ...
  int32_T c12_i123;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), &c12_i123, 1, 6, 0U, 0, 0U, 0);
  c12_y = c12_i123;
  sf_mex_destroy(&c12_u);
  return c12_y;
}
  ...
  const mxArray *c12_b_is_active_c12_DIPCalt, const char_T *c12_identifier)
{
  ...
  c12_y = c12_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_DIPCalt), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_DIPCalt);
  return c12_y;
}
...
static void init_simulink_io_address(SFc12_DIPCaltInstanceStruct *chartInstance)
{
  chartInstance->c12_G = (real_T (*)[144])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c12_x = (real_T (*)[7])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
}
...
void sf_c12_DIPCalt_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c12_DIPCalt_get_post_codegen_info(void);
mxArray *sf_c12_DIPCalt_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c12_DIPCalt_get_post_codegen_info();
...
mxArray *sf_c12_DIPCalt_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c12_DIPCalt_jit_fallback_info(void)
{
...
mxArray *sf_c12_DIPCalt_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c12_DIPCalt(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"G\",},{M[8],M[0],T\"is_active_c12_DIPCalt\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_DIPCalt_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc12_DIPCaltInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c12_rv);
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c12_G);
        _SFD_SET_DATA_VALUE_PTR(2U, *chartInstance->c12_x);
      }
    } else {
...
static void sf_opaque_initialize_c12_DIPCalt(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_DIPCaltInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c12_DIPCalt((SFc12_DIPCaltInstanceStruct*) chartInstanceVar);
  initialize_c12_DIPCalt((SFc12_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c12_DIPCalt(void *chartInstanceVar)
{
  enable_c12_DIPCalt((SFc12_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_DIPCalt(void *chartInstanceVar)
{
  disable_c12_DIPCalt((SFc12_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c12_DIPCalt(void *chartInstanceVar)
{
  sf_gateway_c12_DIPCalt((SFc12_DIPCaltInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c12_DIPCalt(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c12_DIPCalt((SFc12_DIPCaltInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c12_DIPCalt(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c12_DIPCalt((SFc12_DIPCaltInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c12_DIPCalt(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_DIPCaltInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c12_DIPCalt((SFc12_DIPCaltInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc12_DIPCalt((SFc12_DIPCaltInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_DIPCalt(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c12_DIPCalt((SFc12_DIPCaltInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c12_DIPCalt(SimStruct *S)
{
...
static void mdlRTW_c12_DIPCalt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_DIPCalt(SimStruct *S)
{
  SFc12_DIPCaltInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc12_DIPCaltInstanceStruct *)utMalloc(sizeof
    (SFc12_DIPCaltInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc12_DIPCaltInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c12_DIPCalt;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c12_DIPCalt;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c12_DIPCalt;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c12_DIPCalt;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c12_DIPCalt;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c12_DIPCalt;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c12_DIPCalt;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c12_DIPCalt;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_DIPCalt;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_DIPCalt;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c12_DIPCalt;
...
void c12_DIPCalt_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_DIPCalt(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_DIPCalt(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_DIPCalt(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_DIPCalt_method_dispatcher.\n"
