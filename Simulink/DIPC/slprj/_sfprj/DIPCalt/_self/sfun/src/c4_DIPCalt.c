...
static void initialize_c4_DIPCalt(SFc4_DIPCaltInstanceStruct *chartInstance);
static void initialize_params_c4_DIPCalt(SFc4_DIPCaltInstanceStruct
  *chartInstance);
static void enable_c4_DIPCalt(SFc4_DIPCaltInstanceStruct *chartInstance);
static void disable_c4_DIPCalt(SFc4_DIPCaltInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_DIPCalt(SFc4_DIPCaltInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c4_DIPCalt(SFc4_DIPCaltInstanceStruct
  *chartInstance);
static void set_sim_state_c4_DIPCalt(SFc4_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c4_st);
static void finalize_c4_DIPCalt(SFc4_DIPCaltInstanceStruct *chartInstance);
static void sf_gateway_c4_DIPCalt(SFc4_DIPCaltInstanceStruct *chartInstance);
static void mdl_start_c4_DIPCalt(SFc4_DIPCaltInstanceStruct *chartInstance);
static void initSimStructsc4_DIPCalt(SFc4_DIPCaltInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static void c4_emlrt_marshallIn(SFc4_DIPCaltInstanceStruct *chartInstance, const
  mxArray *c4_b_qb4, const char_T *c4_identifier, real_T c4_y[4]);
static void c4_b_emlrt_marshallIn(SFc4_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[4]);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_c_emlrt_marshallIn(SFc4_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c4_b_pb4, const char_T *c4_identifier, real_T c4_y[3]);
static void c4_d_emlrt_marshallIn(SFc4_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[3]);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_e_emlrt_marshallIn(SFc4_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[12]);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_f_emlrt_marshallIn(SFc4_DIPCaltInstanceStruct *chartInstance,
...
static void c4_quatmultiply(SFc4_DIPCaltInstanceStruct *chartInstance, real_T
  c4_q[4], real_T c4_r[4], real_T c4_qout[4]);
static const mxArray *c4_e_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_g_emlrt_marshallIn(SFc4_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_h_emlrt_marshallIn(SFc4_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c4_b_is_active_c4_DIPCalt, const char_T *c4_identifier);
static uint8_T c4_i_emlrt_marshallIn(SFc4_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_DIPCaltInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc4_DIPCaltInstanceStruct *chartInstance);
...
static void initialize_c4_DIPCalt(SFc4_DIPCaltInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_DIPCalt = 0U;
}
  ...
  *chartInstance)
{
  ...
  c4_hoistedGlobal = chartInstance->c4_is_active_c4_DIPCalt;
  ...
  const mxArray *c4_st)
{
  ...
  chartInstance->c4_is_active_c4_DIPCalt = c4_h_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c4_u, 2)), "is_active_c4_DIPCalt");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_DIPCalt(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  real_T c4_u[4];
  const mxArray *c4_y = NULL;
  SFc4_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc4_DIPCaltInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_DIPCalt_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c4_b_is_active_c4_DIPCalt, const char_T *c4_identifier)
{
  ...
  c4_y = c4_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_DIPCalt), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_DIPCalt);
  return c4_y;
}
...
void sf_c4_DIPCalt_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c4_DIPCalt_get_post_codegen_info(void);
mxArray *sf_c4_DIPCalt_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c4_DIPCalt_get_post_codegen_info();
...
mxArray *sf_c4_DIPCalt_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_DIPCalt_jit_fallback_info(void)
{
...
mxArray *sf_c4_DIPCalt_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_DIPCalt(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"pb4\",},{M[1],M[8],T\"qb4\",},{M[8],M[0],T\"is_active_c4_DIPCalt\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_DIPCalt_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_DIPCaltInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c4_DIPCalt(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_DIPCaltInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c4_DIPCalt((SFc4_DIPCaltInstanceStruct*) chartInstanceVar);
  initialize_c4_DIPCalt((SFc4_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_DIPCalt(void *chartInstanceVar)
{
  enable_c4_DIPCalt((SFc4_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_DIPCalt(void *chartInstanceVar)
{
  disable_c4_DIPCalt((SFc4_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_DIPCalt(void *chartInstanceVar)
{
  sf_gateway_c4_DIPCalt((SFc4_DIPCaltInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c4_DIPCalt(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c4_DIPCalt((SFc4_DIPCaltInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c4_DIPCalt(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c4_DIPCalt((SFc4_DIPCaltInstanceStruct*)chartInfo->chartInstance,
    st);
}

static void sf_opaque_terminate_c4_DIPCalt(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_DIPCaltInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_DIPCalt((SFc4_DIPCaltInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_DIPCalt((SFc4_DIPCaltInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_DIPCalt(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c4_DIPCalt((SFc4_DIPCaltInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_DIPCalt(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(462418633U));
  ssSetChecksum1(S,(2380605535U));
  ssSetChecksum2(S,(3695443817U));
  ssSetChecksum3(S,(3844655592U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c4_DIPCalt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_DIPCalt(SimStruct *S)
{
  SFc4_DIPCaltInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_DIPCaltInstanceStruct *)utMalloc(sizeof
    (SFc4_DIPCaltInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_DIPCaltInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_DIPCalt;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c4_DIPCalt;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c4_DIPCalt;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_DIPCalt;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_DIPCalt;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c4_DIPCalt;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c4_DIPCalt;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c4_DIPCalt;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_DIPCalt;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_DIPCalt;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_DIPCalt;
...
void c4_DIPCalt_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_DIPCalt(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_DIPCalt(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_DIPCalt(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_DIPCalt_method_dispatcher.\n"
