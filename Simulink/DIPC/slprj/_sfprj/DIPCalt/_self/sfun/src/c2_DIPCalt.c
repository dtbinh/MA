...
static void initialize_c2_DIPCalt(SFc2_DIPCaltInstanceStruct *chartInstance);
static void initialize_params_c2_DIPCalt(SFc2_DIPCaltInstanceStruct
  *chartInstance);
static void enable_c2_DIPCalt(SFc2_DIPCaltInstanceStruct *chartInstance);
static void disable_c2_DIPCalt(SFc2_DIPCaltInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_DIPCalt(SFc2_DIPCaltInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_DIPCalt(SFc2_DIPCaltInstanceStruct
  *chartInstance);
static void set_sim_state_c2_DIPCalt(SFc2_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c2_st);
static void finalize_c2_DIPCalt(SFc2_DIPCaltInstanceStruct *chartInstance);
static void sf_gateway_c2_DIPCalt(SFc2_DIPCaltInstanceStruct *chartInstance);
static void mdl_start_c2_DIPCalt(SFc2_DIPCaltInstanceStruct *chartInstance);
static void initSimStructsc2_DIPCalt(SFc2_DIPCaltInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_DIPCaltInstanceStruct *chartInstance, const
  mxArray *c2_b_qb2, const char_T *c2_identifier, real_T c2_y[4]);
static void c2_b_emlrt_marshallIn(SFc2_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[4]);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c2_b_pb2, const char_T *c2_identifier, real_T c2_y[3]);
static void c2_d_emlrt_marshallIn(SFc2_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[3]);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[12]);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_f_emlrt_marshallIn(SFc2_DIPCaltInstanceStruct *chartInstance,
...
static void c2_quatmultiply(SFc2_DIPCaltInstanceStruct *chartInstance, real_T
  c2_q[4], real_T c2_r[4], real_T c2_qout[4]);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_g_emlrt_marshallIn(SFc2_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_h_emlrt_marshallIn(SFc2_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c2_b_is_active_c2_DIPCalt, const char_T *c2_identifier);
static uint8_T c2_i_emlrt_marshallIn(SFc2_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_DIPCaltInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc2_DIPCaltInstanceStruct *chartInstance);
...
static void initialize_c2_DIPCalt(SFc2_DIPCaltInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_DIPCalt = 0U;
}
  ...
  *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_DIPCalt;
  ...
  const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_DIPCalt = c2_h_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 2)), "is_active_c2_DIPCalt");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_DIPCalt(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  real_T c2_u[4];
  const mxArray *c2_y = NULL;
  SFc2_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc2_DIPCaltInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_DIPCalt_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c2_b_is_active_c2_DIPCalt, const char_T *c2_identifier)
{
  ...
  c2_y = c2_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_DIPCalt), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_DIPCalt);
  return c2_y;
}
...
void sf_c2_DIPCalt_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_DIPCalt_get_post_codegen_info(void);
mxArray *sf_c2_DIPCalt_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_DIPCalt_get_post_codegen_info();
...
mxArray *sf_c2_DIPCalt_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_DIPCalt_jit_fallback_info(void)
{
...
mxArray *sf_c2_DIPCalt_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_DIPCalt(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"pb2\",},{M[1],M[8],T\"qb2\",},{M[8],M[0],T\"is_active_c2_DIPCalt\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_DIPCalt_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_DIPCaltInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c2_DIPCalt(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_DIPCaltInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c2_DIPCalt((SFc2_DIPCaltInstanceStruct*) chartInstanceVar);
  initialize_c2_DIPCalt((SFc2_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_DIPCalt(void *chartInstanceVar)
{
  enable_c2_DIPCalt((SFc2_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_DIPCalt(void *chartInstanceVar)
{
  disable_c2_DIPCalt((SFc2_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_DIPCalt(void *chartInstanceVar)
{
  sf_gateway_c2_DIPCalt((SFc2_DIPCaltInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_DIPCalt(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_DIPCalt((SFc2_DIPCaltInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_DIPCalt(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_DIPCalt((SFc2_DIPCaltInstanceStruct*)chartInfo->chartInstance,
    st);
}

static void sf_opaque_terminate_c2_DIPCalt(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_DIPCaltInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_DIPCalt((SFc2_DIPCaltInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_DIPCalt((SFc2_DIPCaltInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_DIPCalt(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_DIPCalt((SFc2_DIPCaltInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_DIPCalt(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3586177644U));
  ssSetChecksum1(S,(3873030243U));
  ssSetChecksum2(S,(2686555426U));
  ssSetChecksum3(S,(1850337554U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_DIPCalt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_DIPCalt(SimStruct *S)
{
  SFc2_DIPCaltInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_DIPCaltInstanceStruct *)utMalloc(sizeof
    (SFc2_DIPCaltInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_DIPCaltInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_DIPCalt;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_DIPCalt;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_DIPCalt;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_DIPCalt;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_DIPCalt;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_DIPCalt;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_DIPCalt;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_DIPCalt;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_DIPCalt;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_DIPCalt;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_DIPCalt;
...
void c2_DIPCalt_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_DIPCalt(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_DIPCalt(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_DIPCalt(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_DIPCalt_method_dispatcher.\n"
