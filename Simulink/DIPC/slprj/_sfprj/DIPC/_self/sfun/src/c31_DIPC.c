...
static void sf_gateway_c31_DIPC(SFc31_DIPCInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 9U, chartInstance->c31_sfEvent);
...
static void c31_chartstep_c31_DIPC(SFc31_DIPCInstanceStruct *chartInstance)
{
  ...
  int32_T c31_i52;
  int32_T c31_i53;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 9U, chartInstance->c31_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 9U, chartInstance->c31_sfEvent);
}
