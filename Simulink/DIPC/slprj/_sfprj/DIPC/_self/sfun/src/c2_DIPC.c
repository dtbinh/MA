...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_DIPCInstanceStruct *chartInstance, const
  mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[12]);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_f_emlrt_marshallIn(SFc2_DIPCInstanceStruct *chartInstance,
...
static void c2_quatmultiply(SFc2_DIPCInstanceStruct *chartInstance, real_T c2_q
  [4], real_T c2_b_r[4], real_T c2_qout[4]);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_g_emlrt_marshallIn(SFc2_DIPCInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static uint8_T c2_i_emlrt_marshallIn(SFc2_DIPCInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
  ...
  mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_DIPC = c2_h_emlrt_marshallIn(chartInstance,
...
static void sf_gateway_c2_DIPC(SFc2_DIPCInstanceStruct *chartInstance)
{
  ...
  for (c2_i9 = 0; c2_i9 < 12; c2_i9++) {
    c2_b_r[c2_i9] = chartInstance->c2_r[c2_i9];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_b_r, 4U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_q, 3U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_c_r, 4U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  ...
  for (c2_i24 = 0; c2_i24 < 12; c2_i24++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c2_r[c2_i24], 3U);
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_r), &c2_thisId, c2_y);
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPC/quatrot.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1446631716U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  const mxArray *c2_b_is_active_c2_DIPC, const char_T *c2_identifier)
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_y = c2_i_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_is_active_c2_DIPC),
    &c2_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(317905961U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3796577245U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1520031961U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1149708234U);
}
...
mxArray *sf_c2_DIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("A32CIniuosT7As0lNgvPgE");
...
static void mdlSetWorkWidths_c2_DIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1652254717U));
  ssSetChecksum1(S,(994874624U));
  ssSetChecksum2(S,(2214107532U));
  ssSetChecksum3(S,(3328046413U));
