...
static void c30_quatrot(SFc30_DIPCInstanceStruct *chartInstance, real_T c30_q[4],
  real_T c30_b_r[3], real_T c30_rw[3]);
...
static void c30_emlrt_marshallIn(SFc30_DIPCInstanceStruct *chartInstance, const
  mxArray *c30_b_Ared, const char_T *c30_identifier, real_T c30_y[432]);
...
static void sf_gateway_c30_DIPC(SFc30_DIPCInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 8U, chartInstance->c30_sfEvent);
  for (c30_i3 = 0; c30_i3 < 12; c30_i3++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c30_r[c30_i3], 0U);
  }

  chartInstance->c30_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 8U, chartInstance->c30_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 8U, chartInstance->c30_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
