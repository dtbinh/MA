...
static void initialize_c31_DePascali4M(SFc31_DePascali4MInstanceStruct
  *chartInstance);
static void initialize_params_c31_DePascali4M(SFc31_DePascali4MInstanceStruct
  *chartInstance);
static void enable_c31_DePascali4M(SFc31_DePascali4MInstanceStruct
  *chartInstance);
static void disable_c31_DePascali4M(SFc31_DePascali4MInstanceStruct
  *chartInstance);
static void c31_update_debugger_state_c31_DePascali4M
  (SFc31_DePascali4MInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c31_DePascali4M
  (SFc31_DePascali4MInstanceStruct *chartInstance);
static void set_sim_state_c31_DePascali4M(SFc31_DePascali4MInstanceStruct
  *chartInstance, const mxArray *c31_st);
static void finalize_c31_DePascali4M(SFc31_DePascali4MInstanceStruct
  *chartInstance);
static void sf_gateway_c31_DePascali4M(SFc31_DePascali4MInstanceStruct
  *chartInstance);
static void mdl_start_c31_DePascali4M(SFc31_DePascali4MInstanceStruct
  *chartInstance);
static void c31_chartstep_c31_DePascali4M(SFc31_DePascali4MInstanceStruct
  *chartInstance);
static void initSimStructsc31_DePascali4M(SFc31_DePascali4MInstanceStruct
  *chartInstance);
static void c31_skew_sm(SFc31_DePascali4MInstanceStruct *chartInstance, real_T
  c31_b_x[3], real_T c31_X[9]);
static void c31_quatrot(SFc31_DePascali4MInstanceStruct *chartInstance, real_T
...
static const mxArray *c31_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_emlrt_marshallIn(SFc31_DePascali4MInstanceStruct *chartInstance,
  const mxArray *c31_b_bred, const char_T *c31_identifier, real_T c31_y[18]);
static void c31_b_emlrt_marshallIn(SFc31_DePascali4MInstanceStruct
...
static const mxArray *c31_d_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_c_emlrt_marshallIn(SFc31_DePascali4MInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId,
  real_T c31_y[12]);
...
static const mxArray *c31_e_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static real_T c31_d_emlrt_marshallIn(SFc31_DePascali4MInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
...
static const mxArray *c31_f_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_e_emlrt_marshallIn(SFc31_DePascali4MInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId,
  real_T c31_y[9]);
...
static const mxArray *c31_g_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_f_emlrt_marshallIn(SFc31_DePascali4MInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId,
  real_T c31_y[3]);
...
static const mxArray *c31_h_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_g_emlrt_marshallIn(SFc31_DePascali4MInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId,
  real_T c31_y[4]);
...
static void c31_eml_scalar_eg(SFc31_DePascali4MInstanceStruct *chartInstance);
static void c31_threshold(SFc31_DePascali4MInstanceStruct *chartInstance);
static void c31_quatmultiply(SFc31_DePascali4MInstanceStruct *chartInstance,
  real_T c31_q[4], real_T c31_b_r[4], real_T c31_qout[4]);
static void c31_b_eml_scalar_eg(SFc31_DePascali4MInstanceStruct *chartInstance);
static const mxArray *c31_i_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static int32_T c31_h_emlrt_marshallIn(SFc31_DePascali4MInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
static void c31_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData);
static uint8_T c31_i_emlrt_marshallIn(SFc31_DePascali4MInstanceStruct
  *chartInstance, const mxArray *c31_b_is_active_c31_DePascali4M, const char_T
  *c31_identifier);
static uint8_T c31_j_emlrt_marshallIn(SFc31_DePascali4MInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
static void init_dsm_address_info(SFc31_DePascali4MInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc31_DePascali4MInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c31_is_active_c31_DePascali4M = 0U;
}
  ...
  (SFc31_DePascali4MInstanceStruct *chartInstance)
{
  ...
  c31_hoistedGlobal = chartInstance->c31_is_active_c31_DePascali4M;
  ...
  *chartInstance, const mxArray *c31_st)
{
  ...
  chartInstance->c31_is_active_c31_DePascali4M = c31_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c31_u, 1)),
     "is_active_c31_DePascali4M");
  sf_mex_destroy(&c31_u);
  c31_update_debugger_state_c31_DePascali4M(chartInstance);
  ...
  *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 13U, chartInstance->c31_sfEvent);
  ...
  chartInstance->c31_sfEvent = CALL_EVENT;
  c31_chartstep_c31_DePascali4M(chartInstance);
  ...
  *chartInstance)
{
  ...
  int32_T c31_i53;
  int32_T c31_i54;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 13U, chartInstance->c31_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 13U, chartInstance->c31_sfEvent);
}
  ...
  *c31_inData)
{
  ...
  const mxArray *c31_y = NULL;
  SFc31_DePascali4MInstanceStruct *chartInstance;
  chartInstance = (SFc31_DePascali4MInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c31_DePascali4M_get_eml_resolved_functions_info(void)
{
  ...
  *c31_identifier)
{
  ...
  c31_y = c31_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c31_b_is_active_c31_DePascali4M), &c31_thisId);
  sf_mex_destroy(&c31_b_is_active_c31_DePascali4M);
  return c31_y;
}
...
void sf_c31_DePascali4M_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c31_DePascali4M_get_post_codegen_info(void);
mxArray *sf_c31_DePascali4M_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c31_DePascali4M_get_post_codegen_info();
...
mxArray *sf_c31_DePascali4M_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c31_DePascali4M_jit_fallback_info(void)
{
...
mxArray *sf_c31_DePascali4M_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c31_DePascali4M(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"bred\",},{M[8],M[0],T\"is_active_c31_DePascali4M\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c31_DePascali4M_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc31_DePascali4MInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c31_DePascali4M(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc31_DePascali4MInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c31_DePascali4M((SFc31_DePascali4MInstanceStruct*)
    chartInstanceVar);
  initialize_c31_DePascali4M((SFc31_DePascali4MInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c31_DePascali4M(void *chartInstanceVar)
{
  enable_c31_DePascali4M((SFc31_DePascali4MInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c31_DePascali4M(void *chartInstanceVar)
{
  disable_c31_DePascali4M((SFc31_DePascali4MInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c31_DePascali4M(void *chartInstanceVar)
{
  sf_gateway_c31_DePascali4M((SFc31_DePascali4MInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c31_DePascali4M(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c31_DePascali4M((SFc31_DePascali4MInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c31_DePascali4M(SimStruct* S, const mxArray *
  st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c31_DePascali4M((SFc31_DePascali4MInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c31_DePascali4M(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc31_DePascali4MInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c31_DePascali4M((SFc31_DePascali4MInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc31_DePascali4M((SFc31_DePascali4MInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c31_DePascali4M(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c31_DePascali4M(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1480344068U));
  ssSetChecksum1(S,(3487350155U));
  ssSetChecksum2(S,(3457432590U));
  ssSetChecksum3(S,(1831400523U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c31_DePascali4M(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c31_DePascali4M(SimStruct *S)
{
  SFc31_DePascali4MInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc31_DePascali4MInstanceStruct *)utMalloc(sizeof
    (SFc31_DePascali4MInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc31_DePascali4MInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c31_DePascali4M;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c31_DePascali4M;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c31_DePascali4M;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c31_DePascali4M;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c31_DePascali4M;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c31_DePascali4M;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c31_DePascali4M;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c31_DePascali4M;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c31_DePascali4M;
  chartInstance->chartInfo.mdlStart = mdlStart_c31_DePascali4M;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c31_DePascali4M;
...
void c31_DePascali4M_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c31_DePascali4M(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c31_DePascali4M(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c31_DePascali4M(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c31_DePascali4M_method_dispatcher.\n"
