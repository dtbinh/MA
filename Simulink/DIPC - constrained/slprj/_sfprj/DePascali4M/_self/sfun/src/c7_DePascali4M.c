...
static void initialize_c7_DePascali4M(SFc7_DePascali4MInstanceStruct
  *chartInstance);
static void initialize_params_c7_DePascali4M(SFc7_DePascali4MInstanceStruct
  *chartInstance);
static void enable_c7_DePascali4M(SFc7_DePascali4MInstanceStruct *chartInstance);
static void disable_c7_DePascali4M(SFc7_DePascali4MInstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_DePascali4M
  (SFc7_DePascali4MInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_DePascali4M
  (SFc7_DePascali4MInstanceStruct *chartInstance);
static void set_sim_state_c7_DePascali4M(SFc7_DePascali4MInstanceStruct
  *chartInstance, const mxArray *c7_st);
static void finalize_c7_DePascali4M(SFc7_DePascali4MInstanceStruct
  *chartInstance);
static void sf_gateway_c7_DePascali4M(SFc7_DePascali4MInstanceStruct
  *chartInstance);
static void mdl_start_c7_DePascali4M(SFc7_DePascali4MInstanceStruct
  *chartInstance);
static void initSimStructsc7_DePascali4M(SFc7_DePascali4MInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber, uint32_T c7_instanceNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static void c7_emlrt_marshallIn(SFc7_DePascali4MInstanceStruct *chartInstance,
  const mxArray *c7_b_hcoriolis, const char_T *c7_identifier, real_T c7_y[6]);
static void c7_b_emlrt_marshallIn(SFc7_DePascali4MInstanceStruct *chartInstance,
  const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId, real_T c7_y[6]);
static void c7_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_b_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static real_T c7_c_emlrt_marshallIn(SFc7_DePascali4MInstanceStruct
...
static const mxArray *c7_d_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_d_emlrt_marshallIn(SFc7_DePascali4MInstanceStruct *chartInstance,
...
static const mxArray *c7_e_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_e_emlrt_marshallIn(SFc7_DePascali4MInstanceStruct *chartInstance,
...
static void c7_eml_scalar_eg(SFc7_DePascali4MInstanceStruct *chartInstance);
static void c7_eml_xgemm(SFc7_DePascali4MInstanceStruct *chartInstance, real_T
  c7_A[9], real_T c7_B[3], real_T c7_C[3], real_T c7_b_C[3]);
static const mxArray *c7_f_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_f_emlrt_marshallIn(SFc7_DePascali4MInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint8_T c7_g_emlrt_marshallIn(SFc7_DePascali4MInstanceStruct
  *chartInstance, const mxArray *c7_b_is_active_c7_DePascali4M, const char_T
  *c7_identifier);
static uint8_T c7_h_emlrt_marshallIn(SFc7_DePascali4MInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_eml_xgemm(SFc7_DePascali4MInstanceStruct *chartInstance, real_T
  c7_A[9], real_T c7_B[3], real_T c7_C[3]);
static void init_dsm_address_info(SFc7_DePascali4MInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc7_DePascali4MInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_DePascali4M = 0U;
}
  ...
  (SFc7_DePascali4MInstanceStruct *chartInstance)
{
  ...
  c7_hoistedGlobal = chartInstance->c7_is_active_c7_DePascali4M;
  ...
  *chartInstance, const mxArray *c7_st)
{
  ...
  chartInstance->c7_is_active_c7_DePascali4M = c7_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 1)),
     "is_active_c7_DePascali4M");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_DePascali4M(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_DePascali4MInstanceStruct *chartInstance;
  chartInstance = (SFc7_DePascali4MInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c7_DePascali4M_get_eml_resolved_functions_info(void)
{
  ...
  *c7_identifier)
{
  ...
  c7_y = c7_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_DePascali4M), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_DePascali4M);
  return c7_y;
}
...
void sf_c7_DePascali4M_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c7_DePascali4M_get_post_codegen_info(void);
mxArray *sf_c7_DePascali4M_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c7_DePascali4M_get_post_codegen_info();
...
mxArray *sf_c7_DePascali4M_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c7_DePascali4M_jit_fallback_info(void)
{
...
mxArray *sf_c7_DePascali4M_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c7_DePascali4M(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"hcoriolis\",},{M[8],M[0],T\"is_active_c7_DePascali4M\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_DePascali4M_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc7_DePascali4MInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c7_DePascali4M(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_DePascali4MInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c7_DePascali4M((SFc7_DePascali4MInstanceStruct*)
    chartInstanceVar);
  initialize_c7_DePascali4M((SFc7_DePascali4MInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_DePascali4M(void *chartInstanceVar)
{
  enable_c7_DePascali4M((SFc7_DePascali4MInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c7_DePascali4M(void *chartInstanceVar)
{
  disable_c7_DePascali4M((SFc7_DePascali4MInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c7_DePascali4M(void *chartInstanceVar)
{
  sf_gateway_c7_DePascali4M((SFc7_DePascali4MInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c7_DePascali4M(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c7_DePascali4M((SFc7_DePascali4MInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c7_DePascali4M(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c7_DePascali4M((SFc7_DePascali4MInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c7_DePascali4M(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_DePascali4MInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c7_DePascali4M((SFc7_DePascali4MInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc7_DePascali4M((SFc7_DePascali4MInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_DePascali4M(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c7_DePascali4M(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1415645508U));
  ssSetChecksum1(S,(2579135138U));
  ssSetChecksum2(S,(1097850832U));
  ssSetChecksum3(S,(210606000U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c7_DePascali4M(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_DePascali4M(SimStruct *S)
{
  SFc7_DePascali4MInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc7_DePascali4MInstanceStruct *)utMalloc(sizeof
    (SFc7_DePascali4MInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_DePascali4MInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c7_DePascali4M;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c7_DePascali4M;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c7_DePascali4M;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_DePascali4M;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c7_DePascali4M;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c7_DePascali4M;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c7_DePascali4M;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_DePascali4M;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_DePascali4M;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_DePascali4M;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c7_DePascali4M;
...
void c7_DePascali4M_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_DePascali4M(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_DePascali4M(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_DePascali4M(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_DePascali4M_method_dispatcher.\n"
