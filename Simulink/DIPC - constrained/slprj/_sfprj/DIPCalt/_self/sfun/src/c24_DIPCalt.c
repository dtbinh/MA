...
static const char * c24_debug_family_names[6] = { "nargin", "nargout", "dx",
  "j3", "m3", "hcoriolis" };
...
static void initialize_c24_DIPCalt(SFc24_DIPCaltInstanceStruct *chartInstance);
static void initialize_params_c24_DIPCalt(SFc24_DIPCaltInstanceStruct
  *chartInstance);
static void enable_c24_DIPCalt(SFc24_DIPCaltInstanceStruct *chartInstance);
static void disable_c24_DIPCalt(SFc24_DIPCaltInstanceStruct *chartInstance);
static void c24_update_debugger_state_c24_DIPCalt(SFc24_DIPCaltInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c24_DIPCalt(SFc24_DIPCaltInstanceStruct
  *chartInstance);
static void set_sim_state_c24_DIPCalt(SFc24_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c24_st);
static void finalize_c24_DIPCalt(SFc24_DIPCaltInstanceStruct *chartInstance);
static void sf_gateway_c24_DIPCalt(SFc24_DIPCaltInstanceStruct *chartInstance);
static void mdl_start_c24_DIPCalt(SFc24_DIPCaltInstanceStruct *chartInstance);
static void initSimStructsc24_DIPCalt(SFc24_DIPCaltInstanceStruct *chartInstance);
...
static const mxArray *c24_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static void c24_emlrt_marshallIn(SFc24_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c24_b_hcoriolis, const char_T *c24_identifier, real_T c24_y[6]);
static void c24_b_emlrt_marshallIn(SFc24_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c24_b_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static real_T c24_c_emlrt_marshallIn(SFc24_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c24_c_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static void c24_d_emlrt_marshallIn(SFc24_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c24_d_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static void c24_e_emlrt_marshallIn(SFc24_DIPCaltInstanceStruct *chartInstance,
...
static void c24_eml_scalar_eg(SFc24_DIPCaltInstanceStruct *chartInstance);
static void c24_eml_xgemm(SFc24_DIPCaltInstanceStruct *chartInstance, real_T
  c24_A[9], real_T c24_B[3], real_T c24_C[3], real_T c24_b_C[3]);
static const mxArray *c24_e_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static int32_T c24_f_emlrt_marshallIn(SFc24_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
static void c24_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c24_mxArrayInData, const char_T *c24_varName, void *c24_outData);
static uint8_T c24_g_emlrt_marshallIn(SFc24_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c24_b_is_active_c24_DIPCalt, const char_T *c24_identifier);
static uint8_T c24_h_emlrt_marshallIn(SFc24_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
static void c24_b_eml_xgemm(SFc24_DIPCaltInstanceStruct *chartInstance, real_T
  c24_A[9], real_T c24_B[3], real_T c24_C[3]);
static void init_dsm_address_info(SFc24_DIPCaltInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc24_DIPCaltInstanceStruct *chartInstance);
...
static void initialize_c24_DIPCalt(SFc24_DIPCaltInstanceStruct *chartInstance)
{
  ...
  chartInstance->c24_is_active_c24_DIPCalt = 0U;
}
  ...
  *chartInstance)
{
  real_T c24_d0;
  real_T c24_d1;
  sf_mex_import_named("j3", sf_mex_get_sfun_param(chartInstance->S, 0, 0),
                      &c24_d0, 0, 0, 0U, 0, 0U, 0);
  chartInstance->c24_j3 = c24_d0;
  sf_mex_import_named("m3", sf_mex_get_sfun_param(chartInstance->S, 1, 0),
                      &c24_d1, 0, 0, 0U, 0, 0U, 0);
  chartInstance->c24_m3 = c24_d1;
}
  ...
  *chartInstance)
{
  ...
  for (c24_i0 = 0; c24_i0 < 6; c24_i0++) {
    c24_u[c24_i0] = (*chartInstance->c24_hcoriolis)[c24_i0];
  }

  c24_b_y = NULL;
  sf_mex_assign(&c24_b_y, sf_mex_create("y", c24_u, 0, 0U, 1U, 0U, 1, 6), false);
  sf_mex_setcell(c24_y, 0, c24_b_y);
  c24_hoistedGlobal = chartInstance->c24_is_active_c24_DIPCalt;
  ...
  const mxArray *c24_st)
{
  ...
  for (c24_i1 = 0; c24_i1 < 6; c24_i1++) {
    (*chartInstance->c24_hcoriolis)[c24_i1] = c24_dv0[c24_i1];
  }

  chartInstance->c24_is_active_c24_DIPCalt = c24_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c24_u, 1)),
     "is_active_c24_DIPCalt");
  sf_mex_destroy(&c24_u);
  c24_update_debugger_state_c24_DIPCalt(chartInstance);
...
static void sf_gateway_c24_DIPCalt(SFc24_DIPCaltInstanceStruct *chartInstance)
{
  ...
  int32_T c24_i11;
  real_T c24_b_x[3];
  real_T c24_c_nargin = 1.0;
  real_T c24_c_nargout = 1.0;
  real_T c24_b_X[9];
  real_T c24_b_a;
  int32_T c24_i12;
  int32_T c24_i13;
  ...
  for (c24_i2 = 0; c24_i2 < 6; c24_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c24_dx)[c24_i2], 0U);
  }

  chartInstance->c24_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 18U, chartInstance->c24_sfEvent);
  c24_hoistedGlobal = chartInstance->c24_j3;
  c24_b_hoistedGlobal = chartInstance->c24_m3;
  for (c24_i3 = 0; c24_i3 < 6; c24_i3++) {
    c24_b_dx[c24_i3] = (*chartInstance->c24_dx)[c24_i3];
  }

  c24_b_j3 = c24_hoistedGlobal;
  c24_b_m3 = c24_b_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c24_nargout, 1U, c24_b_sf_marshallOut,
    c24_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c24_b_dx, 2U, c24_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c24_b_j3, 3U, c24_b_sf_marshallOut,
    c24_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c24_b_m3, 4U, c24_b_sf_marshallOut,
    c24_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c24_b_hcoriolis, 5U, c24_sf_marshallOut,
    c24_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c24_sfEvent, 2);
  for (c24_i4 = 0; c24_i4 < 3; c24_i4++) {
    c24_x[c24_i4] = c24_b_dx[c24_i4 + 3];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c24_b_nargout, 1U, c24_b_sf_marshallOut,
    c24_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c24_x, 2U, c24_d_sf_marshallOut,
    c24_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c24_X, 3U, c24_c_sf_marshallOut,
    c24_c_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  ...
  for (c24_i7 = 0; c24_i7 < 3; c24_i7++) {
    c24_b_b[c24_i7] = c24_b_dx[c24_i7];
  }
  ...
  for (c24_i9 = 0; c24_i9 < 9; c24_i9++) {
    c24_c_b[c24_i9] = c24_b[c24_i9];
  }

  for (c24_i10 = 0; c24_i10 < 3; c24_i10++) {
    c24_d_b[c24_i10] = c24_b_b[c24_i10];
  }

  c24_b_eml_xgemm(chartInstance, c24_c_b, c24_d_b, c24_y);
  for (c24_i11 = 0; c24_i11 < 3; c24_i11++) {
    c24_b_x[c24_i11] = c24_b_dx[c24_i11 + 3];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 4U, 4U, c24_b_debug_family_names,
    c24_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c24_c_nargin, 0U, c24_b_sf_marshallOut,
    c24_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c24_c_nargout, 1U, c24_b_sf_marshallOut,
    c24_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c24_b_x, 2U, c24_d_sf_marshallOut,
    c24_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c24_b_X, 3U, c24_c_sf_marshallOut,
    c24_c_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  _SFD_SCRIPT_CALL(0U, chartInstance->c24_sfEvent, 3);
  c24_b_X[0] = 0.0;
  ...
  _SFD_SYMBOL_SCOPE_POP();
  c24_b_a = c24_b_j3;
  for (c24_i12 = 0; c24_i12 < 9; c24_i12++) {
    c24_b[c24_i12] = c24_b_X[c24_i12];
  }

  for (c24_i13 = 0; c24_i13 < 9; c24_i13++) {
    c24_b[c24_i13] *= c24_b_a;
  }

  for (c24_i14 = 0; c24_i14 < 3; c24_i14++) {
    c24_b_b[c24_i14] = c24_b_dx[c24_i14 + 3];
  }
  ...
  for (c24_i16 = 0; c24_i16 < 9; c24_i16++) {
    c24_e_b[c24_i16] = c24_b[c24_i16];
  }

  for (c24_i17 = 0; c24_i17 < 3; c24_i17++) {
    c24_f_b[c24_i17] = c24_b_b[c24_i17];
  }

  c24_b_eml_xgemm(chartInstance, c24_e_b, c24_f_b, c24_b_y);
  for (c24_i18 = 0; c24_i18 < 3; c24_i18++) {
    c24_b_hcoriolis[c24_i18] = c24_y[c24_i18];
  }

  for (c24_i19 = 0; c24_i19 < 3; c24_i19++) {
    c24_b_hcoriolis[c24_i19 + 3] = c24_b_y[c24_i19];
  }

  _SFD_EML_CALL(0U, chartInstance->c24_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c24_i20 = 0; c24_i20 < 6; c24_i20++) {
    (*chartInstance->c24_hcoriolis)[c24_i20] = c24_b_hcoriolis[c24_i20];
  }
  ...
  for (c24_i21 = 0; c24_i21 < 6; c24_i21++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c24_hcoriolis)[c24_i21], 1U);
  }

  _SFD_DATA_RANGE_CHECK(chartInstance->c24_j3, 2U);
  _SFD_DATA_RANGE_CHECK(chartInstance->c24_m3, 3U);
}
  ...
  *c24_inData)
{
  ...
  real_T c24_u[6];
  const mxArray *c24_y = NULL;
  SFc24_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc24_DIPCaltInstanceStruct *)chartInstanceVoid;
  c24_mxArrayOutData = NULL;
  for (c24_i22 = 0; c24_i22 < 6; c24_i22++) {
    c24_b_inData[c24_i22] = (*(real_T (*)[6])c24_inData)[c24_i22];
  }

  for (c24_i23 = 0; c24_i23 < 6; c24_i23++) {
    c24_u[c24_i23] = c24_b_inData[c24_i23];
  }
  ...
  const mxArray *c24_b_hcoriolis, const char_T *c24_identifier, real_T c24_y[6])
{
  ...
  c24_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c24_b_hcoriolis), &c24_thisId,
    c24_y);
  sf_mex_destroy(&c24_b_hcoriolis);
}
  ...
  *c24_mxArrayInData, const char_T *c24_varName, void *c24_outData)
{
  ...
  SFc24_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc24_DIPCaltInstanceStruct *)chartInstanceVoid;
  c24_b_hcoriolis = sf_mex_dup(c24_mxArrayInData);
  ...
  for (c24_i25 = 0; c24_i25 < 6; c24_i25++) {
    (*(real_T (*)[6])c24_outData)[c24_i25] = c24_y[c24_i25];
  }
...
static void c24_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c24_mxArrayInData, const char_T *c24_varName, void *c24_outData)
{
  const mxArray *c24_b_m3;
  const char_T *c24_identifier;
  emlrtMsgIdentifier c24_thisId;
  real_T c24_y;
  SFc24_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc24_DIPCaltInstanceStruct *)chartInstanceVoid;
  c24_b_m3 = sf_mex_dup(c24_mxArrayInData);
  c24_identifier = c24_varName;
  c24_thisId.fIdentifier = c24_identifier;
  c24_thisId.fParent = NULL;
  c24_y = c24_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c24_b_m3),
    &c24_thisId);
  sf_mex_destroy(&c24_b_m3);
  ...
  *c24_inData)
{
  ...
  for (c24_i27 = 0; c24_i27 < 3; c24_i27++) {
    for (c24_i28 = 0; c24_i28 < 3; c24_i28++) {
      c24_b_inData[c24_i28 + c24_i26] = (*(real_T (*)[9])c24_inData)[c24_i28 +
        c24_i26];
    }
  ...
  for (c24_i30 = 0; c24_i30 < 3; c24_i30++) {
    for (c24_i31 = 0; c24_i31 < 3; c24_i31++) {
      c24_u[c24_i31 + c24_i29] = c24_b_inData[c24_i31 + c24_i29];
    }
  ...
  *c24_mxArrayInData, const char_T *c24_varName, void *c24_outData)
{
  ...
  for (c24_i34 = 0; c24_i34 < 3; c24_i34++) {
    for (c24_i35 = 0; c24_i35 < 3; c24_i35++) {
      (*(real_T (*)[9])c24_outData)[c24_i35 + c24_i33] = c24_y[c24_i35 + c24_i33];
    }
  ...
  *c24_inData)
{
  ...
  for (c24_i36 = 0; c24_i36 < 3; c24_i36++) {
    c24_b_inData[c24_i36] = (*(real_T (*)[3])c24_inData)[c24_i36];
  }

  for (c24_i37 = 0; c24_i37 < 3; c24_i37++) {
    c24_u[c24_i37] = c24_b_inData[c24_i37];
  }
  ...
  *c24_mxArrayInData, const char_T *c24_varName, void *c24_outData)
{
  ...
  for (c24_i39 = 0; c24_i39 < 3; c24_i39++) {
    (*(real_T (*)[3])c24_outData)[c24_i39] = c24_y[c24_i39];
  }

  sf_mex_destroy(&c24_mxArrayInData);
}

const mxArray *sf_c24_DIPCalt_get_eml_resolved_functions_info(void)
{
  const mxArray *c24_nameCaptureInfo = NULL;
  c24_nameCaptureInfo = NULL;
  sf_mex_assign(&c24_nameCaptureInfo, sf_mex_createstruct("structure", 2, 14, 1),
                false);
...
static void c24_info_helper(const mxArray **c24_info)
{
  ...
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m"),
                  "resolved", "resolved", 3);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(1323195778U), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 3);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m"), "resolved",
                  "resolved", 4);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(1376005888U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/scalarEg.p"),
                  "resolved", "resolved", 5);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(1410832970U), "fileTimeLo",
                  "fileTimeLo", 5);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 5);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgemm.m"),
                  "resolved", "resolved", 6);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(1376005890U), "fileTimeLo",
                  "fileTimeLo", 6);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 6);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/inline.p"),
                  "resolved", "resolved", 7);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(1410832972U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgemm.m"), "context",
                  "context", 8);
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut("coder.internal.blas.xgemm"),
                  "name", "name", 8);
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 8);
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(1393356058U), "fileTimeLo",
                  "fileTimeLo", 11);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 11);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  c24_A[9], real_T c24_B[3], real_T c24_C[3], real_T c24_b_C[3])
{
  ...
  for (c24_i40 = 0; c24_i40 < 3; c24_i40++) {
    c24_b_C[c24_i40] = c24_C[c24_i40];
  }

  for (c24_i41 = 0; c24_i41 < 9; c24_i41++) {
    c24_b_A[c24_i41] = c24_A[c24_i41];
  }

  for (c24_i42 = 0; c24_i42 < 3; c24_i42++) {
    c24_b_B[c24_i42] = c24_B[c24_i42];
  }

  c24_b_eml_xgemm(chartInstance, c24_b_A, c24_b_B, c24_b_C);
}
  ...
  const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId)
{
  ...
  int32_T c24_i43;
  (void)chartInstance;
  sf_mex_import(c24_parentId, sf_mex_dup(c24_u), &c24_i43, 1, 6, 0U, 0, 0U, 0);
  c24_y = c24_i43;
  sf_mex_destroy(&c24_u);
  return c24_y;
}
  ...
  const mxArray *c24_b_is_active_c24_DIPCalt, const char_T *c24_identifier)
{
  ...
  c24_y = c24_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c24_b_is_active_c24_DIPCalt), &c24_thisId);
  sf_mex_destroy(&c24_b_is_active_c24_DIPCalt);
  return c24_y;
}
  ...
  c24_A[9], real_T c24_B[3], real_T c24_C[3])
{
  ...
  for (c24_i44 = 0; c24_i44 < 3; c24_i44++) {
    ...
    for (c24_i46 = 0; c24_i46 < 3; c24_i46++) {
      c24_C[c24_i44] += c24_A[c24_i45 + c24_i44] * c24_B[c24_i46];
      c24_i45 += 3;
    }
  }
}
...
static void init_simulink_io_address(SFc24_DIPCaltInstanceStruct *chartInstance)
{
  chartInstance->c24_dx = (real_T (*)[6])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c24_hcoriolis = (real_T (*)[6])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
void sf_c24_DIPCalt_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2210958886U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(385399976U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1297418843U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4177207482U);
}

mxArray* sf_c24_DIPCalt_get_post_codegen_info(void);
mxArray *sf_c24_DIPCalt_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("NWWIP1chAnCJwYw2rm9dzE");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c24_DIPCalt_get_post_codegen_info();
...
mxArray *sf_c24_DIPCalt_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c24_DIPCalt_jit_fallback_info(void)
{
...
mxArray *sf_c24_DIPCalt_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c24_DIPCalt(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"hcoriolis\",},{M[8],M[0],T\"is_active_c24_DIPCalt\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c24_DIPCalt_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc24_DIPCaltInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(2,10,0,0,"j3");
          _SFD_SET_DATA_PROPS(3,10,0,0,"m3");
        ...
        _SFD_SET_DATA_COMPILED_PROPS(3,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c24_b_sf_marshallOut,(MexInFcnForType)
          c24_b_sf_marshallIn);
        _SFD_SET_DATA_VALUE_PTR(0U, *chartInstance->c24_dx);
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c24_hcoriolis);
        _SFD_SET_DATA_VALUE_PTR(2U, &chartInstance->c24_j3);
        _SFD_SET_DATA_VALUE_PTR(3U, &chartInstance->c24_m3);
      }
    } else {
...
{
  return "b0frbEAn6hbBO7GDljLVvC";
}

static void sf_opaque_initialize_c24_DIPCalt(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc24_DIPCaltInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c24_DIPCalt((SFc24_DIPCaltInstanceStruct*) chartInstanceVar);
  initialize_c24_DIPCalt((SFc24_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c24_DIPCalt(void *chartInstanceVar)
{
  enable_c24_DIPCalt((SFc24_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c24_DIPCalt(void *chartInstanceVar)
{
  disable_c24_DIPCalt((SFc24_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c24_DIPCalt(void *chartInstanceVar)
{
  sf_gateway_c24_DIPCalt((SFc24_DIPCaltInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c24_DIPCalt(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c24_DIPCalt((SFc24_DIPCaltInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c24_DIPCalt(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c24_DIPCalt((SFc24_DIPCaltInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c24_DIPCalt(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc24_DIPCaltInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c24_DIPCalt((SFc24_DIPCaltInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc24_DIPCalt((SFc24_DIPCaltInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c24_DIPCalt(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c24_DIPCalt((SFc24_DIPCaltInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c24_DIPCalt(SimStruct *S)
{
  /* Actual parameters from chart:
     j3 m3
   */
  const char_T *rtParamNames[] = { "j3", "m3" };
  ...
  ssSetChecksum0(S,(148654496U));
  ssSetChecksum1(S,(640818491U));
  ssSetChecksum2(S,(755498461U));
  ssSetChecksum3(S,(2784956538U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c24_DIPCalt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c24_DIPCalt(SimStruct *S)
{
  SFc24_DIPCaltInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc24_DIPCaltInstanceStruct *)utMalloc(sizeof
    (SFc24_DIPCaltInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc24_DIPCaltInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c24_DIPCalt;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c24_DIPCalt;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c24_DIPCalt;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c24_DIPCalt;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c24_DIPCalt;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c24_DIPCalt;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c24_DIPCalt;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c24_DIPCalt;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c24_DIPCalt;
  chartInstance->chartInfo.mdlStart = mdlStart_c24_DIPCalt;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c24_DIPCalt;
...
void c24_DIPCalt_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c24_DIPCalt(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c24_DIPCalt(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c24_DIPCalt(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c24_DIPCalt_method_dispatcher.\n"
