...
static void initialize_c22_DIPCalt(SFc22_DIPCaltInstanceStruct *chartInstance);
static void initialize_params_c22_DIPCalt(SFc22_DIPCaltInstanceStruct
  *chartInstance);
static void enable_c22_DIPCalt(SFc22_DIPCaltInstanceStruct *chartInstance);
static void disable_c22_DIPCalt(SFc22_DIPCaltInstanceStruct *chartInstance);
static void c22_update_debugger_state_c22_DIPCalt(SFc22_DIPCaltInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c22_DIPCalt(SFc22_DIPCaltInstanceStruct
  *chartInstance);
static void set_sim_state_c22_DIPCalt(SFc22_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c22_st);
static void finalize_c22_DIPCalt(SFc22_DIPCaltInstanceStruct *chartInstance);
static void sf_gateway_c22_DIPCalt(SFc22_DIPCaltInstanceStruct *chartInstance);
static void mdl_start_c22_DIPCalt(SFc22_DIPCaltInstanceStruct *chartInstance);
static void initSimStructsc22_DIPCalt(SFc22_DIPCaltInstanceStruct *chartInstance);
...
static const mxArray *c22_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static void c22_emlrt_marshallIn(SFc22_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c22_b_hcoriolis, const char_T *c22_identifier, real_T c22_y[6]);
static void c22_b_emlrt_marshallIn(SFc22_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c22_b_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static real_T c22_c_emlrt_marshallIn(SFc22_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c22_c_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static void c22_d_emlrt_marshallIn(SFc22_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c22_d_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static void c22_e_emlrt_marshallIn(SFc22_DIPCaltInstanceStruct *chartInstance,
...
static void c22_eml_scalar_eg(SFc22_DIPCaltInstanceStruct *chartInstance);
static void c22_eml_xgemm(SFc22_DIPCaltInstanceStruct *chartInstance, real_T
...
static const mxArray *c22_e_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static int32_T c22_f_emlrt_marshallIn(SFc22_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
static void c22_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c22_mxArrayInData, const char_T *c22_varName, void *c22_outData);
static uint8_T c22_g_emlrt_marshallIn(SFc22_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c22_b_is_active_c22_DIPCalt, const char_T *c22_identifier);
static uint8_T c22_h_emlrt_marshallIn(SFc22_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
static void c22_b_eml_xgemm(SFc22_DIPCaltInstanceStruct *chartInstance, real_T
  c22_A[9], real_T c22_B[3], real_T c22_C[3]);
static void init_dsm_address_info(SFc22_DIPCaltInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc22_DIPCaltInstanceStruct *chartInstance);
...
static void initialize_c22_DIPCalt(SFc22_DIPCaltInstanceStruct *chartInstance)
{
  ...
  chartInstance->c22_is_active_c22_DIPCalt = 0U;
}
  ...
  *chartInstance)
{
  real_T c22_d0;
  real_T c22_d1;
  sf_mex_import_named("j2", sf_mex_get_sfun_param(chartInstance->S, 0, 0),
                      &c22_d0, 0, 0, 0U, 0, 0U, 0);
  chartInstance->c22_j2 = c22_d0;
  sf_mex_import_named("m2", sf_mex_get_sfun_param(chartInstance->S, 1, 0),
                      &c22_d1, 0, 0, 0U, 0, 0U, 0);
  chartInstance->c22_m2 = c22_d1;
}
  ...
  *chartInstance)
{
  ...
  c22_hoistedGlobal = chartInstance->c22_is_active_c22_DIPCalt;
  ...
  const mxArray *c22_st)
{
  ...
  chartInstance->c22_is_active_c22_DIPCalt = c22_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c22_u, 1)),
     "is_active_c22_DIPCalt");
  sf_mex_destroy(&c22_u);
  c22_update_debugger_state_c22_DIPCalt(chartInstance);
...
static void sf_gateway_c22_DIPCalt(SFc22_DIPCaltInstanceStruct *chartInstance)
{
  ...
  c22_hoistedGlobal = chartInstance->c22_j2;
  c22_b_hoistedGlobal = chartInstance->c22_m2;
  for (c22_i3 = 0; c22_i3 < 6; c22_i3++) {
    c22_b_dx[c22_i3] = (*chartInstance->c22_dx)[c22_i3];
  }

  c22_b_j2 = c22_hoistedGlobal;
  c22_b_m2 = c22_b_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c22_b_j2, 3U, c22_b_sf_marshallOut,
    c22_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c22_b_m2, 4U, c22_b_sf_marshallOut,
    c22_b_sf_marshallIn);
  ...
  _SFD_DATA_RANGE_CHECK(chartInstance->c22_j2, 2U);
  _SFD_DATA_RANGE_CHECK(chartInstance->c22_m2, 3U);
}
  ...
  *c22_inData)
{
  ...
  real_T c22_u[6];
  const mxArray *c22_y = NULL;
  SFc22_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc22_DIPCaltInstanceStruct *)chartInstanceVoid;
...
static void c22_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c22_mxArrayInData, const char_T *c22_varName, void *c22_outData)
{
  const mxArray *c22_b_m2;
  const char_T *c22_identifier;
  emlrtMsgIdentifier c22_thisId;
  real_T c22_y;
  SFc22_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc22_DIPCaltInstanceStruct *)chartInstanceVoid;
  c22_b_m2 = sf_mex_dup(c22_mxArrayInData);
  c22_identifier = c22_varName;
  c22_thisId.fIdentifier = c22_identifier;
  c22_thisId.fParent = NULL;
  c22_y = c22_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c22_b_m2),
    &c22_thisId);
  sf_mex_destroy(&c22_b_m2);
...
const mxArray *sf_c22_DIPCalt_get_eml_resolved_functions_info(void)
{
...
static void c22_info_helper(const mxArray **c22_info)
{
  ...
  sf_mex_addfield(*c22_info, c22_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPC - constrained/skew_sm.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c22_info, c22_b_emlrt_marshallOut(1445505143U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  const mxArray *c22_b_is_active_c22_DIPCalt, const char_T *c22_identifier)
{
  ...
  c22_y = c22_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c22_b_is_active_c22_DIPCalt), &c22_thisId);
  sf_mex_destroy(&c22_b_is_active_c22_DIPCalt);
  return c22_y;
}
...
void sf_c22_DIPCalt_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3393252676U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(613944196U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(365811978U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(163510623U);
}

mxArray* sf_c22_DIPCalt_get_post_codegen_info(void);
mxArray *sf_c22_DIPCalt_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("MgyfHz9qLln6ivDqrVDZqF");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c22_DIPCalt_get_post_codegen_info();
...
mxArray *sf_c22_DIPCalt_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c22_DIPCalt_jit_fallback_info(void)
{
...
mxArray *sf_c22_DIPCalt_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c22_DIPCalt(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"hcoriolis\",},{M[8],M[0],T\"is_active_c22_DIPCalt\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c22_DIPCalt_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc22_DIPCaltInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(2,10,0,0,"j2");
          _SFD_SET_DATA_PROPS(3,10,0,0,"m2");
        ...
        _SFD_SET_DATA_VALUE_PTR(2U, &chartInstance->c22_j2);
        _SFD_SET_DATA_VALUE_PTR(3U, &chartInstance->c22_m2);
      }
    } else {
...
{
  return "n09ON2SFJv5aHbmvY8p8dC";
}

static void sf_opaque_initialize_c22_DIPCalt(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc22_DIPCaltInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c22_DIPCalt((SFc22_DIPCaltInstanceStruct*) chartInstanceVar);
  initialize_c22_DIPCalt((SFc22_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c22_DIPCalt(void *chartInstanceVar)
{
  enable_c22_DIPCalt((SFc22_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c22_DIPCalt(void *chartInstanceVar)
{
  disable_c22_DIPCalt((SFc22_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c22_DIPCalt(void *chartInstanceVar)
{
  sf_gateway_c22_DIPCalt((SFc22_DIPCaltInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c22_DIPCalt(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c22_DIPCalt((SFc22_DIPCaltInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c22_DIPCalt(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c22_DIPCalt((SFc22_DIPCaltInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c22_DIPCalt(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc22_DIPCaltInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c22_DIPCalt((SFc22_DIPCaltInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc22_DIPCalt((SFc22_DIPCaltInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c22_DIPCalt(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c22_DIPCalt((SFc22_DIPCaltInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c22_DIPCalt(SimStruct *S)
{
  /* Actual parameters from chart:
     j2 m2
   */
  const char_T *rtParamNames[] = { "j2", "m2" };
  ...
  ssSetChecksum0(S,(3450086523U));
  ssSetChecksum1(S,(2646087626U));
  ssSetChecksum2(S,(2012767296U));
  ssSetChecksum3(S,(3393290955U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c22_DIPCalt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c22_DIPCalt(SimStruct *S)
{
  SFc22_DIPCaltInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc22_DIPCaltInstanceStruct *)utMalloc(sizeof
    (SFc22_DIPCaltInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc22_DIPCaltInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c22_DIPCalt;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c22_DIPCalt;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c22_DIPCalt;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c22_DIPCalt;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c22_DIPCalt;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c22_DIPCalt;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c22_DIPCalt;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c22_DIPCalt;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c22_DIPCalt;
  chartInstance->chartInfo.mdlStart = mdlStart_c22_DIPCalt;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c22_DIPCalt;
...
void c22_DIPCalt_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c22_DIPCalt(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c22_DIPCalt(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c22_DIPCalt(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c22_DIPCalt_method_dispatcher.\n"
