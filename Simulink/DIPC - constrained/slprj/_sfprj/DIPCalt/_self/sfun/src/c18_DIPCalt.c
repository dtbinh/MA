...
static void initialize_c18_DIPCalt(SFc18_DIPCaltInstanceStruct *chartInstance);
static void initialize_params_c18_DIPCalt(SFc18_DIPCaltInstanceStruct
  *chartInstance);
static void enable_c18_DIPCalt(SFc18_DIPCaltInstanceStruct *chartInstance);
static void disable_c18_DIPCalt(SFc18_DIPCaltInstanceStruct *chartInstance);
static void c18_update_debugger_state_c18_DIPCalt(SFc18_DIPCaltInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c18_DIPCalt(SFc18_DIPCaltInstanceStruct
  *chartInstance);
static void set_sim_state_c18_DIPCalt(SFc18_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c18_st);
static void finalize_c18_DIPCalt(SFc18_DIPCaltInstanceStruct *chartInstance);
static void sf_gateway_c18_DIPCalt(SFc18_DIPCaltInstanceStruct *chartInstance);
static void mdl_start_c18_DIPCalt(SFc18_DIPCaltInstanceStruct *chartInstance);
static void c18_chartstep_c18_DIPCalt(SFc18_DIPCaltInstanceStruct *chartInstance);
static void initSimStructsc18_DIPCalt(SFc18_DIPCaltInstanceStruct *chartInstance);
static void c18_skew_sm(SFc18_DIPCaltInstanceStruct *chartInstance, real_T
  c18_x[3], real_T c18_X[9]);
static void c18_quatrot(SFc18_DIPCaltInstanceStruct *chartInstance, real_T
  c18_q[4], real_T c18_r[3], real_T c18_rw[3]);
...
static const mxArray *c18_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static void c18_emlrt_marshallIn(SFc18_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c18_b_b, const char_T *c18_identifier, real_T c18_y[24]);
static void c18_b_emlrt_marshallIn(SFc18_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c18_b_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static void c18_c_emlrt_marshallIn(SFc18_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c18_e_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static real_T c18_d_emlrt_marshallIn(SFc18_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c18_f_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static void c18_e_emlrt_marshallIn(SFc18_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c18_g_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static void c18_f_emlrt_marshallIn(SFc18_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c18_h_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static void c18_g_emlrt_marshallIn(SFc18_DIPCaltInstanceStruct *chartInstance,
...
static void c18_eml_scalar_eg(SFc18_DIPCaltInstanceStruct *chartInstance);
static void c18_threshold(SFc18_DIPCaltInstanceStruct *chartInstance);
static void c18_quatmultiply(SFc18_DIPCaltInstanceStruct *chartInstance, real_T
  c18_q[4], real_T c18_r[4], real_T c18_qout[4]);
static void c18_b_eml_scalar_eg(SFc18_DIPCaltInstanceStruct *chartInstance);
static const mxArray *c18_i_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static int32_T c18_h_emlrt_marshallIn(SFc18_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void c18_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c18_mxArrayInData, const char_T *c18_varName, void *c18_outData);
static uint8_T c18_i_emlrt_marshallIn(SFc18_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c18_b_is_active_c18_DIPCalt, const char_T *c18_identifier);
static uint8_T c18_j_emlrt_marshallIn(SFc18_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void init_dsm_address_info(SFc18_DIPCaltInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc18_DIPCaltInstanceStruct *chartInstance);
...
static void initialize_c18_DIPCalt(SFc18_DIPCaltInstanceStruct *chartInstance)
{
  ...
  chartInstance->c18_is_active_c18_DIPCalt = 0U;
}
  ...
  *chartInstance)
{
  ...
  c18_hoistedGlobal = chartInstance->c18_is_active_c18_DIPCalt;
  ...
  const mxArray *c18_st)
{
  ...
  chartInstance->c18_is_active_c18_DIPCalt = c18_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c18_u, 1)),
     "is_active_c18_DIPCalt");
  sf_mex_destroy(&c18_u);
  c18_update_debugger_state_c18_DIPCalt(chartInstance);
...
static void sf_gateway_c18_DIPCalt(SFc18_DIPCaltInstanceStruct *chartInstance)
{
  ...
  chartInstance->c18_sfEvent = CALL_EVENT;
  c18_chartstep_c18_DIPCalt(chartInstance);
  ...
  *c18_inData)
{
  ...
  real_T c18_u[24];
  const mxArray *c18_y = NULL;
  SFc18_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc18_DIPCaltInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c18_DIPCalt_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c18_b_is_active_c18_DIPCalt, const char_T *c18_identifier)
{
  ...
  c18_y = c18_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c18_b_is_active_c18_DIPCalt), &c18_thisId);
  sf_mex_destroy(&c18_b_is_active_c18_DIPCalt);
  return c18_y;
}
...
void sf_c18_DIPCalt_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c18_DIPCalt_get_post_codegen_info(void);
mxArray *sf_c18_DIPCalt_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c18_DIPCalt_get_post_codegen_info();
...
mxArray *sf_c18_DIPCalt_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c18_DIPCalt_jit_fallback_info(void)
{
...
mxArray *sf_c18_DIPCalt_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c18_DIPCalt(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"b\",},{M[8],M[0],T\"is_active_c18_DIPCalt\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c18_DIPCalt_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc18_DIPCaltInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c18_DIPCalt(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc18_DIPCaltInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c18_DIPCalt((SFc18_DIPCaltInstanceStruct*) chartInstanceVar);
  initialize_c18_DIPCalt((SFc18_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c18_DIPCalt(void *chartInstanceVar)
{
  enable_c18_DIPCalt((SFc18_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c18_DIPCalt(void *chartInstanceVar)
{
  disable_c18_DIPCalt((SFc18_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c18_DIPCalt(void *chartInstanceVar)
{
  sf_gateway_c18_DIPCalt((SFc18_DIPCaltInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c18_DIPCalt(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c18_DIPCalt((SFc18_DIPCaltInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c18_DIPCalt(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c18_DIPCalt((SFc18_DIPCaltInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c18_DIPCalt(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc18_DIPCaltInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c18_DIPCalt((SFc18_DIPCaltInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc18_DIPCalt((SFc18_DIPCaltInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c18_DIPCalt(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c18_DIPCalt((SFc18_DIPCaltInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c18_DIPCalt(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3139922456U));
  ssSetChecksum1(S,(1120664606U));
  ssSetChecksum2(S,(784988427U));
  ssSetChecksum3(S,(2297549461U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c18_DIPCalt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c18_DIPCalt(SimStruct *S)
{
  SFc18_DIPCaltInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc18_DIPCaltInstanceStruct *)utMalloc(sizeof
    (SFc18_DIPCaltInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc18_DIPCaltInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c18_DIPCalt;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c18_DIPCalt;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c18_DIPCalt;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c18_DIPCalt;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c18_DIPCalt;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c18_DIPCalt;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c18_DIPCalt;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c18_DIPCalt;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c18_DIPCalt;
  chartInstance->chartInfo.mdlStart = mdlStart_c18_DIPCalt;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c18_DIPCalt;
...
void c18_DIPCalt_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c18_DIPCalt(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c18_DIPCalt(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c18_DIPCalt(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c18_DIPCalt_method_dispatcher.\n"
