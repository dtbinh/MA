...
static void initialize_c3_DIPCalt(SFc3_DIPCaltInstanceStruct *chartInstance);
static void initialize_params_c3_DIPCalt(SFc3_DIPCaltInstanceStruct
  *chartInstance);
static void enable_c3_DIPCalt(SFc3_DIPCaltInstanceStruct *chartInstance);
static void disable_c3_DIPCalt(SFc3_DIPCaltInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_DIPCalt(SFc3_DIPCaltInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_DIPCalt(SFc3_DIPCaltInstanceStruct
  *chartInstance);
static void set_sim_state_c3_DIPCalt(SFc3_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c3_st);
static void finalize_c3_DIPCalt(SFc3_DIPCaltInstanceStruct *chartInstance);
static void sf_gateway_c3_DIPCalt(SFc3_DIPCaltInstanceStruct *chartInstance);
static void mdl_start_c3_DIPCalt(SFc3_DIPCaltInstanceStruct *chartInstance);
static void initSimStructsc3_DIPCalt(SFc3_DIPCaltInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_DIPCaltInstanceStruct *chartInstance, const
  mxArray *c3_b_qb3, const char_T *c3_identifier, real_T c3_y[4]);
static void c3_b_emlrt_marshallIn(SFc3_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[4]);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_c_emlrt_marshallIn(SFc3_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c3_b_pb3, const char_T *c3_identifier, real_T c3_y[3]);
static void c3_d_emlrt_marshallIn(SFc3_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[3]);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_e_emlrt_marshallIn(SFc3_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[12]);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_f_emlrt_marshallIn(SFc3_DIPCaltInstanceStruct *chartInstance,
...
static void c3_quatmultiply(SFc3_DIPCaltInstanceStruct *chartInstance, real_T
  c3_q[4], real_T c3_r[4], real_T c3_qout[4]);
static const mxArray *c3_e_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_g_emlrt_marshallIn(SFc3_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_h_emlrt_marshallIn(SFc3_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c3_b_is_active_c3_DIPCalt, const char_T *c3_identifier);
static uint8_T c3_i_emlrt_marshallIn(SFc3_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_DIPCaltInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc3_DIPCaltInstanceStruct *chartInstance);
...
static void initialize_c3_DIPCalt(SFc3_DIPCaltInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_DIPCalt = 0U;
}
  ...
  *chartInstance)
{
  ...
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_DIPCalt;
  ...
  const mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_DIPCalt = c3_h_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 2)), "is_active_c3_DIPCalt");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_DIPCalt(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  real_T c3_u[4];
  const mxArray *c3_y = NULL;
  SFc3_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc3_DIPCaltInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_DIPCalt_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c3_b_is_active_c3_DIPCalt, const char_T *c3_identifier)
{
  ...
  c3_y = c3_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_DIPCalt), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_DIPCalt);
  return c3_y;
}
...
void sf_c3_DIPCalt_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c3_DIPCalt_get_post_codegen_info(void);
mxArray *sf_c3_DIPCalt_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c3_DIPCalt_get_post_codegen_info();
...
mxArray *sf_c3_DIPCalt_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_DIPCalt_jit_fallback_info(void)
{
...
mxArray *sf_c3_DIPCalt_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_DIPCalt(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"pb3\",},{M[1],M[8],T\"qb3\",},{M[8],M[0],T\"is_active_c3_DIPCalt\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_DIPCalt_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_DIPCaltInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c3_DIPCalt(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_DIPCaltInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c3_DIPCalt((SFc3_DIPCaltInstanceStruct*) chartInstanceVar);
  initialize_c3_DIPCalt((SFc3_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_DIPCalt(void *chartInstanceVar)
{
  enable_c3_DIPCalt((SFc3_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_DIPCalt(void *chartInstanceVar)
{
  disable_c3_DIPCalt((SFc3_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_DIPCalt(void *chartInstanceVar)
{
  sf_gateway_c3_DIPCalt((SFc3_DIPCaltInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c3_DIPCalt(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c3_DIPCalt((SFc3_DIPCaltInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_DIPCalt(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c3_DIPCalt((SFc3_DIPCaltInstanceStruct*)chartInfo->chartInstance,
    st);
}

static void sf_opaque_terminate_c3_DIPCalt(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_DIPCaltInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_DIPCalt((SFc3_DIPCaltInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_DIPCalt((SFc3_DIPCaltInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_DIPCalt(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c3_DIPCalt((SFc3_DIPCaltInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_DIPCalt(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3178637804U));
  ssSetChecksum1(S,(2433624990U));
  ssSetChecksum2(S,(1941177200U));
  ssSetChecksum3(S,(1263251176U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_DIPCalt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_DIPCalt(SimStruct *S)
{
  SFc3_DIPCaltInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_DIPCaltInstanceStruct *)utMalloc(sizeof
    (SFc3_DIPCaltInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_DIPCaltInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_DIPCalt;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_DIPCalt;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_DIPCalt;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_DIPCalt;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_DIPCalt;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_DIPCalt;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_DIPCalt;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_DIPCalt;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_DIPCalt;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_DIPCalt;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_DIPCalt;
...
void c3_DIPCalt_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_DIPCalt(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_DIPCalt(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_DIPCalt(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_DIPCalt_method_dispatcher.\n"
