...
static const char * c25_debug_family_names[6] = { "nargin", "nargout", "dx",
  "j4", "m4", "hcoriolis" };

static const char * c25_b_debug_family_names[4] = { "nargin", "nargout", "x",
  "X" };

/* Function Declarations */
static void initialize_c25_DIPCalt(SFc25_DIPCaltInstanceStruct *chartInstance);
static void initialize_params_c25_DIPCalt(SFc25_DIPCaltInstanceStruct
  *chartInstance);
static void enable_c25_DIPCalt(SFc25_DIPCaltInstanceStruct *chartInstance);
static void disable_c25_DIPCalt(SFc25_DIPCaltInstanceStruct *chartInstance);
static void c25_update_debugger_state_c25_DIPCalt(SFc25_DIPCaltInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c25_DIPCalt(SFc25_DIPCaltInstanceStruct
  *chartInstance);
static void set_sim_state_c25_DIPCalt(SFc25_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c25_st);
static void finalize_c25_DIPCalt(SFc25_DIPCaltInstanceStruct *chartInstance);
static void sf_gateway_c25_DIPCalt(SFc25_DIPCaltInstanceStruct *chartInstance);
static void mdl_start_c25_DIPCalt(SFc25_DIPCaltInstanceStruct *chartInstance);
static void initSimStructsc25_DIPCalt(SFc25_DIPCaltInstanceStruct *chartInstance);
...
static const mxArray *c25_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static void c25_emlrt_marshallIn(SFc25_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c25_b_hcoriolis, const char_T *c25_identifier, real_T c25_y[6]);
static void c25_b_emlrt_marshallIn(SFc25_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c25_b_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static real_T c25_c_emlrt_marshallIn(SFc25_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c25_c_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static void c25_d_emlrt_marshallIn(SFc25_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c25_d_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static void c25_e_emlrt_marshallIn(SFc25_DIPCaltInstanceStruct *chartInstance,
...
static void c25_eml_scalar_eg(SFc25_DIPCaltInstanceStruct *chartInstance);
static void c25_eml_xgemm(SFc25_DIPCaltInstanceStruct *chartInstance, real_T
  c25_A[9], real_T c25_B[3], real_T c25_C[3], real_T c25_b_C[3]);
static const mxArray *c25_e_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static int32_T c25_f_emlrt_marshallIn(SFc25_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId);
static void c25_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c25_mxArrayInData, const char_T *c25_varName, void *c25_outData);
static uint8_T c25_g_emlrt_marshallIn(SFc25_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c25_b_is_active_c25_DIPCalt, const char_T *c25_identifier);
static uint8_T c25_h_emlrt_marshallIn(SFc25_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId);
static void c25_b_eml_xgemm(SFc25_DIPCaltInstanceStruct *chartInstance, real_T
  c25_A[9], real_T c25_B[3], real_T c25_C[3]);
static void init_dsm_address_info(SFc25_DIPCaltInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc25_DIPCaltInstanceStruct *chartInstance);
...
static void initialize_c25_DIPCalt(SFc25_DIPCaltInstanceStruct *chartInstance)
{
  ...
  chartInstance->c25_is_active_c25_DIPCalt = 0U;
}
  ...
  *chartInstance)
{
  real_T c25_d0;
  real_T c25_d1;
  sf_mex_import_named("j4", sf_mex_get_sfun_param(chartInstance->S, 0, 0),
                      &c25_d0, 0, 0, 0U, 0, 0U, 0);
  chartInstance->c25_j4 = c25_d0;
  sf_mex_import_named("m4", sf_mex_get_sfun_param(chartInstance->S, 1, 0),
                      &c25_d1, 0, 0, 0U, 0, 0U, 0);
  chartInstance->c25_m4 = c25_d1;
}
  ...
  *chartInstance)
{
  ...
  for (c25_i0 = 0; c25_i0 < 6; c25_i0++) {
    c25_u[c25_i0] = (*chartInstance->c25_hcoriolis)[c25_i0];
  }

  c25_b_y = NULL;
  sf_mex_assign(&c25_b_y, sf_mex_create("y", c25_u, 0, 0U, 1U, 0U, 1, 6), false);
  sf_mex_setcell(c25_y, 0, c25_b_y);
  c25_hoistedGlobal = chartInstance->c25_is_active_c25_DIPCalt;
  ...
  const mxArray *c25_st)
{
  ...
  for (c25_i1 = 0; c25_i1 < 6; c25_i1++) {
    (*chartInstance->c25_hcoriolis)[c25_i1] = c25_dv0[c25_i1];
  }

  chartInstance->c25_is_active_c25_DIPCalt = c25_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c25_u, 1)),
     "is_active_c25_DIPCalt");
  sf_mex_destroy(&c25_u);
  c25_update_debugger_state_c25_DIPCalt(chartInstance);
...
static void sf_gateway_c25_DIPCalt(SFc25_DIPCaltInstanceStruct *chartInstance)
{
  ...
  for (c25_i2 = 0; c25_i2 < 6; c25_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c25_dx)[c25_i2], 0U);
  }

  chartInstance->c25_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 19U, chartInstance->c25_sfEvent);
  c25_hoistedGlobal = chartInstance->c25_j4;
  c25_b_hoistedGlobal = chartInstance->c25_m4;
  for (c25_i3 = 0; c25_i3 < 6; c25_i3++) {
    c25_b_dx[c25_i3] = (*chartInstance->c25_dx)[c25_i3];
  }

  c25_b_j4 = c25_hoistedGlobal;
  c25_b_m4 = c25_b_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c25_nargout, 1U, c25_b_sf_marshallOut,
    c25_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c25_b_dx, 2U, c25_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c25_b_j4, 3U, c25_b_sf_marshallOut,
    c25_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c25_b_m4, 4U, c25_b_sf_marshallOut,
    c25_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c25_b_hcoriolis, 5U, c25_sf_marshallOut,
    c25_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c25_sfEvent, 2);
  for (c25_i4 = 0; c25_i4 < 3; c25_i4++) {
    c25_x[c25_i4] = c25_b_dx[c25_i4 + 3];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 4U, 4U, c25_b_debug_family_names,
    c25_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c25_b_nargin, 0U, c25_b_sf_marshallOut,
    c25_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c25_b_nargout, 1U, c25_b_sf_marshallOut,
    c25_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c25_x, 2U, c25_d_sf_marshallOut,
    c25_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c25_X, 3U, c25_c_sf_marshallOut,
    c25_c_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  _SFD_SCRIPT_CALL(0U, chartInstance->c25_sfEvent, 3);
  c25_X[0] = 0.0;
  c25_X[3] = -c25_x[2];
  c25_X[6] = c25_x[1];
  c25_X[1] = c25_x[2];
  ...
  for (c25_i7 = 0; c25_i7 < 3; c25_i7++) {
    c25_b_b[c25_i7] = c25_b_dx[c25_i7];
  }
  ...
  for (c25_i9 = 0; c25_i9 < 9; c25_i9++) {
    c25_c_b[c25_i9] = c25_b[c25_i9];
  }

  for (c25_i10 = 0; c25_i10 < 3; c25_i10++) {
    c25_d_b[c25_i10] = c25_b_b[c25_i10];
  }

  c25_b_eml_xgemm(chartInstance, c25_c_b, c25_d_b, c25_y);
  for (c25_i11 = 0; c25_i11 < 3; c25_i11++) {
    c25_b_x[c25_i11] = c25_b_dx[c25_i11 + 3];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 4U, 4U, c25_b_debug_family_names,
    c25_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c25_c_nargin, 0U, c25_b_sf_marshallOut,
    c25_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c25_c_nargout, 1U, c25_b_sf_marshallOut,
    c25_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c25_b_x, 2U, c25_d_sf_marshallOut,
    c25_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c25_b_X, 3U, c25_c_sf_marshallOut,
    c25_c_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  _SFD_SCRIPT_CALL(0U, chartInstance->c25_sfEvent, 3);
  c25_b_X[0] = 0.0;
  ...
  for (c25_i12 = 0; c25_i12 < 9; c25_i12++) {
    c25_b[c25_i12] = c25_b_X[c25_i12];
  }

  for (c25_i13 = 0; c25_i13 < 9; c25_i13++) {
    c25_b[c25_i13] *= c25_b_a;
  }

  for (c25_i14 = 0; c25_i14 < 3; c25_i14++) {
    c25_b_b[c25_i14] = c25_b_dx[c25_i14 + 3];
  }
  ...
  for (c25_i16 = 0; c25_i16 < 9; c25_i16++) {
    c25_e_b[c25_i16] = c25_b[c25_i16];
  }

  for (c25_i17 = 0; c25_i17 < 3; c25_i17++) {
    c25_f_b[c25_i17] = c25_b_b[c25_i17];
  }

  c25_b_eml_xgemm(chartInstance, c25_e_b, c25_f_b, c25_b_y);
  for (c25_i18 = 0; c25_i18 < 3; c25_i18++) {
    c25_b_hcoriolis[c25_i18] = c25_y[c25_i18];
  }

  for (c25_i19 = 0; c25_i19 < 3; c25_i19++) {
    c25_b_hcoriolis[c25_i19 + 3] = c25_b_y[c25_i19];
  }

  _SFD_EML_CALL(0U, chartInstance->c25_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c25_i20 = 0; c25_i20 < 6; c25_i20++) {
    (*chartInstance->c25_hcoriolis)[c25_i20] = c25_b_hcoriolis[c25_i20];
  }
  ...
  for (c25_i21 = 0; c25_i21 < 6; c25_i21++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c25_hcoriolis)[c25_i21], 1U);
  }

  _SFD_DATA_RANGE_CHECK(chartInstance->c25_j4, 2U);
  _SFD_DATA_RANGE_CHECK(chartInstance->c25_m4, 3U);
}
  ...
  *c25_inData)
{
  ...
  real_T c25_u[6];
  const mxArray *c25_y = NULL;
  SFc25_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc25_DIPCaltInstanceStruct *)chartInstanceVoid;
  c25_mxArrayOutData = NULL;
  for (c25_i22 = 0; c25_i22 < 6; c25_i22++) {
    c25_b_inData[c25_i22] = (*(real_T (*)[6])c25_inData)[c25_i22];
  }

  for (c25_i23 = 0; c25_i23 < 6; c25_i23++) {
    c25_u[c25_i23] = c25_b_inData[c25_i23];
  }
  ...
  const mxArray *c25_b_hcoriolis, const char_T *c25_identifier, real_T c25_y[6])
{
  ...
  c25_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c25_b_hcoriolis), &c25_thisId,
    c25_y);
  sf_mex_destroy(&c25_b_hcoriolis);
}
  ...
  *c25_mxArrayInData, const char_T *c25_varName, void *c25_outData)
{
  ...
  SFc25_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc25_DIPCaltInstanceStruct *)chartInstanceVoid;
  c25_b_hcoriolis = sf_mex_dup(c25_mxArrayInData);
  ...
  for (c25_i25 = 0; c25_i25 < 6; c25_i25++) {
    (*(real_T (*)[6])c25_outData)[c25_i25] = c25_y[c25_i25];
  }
...
static void c25_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c25_mxArrayInData, const char_T *c25_varName, void *c25_outData)
{
  const mxArray *c25_b_m4;
  const char_T *c25_identifier;
  emlrtMsgIdentifier c25_thisId;
  real_T c25_y;
  SFc25_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc25_DIPCaltInstanceStruct *)chartInstanceVoid;
  c25_b_m4 = sf_mex_dup(c25_mxArrayInData);
  c25_identifier = c25_varName;
  c25_thisId.fIdentifier = c25_identifier;
  c25_thisId.fParent = NULL;
  c25_y = c25_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c25_b_m4),
    &c25_thisId);
  sf_mex_destroy(&c25_b_m4);
  ...
  *c25_inData)
{
  ...
  for (c25_i27 = 0; c25_i27 < 3; c25_i27++) {
    for (c25_i28 = 0; c25_i28 < 3; c25_i28++) {
      c25_b_inData[c25_i28 + c25_i26] = (*(real_T (*)[9])c25_inData)[c25_i28 +
        c25_i26];
    }
  ...
  for (c25_i30 = 0; c25_i30 < 3; c25_i30++) {
    for (c25_i31 = 0; c25_i31 < 3; c25_i31++) {
      c25_u[c25_i31 + c25_i29] = c25_b_inData[c25_i31 + c25_i29];
    }
  ...
  const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId, real_T c25_y[9])
{
  ...
  sf_mex_import(c25_parentId, sf_mex_dup(c25_u), c25_dv2, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c25_i32 = 0; c25_i32 < 9; c25_i32++) {
    c25_y[c25_i32] = c25_dv2[c25_i32];
  }
  ...
  *c25_mxArrayInData, const char_T *c25_varName, void *c25_outData)
{
  ...
  c25_thisId.fIdentifier = c25_identifier;
  c25_thisId.fParent = NULL;
  c25_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c25_X), &c25_thisId, c25_y);
  sf_mex_destroy(&c25_X);
  c25_i33 = 0;
  for (c25_i34 = 0; c25_i34 < 3; c25_i34++) {
    for (c25_i35 = 0; c25_i35 < 3; c25_i35++) {
      (*(real_T (*)[9])c25_outData)[c25_i35 + c25_i33] = c25_y[c25_i35 + c25_i33];
    }
  ...
  *c25_inData)
{
  ...
  for (c25_i36 = 0; c25_i36 < 3; c25_i36++) {
    c25_b_inData[c25_i36] = (*(real_T (*)[3])c25_inData)[c25_i36];
  }

  for (c25_i37 = 0; c25_i37 < 3; c25_i37++) {
    c25_u[c25_i37] = c25_b_inData[c25_i37];
  }
  ...
  *c25_mxArrayInData, const char_T *c25_varName, void *c25_outData)
{
  ...
  c25_thisId.fIdentifier = c25_identifier;
  c25_thisId.fParent = NULL;
  c25_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c25_x), &c25_thisId, c25_y);
  sf_mex_destroy(&c25_x);
  for (c25_i39 = 0; c25_i39 < 3; c25_i39++) {
    (*(real_T (*)[3])c25_outData)[c25_i39] = c25_y[c25_i39];
  }

  sf_mex_destroy(&c25_mxArrayInData);
}

const mxArray *sf_c25_DIPCalt_get_eml_resolved_functions_info(void)
{
  const mxArray *c25_nameCaptureInfo = NULL;
  c25_nameCaptureInfo = NULL;
  sf_mex_assign(&c25_nameCaptureInfo, sf_mex_createstruct("structure", 2, 14, 1),
                false);
...
static void c25_info_helper(const mxArray **c25_info)
{
  ...
  sf_mex_addfield(*c25_info, c25_emlrt_marshallOut("skew_sm"), "name", "name", 0);
  ...
  sf_mex_addfield(*c25_info, sf_mex_duplicatearraysafe(&c25_lhs0), "lhs", "lhs",
                  0);
  sf_mex_addfield(*c25_info, c25_emlrt_marshallOut(""), "context", "context", 1);
  ...
  sf_mex_addfield(*c25_info, c25_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/eml_mtimes_helper.m"),
                  "resolved", "resolved", 1);
  sf_mex_addfield(*c25_info, c25_b_emlrt_marshallOut(1383902494U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c25_info, c25_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c25_info, c25_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c25_info, c25_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgemm.m"),
                  "resolved", "resolved", 6);
  sf_mex_addfield(*c25_info, c25_b_emlrt_marshallOut(1376005890U), "fileTimeLo",
                  "fileTimeLo", 6);
  sf_mex_addfield(*c25_info, c25_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 6);
  sf_mex_addfield(*c25_info, c25_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c25_info, c25_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/inline.p"),
                  "resolved", "resolved", 7);
  sf_mex_addfield(*c25_info, c25_b_emlrt_marshallOut(1410832972U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c25_info, c25_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c25_info, c25_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  c25_A[9], real_T c25_B[3], real_T c25_C[3], real_T c25_b_C[3])
{
  ...
  for (c25_i40 = 0; c25_i40 < 3; c25_i40++) {
    c25_b_C[c25_i40] = c25_C[c25_i40];
  }

  for (c25_i41 = 0; c25_i41 < 9; c25_i41++) {
    c25_b_A[c25_i41] = c25_A[c25_i41];
  }

  for (c25_i42 = 0; c25_i42 < 3; c25_i42++) {
    c25_b_B[c25_i42] = c25_B[c25_i42];
  }

  c25_b_eml_xgemm(chartInstance, c25_b_A, c25_b_B, c25_b_C);
}
  ...
  const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId)
{
  ...
  int32_T c25_i43;
  (void)chartInstance;
  sf_mex_import(c25_parentId, sf_mex_dup(c25_u), &c25_i43, 1, 6, 0U, 0, 0U, 0);
  c25_y = c25_i43;
  sf_mex_destroy(&c25_u);
  return c25_y;
}
  ...
  *c25_mxArrayInData, const char_T *c25_varName, void *c25_outData)
{
  ...
  c25_thisId.fIdentifier = c25_identifier;
  c25_thisId.fParent = NULL;
  c25_y = c25_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c25_b_sfEvent),
    &c25_thisId);
  ...
  const mxArray *c25_b_is_active_c25_DIPCalt, const char_T *c25_identifier)
{
  ...
  c25_thisId.fIdentifier = c25_identifier;
  c25_thisId.fParent = NULL;
  c25_y = c25_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c25_b_is_active_c25_DIPCalt), &c25_thisId);
  sf_mex_destroy(&c25_b_is_active_c25_DIPCalt);
  return c25_y;
}
  ...
  c25_A[9], real_T c25_B[3], real_T c25_C[3])
{
  ...
  for (c25_i44 = 0; c25_i44 < 3; c25_i44++) {
    ...
    for (c25_i46 = 0; c25_i46 < 3; c25_i46++) {
      c25_C[c25_i44] += c25_A[c25_i45 + c25_i44] * c25_B[c25_i46];
      c25_i45 += 3;
    }
  }
}
...
static void init_simulink_io_address(SFc25_DIPCaltInstanceStruct *chartInstance)
{
  chartInstance->c25_dx = (real_T (*)[6])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c25_hcoriolis = (real_T (*)[6])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
void sf_c25_DIPCalt_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1793199800U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2506756496U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(360052180U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3601667918U);
}

mxArray* sf_c25_DIPCalt_get_post_codegen_info(void);
mxArray *sf_c25_DIPCalt_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("IhofbgoNMacUXnKFhmhOvF");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c25_DIPCalt_get_post_codegen_info();
...
mxArray *sf_c25_DIPCalt_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c25_DIPCalt_jit_fallback_info(void)
{
...
mxArray *sf_c25_DIPCalt_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c25_DIPCalt(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"hcoriolis\",},{M[8],M[0],T\"is_active_c25_DIPCalt\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c25_DIPCalt_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc25_DIPCaltInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(2,10,0,0,"j4");
          _SFD_SET_DATA_PROPS(3,10,0,0,"m4");
        ...
        _SFD_SET_DATA_COMPILED_PROPS(3,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c25_b_sf_marshallOut,(MexInFcnForType)
          c25_b_sf_marshallIn);
        _SFD_SET_DATA_VALUE_PTR(0U, *chartInstance->c25_dx);
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c25_hcoriolis);
        _SFD_SET_DATA_VALUE_PTR(2U, &chartInstance->c25_j4);
        _SFD_SET_DATA_VALUE_PTR(3U, &chartInstance->c25_m4);
      }
    } else {
...
{
  return "tF5Re9ZTh0jvjxkC0rQsqG";
}

static void sf_opaque_initialize_c25_DIPCalt(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc25_DIPCaltInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c25_DIPCalt((SFc25_DIPCaltInstanceStruct*) chartInstanceVar);
  initialize_c25_DIPCalt((SFc25_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c25_DIPCalt(void *chartInstanceVar)
{
  enable_c25_DIPCalt((SFc25_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c25_DIPCalt(void *chartInstanceVar)
{
  disable_c25_DIPCalt((SFc25_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c25_DIPCalt(void *chartInstanceVar)
{
  sf_gateway_c25_DIPCalt((SFc25_DIPCaltInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c25_DIPCalt(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c25_DIPCalt((SFc25_DIPCaltInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c25_DIPCalt(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c25_DIPCalt((SFc25_DIPCaltInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c25_DIPCalt(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc25_DIPCaltInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c25_DIPCalt((SFc25_DIPCaltInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc25_DIPCalt((SFc25_DIPCaltInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c25_DIPCalt(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c25_DIPCalt((SFc25_DIPCaltInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c25_DIPCalt(SimStruct *S)
{
  /* Actual parameters from chart:
     j4 m4
   */
  const char_T *rtParamNames[] = { "j4", "m4" };
  ...
  ssSetChecksum0(S,(1512698699U));
  ssSetChecksum1(S,(1459824442U));
  ssSetChecksum2(S,(1508257684U));
  ssSetChecksum3(S,(4256600172U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c25_DIPCalt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c25_DIPCalt(SimStruct *S)
{
  SFc25_DIPCaltInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc25_DIPCaltInstanceStruct *)utMalloc(sizeof
    (SFc25_DIPCaltInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc25_DIPCaltInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c25_DIPCalt;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c25_DIPCalt;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c25_DIPCalt;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c25_DIPCalt;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c25_DIPCalt;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c25_DIPCalt;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c25_DIPCalt;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c25_DIPCalt;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c25_DIPCalt;
  chartInstance->chartInfo.mdlStart = mdlStart_c25_DIPCalt;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c25_DIPCalt;
...
void c25_DIPCalt_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c25_DIPCalt(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c25_DIPCalt(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c25_DIPCalt(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c25_DIPCalt_method_dispatcher.\n"
