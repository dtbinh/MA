...
static void c1_d_emlrt_marshallIn(SFc1_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_f_emlrt_marshallIn(SFc1_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_g_emlrt_marshallIn(SFc1_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_h_emlrt_marshallIn(SFc1_DIPCaltInstanceStruct *chartInstance,
  ...
  const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_DIPCalt = c1_h_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 2)), "is_active_c1_DIPCalt");
  sf_mex_destroy(&c1_u);
...
static const mxArray *sf_get_sim_state_info_c1_DIPCalt(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"pb1\",},{M[1],M[8],T\"qb1\",},{M[8],M[0],T\"is_active_c1_DIPCalt\",}}"
  };
...
static void mdlSetWorkWidths_c1_DIPCalt(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3775649885U));
  ssSetChecksum1(S,(829890501U));
  ssSetChecksum2(S,(3990358473U));
  ssSetChecksum3(S,(3767755097U));
