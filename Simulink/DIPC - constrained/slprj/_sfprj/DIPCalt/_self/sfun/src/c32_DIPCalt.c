...
static const char * c32_debug_family_names[6] = { "nargin", "nargout", "dx",
  "rv", "x", "b" };

static const char * c32_b_debug_family_names[4] = { "nargin", "nargout", "x",
  "X" };

static const char * c32_c_debug_family_names[6] = { "rwq", "nargin", "nargout",
  "q", "r", "rw" };

/* Function Declarations */
static void initialize_c32_DIPCalt(SFc32_DIPCaltInstanceStruct *chartInstance);
static void initialize_params_c32_DIPCalt(SFc32_DIPCaltInstanceStruct
  *chartInstance);
static void enable_c32_DIPCalt(SFc32_DIPCaltInstanceStruct *chartInstance);
static void disable_c32_DIPCalt(SFc32_DIPCaltInstanceStruct *chartInstance);
static void c32_update_debugger_state_c32_DIPCalt(SFc32_DIPCaltInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c32_DIPCalt(SFc32_DIPCaltInstanceStruct
  *chartInstance);
static void set_sim_state_c32_DIPCalt(SFc32_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c32_st);
static void finalize_c32_DIPCalt(SFc32_DIPCaltInstanceStruct *chartInstance);
static void sf_gateway_c32_DIPCalt(SFc32_DIPCaltInstanceStruct *chartInstance);
static void mdl_start_c32_DIPCalt(SFc32_DIPCaltInstanceStruct *chartInstance);
static void c32_chartstep_c32_DIPCalt(SFc32_DIPCaltInstanceStruct *chartInstance);
static void initSimStructsc32_DIPCalt(SFc32_DIPCaltInstanceStruct *chartInstance);
static void c32_skew_sm(SFc32_DIPCaltInstanceStruct *chartInstance, real_T
  c32_b_x[3], real_T c32_X[9]);
static void c32_quatrot(SFc32_DIPCaltInstanceStruct *chartInstance, real_T
  c32_q[4], real_T c32_r[3], real_T c32_rw[3]);
...
static const mxArray *c32_sf_marshallOut(void *chartInstanceVoid, void
  *c32_inData);
static void c32_emlrt_marshallIn(SFc32_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c32_b_b, const char_T *c32_identifier, real_T c32_y[24]);
static void c32_b_emlrt_marshallIn(SFc32_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId, real_T c32_y[24]);
...
static const mxArray *c32_c_sf_marshallOut(void *chartInstanceVoid, void
  *c32_inData);
static void c32_c_emlrt_marshallIn(SFc32_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId, real_T c32_y[12]);
...
static const mxArray *c32_e_sf_marshallOut(void *chartInstanceVoid, void
  *c32_inData);
static real_T c32_d_emlrt_marshallIn(SFc32_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c32_f_sf_marshallOut(void *chartInstanceVoid, void
  *c32_inData);
static void c32_e_emlrt_marshallIn(SFc32_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c32_g_sf_marshallOut(void *chartInstanceVoid, void
  *c32_inData);
static void c32_f_emlrt_marshallIn(SFc32_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c32_h_sf_marshallOut(void *chartInstanceVoid, void
  *c32_inData);
static void c32_g_emlrt_marshallIn(SFc32_DIPCaltInstanceStruct *chartInstance,
...
static void c32_eml_scalar_eg(SFc32_DIPCaltInstanceStruct *chartInstance);
static void c32_threshold(SFc32_DIPCaltInstanceStruct *chartInstance);
static void c32_quatmultiply(SFc32_DIPCaltInstanceStruct *chartInstance, real_T
  c32_q[4], real_T c32_r[4], real_T c32_qout[4]);
static void c32_b_eml_scalar_eg(SFc32_DIPCaltInstanceStruct *chartInstance);
static const mxArray *c32_i_sf_marshallOut(void *chartInstanceVoid, void
  *c32_inData);
static int32_T c32_h_emlrt_marshallIn(SFc32_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId);
static void c32_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c32_mxArrayInData, const char_T *c32_varName, void *c32_outData);
static uint8_T c32_i_emlrt_marshallIn(SFc32_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c32_b_is_active_c32_DIPCalt, const char_T *c32_identifier);
static uint8_T c32_j_emlrt_marshallIn(SFc32_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId);
static void init_dsm_address_info(SFc32_DIPCaltInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc32_DIPCaltInstanceStruct *chartInstance);
...
static void initialize_c32_DIPCalt(SFc32_DIPCaltInstanceStruct *chartInstance)
{
  ...
  chartInstance->c32_is_active_c32_DIPCalt = 0U;
}
  ...
  *chartInstance)
{
  ...
  sf_mex_import_named("rv", sf_mex_get_sfun_param(chartInstance->S, 0, 0),
                      c32_dv0, 0, 0, 0U, 1, 0U, 1, 12);
  for (c32_i0 = 0; c32_i0 < 12; c32_i0++) {
    chartInstance->c32_rv[c32_i0] = c32_dv0[c32_i0];
  }
}
  ...
  *chartInstance)
{
  ...
  for (c32_i1 = 0; c32_i1 < 24; c32_i1++) {
    c32_u[c32_i1] = (*chartInstance->c32_b)[c32_i1];
  }

  c32_b_y = NULL;
  sf_mex_assign(&c32_b_y, sf_mex_create("y", c32_u, 0, 0U, 1U, 0U, 1, 24), false);
  sf_mex_setcell(c32_y, 0, c32_b_y);
  c32_hoistedGlobal = chartInstance->c32_is_active_c32_DIPCalt;
  ...
  const mxArray *c32_st)
{
  ...
  c32_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c32_u, 0)), "b",
                       c32_dv1);
  for (c32_i2 = 0; c32_i2 < 24; c32_i2++) {
    (*chartInstance->c32_b)[c32_i2] = c32_dv1[c32_i2];
  }

  chartInstance->c32_is_active_c32_DIPCalt = c32_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c32_u, 1)),
     "is_active_c32_DIPCalt");
  sf_mex_destroy(&c32_u);
  c32_update_debugger_state_c32_DIPCalt(chartInstance);
...
static void sf_gateway_c32_DIPCalt(SFc32_DIPCaltInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 24U, chartInstance->c32_sfEvent);
  for (c32_i3 = 0; c32_i3 < 6; c32_i3++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c32_dx)[c32_i3], 0U);
  }

  chartInstance->c32_sfEvent = CALL_EVENT;
  c32_chartstep_c32_DIPCalt(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_DIPCaltMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c32_i4 = 0; c32_i4 < 24; c32_i4++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c32_b)[c32_i4], 1U);
  }

  for (c32_i5 = 0; c32_i5 < 12; c32_i5++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c32_rv[c32_i5], 2U);
  }

  for (c32_i6 = 0; c32_i6 < 7; c32_i6++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c32_x)[c32_i6], 3U);
  }
}
...
static void c32_chartstep_c32_DIPCalt(SFc32_DIPCaltInstanceStruct *chartInstance)
{
  ...
  int32_T c32_i46;
  real_T c32_f_x[3];
  uint32_T c32_b_debug_family_var_map[4];
  ...
  int32_T c32_i66;
  int32_T c32_i67;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 24U, chartInstance->c32_sfEvent);
  for (c32_i7 = 0; c32_i7 < 6; c32_i7++) {
    c32_b_dx[c32_i7] = (*chartInstance->c32_dx)[c32_i7];
  }

  for (c32_i8 = 0; c32_i8 < 12; c32_i8++) {
    c32_b_rv[c32_i8] = chartInstance->c32_rv[c32_i8];
  }

  for (c32_i9 = 0; c32_i9 < 7; c32_i9++) {
    c32_b_x[c32_i9] = (*chartInstance->c32_x)[c32_i9];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 6U, 6U, c32_debug_family_names,
    c32_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_nargin, 0U, c32_e_sf_marshallOut,
    c32_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_nargout, 1U, c32_e_sf_marshallOut,
    c32_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c32_b_dx, 2U, c32_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c32_b_rv, 3U, c32_c_sf_marshallOut,
    c32_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c32_b_x, 4U, c32_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c32_b_b, 5U, c32_sf_marshallOut,
    c32_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c32_sfEvent, 2);
  for (c32_i10 = 0; c32_i10 < 3; c32_i10++) {
    c32_c_dx[c32_i10] = c32_b_dx[c32_i10 + 3];
  }

  c32_skew_sm(chartInstance, c32_c_dx, c32_a);
  for (c32_i11 = 0; c32_i11 < 3; c32_i11++) {
    c32_d_dx[c32_i11] = c32_b_dx[c32_i11 + 3];
  }

  c32_skew_sm(chartInstance, c32_d_dx, c32_c_b);
  ...
  for (c32_i12 = 0; c32_i12 < 3; c32_i12++) {
    ...
    for (c32_i14 = 0; c32_i14 < 3; c32_i14++) {
      c32_y[c32_i13 + c32_i12] = 0.0;
      c32_i15 = 0;
      for (c32_i16 = 0; c32_i16 < 3; c32_i16++) {
        c32_y[c32_i13 + c32_i12] += c32_a[c32_i15 + c32_i12] * c32_c_b[c32_i16 +
          c32_i13];
        c32_i15 += 3;
      }
  ...
  for (c32_i17 = 0; c32_i17 < 4; c32_i17++) {
    c32_c_x[c32_i17] = c32_b_x[c32_i17 + 3];
  }

  for (c32_i18 = 0; c32_i18 < 3; c32_i18++) {
    c32_c_rv[c32_i18] = c32_b_rv[c32_i18];
  }

  c32_quatrot(chartInstance, c32_c_x, c32_c_rv, c32_d_b);
  ...
  for (c32_i19 = 0; c32_i19 < 3; c32_i19++) {
    ...
    for (c32_i21 = 0; c32_i21 < 3; c32_i21++) {
      c32_b_y[c32_i19] += c32_y[c32_i20 + c32_i19] * c32_d_b[c32_i21];
      c32_i20 += 3;
    }
  }

  for (c32_i22 = 0; c32_i22 < 3; c32_i22++) {
    c32_e_dx[c32_i22] = c32_b_dx[c32_i22 + 3];
  }

  c32_skew_sm(chartInstance, c32_e_dx, c32_a);
  for (c32_i23 = 0; c32_i23 < 3; c32_i23++) {
    c32_f_dx[c32_i23] = c32_b_dx[c32_i23 + 3];
  }

  c32_skew_sm(chartInstance, c32_f_dx, c32_c_b);
  c32_eml_scalar_eg(chartInstance);
  c32_eml_scalar_eg(chartInstance);
  c32_threshold(chartInstance);
  for (c32_i24 = 0; c32_i24 < 3; c32_i24++) {
    ...
    for (c32_i26 = 0; c32_i26 < 3; c32_i26++) {
      c32_y[c32_i25 + c32_i24] = 0.0;
      c32_i27 = 0;
      for (c32_i28 = 0; c32_i28 < 3; c32_i28++) {
        c32_y[c32_i25 + c32_i24] += c32_a[c32_i27 + c32_i24] * c32_c_b[c32_i28 +
          c32_i25];
        c32_i27 += 3;
      }
  ...
  for (c32_i29 = 0; c32_i29 < 4; c32_i29++) {
    c32_d_x[c32_i29] = c32_b_x[c32_i29 + 3];
  }

  for (c32_i30 = 0; c32_i30 < 3; c32_i30++) {
    c32_d_rv[c32_i30] = c32_b_rv[c32_i30 + 3];
  }

  c32_quatrot(chartInstance, c32_d_x, c32_d_rv, c32_d_b);
  c32_b_eml_scalar_eg(chartInstance);
  c32_b_eml_scalar_eg(chartInstance);
  c32_threshold(chartInstance);
  for (c32_i31 = 0; c32_i31 < 3; c32_i31++) {
    ...
    for (c32_i33 = 0; c32_i33 < 3; c32_i33++) {
      c32_c_y[c32_i31] += c32_y[c32_i32 + c32_i31] * c32_d_b[c32_i33];
      c32_i32 += 3;
    }
  }

  for (c32_i34 = 0; c32_i34 < 3; c32_i34++) {
    c32_g_dx[c32_i34] = c32_b_dx[c32_i34 + 3];
  }

  c32_skew_sm(chartInstance, c32_g_dx, c32_a);
  for (c32_i35 = 0; c32_i35 < 3; c32_i35++) {
    c32_h_dx[c32_i35] = c32_b_dx[c32_i35 + 3];
  }

  c32_skew_sm(chartInstance, c32_h_dx, c32_c_b);
  c32_eml_scalar_eg(chartInstance);
  c32_eml_scalar_eg(chartInstance);
  c32_threshold(chartInstance);
  for (c32_i36 = 0; c32_i36 < 3; c32_i36++) {
    ...
    for (c32_i38 = 0; c32_i38 < 3; c32_i38++) {
      c32_y[c32_i37 + c32_i36] = 0.0;
      c32_i39 = 0;
      for (c32_i40 = 0; c32_i40 < 3; c32_i40++) {
        c32_y[c32_i37 + c32_i36] += c32_a[c32_i39 + c32_i36] * c32_c_b[c32_i40 +
          c32_i37];
        c32_i39 += 3;
      }
  ...
  for (c32_i41 = 0; c32_i41 < 4; c32_i41++) {
    c32_e_x[c32_i41] = c32_b_x[c32_i41 + 3];
  }

  for (c32_i42 = 0; c32_i42 < 3; c32_i42++) {
    c32_e_rv[c32_i42] = c32_b_rv[c32_i42 + 6];
  }

  c32_quatrot(chartInstance, c32_e_x, c32_e_rv, c32_d_b);
  c32_b_eml_scalar_eg(chartInstance);
  c32_b_eml_scalar_eg(chartInstance);
  c32_threshold(chartInstance);
  for (c32_i43 = 0; c32_i43 < 3; c32_i43++) {
    ...
    for (c32_i45 = 0; c32_i45 < 3; c32_i45++) {
      c32_d_y[c32_i43] += c32_y[c32_i44 + c32_i43] * c32_d_b[c32_i45];
      c32_i44 += 3;
    }
  }

  for (c32_i46 = 0; c32_i46 < 3; c32_i46++) {
    c32_f_x[c32_i46] = c32_b_dx[c32_i46 + 3];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 4U, 4U, c32_b_debug_family_names,
    c32_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_b_nargin, 0U, c32_e_sf_marshallOut,
    c32_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_b_nargout, 1U, c32_e_sf_marshallOut,
    c32_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c32_f_x, 2U, c32_g_sf_marshallOut,
    c32_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c32_X, 3U, c32_f_sf_marshallOut,
    c32_d_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  _SFD_SCRIPT_CALL(0U, chartInstance->c32_sfEvent, 3);
  c32_X[0] = 0.0;
  c32_X[3] = -c32_f_x[2];
  c32_X[6] = c32_f_x[1];
  c32_X[1] = c32_f_x[2];
  ...
  _SFD_SCRIPT_CALL(0U, chartInstance->c32_sfEvent, -3);
  _SFD_SYMBOL_SCOPE_POP();
  for (c32_i47 = 0; c32_i47 < 3; c32_i47++) {
    c32_i_dx[c32_i47] = c32_b_dx[c32_i47 + 3];
  }

  c32_skew_sm(chartInstance, c32_i_dx, c32_a);
  for (c32_i48 = 0; c32_i48 < 9; c32_i48++) {
    c32_c_b[c32_i48] = c32_X[c32_i48];
  }

  c32_eml_scalar_eg(chartInstance);
  c32_eml_scalar_eg(chartInstance);
  c32_threshold(chartInstance);
  for (c32_i49 = 0; c32_i49 < 3; c32_i49++) {
    c32_i50 = 0;
    for (c32_i51 = 0; c32_i51 < 3; c32_i51++) {
      c32_y[c32_i50 + c32_i49] = 0.0;
      c32_i52 = 0;
      for (c32_i53 = 0; c32_i53 < 3; c32_i53++) {
        c32_y[c32_i50 + c32_i49] += c32_a[c32_i52 + c32_i49] * c32_c_b[c32_i53 +
          c32_i50];
        c32_i52 += 3;
      }
  ...
  for (c32_i54 = 0; c32_i54 < 4; c32_i54++) {
    c32_g_x[c32_i54] = c32_b_x[c32_i54 + 3];
  }

  for (c32_i55 = 0; c32_i55 < 3; c32_i55++) {
    c32_f_rv[c32_i55] = c32_b_rv[c32_i55 + 9];
  }

  c32_quatrot(chartInstance, c32_g_x, c32_f_rv, c32_d_b);
  c32_b_eml_scalar_eg(chartInstance);
  c32_b_eml_scalar_eg(chartInstance);
  c32_threshold(chartInstance);
  for (c32_i56 = 0; c32_i56 < 3; c32_i56++) {
    c32_e_y[c32_i56] = 0.0;
    c32_i57 = 0;
    for (c32_i58 = 0; c32_i58 < 3; c32_i58++) {
      c32_e_y[c32_i56] += c32_y[c32_i57 + c32_i56] * c32_d_b[c32_i58];
      c32_i57 += 3;
    }
  }

  for (c32_i59 = 0; c32_i59 < 3; c32_i59++) {
    c32_b_b[c32_i59] = c32_b_y[c32_i59];
  }

  for (c32_i60 = 0; c32_i60 < 3; c32_i60++) {
    c32_b_b[c32_i60 + 3] = 0.0;
  }

  for (c32_i61 = 0; c32_i61 < 3; c32_i61++) {
    c32_b_b[c32_i61 + 6] = c32_c_y[c32_i61];
  }

  for (c32_i62 = 0; c32_i62 < 3; c32_i62++) {
    c32_b_b[c32_i62 + 9] = 0.0;
  }

  for (c32_i63 = 0; c32_i63 < 3; c32_i63++) {
    c32_b_b[c32_i63 + 12] = c32_d_y[c32_i63];
  }

  for (c32_i64 = 0; c32_i64 < 3; c32_i64++) {
    c32_b_b[c32_i64 + 15] = 0.0;
  }

  for (c32_i65 = 0; c32_i65 < 3; c32_i65++) {
    c32_b_b[c32_i65 + 18] = c32_e_y[c32_i65];
  }

  for (c32_i66 = 0; c32_i66 < 3; c32_i66++) {
    c32_b_b[c32_i66 + 21] = 0.0;
  }

  _SFD_EML_CALL(0U, chartInstance->c32_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c32_i67 = 0; c32_i67 < 24; c32_i67++) {
    (*chartInstance->c32_b)[c32_i67] = c32_b_b[c32_i67];
  }

  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 24U, chartInstance->c32_sfEvent);
}
  ...
  c32_b_x[3], real_T c32_X[9])
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_nargout, 1U, c32_e_sf_marshallOut,
    c32_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c32_b_x, 2U, c32_g_sf_marshallOut,
    c32_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c32_X, 3U, c32_f_sf_marshallOut,
    c32_d_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  ...
  c32_q[4], real_T c32_r[3], real_T c32_rw[3])
{
  ...
  int32_T c32_i73;
  int32_T c32_i74;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 6U, 6U, c32_c_debug_family_names,
    c32_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c32_rwq, 0U, c32_h_sf_marshallOut,
    c32_f_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_nargin, 1U, c32_e_sf_marshallOut,
    c32_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_nargout, 2U, c32_e_sf_marshallOut,
    c32_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c32_q, 3U, c32_h_sf_marshallOut,
    c32_f_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c32_r, 4U, c32_g_sf_marshallOut,
    c32_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c32_rw, 5U, c32_g_sf_marshallOut,
    c32_e_sf_marshallIn);
  CV_SCRIPT_FCN(1, 0);
  _SFD_SCRIPT_CALL(1U, chartInstance->c32_sfEvent, 4);
  for (c32_i68 = 0; c32_i68 < 4; c32_i68++) {
    c32_b_q[c32_i68] = c32_q[c32_i68];
  }

  for (c32_k = 0; c32_k < 3; c32_k++) {
    c32_b_k = 2.0 + (real_T)c32_k;
    c32_b_q[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      c32_b_k), 1, 4, 1, 0) - 1] = -c32_b_q[_SFD_EML_ARRAY_BOUNDS_CHECK("",
      (int32_T)_SFD_INTEGER_CHECK("", c32_b_k), 1, 4, 1, 0) - 1];
  }

  c32_dv2[0] = 0.0;
  for (c32_i69 = 0; c32_i69 < 3; c32_i69++) {
    c32_dv2[c32_i69 + 1] = c32_r[c32_i69];
  }

  for (c32_i70 = 0; c32_i70 < 4; c32_i70++) {
    c32_c_q[c32_i70] = c32_b_q[c32_i70];
  }

  c32_quatmultiply(chartInstance, c32_dv2, c32_c_q, c32_dv3);
  for (c32_i71 = 0; c32_i71 < 4; c32_i71++) {
    c32_d_q[c32_i71] = c32_q[c32_i71];
  }

  for (c32_i72 = 0; c32_i72 < 4; c32_i72++) {
    c32_dv4[c32_i72] = c32_dv3[c32_i72];
  }

  c32_quatmultiply(chartInstance, c32_d_q, c32_dv4, c32_b_q);
  for (c32_i73 = 0; c32_i73 < 4; c32_i73++) {
    c32_rwq[c32_i73] = c32_b_q[c32_i73];
  }

  _SFD_SCRIPT_CALL(1U, chartInstance->c32_sfEvent, 5);
  for (c32_i74 = 0; c32_i74 < 3; c32_i74++) {
    c32_rw[c32_i74] = c32_rwq[c32_i74 + 1];
  }
  ...
  c32_chartNumber, uint32_T c32_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c32_chartNumber, c32_instanceNumber, 0U,
    sf_debug_get_script_id(
    "C:\\Users\\Martin\\Documents\\Git\\Simulink\\DIPC - constrained\\skew_sm.m"));
  _SFD_SCRIPT_TRANSLATION(c32_chartNumber, c32_instanceNumber, 1U,
    sf_debug_get_script_id(
  ...
  *c32_inData)
{
  ...
  int32_T c32_i75;
  real_T c32_b_inData[24];
  int32_T c32_i76;
  real_T c32_u[24];
  const mxArray *c32_y = NULL;
  SFc32_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc32_DIPCaltInstanceStruct *)chartInstanceVoid;
  c32_mxArrayOutData = NULL;
  for (c32_i75 = 0; c32_i75 < 24; c32_i75++) {
    c32_b_inData[c32_i75] = (*(real_T (*)[24])c32_inData)[c32_i75];
  }

  for (c32_i76 = 0; c32_i76 < 24; c32_i76++) {
    c32_u[c32_i76] = c32_b_inData[c32_i76];
  }

  c32_y = NULL;
  sf_mex_assign(&c32_y, sf_mex_create("y", c32_u, 0, 0U, 1U, 0U, 1, 24), false);
  ...
  const mxArray *c32_b_b, const char_T *c32_identifier, real_T c32_y[24])
{
  ...
  c32_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c32_b_b), &c32_thisId, c32_y);
  sf_mex_destroy(&c32_b_b);
}
  ...
  const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId, real_T c32_y[24])
{
  ...
  int32_T c32_i77;
  (void)chartInstance;
  sf_mex_import(c32_parentId, sf_mex_dup(c32_u), c32_dv5, 1, 0, 0U, 1, 0U, 1, 24);
  for (c32_i77 = 0; c32_i77 < 24; c32_i77++) {
    c32_y[c32_i77] = c32_dv5[c32_i77];
  }
  ...
  *c32_mxArrayInData, const char_T *c32_varName, void *c32_outData)
{
  ...
  SFc32_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc32_DIPCaltInstanceStruct *)chartInstanceVoid;
  c32_b_b = sf_mex_dup(c32_mxArrayInData);
  c32_identifier = c32_varName;
  c32_thisId.fIdentifier = c32_identifier;
  c32_thisId.fParent = NULL;
  c32_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c32_b_b), &c32_thisId, c32_y);
  sf_mex_destroy(&c32_b_b);
  for (c32_i78 = 0; c32_i78 < 24; c32_i78++) {
    (*(real_T (*)[24])c32_outData)[c32_i78] = c32_y[c32_i78];
  }
  ...
  *c32_inData)
{
  ...
  chartInstance = (SFc32_DIPCaltInstanceStruct *)chartInstanceVoid;
  c32_mxArrayOutData = NULL;
  for (c32_i79 = 0; c32_i79 < 7; c32_i79++) {
    c32_b_inData[c32_i79] = (*(real_T (*)[7])c32_inData)[c32_i79];
  }

  for (c32_i80 = 0; c32_i80 < 7; c32_i80++) {
    c32_u[c32_i80] = c32_b_inData[c32_i80];
  }

  c32_y = NULL;
  sf_mex_assign(&c32_y, sf_mex_create("y", c32_u, 0, 0U, 1U, 0U, 1, 7), false);
  sf_mex_assign(&c32_mxArrayOutData, c32_y, false);
  return c32_mxArrayOutData;
}
  ...
  *c32_inData)
{
  ...
  chartInstance = (SFc32_DIPCaltInstanceStruct *)chartInstanceVoid;
  c32_mxArrayOutData = NULL;
  for (c32_i81 = 0; c32_i81 < 12; c32_i81++) {
    c32_b_inData[c32_i81] = (*(real_T (*)[12])c32_inData)[c32_i81];
  }

  for (c32_i82 = 0; c32_i82 < 12; c32_i82++) {
    c32_u[c32_i82] = c32_b_inData[c32_i82];
  }
  ...
  const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId, real_T c32_y[12])
{
  ...
  int32_T c32_i83;
  (void)chartInstance;
  sf_mex_import(c32_parentId, sf_mex_dup(c32_u), c32_dv6, 1, 0, 0U, 1, 0U, 1, 12);
  for (c32_i83 = 0; c32_i83 < 12; c32_i83++) {
    c32_y[c32_i83] = c32_dv6[c32_i83];
  }
  ...
  *c32_mxArrayInData, const char_T *c32_varName, void *c32_outData)
{
  ...
  SFc32_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc32_DIPCaltInstanceStruct *)chartInstanceVoid;
  c32_b_rv = sf_mex_dup(c32_mxArrayInData);
  c32_identifier = c32_varName;
  c32_thisId.fIdentifier = c32_identifier;
  c32_thisId.fParent = NULL;
  c32_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c32_b_rv), &c32_thisId, c32_y);
  sf_mex_destroy(&c32_b_rv);
  for (c32_i84 = 0; c32_i84 < 12; c32_i84++) {
    (*(real_T (*)[12])c32_outData)[c32_i84] = c32_y[c32_i84];
  }
  ...
  *c32_inData)
{
  ...
  chartInstance = (SFc32_DIPCaltInstanceStruct *)chartInstanceVoid;
  c32_mxArrayOutData = NULL;
  for (c32_i85 = 0; c32_i85 < 6; c32_i85++) {
    c32_b_inData[c32_i85] = (*(real_T (*)[6])c32_inData)[c32_i85];
  }

  for (c32_i86 = 0; c32_i86 < 6; c32_i86++) {
    c32_u[c32_i86] = c32_b_inData[c32_i86];
  }
  ...
  *c32_mxArrayInData, const char_T *c32_varName, void *c32_outData)
{
  ...
  c32_thisId.fIdentifier = c32_identifier;
  c32_thisId.fParent = NULL;
  c32_y = c32_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c32_nargout),
    &c32_thisId);
  ...
  *c32_inData)
{
  ...
  c32_mxArrayOutData = NULL;
  c32_i87 = 0;
  for (c32_i88 = 0; c32_i88 < 3; c32_i88++) {
    for (c32_i89 = 0; c32_i89 < 3; c32_i89++) {
      c32_b_inData[c32_i89 + c32_i87] = (*(real_T (*)[9])c32_inData)[c32_i89 +
        c32_i87];
    }
  ...
  for (c32_i91 = 0; c32_i91 < 3; c32_i91++) {
    for (c32_i92 = 0; c32_i92 < 3; c32_i92++) {
      c32_u[c32_i92 + c32_i90] = c32_b_inData[c32_i92 + c32_i90];
    }
  ...
  *c32_mxArrayInData, const char_T *c32_varName, void *c32_outData)
{
  ...
  SFc32_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc32_DIPCaltInstanceStruct *)chartInstanceVoid;
  c32_X = sf_mex_dup(c32_mxArrayInData);
  c32_identifier = c32_varName;
  c32_thisId.fIdentifier = c32_identifier;
  c32_thisId.fParent = NULL;
  c32_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c32_X), &c32_thisId, c32_y);
  sf_mex_destroy(&c32_X);
  c32_i94 = 0;
  for (c32_i95 = 0; c32_i95 < 3; c32_i95++) {
    for (c32_i96 = 0; c32_i96 < 3; c32_i96++) {
      (*(real_T (*)[9])c32_outData)[c32_i96 + c32_i94] = c32_y[c32_i96 + c32_i94];
    }
  ...
  *c32_inData)
{
  ...
  chartInstance = (SFc32_DIPCaltInstanceStruct *)chartInstanceVoid;
  c32_mxArrayOutData = NULL;
  for (c32_i97 = 0; c32_i97 < 3; c32_i97++) {
    c32_b_inData[c32_i97] = (*(real_T (*)[3])c32_inData)[c32_i97];
  }

  for (c32_i98 = 0; c32_i98 < 3; c32_i98++) {
    c32_u[c32_i98] = c32_b_inData[c32_i98];
  }
  ...
  const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId, real_T c32_y[3])
{
  ...
  int32_T c32_i99;
  (void)chartInstance;
  sf_mex_import(c32_parentId, sf_mex_dup(c32_u), c32_dv8, 1, 0, 0U, 1, 0U, 1, 3);
  for (c32_i99 = 0; c32_i99 < 3; c32_i99++) {
    c32_y[c32_i99] = c32_dv8[c32_i99];
  }
  ...
  *c32_mxArrayInData, const char_T *c32_varName, void *c32_outData)
{
  ...
  SFc32_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc32_DIPCaltInstanceStruct *)chartInstanceVoid;
  c32_b_x = sf_mex_dup(c32_mxArrayInData);
  c32_identifier = c32_varName;
  c32_thisId.fIdentifier = c32_identifier;
  c32_thisId.fParent = NULL;
  c32_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c32_b_x), &c32_thisId, c32_y);
  sf_mex_destroy(&c32_b_x);
  for (c32_i100 = 0; c32_i100 < 3; c32_i100++) {
    (*(real_T (*)[3])c32_outData)[c32_i100] = c32_y[c32_i100];
  }
  ...
  *c32_inData)
{
  ...
  chartInstance = (SFc32_DIPCaltInstanceStruct *)chartInstanceVoid;
  c32_mxArrayOutData = NULL;
  for (c32_i101 = 0; c32_i101 < 4; c32_i101++) {
    c32_b_inData[c32_i101] = (*(real_T (*)[4])c32_inData)[c32_i101];
  }

  for (c32_i102 = 0; c32_i102 < 4; c32_i102++) {
    c32_u[c32_i102] = c32_b_inData[c32_i102];
  }
  ...
  const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId, real_T c32_y[4])
{
  ...
  int32_T c32_i103;
  (void)chartInstance;
  sf_mex_import(c32_parentId, sf_mex_dup(c32_u), c32_dv9, 1, 0, 0U, 1, 0U, 1, 4);
  for (c32_i103 = 0; c32_i103 < 4; c32_i103++) {
    c32_y[c32_i103] = c32_dv9[c32_i103];
  }
  ...
  *c32_mxArrayInData, const char_T *c32_varName, void *c32_outData)
{
  ...
  c32_thisId.fIdentifier = c32_identifier;
  c32_thisId.fParent = NULL;
  c32_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c32_q), &c32_thisId, c32_y);
  sf_mex_destroy(&c32_q);
  for (c32_i104 = 0; c32_i104 < 4; c32_i104++) {
    (*(real_T (*)[4])c32_outData)[c32_i104] = c32_y[c32_i104];
  }

  sf_mex_destroy(&c32_mxArrayInData);
}

const mxArray *sf_c32_DIPCalt_get_eml_resolved_functions_info(void)
{
  const mxArray *c32_nameCaptureInfo = NULL;
  c32_nameCaptureInfo = NULL;
  sf_mex_assign(&c32_nameCaptureInfo, sf_mex_createstruct("structure", 2, 25, 1),
                false);
...
static void c32_info_helper(const mxArray **c32_info)
{
  ...
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("skew_sm"), "name", "name", 0);
  ...
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPC - constrained/skew_sm.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c32_info, c32_b_emlrt_marshallOut(1445505143U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c32_info, sf_mex_duplicatearraysafe(&c32_lhs0), "lhs", "lhs",
                  0);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(""), "context", "context", 1);
  ...
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("quatrot"), "name", "name",
                  14);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 14);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c32_info, c32_b_emlrt_marshallOut(1446631716U), "fileTimeLo",
                  "fileTimeLo", 14);
  sf_mex_addfield(*c32_info, c32_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 14);
  sf_mex_addfield(*c32_info, c32_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPC - constrained/quatrot.m"),
                  "context", "context", 15);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("quatconj"), "name", "name",
                  15);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 15);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/aeroblks/eml/quatconj.p"), "resolved", "resolved",
                  15);
  sf_mex_addfield(*c32_info, c32_b_emlrt_marshallOut(1410808258U), "fileTimeLo",
                  "fileTimeLo", 15);
  sf_mex_addfield(*c32_info, c32_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 15);
  sf_mex_addfield(*c32_info, c32_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPC - constrained/quatrot.m"),
                  "context", "context", 16);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("quatmultiply"), "name",
                  "name", 16);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 16);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/aeroblks/eml/quatmultiply.p"), "context",
                  "context", 17);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("max"), "name", "name", 17);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 17);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/max.m"), "resolved",
                  "resolved", 17);
  sf_mex_addfield(*c32_info, c32_b_emlrt_marshallOut(1311280516U), "fileTimeLo",
                  "fileTimeLo", 17);
  sf_mex_addfield(*c32_info, c32_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 17);
  sf_mex_addfield(*c32_info, c32_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c32_info, c32_b_emlrt_marshallOut(1378321184U), "fileTimeLo",
                  "fileTimeLo", 18);
  sf_mex_addfield(*c32_info, c32_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 18);
  sf_mex_addfield(*c32_info, c32_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  c32_q[4], real_T c32_r[4], real_T c32_qout[4])
{
  ...
  c32_r3 = c32_r[2];
  c32_r4 = c32_r[3];
  c32_qout[0] = ((c32_q1 * c32_r1 - c32_q2 * c32_r2) - c32_q3 * c32_r3) - c32_q4
    * c32_r4;
  c32_qout[1] = (c32_q1 * c32_r2 + c32_r1 * c32_q2) + (c32_q3 * c32_r4 - c32_q4 *
    c32_r3);
  c32_qout[2] = (c32_q1 * c32_r3 + c32_r1 * c32_q3) + (c32_q4 * c32_r2 - c32_q2 *
    c32_r4);
  c32_qout[3] = (c32_q1 * c32_r4 + c32_r1 * c32_q4) + (c32_q2 * c32_r3 - c32_q3 *
    c32_r2);
}
  ...
  const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId)
{
  ...
  int32_T c32_i105;
  (void)chartInstance;
  sf_mex_import(c32_parentId, sf_mex_dup(c32_u), &c32_i105, 1, 6, 0U, 0, 0U, 0);
  c32_y = c32_i105;
  sf_mex_destroy(&c32_u);
  return c32_y;
}
  ...
  *c32_mxArrayInData, const char_T *c32_varName, void *c32_outData)
{
  ...
  c32_thisId.fIdentifier = c32_identifier;
  c32_thisId.fParent = NULL;
  c32_y = c32_h_emlrt_marshallIn(chartInstance, sf_mex_dup(c32_b_sfEvent),
    &c32_thisId);
  ...
  const mxArray *c32_b_is_active_c32_DIPCalt, const char_T *c32_identifier)
{
  ...
  c32_thisId.fIdentifier = c32_identifier;
  c32_thisId.fParent = NULL;
  c32_y = c32_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c32_b_is_active_c32_DIPCalt), &c32_thisId);
  sf_mex_destroy(&c32_b_is_active_c32_DIPCalt);
  return c32_y;
}
...
static void init_simulink_io_address(SFc32_DIPCaltInstanceStruct *chartInstance)
{
  chartInstance->c32_dx = (real_T (*)[6])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c32_b = (real_T (*)[24])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c32_x = (real_T (*)[7])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
void sf_c32_DIPCalt_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c32_DIPCalt_get_post_codegen_info(void);
mxArray *sf_c32_DIPCalt_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c32_DIPCalt_get_post_codegen_info();
...
mxArray *sf_c32_DIPCalt_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c32_DIPCalt_jit_fallback_info(void)
{
...
mxArray *sf_c32_DIPCalt_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c32_DIPCalt(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"b\",},{M[8],M[0],T\"is_active_c32_DIPCalt\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c32_DIPCalt_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc32_DIPCaltInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(0U, *chartInstance->c32_dx);
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c32_b);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c32_rv);
        _SFD_SET_DATA_VALUE_PTR(3U, *chartInstance->c32_x);
      }
    } else {
...
static void sf_opaque_initialize_c32_DIPCalt(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc32_DIPCaltInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c32_DIPCalt((SFc32_DIPCaltInstanceStruct*) chartInstanceVar);
  initialize_c32_DIPCalt((SFc32_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c32_DIPCalt(void *chartInstanceVar)
{
  enable_c32_DIPCalt((SFc32_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c32_DIPCalt(void *chartInstanceVar)
{
  disable_c32_DIPCalt((SFc32_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c32_DIPCalt(void *chartInstanceVar)
{
  sf_gateway_c32_DIPCalt((SFc32_DIPCaltInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c32_DIPCalt(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c32_DIPCalt((SFc32_DIPCaltInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c32_DIPCalt(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c32_DIPCalt((SFc32_DIPCaltInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c32_DIPCalt(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc32_DIPCaltInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c32_DIPCalt((SFc32_DIPCaltInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc32_DIPCalt((SFc32_DIPCaltInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c32_DIPCalt(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c32_DIPCalt((SFc32_DIPCaltInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c32_DIPCalt(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1764431957U));
  ssSetChecksum1(S,(215112007U));
  ssSetChecksum2(S,(2488166206U));
  ssSetChecksum3(S,(4027864424U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c32_DIPCalt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c32_DIPCalt(SimStruct *S)
{
  SFc32_DIPCaltInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc32_DIPCaltInstanceStruct *)utMalloc(sizeof
    (SFc32_DIPCaltInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc32_DIPCaltInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c32_DIPCalt;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c32_DIPCalt;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c32_DIPCalt;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c32_DIPCalt;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c32_DIPCalt;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c32_DIPCalt;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c32_DIPCalt;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c32_DIPCalt;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c32_DIPCalt;
  chartInstance->chartInfo.mdlStart = mdlStart_c32_DIPCalt;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c32_DIPCalt;
...
void c32_DIPCalt_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c32_DIPCalt(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c32_DIPCalt(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c32_DIPCalt(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c32_DIPCalt_method_dispatcher.\n"
