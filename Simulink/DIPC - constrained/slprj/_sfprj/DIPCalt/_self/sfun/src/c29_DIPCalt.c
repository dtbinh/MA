...
static void c29_info_helper(const mxArray **c29_info)
{
  ...
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(1446631716U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(1445505143U), "fileTimeLo",
                  "fileTimeLo", 33);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 33);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(0U), "mFileTimeLo",
...
static void mdlSetWorkWidths_c29_DIPCalt(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3169419247U));
  ssSetChecksum1(S,(3764030742U));
  ssSetChecksum2(S,(877742677U));
  ssSetChecksum3(S,(3197912369U));
