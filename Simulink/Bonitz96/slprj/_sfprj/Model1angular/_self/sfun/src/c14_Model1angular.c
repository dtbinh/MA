...
static void initialize_c14_Model1angular(SFc14_Model1angularInstanceStruct
  *chartInstance);
static void initialize_params_c14_Model1angular
  (SFc14_Model1angularInstanceStruct *chartInstance);
static void enable_c14_Model1angular(SFc14_Model1angularInstanceStruct
  *chartInstance);
static void disable_c14_Model1angular(SFc14_Model1angularInstanceStruct
  *chartInstance);
static void c14_update_debugger_state_c14_Model1angular
  (SFc14_Model1angularInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c14_Model1angular
  (SFc14_Model1angularInstanceStruct *chartInstance);
static void set_sim_state_c14_Model1angular(SFc14_Model1angularInstanceStruct
  *chartInstance, const mxArray *c14_st);
static void finalize_c14_Model1angular(SFc14_Model1angularInstanceStruct
  *chartInstance);
static void sf_gateway_c14_Model1angular(SFc14_Model1angularInstanceStruct
  *chartInstance);
static void mdl_start_c14_Model1angular(SFc14_Model1angularInstanceStruct
  *chartInstance);
static void initSimStructsc14_Model1angular(SFc14_Model1angularInstanceStruct
  *chartInstance);
...
static const mxArray *c14_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static void c14_emlrt_marshallIn(SFc14_Model1angularInstanceStruct
  *chartInstance, const mxArray *c14_b_rot, const char_T *c14_identifier, real_T
  c14_y[6]);
static void c14_b_emlrt_marshallIn(SFc14_Model1angularInstanceStruct
...
static const mxArray *c14_b_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static real_T c14_c_emlrt_marshallIn(SFc14_Model1angularInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
...
static real_T c14_eml_xdotu(SFc14_Model1angularInstanceStruct *chartInstance,
  real_T c14_x[3], real_T c14_y[3]);
static const mxArray *c14_c_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static int32_T c14_d_emlrt_marshallIn(SFc14_Model1angularInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void c14_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c14_mxArrayInData, const char_T *c14_varName, void *c14_outData);
static uint8_T c14_e_emlrt_marshallIn(SFc14_Model1angularInstanceStruct
  *chartInstance, const mxArray *c14_b_is_active_c14_Model1angular, const char_T
  *c14_identifier);
static uint8_T c14_f_emlrt_marshallIn(SFc14_Model1angularInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void init_dsm_address_info(SFc14_Model1angularInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc14_Model1angularInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c14_is_active_c14_Model1angular = 0U;
}
  ...
  (SFc14_Model1angularInstanceStruct *chartInstance)
{
  ...
  c14_hoistedGlobal = chartInstance->c14_is_active_c14_Model1angular;
  ...
  *chartInstance, const mxArray *c14_st)
{
  ...
  chartInstance->c14_is_active_c14_Model1angular = c14_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c14_u, 1)),
     "is_active_c14_Model1angular");
  sf_mex_destroy(&c14_u);
  c14_update_debugger_state_c14_Model1angular(chartInstance);
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c14_b_r, 3U, c14_sf_marshallOut,
    c14_sf_marshallIn);
  ...
  *c14_inData)
{
  ...
  const mxArray *c14_y = NULL;
  SFc14_Model1angularInstanceStruct *chartInstance;
  chartInstance = (SFc14_Model1angularInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c14_Model1angular_get_eml_resolved_functions_info(void)
{
  ...
  *c14_identifier)
{
  ...
  c14_y = c14_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c14_b_is_active_c14_Model1angular), &c14_thisId);
  sf_mex_destroy(&c14_b_is_active_c14_Model1angular);
  return c14_y;
}
...
void sf_c14_Model1angular_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1571165080U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(388174445U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1561435464U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(229088529U);
}

mxArray* sf_c14_Model1angular_get_post_codegen_info(void);
mxArray *sf_c14_Model1angular_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("F75ftBpB2IevM8bKtVJV4G");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c14_Model1angular_get_post_codegen_info();
...
mxArray *sf_c14_Model1angular_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c14_Model1angular_jit_fallback_info(void)
{
...
mxArray *sf_c14_Model1angular_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c14_Model1angular(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"rot\",},{M[8],M[0],T\"is_active_c14_Model1angular\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c14_Model1angular_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc14_Model1angularInstanceStruct *)
...
{
  return "l1iTpMTMq75htSBX6uzriE";
}

static void sf_opaque_initialize_c14_Model1angular(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc14_Model1angularInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c14_Model1angular((SFc14_Model1angularInstanceStruct*)
    chartInstanceVar);
  initialize_c14_Model1angular((SFc14_Model1angularInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c14_Model1angular(void *chartInstanceVar)
{
  enable_c14_Model1angular((SFc14_Model1angularInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c14_Model1angular(void *chartInstanceVar)
{
  disable_c14_Model1angular((SFc14_Model1angularInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c14_Model1angular(void *chartInstanceVar)
{
  sf_gateway_c14_Model1angular((SFc14_Model1angularInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c14_Model1angular(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c14_Model1angular((SFc14_Model1angularInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c14_Model1angular(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c14_Model1angular((SFc14_Model1angularInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c14_Model1angular(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc14_Model1angularInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c14_Model1angular((SFc14_Model1angularInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc14_Model1angular((SFc14_Model1angularInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c14_Model1angular(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c14_Model1angular(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2843193564U));
  ssSetChecksum1(S,(3242951730U));
  ssSetChecksum2(S,(329928928U));
  ssSetChecksum3(S,(1443805247U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c14_Model1angular(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c14_Model1angular(SimStruct *S)
{
  SFc14_Model1angularInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc14_Model1angularInstanceStruct *)utMalloc(sizeof
    (SFc14_Model1angularInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc14_Model1angularInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c14_Model1angular;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c14_Model1angular;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c14_Model1angular;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c14_Model1angular;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c14_Model1angular;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c14_Model1angular;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c14_Model1angular;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c14_Model1angular;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c14_Model1angular;
  chartInstance->chartInfo.mdlStart = mdlStart_c14_Model1angular;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c14_Model1angular;
...
void c14_Model1angular_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c14_Model1angular(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c14_Model1angular(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c14_Model1angular(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c14_Model1angular_method_dispatcher.\n"
