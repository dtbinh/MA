  ...
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  ...
  if (chartFileNumber==6) {
    c6_Model1angular_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2041904167U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1579420956U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3600851189U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3706997480U);
      ...
      switch (chartFileNumber) {
       ...
       case 6:
        {
          extern void sf_c6_Model1angular_get_check_sum(mxArray *plhs[]);
          sf_c6_Model1angular_get_check_sum(plhs);
          break;
        }
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2520948912U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1996896187U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(810390854U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3514842326U);
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 6:
      {
        if (strcmp(aiChksum, "PDOjJD7CaMZuAXN1UghOMH") == 0) {
          extern mxArray *sf_c6_Model1angular_get_autoinheritance_info(void);
          plhs[0] = sf_c6_Model1angular_get_autoinheritance_info();
          break;
        }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 6:
      {
        extern const mxArray
          *sf_c6_Model1angular_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c6_Model1angular_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 6:
      {
        if (strcmp(tpChksum, "AODkGV0qQXVaZIFOnEcNSB") == 0) {
          extern mxArray *sf_c6_Model1angular_third_party_uses_info(void);
          plhs[0] = sf_c6_Model1angular_third_party_uses_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 6:
      {
        if (strcmp(tpChksum, "AODkGV0qQXVaZIFOnEcNSB") == 0) {
          extern mxArray *sf_c6_Model1angular_jit_fallback_info(void);
          plhs[0] = sf_c6_Model1angular_jit_fallback_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 6:
      {
        if (strcmp(tpChksum, "AODkGV0qQXVaZIFOnEcNSB") == 0) {
          extern mxArray *sf_c6_Model1angular_updateBuildInfo_args_info(void);
          plhs[0] = sf_c6_Model1angular_updateBuildInfo_args_info();
          break;
        }
      }
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  switch (chartFileNumber) {
   ...
   case 6:
    {
      if (strcmp(tpChksum, "AODkGV0qQXVaZIFOnEcNSB") == 0) {
        extern mxArray *sf_c6_Model1angular_get_post_codegen_info(void);
        plhs[0] = sf_c6_Model1angular_get_post_codegen_info();
        return;
      }
    }
    break;
