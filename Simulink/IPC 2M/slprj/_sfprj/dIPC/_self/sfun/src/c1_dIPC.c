...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_e_emlrt_marshallIn(SFc1_dIPCInstanceStruct *chartInstance,
...
static void c1_quatmultiply(SFc1_dIPCInstanceStruct *chartInstance, real_T c1_q
  [4], real_T c1_r[4], real_T c1_qout[4]);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_f_emlrt_marshallIn(SFc1_dIPCInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_g_emlrt_marshallIn(SFc1_dIPCInstanceStruct *chartInstance,
  ...
  *chartInstance)
{
  ...
  for (c1_i0 = 0; c1_i0 < 3; c1_i0++) {
    c1_u[c1_i0] = (*chartInstance->c1_pb1)[c1_i0];
  }
  ...
  for (c1_i1 = 0; c1_i1 < 4; c1_i1++) {
    c1_b_u[c1_i1] = (*chartInstance->c1_qb1)[c1_i1];
  }
  ...
  mxArray *c1_st)
{
  ...
  for (c1_i2 = 0; c1_i2 < 3; c1_i2++) {
    (*chartInstance->c1_pb1)[c1_i2] = c1_dv0[c1_i2];
  }

  c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)), "qb1",
                      c1_dv1);
  for (c1_i3 = 0; c1_i3 < 4; c1_i3++) {
    (*chartInstance->c1_qb1)[c1_i3] = c1_dv1[c1_i3];
  }

  chartInstance->c1_is_active_c1_dIPC = c1_g_emlrt_marshallIn(chartInstance,
...
static void sf_gateway_c1_dIPC(SFc1_dIPCInstanceStruct *chartInstance)
{
  ...
  for (c1_i4 = 0; c1_i4 < 3; c1_i4++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c1_pb)[c1_i4], 0U);
  }

  for (c1_i5 = 0; c1_i5 < 4; c1_i5++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c1_qb)[c1_i5], 1U);
  }

  chartInstance->c1_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  for (c1_i6 = 0; c1_i6 < 3; c1_i6++) {
    c1_b_pb[c1_i6] = (*chartInstance->c1_pb)[c1_i6];
  }

  for (c1_i7 = 0; c1_i7 < 4; c1_i7++) {
    c1_b_qb[c1_i7] = (*chartInstance->c1_qb)[c1_i7];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_b_rv, 4U, c1_c_sf_marshallOut);
  ...
  for (c1_i9 = 0; c1_i9 < 4; c1_i9++) {
    c1_q[c1_i9] = c1_b_qb[c1_i9];
  }

  for (c1_i10 = 0; c1_i10 < 3; c1_i10++) {
    c1_r[c1_i10] = c1_b_rv[c1_i10];
  }
  ...
  for (c1_i22 = 0; c1_i22 < 3; c1_i22++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c1_pb1)[c1_i22], 2U);
  }

  for (c1_i23 = 0; c1_i23 < 6; c1_i23++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c1_rv)[c1_i23], 3U);
  }

  for (c1_i24 = 0; c1_i24 < 4; c1_i24++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c1_qb1)[c1_i24], 4U);
  }
}
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  for (c1_i25 = 0; c1_i25 < 4; c1_i25++) {
    c1_b_inData[c1_i25] = (*(real_T (*)[4])c1_inData)[c1_i25];
  }
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  for (c1_i28 = 0; c1_i28 < 4; c1_i28++) {
    (*(real_T (*)[4])c1_outData)[c1_i28] = c1_y[c1_i28];
  }
  ...
  const mxArray *c1_b_is_active_c1_dIPC, const char_T *c1_identifier)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_y = c1_h_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_is_active_c1_dIPC),
    &c1_thisId);
...
static void init_simulink_io_address(SFc1_dIPCInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_pb1 = (real_T (*)[3])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c1_rv = (real_T (*)[6])ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(61534425U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3686095224U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1239568082U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1901880290U);
}
...
mxArray *sf_c1_dIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("u5nCS9OynG2QpYKb6hLGDH");
...
static void mdlSetWorkWidths_c1_dIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(21419109U));
  ssSetChecksum1(S,(428672239U));
  ssSetChecksum2(S,(3804717656U));
  ssSetChecksum3(S,(4051973336U));
