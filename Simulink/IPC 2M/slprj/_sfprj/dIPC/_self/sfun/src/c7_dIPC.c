  ...
  *c7_inData)
{
  ...
  chartInstance = (SFc7_dIPCInstanceStruct *)chartInstanceVoid;
  c7_mxArrayOutData = NULL;
  for (c7_i26 = 0; c7_i26 < 12; c7_i26++) {
    c7_b_inData[c7_i26] = (*(real_T (*)[12])c7_inData)[c7_i26];
  }

  for (c7_i27 = 0; c7_i27 < 12; c7_i27++) {
...
static void init_simulink_io_address(SFc7_dIPCInstanceStruct *chartInstance)
{
  chartInstance->c7_dx = (real_T (*)[12])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1470382139U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1304126717U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1583224853U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(35434753U);
}
...
mxArray *sf_c7_dIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("1oJUcgcUIKhUxwRnIGnvQH");
...
static void mdlSetWorkWidths_c7_dIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2804168897U));
  ssSetChecksum1(S,(4140850881U));
  ssSetChecksum2(S,(2294912583U));
  ssSetChecksum3(S,(1389397261U));
