...
static const char * c6_debug_family_names[6] = { "nargin", "nargout", "dx", "x",
  "r", "b" };
...
static void initialize_c6_dIPC(SFc6_dIPCInstanceStruct *chartInstance);
static void initialize_params_c6_dIPC(SFc6_dIPCInstanceStruct *chartInstance);
static void enable_c6_dIPC(SFc6_dIPCInstanceStruct *chartInstance);
static void disable_c6_dIPC(SFc6_dIPCInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_dIPC(SFc6_dIPCInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c6_dIPC(SFc6_dIPCInstanceStruct
  *chartInstance);
static void set_sim_state_c6_dIPC(SFc6_dIPCInstanceStruct *chartInstance, const
  mxArray *c6_st);
static void finalize_c6_dIPC(SFc6_dIPCInstanceStruct *chartInstance);
static void sf_gateway_c6_dIPC(SFc6_dIPCInstanceStruct *chartInstance);
static void mdl_start_c6_dIPC(SFc6_dIPCInstanceStruct *chartInstance);
static void c6_chartstep_c6_dIPC(SFc6_dIPCInstanceStruct *chartInstance);
static void initSimStructsc6_dIPC(SFc6_dIPCInstanceStruct *chartInstance);
static void c6_skew_sm(SFc6_dIPCInstanceStruct *chartInstance, real_T c6_b_x[3],
  real_T c6_X[9]);
static void c6_quatrot(SFc6_dIPCInstanceStruct *chartInstance, real_T c6_q[4],
  real_T c6_b_r[3], real_T c6_rw[3]);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static void c6_emlrt_marshallIn(SFc6_dIPCInstanceStruct *chartInstance, const
  mxArray *c6_b_b, const char_T *c6_identifier, real_T c6_y[12]);
static void c6_b_emlrt_marshallIn(SFc6_dIPCInstanceStruct *chartInstance, const
  mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[12]);
...
static const mxArray *c6_d_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real_T c6_c_emlrt_marshallIn(SFc6_dIPCInstanceStruct *chartInstance,
...
static const mxArray *c6_e_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_d_emlrt_marshallIn(SFc6_dIPCInstanceStruct *chartInstance, const
...
static const mxArray *c6_f_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_e_emlrt_marshallIn(SFc6_dIPCInstanceStruct *chartInstance, const
...
static const mxArray *c6_g_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_f_emlrt_marshallIn(SFc6_dIPCInstanceStruct *chartInstance, const
...
static void c6_eml_scalar_eg(SFc6_dIPCInstanceStruct *chartInstance);
static void c6_threshold(SFc6_dIPCInstanceStruct *chartInstance);
static void c6_quatmultiply(SFc6_dIPCInstanceStruct *chartInstance, real_T c6_q
  [4], real_T c6_b_r[4], real_T c6_qout[4]);
static void c6_b_eml_scalar_eg(SFc6_dIPCInstanceStruct *chartInstance);
static const mxArray *c6_h_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_g_emlrt_marshallIn(SFc6_dIPCInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_h_emlrt_marshallIn(SFc6_dIPCInstanceStruct *chartInstance,
  const mxArray *c6_b_is_active_c6_dIPC, const char_T *c6_identifier);
static uint8_T c6_i_emlrt_marshallIn(SFc6_dIPCInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_dIPCInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc6_dIPCInstanceStruct *chartInstance);
...
static void initialize_c6_dIPC(SFc6_dIPCInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_dIPC = 0U;
}
  ...
  *chartInstance)
{
  ...
  for (c6_i0 = 0; c6_i0 < 12; c6_i0++) {
    c6_u[c6_i0] = (*chartInstance->c6_b)[c6_i0];
  }

  c6_b_y = NULL;
  sf_mex_assign(&c6_b_y, sf_mex_create("y", c6_u, 0, 0U, 1U, 0U, 1, 12), false);
  sf_mex_setcell(c6_y, 0, c6_b_y);
  c6_hoistedGlobal = chartInstance->c6_is_active_c6_dIPC;
  ...
  mxArray *c6_st)
{
  ...
  for (c6_i1 = 0; c6_i1 < 12; c6_i1++) {
    (*chartInstance->c6_b)[c6_i1] = c6_dv0[c6_i1];
  }

  chartInstance->c6_is_active_c6_dIPC = c6_h_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c6_u, 1)), "is_active_c6_dIPC");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_dIPC(chartInstance);
...
static void sf_gateway_c6_dIPC(SFc6_dIPCInstanceStruct *chartInstance)
{
  ...
  for (c6_i2 = 0; c6_i2 < 12; c6_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c6_dx)[c6_i2], 0U);
  }

  chartInstance->c6_sfEvent = CALL_EVENT;
  c6_chartstep_c6_dIPC(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_dIPCMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c6_i3 = 0; c6_i3 < 12; c6_i3++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c6_b)[c6_i3], 1U);
  }

  for (c6_i4 = 0; c6_i4 < 14; c6_i4++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c6_x)[c6_i4], 2U);
  }

  for (c6_i5 = 0; c6_i5 < 6; c6_i5++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c6_r)[c6_i5], 3U);
  }
}
...
static void c6_chartstep_c6_dIPC(SFc6_dIPCInstanceStruct *chartInstance)
{
  ...
  for (c6_i6 = 0; c6_i6 < 12; c6_i6++) {
    c6_b_dx[c6_i6] = (*chartInstance->c6_dx)[c6_i6];
  }

  for (c6_i7 = 0; c6_i7 < 14; c6_i7++) {
    c6_b_x[c6_i7] = (*chartInstance->c6_x)[c6_i7];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(c6_b_x, 3U, c6_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c6_b_r, 4U, c6_b_sf_marshallOut);
  ...
  for (c6_i11 = 0; c6_i11 < 3; c6_i11++) {
    ...
    for (c6_i13 = 0; c6_i13 < 3; c6_i13++) {
      c6_y[c6_i12 + c6_i11] = 0.0;
      c6_i14 = 0;
      for (c6_i15 = 0; c6_i15 < 3; c6_i15++) {
        c6_y[c6_i12 + c6_i11] += c6_a[c6_i14 + c6_i11] * c6_c_b[c6_i15 + c6_i12];
        c6_i14 += 3;
      }
  ...
  for (c6_i16 = 0; c6_i16 < 4; c6_i16++) {
    c6_c_x[c6_i16] = c6_b_x[c6_i16 + 3];
  }

  for (c6_i17 = 0; c6_i17 < 3; c6_i17++) {
    c6_c_r[c6_i17] = c6_b_r[c6_i17];
  }
  ...
  for (c6_i18 = 0; c6_i18 < 3; c6_i18++) {
    ...
    for (c6_i20 = 0; c6_i20 < 3; c6_i20++) {
      c6_b_y[c6_i18] += c6_y[c6_i19 + c6_i18] * c6_d_b[c6_i20];
      c6_i19 += 3;
    }
  }

  for (c6_i21 = 0; c6_i21 < 3; c6_i21++) {
    c6_d_x[c6_i21] = c6_b_dx[c6_i21 + 3];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_b_nargout, 1U, c6_d_sf_marshallOut,
    c6_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c6_d_x, 2U, c6_f_sf_marshallOut,
    c6_d_sf_marshallIn);
  ...
  c6_quatrot(chartInstance, c6_e_x, c6_d_r, c6_d_b);
  c6_b_eml_scalar_eg(chartInstance);
  c6_b_eml_scalar_eg(chartInstance);
  c6_threshold(chartInstance);
  ...
  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c6_i38 = 0; c6_i38 < 12; c6_i38++) {
    (*chartInstance->c6_b)[c6_i38] = c6_b_b[c6_i38];
  }
  ...
  real_T c6_b_r[3], real_T c6_rw[3])
{
  ...
  for (c6_i40 = 0; c6_i40 < 3; c6_i40++) {
    c6_dv1[c6_i40 + 1] = c6_b_r[c6_i40];
  }

  for (c6_i41 = 0; c6_i41 < 4; c6_i41++) {
    c6_c_q[c6_i41] = c6_b_q[c6_i41];
  }

  c6_quatmultiply(chartInstance, c6_dv1, c6_c_q, c6_dv2);
  for (c6_i42 = 0; c6_i42 < 4; c6_i42++) {
    c6_d_q[c6_i42] = c6_q[c6_i42];
  }

  for (c6_i43 = 0; c6_i43 < 4; c6_i43++) {
    c6_dv3[c6_i43] = c6_dv2[c6_i43];
  }

  c6_quatmultiply(chartInstance, c6_d_q, c6_dv3, c6_b_q);
  for (c6_i44 = 0; c6_i44 < 4; c6_i44++) {
    c6_rwq[c6_i44] = c6_b_q[c6_i44];
  }

  _SFD_SCRIPT_CALL(1U, chartInstance->c6_sfEvent, 5);
  for (c6_i45 = 0; c6_i45 < 3; c6_i45++) {
    c6_rw[c6_i45] = c6_rwq[c6_i45 + 1];
  }
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  real_T c6_u[12];
  const mxArray *c6_y = NULL;
  SFc6_dIPCInstanceStruct *chartInstance;
  chartInstance = (SFc6_dIPCInstanceStruct *)chartInstanceVoid;
  c6_mxArrayOutData = NULL;
  for (c6_i46 = 0; c6_i46 < 12; c6_i46++) {
    c6_b_inData[c6_i46] = (*(real_T (*)[12])c6_inData)[c6_i46];
  }

  for (c6_i47 = 0; c6_i47 < 12; c6_i47++) {
    c6_u[c6_i47] = c6_b_inData[c6_i47];
  }
  ...
  mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[12])
{
  ...
  int32_T c6_i48;
  (void)chartInstance;
  sf_mex_import(c6_parentId, sf_mex_dup(c6_u), c6_dv4, 1, 0, 0U, 1, 0U, 1, 12);
  for (c6_i48 = 0; c6_i48 < 12; c6_i48++) {
    c6_y[c6_i48] = c6_dv4[c6_i48];
  }
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  for (c6_i49 = 0; c6_i49 < 12; c6_i49++) {
    (*(real_T (*)[12])c6_outData)[c6_i49] = c6_y[c6_i49];
  }
  ...
  *c6_inData)
{
  ...
  for (c6_i50 = 0; c6_i50 < 6; c6_i50++) {
    c6_b_inData[c6_i50] = (*(real_T (*)[6])c6_inData)[c6_i50];
  }
  ...
  *c6_inData)
{
  ...
  chartInstance = (SFc6_dIPCInstanceStruct *)chartInstanceVoid;
  c6_mxArrayOutData = NULL;
  for (c6_i52 = 0; c6_i52 < 14; c6_i52++) {
    c6_b_inData[c6_i52] = (*(real_T (*)[14])c6_inData)[c6_i52];
  }

  for (c6_i53 = 0; c6_i53 < 14; c6_i53++) {
    c6_u[c6_i53] = c6_b_inData[c6_i53];
  }

  c6_y = NULL;
  sf_mex_assign(&c6_y, sf_mex_create("y", c6_u, 0, 0U, 1U, 0U, 1, 14), false);
  sf_mex_assign(&c6_mxArrayOutData, c6_y, false);
  return c6_mxArrayOutData;
}
  ...
  *c6_inData)
{
  ...
  for (c6_i55 = 0; c6_i55 < 3; c6_i55++) {
    for (c6_i56 = 0; c6_i56 < 3; c6_i56++) {
      c6_b_inData[c6_i56 + c6_i54] = (*(real_T (*)[9])c6_inData)[c6_i56 + c6_i54];
    }
  ...
  mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[9])
{
  ...
  for (c6_i60 = 0; c6_i60 < 9; c6_i60++) {
    c6_y[c6_i60] = c6_dv5[c6_i60];
  }
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  c6_thisId.fIdentifier = c6_identifier;
  c6_thisId.fParent = NULL;
  c6_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_X), &c6_thisId, c6_y);
  sf_mex_destroy(&c6_X);
  c6_i61 = 0;
  for (c6_i62 = 0; c6_i62 < 3; c6_i62++) {
    for (c6_i63 = 0; c6_i63 < 3; c6_i63++) {
      (*(real_T (*)[9])c6_outData)[c6_i63 + c6_i61] = c6_y[c6_i63 + c6_i61];
    }
  ...
  *c6_inData)
{
  ...
  for (c6_i64 = 0; c6_i64 < 3; c6_i64++) {
    c6_b_inData[c6_i64] = (*(real_T (*)[3])c6_inData)[c6_i64];
  }

  for (c6_i65 = 0; c6_i65 < 3; c6_i65++) {
    c6_u[c6_i65] = c6_b_inData[c6_i65];
  }
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  c6_thisId.fIdentifier = c6_identifier;
  c6_thisId.fParent = NULL;
  c6_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_b_x), &c6_thisId, c6_y);
  sf_mex_destroy(&c6_b_x);
  for (c6_i67 = 0; c6_i67 < 3; c6_i67++) {
    (*(real_T (*)[3])c6_outData)[c6_i67] = c6_y[c6_i67];
  }
  ...
  *c6_inData)
{
  ...
  for (c6_i68 = 0; c6_i68 < 4; c6_i68++) {
    c6_b_inData[c6_i68] = (*(real_T (*)[4])c6_inData)[c6_i68];
  }
  ...
  mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[4])
{
  ...
  int32_T c6_i70;
  (void)chartInstance;
  sf_mex_import(c6_parentId, sf_mex_dup(c6_u), c6_dv7, 1, 0, 0U, 1, 0U, 1, 4);
  for (c6_i70 = 0; c6_i70 < 4; c6_i70++) {
    c6_y[c6_i70] = c6_dv7[c6_i70];
  }
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  c6_thisId.fIdentifier = c6_identifier;
  c6_thisId.fParent = NULL;
  c6_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_q), &c6_thisId, c6_y);
  sf_mex_destroy(&c6_q);
  for (c6_i71 = 0; c6_i71 < 4; c6_i71++) {
    (*(real_T (*)[4])c6_outData)[c6_i71] = c6_y[c6_i71];
  }

  sf_mex_destroy(&c6_mxArrayInData);
}

const mxArray *sf_c6_dIPC_get_eml_resolved_functions_info(void)
{
...
static void c6_info_helper(const mxArray **c6_info)
{
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/IPC 2M/skew_sm.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1460657806U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId)
{
  ...
  int32_T c6_i72;
  (void)chartInstance;
  sf_mex_import(c6_parentId, sf_mex_dup(c6_u), &c6_i72, 1, 6, 0U, 0, 0U, 0);
  c6_y = c6_i72;
  sf_mex_destroy(&c6_u);
  return c6_y;
}
  ...
  const mxArray *c6_b_is_active_c6_dIPC, const char_T *c6_identifier)
{
  ...
  c6_thisId.fIdentifier = c6_identifier;
  c6_thisId.fParent = NULL;
  c6_y = c6_i_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_b_is_active_c6_dIPC),
    &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_dIPC);
  return c6_y;
}
...
static void init_simulink_io_address(SFc6_dIPCInstanceStruct *chartInstance)
{
  chartInstance->c6_dx = (real_T (*)[12])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c6_b = (real_T (*)[12])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c6_x = (real_T (*)[14])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c6_r = (real_T (*)[6])ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
}
...
void sf_c6_dIPC_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3896566472U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(386354047U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(440934221U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(847882253U);
}

mxArray* sf_c6_dIPC_get_post_codegen_info(void);
mxArray *sf_c6_dIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("4K0B5UjRfMoItnY7Zt6cJF");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c6_dIPC_get_post_codegen_info();
...
mxArray *sf_c6_dIPC_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_dIPC_jit_fallback_info(void)
{
...
mxArray *sf_c6_dIPC_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c6_dIPC(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"b\",},{M[8],M[0],T\"is_active_c6_dIPC\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_dIPC_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_dIPCInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(2U, *chartInstance->c6_x);
        _SFD_SET_DATA_VALUE_PTR(3U, *chartInstance->c6_r);
      }
    } else {
...
{
  return "yR2T7NgF1hTzOnO1lz13NG";
}

static void sf_opaque_initialize_c6_dIPC(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_dIPCInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c6_dIPC((SFc6_dIPCInstanceStruct*) chartInstanceVar);
  initialize_c6_dIPC((SFc6_dIPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_dIPC(void *chartInstanceVar)
{
  enable_c6_dIPC((SFc6_dIPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_dIPC(void *chartInstanceVar)
{
  disable_c6_dIPC((SFc6_dIPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_dIPC(void *chartInstanceVar)
{
  sf_gateway_c6_dIPC((SFc6_dIPCInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c6_dIPC(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c6_dIPC((SFc6_dIPCInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c6_dIPC(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c6_dIPC((SFc6_dIPCInstanceStruct*)chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c6_dIPC(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_dIPCInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_dIPC((SFc6_dIPCInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_dIPC((SFc6_dIPCInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_dIPC(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c6_dIPC((SFc6_dIPCInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c6_dIPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(4254240581U));
  ssSetChecksum1(S,(2794464038U));
  ssSetChecksum2(S,(3824596243U));
  ssSetChecksum3(S,(1866261881U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c6_dIPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_dIPC(SimStruct *S)
{
  SFc6_dIPCInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_dIPCInstanceStruct *)utMalloc(sizeof
    (SFc6_dIPCInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_dIPCInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c6_dIPC;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c6_dIPC;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c6_dIPC;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_dIPC;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_dIPC;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c6_dIPC;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c6_dIPC;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c6_dIPC;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_dIPC;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_dIPC;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_dIPC;
...
void c6_dIPC_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_dIPC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_dIPC(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_dIPC_method_dispatcher.\n"
