...
static void c31_emlrt_marshallIn(SFc31_dIPCInstanceStruct *chartInstance, const
  mxArray *c31_b_bred, const char_T *c31_identifier, real_T c31_y[6]);
static void c31_b_emlrt_marshallIn(SFc31_dIPCInstanceStruct *chartInstance,
  const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId, real_T c31_y[6]);
...
static const mxArray *c31_d_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static real_T c31_c_emlrt_marshallIn(SFc31_dIPCInstanceStruct *chartInstance,
...
static const mxArray *c31_e_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_d_emlrt_marshallIn(SFc31_dIPCInstanceStruct *chartInstance,
...
static const mxArray *c31_h_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static int32_T c31_g_emlrt_marshallIn(SFc31_dIPCInstanceStruct *chartInstance,
  const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
static void c31_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData);
static uint8_T c31_h_emlrt_marshallIn(SFc31_dIPCInstanceStruct *chartInstance,
  ...
  *chartInstance)
{
  ...
  for (c31_i0 = 0; c31_i0 < 6; c31_i0++) {
    c31_u[c31_i0] = (*chartInstance->c31_bred)[c31_i0];
  }

  c31_b_y = NULL;
  sf_mex_assign(&c31_b_y, sf_mex_create("y", c31_u, 0, 0U, 1U, 0U, 1, 6), false);
  ...
  const mxArray *c31_st)
{
  ...
  c31_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c31_u, 0)),
                       "bred", c31_dv0);
  for (c31_i1 = 0; c31_i1 < 6; c31_i1++) {
    (*chartInstance->c31_bred)[c31_i1] = c31_dv0[c31_i1];
  }

  chartInstance->c31_is_active_c31_dIPC = c31_h_emlrt_marshallIn(chartInstance,
...
static void sf_gateway_c31_dIPC(SFc31_dIPCInstanceStruct *chartInstance)
{
  ...
  for (c31_i2 = 0; c31_i2 < 6; c31_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c31_r)[c31_i2], 0U);
  }

  for (c31_i3 = 0; c31_i3 < 14; c31_i3++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c31_x)[c31_i3], 1U);
  }
  ...
  for (c31_i4 = 0; c31_i4 < 6; c31_i4++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c31_bred)[c31_i4], 2U);
  }

  for (c31_i5 = 0; c31_i5 < 12; c31_i5++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c31_dx)[c31_i5], 3U);
  }
}
...
static void c31_chartstep_c31_dIPC(SFc31_dIPCInstanceStruct *chartInstance)
{
  ...
  for (c31_i6 = 0; c31_i6 < 6; c31_i6++) {
    c31_b_r[c31_i6] = (*chartInstance->c31_r)[c31_i6];
  }

  for (c31_i7 = 0; c31_i7 < 14; c31_i7++) {
    c31_b_x[c31_i7] = (*chartInstance->c31_x)[c31_i7];
  }

  for (c31_i8 = 0; c31_i8 < 12; c31_i8++) {
    c31_b_dx[c31_i8] = (*chartInstance->c31_dx)[c31_i8];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 6U, 6U, c31_debug_family_names,
    c31_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c31_nargin, 0U, c31_d_sf_marshallOut,
    c31_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c31_nargout, 1U, c31_d_sf_marshallOut,
    c31_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c31_b_r, 2U, c31_sf_marshallOut);
  ...
  for (c31_i11 = 0; c31_i11 < 3; c31_i11++) {
    ...
    for (c31_i13 = 0; c31_i13 < 3; c31_i13++) {
      c31_y[c31_i12 + c31_i11] = 0.0;
      c31_i14 = 0;
      for (c31_i15 = 0; c31_i15 < 3; c31_i15++) {
        c31_y[c31_i12 + c31_i11] += c31_a[c31_i14 + c31_i11] * c31_b[c31_i15 +
          c31_i12];
        c31_i14 += 3;
      }
  ...
  for (c31_i16 = 0; c31_i16 < 4; c31_i16++) {
    c31_q[c31_i16] = c31_b_x[c31_i16 + 3];
  }

  for (c31_i17 = 0; c31_i17 < 3; c31_i17++) {
    c31_c_r[c31_i17] = c31_b_r[c31_i17 + 3] - c31_b_r[c31_i17];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 6U, 6U, c31_c_debug_family_names,
    c31_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c31_rwq, 0U, c31_g_sf_marshallOut,
    c31_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c31_b_nargin, 1U, c31_d_sf_marshallOut,
    c31_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c31_b_nargout, 2U, c31_d_sf_marshallOut,
    c31_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c31_q, 3U, c31_g_sf_marshallOut,
    c31_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c31_c_r, 4U, c31_f_sf_marshallOut,
    c31_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c31_rw, 5U, c31_f_sf_marshallOut,
    c31_d_sf_marshallIn);
  CV_SCRIPT_FCN(1, 0);
  _SFD_SCRIPT_CALL(1U, chartInstance->c31_sfEvent, 4);
  for (c31_i18 = 0; c31_i18 < 4; c31_i18++) {
    c31_b_q[c31_i18] = c31_q[c31_i18];
  }
  ...
  for (c31_i19 = 0; c31_i19 < 3; c31_i19++) {
    c31_dv1[c31_i19 + 1] = c31_c_r[c31_i19];
  }

  for (c31_i20 = 0; c31_i20 < 4; c31_i20++) {
    c31_c_q[c31_i20] = c31_b_q[c31_i20];
  }

  c31_quatmultiply(chartInstance, c31_dv1, c31_c_q, c31_dv2);
  for (c31_i21 = 0; c31_i21 < 4; c31_i21++) {
    c31_d_q[c31_i21] = c31_q[c31_i21];
  }

  for (c31_i22 = 0; c31_i22 < 4; c31_i22++) {
    c31_dv3[c31_i22] = c31_dv2[c31_i22];
  }

  c31_quatmultiply(chartInstance, c31_d_q, c31_dv3, c31_b_q);
  for (c31_i23 = 0; c31_i23 < 4; c31_i23++) {
    c31_rwq[c31_i23] = c31_b_q[c31_i23];
  }

  _SFD_SCRIPT_CALL(1U, chartInstance->c31_sfEvent, 5);
  for (c31_i24 = 0; c31_i24 < 3; c31_i24++) {
    c31_rw[c31_i24] = c31_rwq[c31_i24 + 1];
  }

  _SFD_SCRIPT_CALL(1U, chartInstance->c31_sfEvent, -5);
  _SFD_SYMBOL_SCOPE_POP();
  for (c31_i25 = 0; c31_i25 < 3; c31_i25++) {
    c31_b_b[c31_i25] = c31_rw[c31_i25];
  }
  ...
  for (c31_i26 = 0; c31_i26 < 3; c31_i26++) {
    ...
    for (c31_i28 = 0; c31_i28 < 3; c31_i28++) {
      c31_b_y[c31_i26] += c31_y[c31_i27 + c31_i26] * c31_b_b[c31_i28];
      c31_i27 += 3;
    }
  }

  for (c31_i29 = 0; c31_i29 < 3; c31_i29++) {
    c31_b_bred[c31_i29] = c31_b_y[c31_i29];
  }

  for (c31_i30 = 0; c31_i30 < 3; c31_i30++) {
    c31_b_bred[c31_i30 + 3] = 0.0;
  }

  _SFD_EML_CALL(0U, chartInstance->c31_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c31_i31 = 0; c31_i31 < 6; c31_i31++) {
    (*chartInstance->c31_bred)[c31_i31] = c31_b_bred[c31_i31];
  }
  ...
  [3], real_T c31_X[9])
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c31_nargout, 1U, c31_d_sf_marshallOut,
    c31_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c31_b_x, 2U, c31_f_sf_marshallOut,
    c31_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c31_X, 3U, c31_e_sf_marshallOut,
    c31_c_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  ...
  *c31_inData)
{
  ...
  for (c31_i32 = 0; c31_i32 < 6; c31_i32++) {
    c31_b_inData[c31_i32] = (*(real_T (*)[6])c31_inData)[c31_i32];
  }

  for (c31_i33 = 0; c31_i33 < 6; c31_i33++) {
    c31_u[c31_i33] = c31_b_inData[c31_i33];
  }

  c31_y = NULL;
  sf_mex_assign(&c31_y, sf_mex_create("y", c31_u, 0, 0U, 1U, 0U, 1, 6), false);
  ...
  const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId, real_T c31_y[6])
{
  ...
  int32_T c31_i34;
  (void)chartInstance;
  sf_mex_import(c31_parentId, sf_mex_dup(c31_u), c31_dv4, 1, 0, 0U, 1, 0U, 1, 6);
  for (c31_i34 = 0; c31_i34 < 6; c31_i34++) {
    c31_y[c31_i34] = c31_dv4[c31_i34];
  }
  ...
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData)
{
  ...
  c31_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c31_b_bred), &c31_thisId,
    c31_y);
  sf_mex_destroy(&c31_b_bred);
  for (c31_i35 = 0; c31_i35 < 6; c31_i35++) {
    (*(real_T (*)[6])c31_outData)[c31_i35] = c31_y[c31_i35];
  }
  ...
  *c31_inData)
{
  ...
  chartInstance = (SFc31_dIPCInstanceStruct *)chartInstanceVoid;
  c31_mxArrayOutData = NULL;
  for (c31_i36 = 0; c31_i36 < 12; c31_i36++) {
    c31_b_inData[c31_i36] = (*(real_T (*)[12])c31_inData)[c31_i36];
  }

  for (c31_i37 = 0; c31_i37 < 12; c31_i37++) {
    c31_u[c31_i37] = c31_b_inData[c31_i37];
  }
  ...
  *c31_inData)
{
  ...
  chartInstance = (SFc31_dIPCInstanceStruct *)chartInstanceVoid;
  c31_mxArrayOutData = NULL;
  for (c31_i38 = 0; c31_i38 < 14; c31_i38++) {
    c31_b_inData[c31_i38] = (*(real_T (*)[14])c31_inData)[c31_i38];
  }

  for (c31_i39 = 0; c31_i39 < 14; c31_i39++) {
    c31_u[c31_i39] = c31_b_inData[c31_i39];
  }

  c31_y = NULL;
  sf_mex_assign(&c31_y, sf_mex_create("y", c31_u, 0, 0U, 1U, 0U, 1, 14), false);
  sf_mex_assign(&c31_mxArrayOutData, c31_y, false);
  return c31_mxArrayOutData;
}
  ...
  *c31_inData)
{
  ...
  for (c31_i41 = 0; c31_i41 < 3; c31_i41++) {
    for (c31_i42 = 0; c31_i42 < 3; c31_i42++) {
      c31_b_inData[c31_i42 + c31_i40] = (*(real_T (*)[9])c31_inData)[c31_i42 +
        c31_i40];
    }
  ...
  for (c31_i44 = 0; c31_i44 < 3; c31_i44++) {
    for (c31_i45 = 0; c31_i45 < 3; c31_i45++) {
      c31_u[c31_i45 + c31_i43] = c31_b_inData[c31_i45 + c31_i43];
    }
  ...
  const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId, real_T c31_y[9])
{
  ...
  int32_T c31_i46;
  (void)chartInstance;
  sf_mex_import(c31_parentId, sf_mex_dup(c31_u), c31_dv5, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c31_i46 = 0; c31_i46 < 9; c31_i46++) {
    c31_y[c31_i46] = c31_dv5[c31_i46];
  }
  ...
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData)
{
  ...
  c31_thisId.fIdentifier = c31_identifier;
  c31_thisId.fParent = NULL;
  c31_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c31_X), &c31_thisId, c31_y);
  sf_mex_destroy(&c31_X);
  c31_i47 = 0;
  for (c31_i48 = 0; c31_i48 < 3; c31_i48++) {
    for (c31_i49 = 0; c31_i49 < 3; c31_i49++) {
      (*(real_T (*)[9])c31_outData)[c31_i49 + c31_i47] = c31_y[c31_i49 + c31_i47];
    }
  ...
  *c31_inData)
{
  ...
  for (c31_i50 = 0; c31_i50 < 3; c31_i50++) {
    c31_b_inData[c31_i50] = (*(real_T (*)[3])c31_inData)[c31_i50];
  }

  for (c31_i51 = 0; c31_i51 < 3; c31_i51++) {
    c31_u[c31_i51] = c31_b_inData[c31_i51];
  }
  ...
  const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId, real_T c31_y[3])
{
  ...
  int32_T c31_i52;
  (void)chartInstance;
  sf_mex_import(c31_parentId, sf_mex_dup(c31_u), c31_dv6, 1, 0, 0U, 1, 0U, 1, 3);
  for (c31_i52 = 0; c31_i52 < 3; c31_i52++) {
    c31_y[c31_i52] = c31_dv6[c31_i52];
  }
  ...
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData)
{
  ...
  c31_thisId.fIdentifier = c31_identifier;
  c31_thisId.fParent = NULL;
  c31_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c31_b_x), &c31_thisId, c31_y);
  sf_mex_destroy(&c31_b_x);
  for (c31_i53 = 0; c31_i53 < 3; c31_i53++) {
    (*(real_T (*)[3])c31_outData)[c31_i53] = c31_y[c31_i53];
  }
  ...
  *c31_inData)
{
  ...
  for (c31_i54 = 0; c31_i54 < 4; c31_i54++) {
    c31_b_inData[c31_i54] = (*(real_T (*)[4])c31_inData)[c31_i54];
  }

  for (c31_i55 = 0; c31_i55 < 4; c31_i55++) {
    c31_u[c31_i55] = c31_b_inData[c31_i55];
  }
  ...
  const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId, real_T c31_y[4])
{
  ...
  int32_T c31_i56;
  (void)chartInstance;
  sf_mex_import(c31_parentId, sf_mex_dup(c31_u), c31_dv7, 1, 0, 0U, 1, 0U, 1, 4);
  for (c31_i56 = 0; c31_i56 < 4; c31_i56++) {
    c31_y[c31_i56] = c31_dv7[c31_i56];
  }
  ...
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData)
{
  ...
  c31_thisId.fIdentifier = c31_identifier;
  c31_thisId.fParent = NULL;
  c31_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c31_q), &c31_thisId, c31_y);
  sf_mex_destroy(&c31_q);
  for (c31_i57 = 0; c31_i57 < 4; c31_i57++) {
    (*(real_T (*)[4])c31_outData)[c31_i57] = c31_y[c31_i57];
  }
  ...
  const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId)
{
  ...
  int32_T c31_i58;
  (void)chartInstance;
  sf_mex_import(c31_parentId, sf_mex_dup(c31_u), &c31_i58, 1, 6, 0U, 0, 0U, 0);
  c31_y = c31_i58;
  sf_mex_destroy(&c31_u);
  return c31_y;
}
  ...
  const mxArray *c31_b_is_active_c31_dIPC, const char_T *c31_identifier)
{
  ...
  c31_thisId.fIdentifier = c31_identifier;
  c31_thisId.fParent = NULL;
  c31_y = c31_i_emlrt_marshallIn(chartInstance, sf_mex_dup
...
static void init_simulink_io_address(SFc31_dIPCInstanceStruct *chartInstance)
{
  chartInstance->c31_r = (real_T (*)[6])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c31_x = (real_T (*)[14])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c31_bred = (real_T (*)[6])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c31_dx = (real_T (*)[12])ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1061056801U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(345057185U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3706869647U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4136833984U);
}
...
mxArray *sf_c31_dIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("W7lRsLfFQlRu0IYOaijg9C");
...
static void mdlSetWorkWidths_c31_dIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(140253188U));
  ssSetChecksum1(S,(3303263860U));
  ssSetChecksum2(S,(2077881313U));
  ssSetChecksum3(S,(1405934164U));
