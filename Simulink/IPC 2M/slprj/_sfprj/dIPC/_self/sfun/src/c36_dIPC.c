...
static const char * c36_debug_family_names[5] = { "nargin", "nargout", "x", "r",
  "G" };
...
static const mxArray *c36_d_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static real_T c36_c_emlrt_marshallIn(SFc36_dIPCInstanceStruct *chartInstance,
...
static const mxArray *c36_e_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_d_emlrt_marshallIn(SFc36_dIPCInstanceStruct *chartInstance,
...
static const mxArray *c36_h_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static int32_T c36_g_emlrt_marshallIn(SFc36_dIPCInstanceStruct *chartInstance,
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void c36_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData);
static uint8_T c36_h_emlrt_marshallIn(SFc36_dIPCInstanceStruct *chartInstance,
  ...
  *chartInstance)
{
  ...
  for (c36_i0 = 0; c36_i0 < 72; c36_i0++) {
    c36_u[c36_i0] = (*chartInstance->c36_G)[c36_i0];
  }
  ...
  const mxArray *c36_st)
{
  ...
  for (c36_i1 = 0; c36_i1 < 72; c36_i1++) {
    (*chartInstance->c36_G)[c36_i1] = c36_dv0[c36_i1];
  }

  chartInstance->c36_is_active_c36_dIPC = c36_h_emlrt_marshallIn(chartInstance,
...
static void sf_gateway_c36_dIPC(SFc36_dIPCInstanceStruct *chartInstance)
{
  ...
  for (c36_i2 = 0; c36_i2 < 14; c36_i2++) {
    c36_b_x[c36_i2] = (*chartInstance->c36_x)[c36_i2];
  }

  for (c36_i3 = 0; c36_i3 < 6; c36_i3++) {
    c36_b_r[c36_i3] = (*chartInstance->c36_r)[c36_i3];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c36_nargout, 1U, c36_d_sf_marshallOut,
    c36_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c36_b_x, 2U, c36_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c36_b_r, 3U, c36_b_sf_marshallOut);
  ...
  for (c36_i4 = 0; c36_i4 < 4; c36_i4++) {
    c36_c_x[c36_i4] = c36_b_x[c36_i4 + 3];
  }

  for (c36_i5 = 0; c36_i5 < 3; c36_i5++) {
    c36_c_r[c36_i5] = c36_b_r[c36_i5];
  }

  c36_quatrot(chartInstance, c36_c_x, c36_c_r, c36_dv1);
  for (c36_i6 = 0; c36_i6 < 3; c36_i6++) {
    c36_d_x[c36_i6] = c36_dv1[c36_i6];
  }
  ...
  for (c36_i7 = 0; c36_i7 < 4; c36_i7++) {
    c36_e_x[c36_i7] = c36_b_x[c36_i7 + 3];
  }

  for (c36_i8 = 0; c36_i8 < 3; c36_i8++) {
    c36_d_r[c36_i8] = c36_b_r[c36_i8 + 3];
  }

  c36_quatrot(chartInstance, c36_e_x, c36_d_r, c36_dv2);
  for (c36_i9 = 0; c36_i9 < 3; c36_i9++) {
    c36_f_x[c36_i9] = c36_dv2[c36_i9];
  }
  ...
  for (c36_i15 = 0; c36_i15 < 3; c36_i15++) {
    for (c36_i16 = 0; c36_i16 < 3; c36_i16++) {
      c36_b_G[(c36_i16 + c36_i14) + 18] = 0.0;
    }
  ...
  for (c36_i19 = 0; c36_i19 < 3; c36_i19++) {
    for (c36_i20 = 0; c36_i20 < 3; c36_i20++) {
      c36_b_G[(c36_i20 + c36_i17) + 36] = c36_dv4[c36_i20 + c36_i18];
    }
  ...
  for (c36_i22 = 0; c36_i22 < 3; c36_i22++) {
    for (c36_i23 = 0; c36_i23 < 3; c36_i23++) {
      c36_b_G[(c36_i23 + c36_i21) + 54] = 0.0;
    }
  ...
  for (c36_i26 = 0; c36_i26 < 3; c36_i26++) {
    for (c36_i27 = 0; c36_i27 < 3; c36_i27++) {
      c36_b_G[(c36_i27 + c36_i24) + 3] = c36_X[c36_i27 + c36_i25];
    }
  ...
  for (c36_i30 = 0; c36_i30 < 3; c36_i30++) {
    for (c36_i31 = 0; c36_i31 < 3; c36_i31++) {
      c36_b_G[(c36_i31 + c36_i28) + 21] = c36_dv5[c36_i31 + c36_i29];
    }
  ...
  for (c36_i34 = 0; c36_i34 < 3; c36_i34++) {
    for (c36_i35 = 0; c36_i35 < 3; c36_i35++) {
      c36_b_G[(c36_i35 + c36_i32) + 39] = c36_b_X[c36_i35 + c36_i33];
    }
  ...
  for (c36_i38 = 0; c36_i38 < 3; c36_i38++) {
    for (c36_i39 = 0; c36_i39 < 3; c36_i39++) {
      c36_b_G[(c36_i39 + c36_i36) + 57] = c36_dv6[c36_i39 + c36_i37];
    }
  ...
  _SFD_EML_CALL(0U, chartInstance->c36_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c36_i40 = 0; c36_i40 < 72; c36_i40++) {
    (*chartInstance->c36_G)[c36_i40] = c36_b_G[c36_i40];
  }
  ...
  for (c36_i41 = 0; c36_i41 < 72; c36_i41++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c36_G)[c36_i41], 0U);
  }

  for (c36_i42 = 0; c36_i42 < 14; c36_i42++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c36_x)[c36_i42], 1U);
  }

  for (c36_i43 = 0; c36_i43 < 6; c36_i43++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c36_r)[c36_i43], 2U);
  }
}
  ...
  real_T c36_b_r[3], real_T c36_rw[3])
{
  ...
  for (c36_i44 = 0; c36_i44 < 4; c36_i44++) {
    c36_b_q[c36_i44] = c36_q[c36_i44];
  }
  ...
  for (c36_i45 = 0; c36_i45 < 3; c36_i45++) {
    c36_dv7[c36_i45 + 1] = c36_b_r[c36_i45];
  }

  for (c36_i46 = 0; c36_i46 < 4; c36_i46++) {
    c36_c_q[c36_i46] = c36_b_q[c36_i46];
  }

  c36_quatmultiply(chartInstance, c36_dv7, c36_c_q, c36_dv8);
  for (c36_i47 = 0; c36_i47 < 4; c36_i47++) {
    c36_d_q[c36_i47] = c36_q[c36_i47];
  }

  for (c36_i48 = 0; c36_i48 < 4; c36_i48++) {
    c36_dv9[c36_i48] = c36_dv8[c36_i48];
  }

  c36_quatmultiply(chartInstance, c36_d_q, c36_dv9, c36_b_q);
  for (c36_i49 = 0; c36_i49 < 4; c36_i49++) {
    c36_rwq[c36_i49] = c36_b_q[c36_i49];
  }

  _SFD_SCRIPT_CALL(0U, chartInstance->c36_sfEvent, 5);
  for (c36_i50 = 0; c36_i50 < 3; c36_i50++) {
    c36_rw[c36_i50] = c36_rwq[c36_i50 + 1];
  }
  ...
  *c36_inData)
{
  ...
  c36_i51 = 0;
  for (c36_i52 = 0; c36_i52 < 12; c36_i52++) {
    for (c36_i53 = 0; c36_i53 < 6; c36_i53++) {
      c36_b_inData[c36_i53 + c36_i51] = (*(real_T (*)[72])c36_inData)[c36_i53 +
        c36_i51];
    }
  ...
  c36_i54 = 0;
  for (c36_i55 = 0; c36_i55 < 12; c36_i55++) {
    for (c36_i56 = 0; c36_i56 < 6; c36_i56++) {
      c36_u[c36_i56 + c36_i54] = c36_b_inData[c36_i56 + c36_i54];
    }
  ...
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId, real_T c36_y[72])
{
  ...
  int32_T c36_i57;
  (void)chartInstance;
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), c36_dv10, 1, 0, 0U, 1, 0U, 2, 6,
                12);
  for (c36_i57 = 0; c36_i57 < 72; c36_i57++) {
    c36_y[c36_i57] = c36_dv10[c36_i57];
  }
  ...
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData)
{
  ...
  sf_mex_destroy(&c36_b_G);
  c36_i58 = 0;
  for (c36_i59 = 0; c36_i59 < 12; c36_i59++) {
    for (c36_i60 = 0; c36_i60 < 6; c36_i60++) {
      (*(real_T (*)[72])c36_outData)[c36_i60 + c36_i58] = c36_y[c36_i60 +
        c36_i58];
    }
  ...
  *c36_inData)
{
  ...
  for (c36_i61 = 0; c36_i61 < 6; c36_i61++) {
    c36_b_inData[c36_i61] = (*(real_T (*)[6])c36_inData)[c36_i61];
  }

  for (c36_i62 = 0; c36_i62 < 6; c36_i62++) {
    c36_u[c36_i62] = c36_b_inData[c36_i62];
  }
  ...
  *c36_inData)
{
  ...
  for (c36_i63 = 0; c36_i63 < 14; c36_i63++) {
    c36_b_inData[c36_i63] = (*(real_T (*)[14])c36_inData)[c36_i63];
  }

  for (c36_i64 = 0; c36_i64 < 14; c36_i64++) {
    c36_u[c36_i64] = c36_b_inData[c36_i64];
  }
  ...
  *c36_inData)
{
  ...
  for (c36_i65 = 0; c36_i65 < 3; c36_i65++) {
    c36_b_inData[c36_i65] = (*(real_T (*)[3])c36_inData)[c36_i65];
  }

  for (c36_i66 = 0; c36_i66 < 3; c36_i66++) {
    c36_u[c36_i66] = c36_b_inData[c36_i66];
  }
  ...
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId, real_T c36_y[3])
{
  ...
  int32_T c36_i67;
  (void)chartInstance;
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), c36_dv11, 1, 0, 0U, 1, 0U, 1, 3);
  for (c36_i67 = 0; c36_i67 < 3; c36_i67++) {
    c36_y[c36_i67] = c36_dv11[c36_i67];
  }
  ...
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData)
{
  ...
  c36_thisId.fIdentifier = c36_identifier;
  c36_thisId.fParent = NULL;
  c36_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c36_rw), &c36_thisId, c36_y);
  sf_mex_destroy(&c36_rw);
  for (c36_i68 = 0; c36_i68 < 3; c36_i68++) {
    (*(real_T (*)[3])c36_outData)[c36_i68] = c36_y[c36_i68];
  }
  ...
  *c36_inData)
{
  ...
  chartInstance = (SFc36_dIPCInstanceStruct *)chartInstanceVoid;
  c36_mxArrayOutData = NULL;
  for (c36_i69 = 0; c36_i69 < 4; c36_i69++) {
    c36_b_inData[c36_i69] = (*(real_T (*)[4])c36_inData)[c36_i69];
  }

  for (c36_i70 = 0; c36_i70 < 4; c36_i70++) {
    c36_u[c36_i70] = c36_b_inData[c36_i70];
  }
  ...
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId, real_T c36_y[4])
{
  ...
  int32_T c36_i71;
  (void)chartInstance;
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), c36_dv12, 1, 0, 0U, 1, 0U, 1, 4);
  for (c36_i71 = 0; c36_i71 < 4; c36_i71++) {
    c36_y[c36_i71] = c36_dv12[c36_i71];
  }
  ...
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData)
{
  ...
  c36_thisId.fIdentifier = c36_identifier;
  c36_thisId.fParent = NULL;
  c36_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c36_q), &c36_thisId, c36_y);
  sf_mex_destroy(&c36_q);
  for (c36_i72 = 0; c36_i72 < 4; c36_i72++) {
    (*(real_T (*)[4])c36_outData)[c36_i72] = c36_y[c36_i72];
  }
  ...
  *c36_inData)
{
  ...
  c36_mxArrayOutData = NULL;
  c36_i73 = 0;
  for (c36_i74 = 0; c36_i74 < 3; c36_i74++) {
    for (c36_i75 = 0; c36_i75 < 3; c36_i75++) {
      c36_b_inData[c36_i75 + c36_i73] = (*(real_T (*)[9])c36_inData)[c36_i75 +
        c36_i73];
    }
  ...
  for (c36_i77 = 0; c36_i77 < 3; c36_i77++) {
    for (c36_i78 = 0; c36_i78 < 3; c36_i78++) {
      c36_u[c36_i78 + c36_i76] = c36_b_inData[c36_i78 + c36_i76];
    }
  ...
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId, real_T c36_y[9])
{
  ...
  int32_T c36_i79;
  (void)chartInstance;
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), c36_dv13, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c36_i79 = 0; c36_i79 < 9; c36_i79++) {
    c36_y[c36_i79] = c36_dv13[c36_i79];
  }
  ...
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData)
{
  ...
  c36_thisId.fIdentifier = c36_identifier;
  c36_thisId.fParent = NULL;
  c36_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c36_X), &c36_thisId, c36_y);
  sf_mex_destroy(&c36_X);
  c36_i80 = 0;
  for (c36_i81 = 0; c36_i81 < 3; c36_i81++) {
    for (c36_i82 = 0; c36_i82 < 3; c36_i82++) {
      (*(real_T (*)[9])c36_outData)[c36_i82 + c36_i80] = c36_y[c36_i82 + c36_i80];
    }
  ...
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId)
{
  ...
  int32_T c36_i84;
  (void)chartInstance;
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), &c36_i84, 1, 6, 0U, 0, 0U, 0);
  c36_y = c36_i84;
  sf_mex_destroy(&c36_u);
  return c36_y;
}
...
static void init_simulink_io_address(SFc36_dIPCInstanceStruct *chartInstance)
{
  ...
  chartInstance->c36_x = (real_T (*)[14])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c36_r = (real_T (*)[6])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2918778177U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3881551529U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2642375116U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(831214575U);
}
...
mxArray *sf_c36_dIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("wAa73v7YfEv9js0HE2yUt");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(0U, *chartInstance->c36_G);
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c36_x);
        _SFD_SET_DATA_VALUE_PTR(2U, *chartInstance->c36_r);
      }
    } else {
...
static void mdlSetWorkWidths_c36_dIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2048863051U));
  ssSetChecksum1(S,(4016254555U));
  ssSetChecksum2(S,(2163493119U));
  ssSetChecksum3(S,(2299540501U));
