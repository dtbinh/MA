...
static void c5_emlrt_marshallIn(SFc5_dIPCInstanceStruct *chartInstance, const
  mxArray *c5_b_A, const char_T *c5_identifier, real_T c5_y[216]);
static void c5_b_emlrt_marshallIn(SFc5_dIPCInstanceStruct *chartInstance, const
  mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[216]);
...
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real_T c5_c_emlrt_marshallIn(SFc5_dIPCInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_e_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_d_emlrt_marshallIn(SFc5_dIPCInstanceStruct *chartInstance, const
...
static const mxArray *c5_h_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_g_emlrt_marshallIn(SFc5_dIPCInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_h_emlrt_marshallIn(SFc5_dIPCInstanceStruct *chartInstance,
  ...
  *chartInstance)
{
  ...
  for (c5_i0 = 0; c5_i0 < 216; c5_i0++) {
    c5_u[c5_i0] = (*chartInstance->c5_A)[c5_i0];
  }
  ...
  mxArray *c5_st)
{
  ...
  for (c5_i1 = 0; c5_i1 < 216; c5_i1++) {
    (*chartInstance->c5_A)[c5_i1] = c5_dv0[c5_i1];
  }

  chartInstance->c5_is_active_c5_dIPC = c5_h_emlrt_marshallIn(chartInstance,
...
static void sf_gateway_c5_dIPC(SFc5_dIPCInstanceStruct *chartInstance)
{
  ...
  for (c5_i2 = 0; c5_i2 < 6; c5_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c5_r)[c5_i2], 0U);
  }

  chartInstance->c5_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 3U, chartInstance->c5_sfEvent);
  for (c5_i3 = 0; c5_i3 < 6; c5_i3++) {
    c5_b_r[c5_i3] = (*chartInstance->c5_r)[c5_i3];
  }

  for (c5_i4 = 0; c5_i4 < 14; c5_i4++) {
    c5_b_x[c5_i4] = (*chartInstance->c5_x)[c5_i4];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 1U, c5_d_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c5_b_r, 2U, c5_c_sf_marshallOut);
  ...
  for (c5_i5 = 0; c5_i5 < 4; c5_i5++) {
    c5_c_x[c5_i5] = c5_b_x[c5_i5 + 3];
  }

  for (c5_i6 = 0; c5_i6 < 3; c5_i6++) {
    c5_c_r[c5_i6] = c5_b_r[c5_i6];
  }

  c5_quatrot(chartInstance, c5_c_x, c5_c_r, c5_dv1);
  for (c5_i7 = 0; c5_i7 < 3; c5_i7++) {
    c5_d_x[c5_i7] = c5_dv1[c5_i7];
  }
  ...
  for (c5_i8 = 0; c5_i8 < 4; c5_i8++) {
    c5_e_x[c5_i8] = c5_b_x[c5_i8 + 3];
  }

  for (c5_i9 = 0; c5_i9 < 3; c5_i9++) {
    c5_d_r[c5_i9] = c5_b_r[c5_i9 + 3];
  }

  c5_quatrot(chartInstance, c5_e_x, c5_d_r, c5_dv2);
  for (c5_i10 = 0; c5_i10 < 3; c5_i10++) {
    c5_f_x[c5_i10] = c5_dv2[c5_i10];
  }
  ...
  for (c5_i13 = 0; c5_i13 < 3; c5_i13++) {
    for (c5_i14 = 0; c5_i14 < 3; c5_i14++) {
      c5_b_A[c5_i14 + c5_i11] = -c5_dv3[c5_i14 + c5_i12];
    }
  ...
  for (c5_i17 = 0; c5_i17 < 3; c5_i17++) {
    for (c5_i18 = 0; c5_i18 < 3; c5_i18++) {
      c5_b_A[(c5_i18 + c5_i15) + 36] = c5_X[c5_i18 + c5_i16];
    }
  ...
  for (c5_i21 = 0; c5_i21 < 3; c5_i21++) {
    for (c5_i22 = 0; c5_i22 < 3; c5_i22++) {
      c5_b_A[(c5_i22 + c5_i19) + 72] = c5_dv4[c5_i22 + c5_i20];
    }
  ...
  for (c5_i31 = 0; c5_i31 < 3; c5_i31++) {
    for (c5_i32 = 0; c5_i32 < 3; c5_i32++) {
      c5_b_A[(c5_i32 + c5_i29) + 39] = -c5_dv5[c5_i32 + c5_i30];
    }
  ...
  for (c5_i38 = 0; c5_i38 < 3; c5_i38++) {
    for (c5_i39 = 0; c5_i39 < 3; c5_i39++) {
      c5_b_A[(c5_i39 + c5_i36) + 111] = c5_dv6[c5_i39 + c5_i37];
    }
  ...
  for (c5_i45 = 0; c5_i45 < 3; c5_i45++) {
    for (c5_i46 = 0; c5_i46 < 3; c5_i46++) {
      c5_b_A[(c5_i46 + c5_i43) + 6] = -c5_dv7[c5_i46 + c5_i44];
    }
  ...
  for (c5_i49 = 0; c5_i49 < 3; c5_i49++) {
    for (c5_i50 = 0; c5_i50 < 3; c5_i50++) {
      c5_b_A[(c5_i50 + c5_i47) + 42] = c5_b_X[c5_i50 + c5_i48];
    }
  ...
  for (c5_i56 = 0; c5_i56 < 3; c5_i56++) {
    for (c5_i57 = 0; c5_i57 < 3; c5_i57++) {
      c5_b_A[(c5_i57 + c5_i54) + 150] = c5_dv8[c5_i57 + c5_i55];
    }
  ...
  for (c5_i66 = 0; c5_i66 < 3; c5_i66++) {
    for (c5_i67 = 0; c5_i67 < 3; c5_i67++) {
      c5_b_A[(c5_i67 + c5_i64) + 45] = -c5_dv9[c5_i67 + c5_i65];
    }
  ...
  for (c5_i73 = 0; c5_i73 < 3; c5_i73++) {
    for (c5_i74 = 0; c5_i74 < 3; c5_i74++) {
      c5_b_A[(c5_i74 + c5_i71) + 189] = c5_dv10[c5_i74 + c5_i72];
    }
  ...
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c5_i75 = 0; c5_i75 < 216; c5_i75++) {
    (*chartInstance->c5_A)[c5_i75] = c5_b_A[c5_i75];
  }
  ...
  for (c5_i76 = 0; c5_i76 < 216; c5_i76++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c5_A)[c5_i76], 1U);
  }

  for (c5_i77 = 0; c5_i77 < 14; c5_i77++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c5_x)[c5_i77], 2U);
  }
}
  ...
  real_T c5_b_r[3], real_T c5_rw[3])
{
  ...
  for (c5_i79 = 0; c5_i79 < 3; c5_i79++) {
    c5_dv11[c5_i79 + 1] = c5_b_r[c5_i79];
  }

  for (c5_i80 = 0; c5_i80 < 4; c5_i80++) {
    c5_c_q[c5_i80] = c5_b_q[c5_i80];
  }

  c5_quatmultiply(chartInstance, c5_dv11, c5_c_q, c5_dv12);
  for (c5_i81 = 0; c5_i81 < 4; c5_i81++) {
    c5_d_q[c5_i81] = c5_q[c5_i81];
  }

  for (c5_i82 = 0; c5_i82 < 4; c5_i82++) {
    c5_dv13[c5_i82] = c5_dv12[c5_i82];
  }

  c5_quatmultiply(chartInstance, c5_d_q, c5_dv13, c5_b_q);
  for (c5_i83 = 0; c5_i83 < 4; c5_i83++) {
    c5_rwq[c5_i83] = c5_b_q[c5_i83];
  }

  _SFD_SCRIPT_CALL(0U, chartInstance->c5_sfEvent, 5);
  for (c5_i84 = 0; c5_i84 < 3; c5_i84++) {
    c5_rw[c5_i84] = c5_rwq[c5_i84 + 1];
  }
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  c5_i85 = 0;
  for (c5_i86 = 0; c5_i86 < 18; c5_i86++) {
    for (c5_i87 = 0; c5_i87 < 12; c5_i87++) {
      c5_b_inData[c5_i87 + c5_i85] = (*(real_T (*)[216])c5_inData)[c5_i87 +
        c5_i85];
    }
  ...
  mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[216])
{
  ...
  int32_T c5_i91;
  (void)chartInstance;
  sf_mex_import(c5_parentId, sf_mex_dup(c5_u), c5_dv14, 1, 0, 0U, 1, 0U, 2, 12,
                18);
  for (c5_i91 = 0; c5_i91 < 216; c5_i91++) {
    c5_y[c5_i91] = c5_dv14[c5_i91];
  }
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  sf_mex_destroy(&c5_b_A);
  c5_i92 = 0;
  for (c5_i93 = 0; c5_i93 < 18; c5_i93++) {
    for (c5_i94 = 0; c5_i94 < 12; c5_i94++) {
      (*(real_T (*)[216])c5_outData)[c5_i94 + c5_i92] = c5_y[c5_i94 + c5_i92];
    }
  ...
  *c5_inData)
{
  ...
  chartInstance = (SFc5_dIPCInstanceStruct *)chartInstanceVoid;
  c5_mxArrayOutData = NULL;
  for (c5_i95 = 0; c5_i95 < 14; c5_i95++) {
    c5_b_inData[c5_i95] = (*(real_T (*)[14])c5_inData)[c5_i95];
  }

  for (c5_i96 = 0; c5_i96 < 14; c5_i96++) {
    c5_u[c5_i96] = c5_b_inData[c5_i96];
  }

  c5_y = NULL;
  sf_mex_assign(&c5_y, sf_mex_create("y", c5_u, 0, 0U, 1U, 0U, 1, 14), false);
  sf_mex_assign(&c5_mxArrayOutData, c5_y, false);
  return c5_mxArrayOutData;
}
  ...
  *c5_inData)
{
  ...
  for (c5_i97 = 0; c5_i97 < 6; c5_i97++) {
    c5_b_inData[c5_i97] = (*(real_T (*)[6])c5_inData)[c5_i97];
  }
  ...
  *c5_inData)
{
  ...
  for (c5_i99 = 0; c5_i99 < 3; c5_i99++) {
    c5_b_inData[c5_i99] = (*(real_T (*)[3])c5_inData)[c5_i99];
  }
  ...
  mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[3])
{
  ...
  int32_T c5_i101;
  (void)chartInstance;
  sf_mex_import(c5_parentId, sf_mex_dup(c5_u), c5_dv15, 1, 0, 0U, 1, 0U, 1, 3);
  for (c5_i101 = 0; c5_i101 < 3; c5_i101++) {
    c5_y[c5_i101] = c5_dv15[c5_i101];
  }
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_rw), &c5_thisId, c5_y);
  sf_mex_destroy(&c5_rw);
  for (c5_i102 = 0; c5_i102 < 3; c5_i102++) {
    (*(real_T (*)[3])c5_outData)[c5_i102] = c5_y[c5_i102];
  }
  ...
  *c5_inData)
{
  ...
  chartInstance = (SFc5_dIPCInstanceStruct *)chartInstanceVoid;
  c5_mxArrayOutData = NULL;
  for (c5_i103 = 0; c5_i103 < 4; c5_i103++) {
    c5_b_inData[c5_i103] = (*(real_T (*)[4])c5_inData)[c5_i103];
  }
  ...
  mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[4])
{
  ...
  int32_T c5_i105;
  (void)chartInstance;
  sf_mex_import(c5_parentId, sf_mex_dup(c5_u), c5_dv16, 1, 0, 0U, 1, 0U, 1, 4);
  for (c5_i105 = 0; c5_i105 < 4; c5_i105++) {
    c5_y[c5_i105] = c5_dv16[c5_i105];
  }
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_q), &c5_thisId, c5_y);
  sf_mex_destroy(&c5_q);
  for (c5_i106 = 0; c5_i106 < 4; c5_i106++) {
    (*(real_T (*)[4])c5_outData)[c5_i106] = c5_y[c5_i106];
  }
  ...
  *c5_inData)
{
  ...
  for (c5_i108 = 0; c5_i108 < 3; c5_i108++) {
    for (c5_i109 = 0; c5_i109 < 3; c5_i109++) {
      c5_b_inData[c5_i109 + c5_i107] = (*(real_T (*)[9])c5_inData)[c5_i109 +
        c5_i107];
    }
  ...
  for (c5_i111 = 0; c5_i111 < 3; c5_i111++) {
    for (c5_i112 = 0; c5_i112 < 3; c5_i112++) {
      c5_u[c5_i112 + c5_i110] = c5_b_inData[c5_i112 + c5_i110];
    }
  ...
  mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[9])
{
  ...
  int32_T c5_i113;
  (void)chartInstance;
  sf_mex_import(c5_parentId, sf_mex_dup(c5_u), c5_dv17, 1, 0, 0U, 1, 0U, 2, 3, 3);
  for (c5_i113 = 0; c5_i113 < 9; c5_i113++) {
    c5_y[c5_i113] = c5_dv17[c5_i113];
  }
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  for (c5_i115 = 0; c5_i115 < 3; c5_i115++) {
    for (c5_i116 = 0; c5_i116 < 3; c5_i116++) {
      (*(real_T (*)[9])c5_outData)[c5_i116 + c5_i114] = c5_y[c5_i116 + c5_i114];
    }
...
static void c5_eye(SFc5_dIPCInstanceStruct *chartInstance, real_T c5_I[9])
{
  ...
  int32_T c5_b_k;
  (void)chartInstance;
  for (c5_i117 = 0; c5_i117 < 9; c5_i117++) {
    c5_I[c5_i117] = 0.0;
  }
  ...
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId)
{
  ...
  int32_T c5_i118;
  (void)chartInstance;
  sf_mex_import(c5_parentId, sf_mex_dup(c5_u), &c5_i118, 1, 6, 0U, 0, 0U, 0);
  c5_y = c5_i118;
  sf_mex_destroy(&c5_u);
  return c5_y;
}
  ...
  const mxArray *c5_b_is_active_c5_dIPC, const char_T *c5_identifier)
{
  ...
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_y = c5_i_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_b_is_active_c5_dIPC),
    &c5_thisId);
...
static void init_simulink_io_address(SFc5_dIPCInstanceStruct *chartInstance)
{
  chartInstance->c5_r = (real_T (*)[6])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c5_A = (real_T (*)[216])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c5_x = (real_T (*)[14])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2021624618U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2519771539U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2434523097U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3127903135U);
}
...
mxArray *sf_c5_dIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("9OiujQXyDLccTdS83ug77B");
...
static void mdlSetWorkWidths_c5_dIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(567820723U));
  ssSetChecksum1(S,(184509661U));
  ssSetChecksum2(S,(2498089809U));
  ssSetChecksum3(S,(3504385029U));
