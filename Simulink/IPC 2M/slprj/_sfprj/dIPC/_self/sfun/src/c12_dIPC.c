...
static const char * c12_debug_family_names[5] = { "nargin", "nargout", "x", "rv",
  "G" };
...
static const mxArray *c12_d_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_c_emlrt_marshallIn(SFc12_dIPCInstanceStruct *chartInstance,
...
static const mxArray *c12_e_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_d_emlrt_marshallIn(SFc12_dIPCInstanceStruct *chartInstance,
...
static const mxArray *c12_h_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_g_emlrt_marshallIn(SFc12_dIPCInstanceStruct *chartInstance,
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static uint8_T c12_h_emlrt_marshallIn(SFc12_dIPCInstanceStruct *chartInstance,
  ...
  *chartInstance)
{
  ...
  for (c12_i0 = 0; c12_i0 < 72; c12_i0++) {
    c12_u[c12_i0] = (*chartInstance->c12_G)[c12_i0];
  }
  ...
  const mxArray *c12_st)
{
  ...
  for (c12_i1 = 0; c12_i1 < 72; c12_i1++) {
    (*chartInstance->c12_G)[c12_i1] = c12_dv0[c12_i1];
  }

  chartInstance->c12_is_active_c12_dIPC = c12_h_emlrt_marshallIn(chartInstance,
...
static void sf_gateway_c12_dIPC(SFc12_dIPCInstanceStruct *chartInstance)
{
  ...
  for (c12_i2 = 0; c12_i2 < 7; c12_i2++) {
    c12_b_x[c12_i2] = (*chartInstance->c12_x)[c12_i2];
  }

  for (c12_i3 = 0; c12_i3 < 6; c12_i3++) {
    c12_b_rv[c12_i3] = (*chartInstance->c12_rv)[c12_i3];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_nargout, 1U, c12_d_sf_marshallOut,
    c12_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c12_b_x, 2U, c12_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c12_b_rv, 3U, c12_b_sf_marshallOut);
  ...
  for (c12_i4 = 0; c12_i4 < 4; c12_i4++) {
    c12_c_x[c12_i4] = c12_b_x[c12_i4 + 3];
  }

  for (c12_i5 = 0; c12_i5 < 3; c12_i5++) {
    c12_c_rv[c12_i5] = c12_b_rv[c12_i5];
  }

  c12_quatrot(chartInstance, c12_c_x, c12_c_rv, c12_dv1);
  for (c12_i6 = 0; c12_i6 < 3; c12_i6++) {
    c12_d_x[c12_i6] = c12_dv1[c12_i6];
  }
  ...
  for (c12_i7 = 0; c12_i7 < 4; c12_i7++) {
    c12_e_x[c12_i7] = c12_b_x[c12_i7 + 3];
  }

  for (c12_i8 = 0; c12_i8 < 3; c12_i8++) {
    c12_d_rv[c12_i8] = c12_b_rv[c12_i8 + 3];
  }

  c12_quatrot(chartInstance, c12_e_x, c12_d_rv, c12_dv2);
  for (c12_i9 = 0; c12_i9 < 3; c12_i9++) {
    c12_f_x[c12_i9] = c12_dv2[c12_i9];
  }
  ...
  for (c12_i12 = 0; c12_i12 < 3; c12_i12++) {
    for (c12_i13 = 0; c12_i13 < 3; c12_i13++) {
      c12_b_G[c12_i13 + c12_i10] = c12_dv3[c12_i13 + c12_i11];
    }
  ...
  for (c12_i15 = 0; c12_i15 < 3; c12_i15++) {
    for (c12_i16 = 0; c12_i16 < 3; c12_i16++) {
      c12_b_G[(c12_i16 + c12_i14) + 18] = 0.0;
    }
  ...
  for (c12_i19 = 0; c12_i19 < 3; c12_i19++) {
    for (c12_i20 = 0; c12_i20 < 3; c12_i20++) {
      c12_b_G[(c12_i20 + c12_i17) + 36] = c12_dv4[c12_i20 + c12_i18];
    }
  ...
  for (c12_i22 = 0; c12_i22 < 3; c12_i22++) {
    for (c12_i23 = 0; c12_i23 < 3; c12_i23++) {
      c12_b_G[(c12_i23 + c12_i21) + 54] = 0.0;
    }
  ...
  for (c12_i26 = 0; c12_i26 < 3; c12_i26++) {
    for (c12_i27 = 0; c12_i27 < 3; c12_i27++) {
      c12_b_G[(c12_i27 + c12_i24) + 3] = c12_X[c12_i27 + c12_i25];
    }
  ...
  for (c12_i30 = 0; c12_i30 < 3; c12_i30++) {
    for (c12_i31 = 0; c12_i31 < 3; c12_i31++) {
      c12_b_G[(c12_i31 + c12_i28) + 21] = c12_dv5[c12_i31 + c12_i29];
    }
  ...
  for (c12_i34 = 0; c12_i34 < 3; c12_i34++) {
    for (c12_i35 = 0; c12_i35 < 3; c12_i35++) {
      c12_b_G[(c12_i35 + c12_i32) + 39] = c12_b_X[c12_i35 + c12_i33];
    }
  ...
  for (c12_i38 = 0; c12_i38 < 3; c12_i38++) {
    for (c12_i39 = 0; c12_i39 < 3; c12_i39++) {
      c12_b_G[(c12_i39 + c12_i36) + 57] = c12_dv6[c12_i39 + c12_i37];
    }
  ...
  _SFD_EML_CALL(0U, chartInstance->c12_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c12_i40 = 0; c12_i40 < 72; c12_i40++) {
    (*chartInstance->c12_G)[c12_i40] = c12_b_G[c12_i40];
  }
  ...
  for (c12_i41 = 0; c12_i41 < 72; c12_i41++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c12_G)[c12_i41], 0U);
  }

  for (c12_i42 = 0; c12_i42 < 7; c12_i42++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c12_x)[c12_i42], 1U);
  }

  for (c12_i43 = 0; c12_i43 < 6; c12_i43++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c12_rv)[c12_i43], 2U);
  }
}
  ...
  real_T c12_r[3], real_T c12_rw[3])
{
  ...
  for (c12_i44 = 0; c12_i44 < 4; c12_i44++) {
    c12_b_q[c12_i44] = c12_q[c12_i44];
  }
  ...
  for (c12_i45 = 0; c12_i45 < 3; c12_i45++) {
    c12_dv7[c12_i45 + 1] = c12_r[c12_i45];
  }

  for (c12_i46 = 0; c12_i46 < 4; c12_i46++) {
    c12_c_q[c12_i46] = c12_b_q[c12_i46];
  }

  c12_quatmultiply(chartInstance, c12_dv7, c12_c_q, c12_dv8);
  for (c12_i47 = 0; c12_i47 < 4; c12_i47++) {
    c12_d_q[c12_i47] = c12_q[c12_i47];
  }

  for (c12_i48 = 0; c12_i48 < 4; c12_i48++) {
    c12_dv9[c12_i48] = c12_dv8[c12_i48];
  }

  c12_quatmultiply(chartInstance, c12_d_q, c12_dv9, c12_b_q);
  for (c12_i49 = 0; c12_i49 < 4; c12_i49++) {
    c12_rwq[c12_i49] = c12_b_q[c12_i49];
  }

  _SFD_SCRIPT_CALL(0U, chartInstance->c12_sfEvent, 5);
  for (c12_i50 = 0; c12_i50 < 3; c12_i50++) {
    c12_rw[c12_i50] = c12_rwq[c12_i50 + 1];
  }
  ...
  *c12_inData)
{
  ...
  c12_i51 = 0;
  for (c12_i52 = 0; c12_i52 < 12; c12_i52++) {
    for (c12_i53 = 0; c12_i53 < 6; c12_i53++) {
      c12_b_inData[c12_i53 + c12_i51] = (*(real_T (*)[72])c12_inData)[c12_i53 +
        c12_i51];
    }
  ...
  for (c12_i55 = 0; c12_i55 < 12; c12_i55++) {
    for (c12_i56 = 0; c12_i56 < 6; c12_i56++) {
  ...
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[72])
{
  ...
  int32_T c12_i57;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), c12_dv10, 1, 0, 0U, 1, 0U, 2, 6,
                12);
  for (c12_i57 = 0; c12_i57 < 72; c12_i57++) {
    c12_y[c12_i57] = c12_dv10[c12_i57];
  }
  ...
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData)
{
  ...
  sf_mex_destroy(&c12_b_G);
  c12_i58 = 0;
  for (c12_i59 = 0; c12_i59 < 12; c12_i59++) {
    for (c12_i60 = 0; c12_i60 < 6; c12_i60++) {
      (*(real_T (*)[72])c12_outData)[c12_i60 + c12_i58] = c12_y[c12_i60 +
        c12_i58];
    }
  ...
  *c12_inData)
{
  ...
  for (c12_i61 = 0; c12_i61 < 6; c12_i61++) {
    c12_b_inData[c12_i61] = (*(real_T (*)[6])c12_inData)[c12_i61];
  }

  for (c12_i62 = 0; c12_i62 < 6; c12_i62++) {
    c12_u[c12_i62] = c12_b_inData[c12_i62];
  }
  ...
  *c12_inData)
{
  ...
  for (c12_i63 = 0; c12_i63 < 7; c12_i63++) {
    c12_b_inData[c12_i63] = (*(real_T (*)[7])c12_inData)[c12_i63];
  }

  for (c12_i64 = 0; c12_i64 < 7; c12_i64++) {
    c12_u[c12_i64] = c12_b_inData[c12_i64];
  }
  ...
  *c12_inData)
{
  ...
  for (c12_i65 = 0; c12_i65 < 3; c12_i65++) {
    c12_b_inData[c12_i65] = (*(real_T (*)[3])c12_inData)[c12_i65];
  }
  ...
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[3])
{
  ...
  int32_T c12_i67;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), c12_dv11, 1, 0, 0U, 1, 0U, 1, 3);
  for (c12_i67 = 0; c12_i67 < 3; c12_i67++) {
    c12_y[c12_i67] = c12_dv11[c12_i67];
  }
  ...
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData)
{
  ...
  c12_thisId.fIdentifier = c12_identifier;
  c12_thisId.fParent = NULL;
  c12_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c12_rw), &c12_thisId, c12_y);
  sf_mex_destroy(&c12_rw);
  for (c12_i68 = 0; c12_i68 < 3; c12_i68++) {
    (*(real_T (*)[3])c12_outData)[c12_i68] = c12_y[c12_i68];
  }
  ...
  *c12_inData)
{
  ...
  for (c12_i69 = 0; c12_i69 < 4; c12_i69++) {
    c12_b_inData[c12_i69] = (*(real_T (*)[4])c12_inData)[c12_i69];
  }

  for (c12_i70 = 0; c12_i70 < 4; c12_i70++) {
    c12_u[c12_i70] = c12_b_inData[c12_i70];
  }
  ...
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[4])
{
  ...
  int32_T c12_i71;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), c12_dv12, 1, 0, 0U, 1, 0U, 1, 4);
  for (c12_i71 = 0; c12_i71 < 4; c12_i71++) {
    c12_y[c12_i71] = c12_dv12[c12_i71];
  }
  ...
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData)
{
  ...
  c12_thisId.fIdentifier = c12_identifier;
  c12_thisId.fParent = NULL;
  c12_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c12_q), &c12_thisId, c12_y);
  sf_mex_destroy(&c12_q);
  for (c12_i72 = 0; c12_i72 < 4; c12_i72++) {
    (*(real_T (*)[4])c12_outData)[c12_i72] = c12_y[c12_i72];
  }
  ...
  *c12_inData)
{
  ...
  c12_mxArrayOutData = NULL;
  c12_i73 = 0;
  for (c12_i74 = 0; c12_i74 < 3; c12_i74++) {
    for (c12_i75 = 0; c12_i75 < 3; c12_i75++) {
      c12_b_inData[c12_i75 + c12_i73] = (*(real_T (*)[9])c12_inData)[c12_i75 +
        c12_i73];
    }
  ...
  for (c12_i77 = 0; c12_i77 < 3; c12_i77++) {
    for (c12_i78 = 0; c12_i78 < 3; c12_i78++) {
      c12_u[c12_i78 + c12_i76] = c12_b_inData[c12_i78 + c12_i76];
    }
  ...
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[9])
{
  ...
  int32_T c12_i79;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), c12_dv13, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c12_i79 = 0; c12_i79 < 9; c12_i79++) {
    c12_y[c12_i79] = c12_dv13[c12_i79];
  }
  ...
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData)
{
  ...
  c12_thisId.fIdentifier = c12_identifier;
  c12_thisId.fParent = NULL;
  c12_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c12_X), &c12_thisId, c12_y);
  sf_mex_destroy(&c12_X);
  c12_i80 = 0;
  for (c12_i81 = 0; c12_i81 < 3; c12_i81++) {
    for (c12_i82 = 0; c12_i82 < 3; c12_i82++) {
      (*(real_T (*)[9])c12_outData)[c12_i82 + c12_i80] = c12_y[c12_i82 + c12_i80];
    }
...
static void c12_eye(SFc12_dIPCInstanceStruct *chartInstance, real_T c12_I[9])
{
  ...
  int32_T c12_b_k;
  (void)chartInstance;
  for (c12_i83 = 0; c12_i83 < 9; c12_i83++) {
    c12_I[c12_i83] = 0.0;
  }
  ...
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId)
{
  ...
  int32_T c12_i84;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), &c12_i84, 1, 6, 0U, 0, 0U, 0);
  c12_y = c12_i84;
  sf_mex_destroy(&c12_u);
  return c12_y;
}
...
static void init_simulink_io_address(SFc12_dIPCInstanceStruct *chartInstance)
{
  ...
  chartInstance->c12_x = (real_T (*)[7])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c12_rv = (real_T (*)[6])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
}
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(0U, *chartInstance->c12_G);
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c12_x);
        _SFD_SET_DATA_VALUE_PTR(2U, *chartInstance->c12_rv);
      }
    } else {
