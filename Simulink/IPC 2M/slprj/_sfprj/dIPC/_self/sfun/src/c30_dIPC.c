...
static void initialize_c30_dIPC(SFc30_dIPCInstanceStruct *chartInstance);
static void initialize_params_c30_dIPC(SFc30_dIPCInstanceStruct *chartInstance);
static void enable_c30_dIPC(SFc30_dIPCInstanceStruct *chartInstance);
static void disable_c30_dIPC(SFc30_dIPCInstanceStruct *chartInstance);
static void c30_update_debugger_state_c30_dIPC(SFc30_dIPCInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c30_dIPC(SFc30_dIPCInstanceStruct
  *chartInstance);
static void set_sim_state_c30_dIPC(SFc30_dIPCInstanceStruct *chartInstance,
  const mxArray *c30_st);
static void finalize_c30_dIPC(SFc30_dIPCInstanceStruct *chartInstance);
static void sf_gateway_c30_dIPC(SFc30_dIPCInstanceStruct *chartInstance);
static void mdl_start_c30_dIPC(SFc30_dIPCInstanceStruct *chartInstance);
static void initSimStructsc30_dIPC(SFc30_dIPCInstanceStruct *chartInstance);
...
static const mxArray *c30_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static void c30_emlrt_marshallIn(SFc30_dIPCInstanceStruct *chartInstance, const
  mxArray *c30_b_Ared, const char_T *c30_identifier, real_T c30_y[72]);
static void c30_b_emlrt_marshallIn(SFc30_dIPCInstanceStruct *chartInstance,
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId, real_T c30_y[72]);
...
static const mxArray *c30_d_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static real_T c30_c_emlrt_marshallIn(SFc30_dIPCInstanceStruct *chartInstance,
...
static const mxArray *c30_e_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static void c30_d_emlrt_marshallIn(SFc30_dIPCInstanceStruct *chartInstance,
...
static const mxArray *c30_f_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static void c30_e_emlrt_marshallIn(SFc30_dIPCInstanceStruct *chartInstance,
...
static const mxArray *c30_g_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static void c30_f_emlrt_marshallIn(SFc30_dIPCInstanceStruct *chartInstance,
...
static void c30_eye(SFc30_dIPCInstanceStruct *chartInstance, real_T c30_I[9]);
static void c30_quatmultiply(SFc30_dIPCInstanceStruct *chartInstance, real_T
  c30_q[4], real_T c30_b_r[4], real_T c30_qout[4]);
static const mxArray *c30_h_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static int32_T c30_g_emlrt_marshallIn(SFc30_dIPCInstanceStruct *chartInstance,
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId);
static void c30_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c30_mxArrayInData, const char_T *c30_varName, void *c30_outData);
static uint8_T c30_h_emlrt_marshallIn(SFc30_dIPCInstanceStruct *chartInstance,
  const mxArray *c30_b_is_active_c30_dIPC, const char_T *c30_identifier);
static uint8_T c30_i_emlrt_marshallIn(SFc30_dIPCInstanceStruct *chartInstance,
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId);
static void init_dsm_address_info(SFc30_dIPCInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc30_dIPCInstanceStruct *chartInstance);
...
static void initialize_c30_dIPC(SFc30_dIPCInstanceStruct *chartInstance)
{
  ...
  chartInstance->c30_is_active_c30_dIPC = 0U;
}
  ...
  *chartInstance)
{
  ...
  for (c30_i0 = 0; c30_i0 < 72; c30_i0++) {
    c30_u[c30_i0] = (*chartInstance->c30_Ared)[c30_i0];
  }

  c30_b_y = NULL;
  sf_mex_assign(&c30_b_y, sf_mex_create("y", c30_u, 0, 0U, 1U, 0U, 2, 6, 12),
                false);
  sf_mex_setcell(c30_y, 0, c30_b_y);
  c30_hoistedGlobal = chartInstance->c30_is_active_c30_dIPC;
  ...
  const mxArray *c30_st)
{
  ...
  c30_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c30_u, 0)),
                       "Ared", c30_dv0);
  for (c30_i1 = 0; c30_i1 < 72; c30_i1++) {
    (*chartInstance->c30_Ared)[c30_i1] = c30_dv0[c30_i1];
  }

  chartInstance->c30_is_active_c30_dIPC = c30_h_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c30_u, 1)), "is_active_c30_dIPC");
  sf_mex_destroy(&c30_u);
  c30_update_debugger_state_c30_dIPC(chartInstance);
...
static void sf_gateway_c30_dIPC(SFc30_dIPCInstanceStruct *chartInstance)
{
  ...
  real_T c30_b_Ared[72];
  int32_T c30_i5;
  real_T c30_q[4];
  int32_T c30_i6;
  real_T c30_c_r[3];
  uint32_T c30_b_debug_family_var_map[6];
  real_T c30_rwq[4];
  real_T c30_b_nargin = 2.0;
  ...
  int32_T c30_i14;
  real_T c30_c_x[3];
  uint32_T c30_c_debug_family_var_map[4];
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 12U, chartInstance->c30_sfEvent);
  for (c30_i2 = 0; c30_i2 < 6; c30_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c30_r)[c30_i2], 0U);
  }

  chartInstance->c30_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 12U, chartInstance->c30_sfEvent);
  for (c30_i3 = 0; c30_i3 < 6; c30_i3++) {
    c30_b_r[c30_i3] = (*chartInstance->c30_r)[c30_i3];
  }

  for (c30_i4 = 0; c30_i4 < 14; c30_i4++) {
    c30_b_x[c30_i4] = (*chartInstance->c30_x)[c30_i4];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c30_nargout, 1U, c30_d_sf_marshallOut,
    c30_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c30_b_r, 2U, c30_c_sf_marshallOut);
  ...
  for (c30_i5 = 0; c30_i5 < 4; c30_i5++) {
    c30_q[c30_i5] = c30_b_x[c30_i5 + 3];
  }

  for (c30_i6 = 0; c30_i6 < 3; c30_i6++) {
    c30_c_r[c30_i6] = c30_b_r[c30_i6 + 3] - c30_b_r[c30_i6];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c30_rwq, 0U, c30_f_sf_marshallOut,
    c30_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c30_b_nargin, 1U, c30_d_sf_marshallOut,
    c30_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c30_b_nargout, 2U, c30_d_sf_marshallOut,
    c30_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c30_q, 3U, c30_f_sf_marshallOut,
    c30_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c30_c_r, 4U, c30_e_sf_marshallOut,
    c30_c_sf_marshallIn);
  ...
  for (c30_i8 = 0; c30_i8 < 3; c30_i8++) {
    c30_dv1[c30_i8 + 1] = c30_c_r[c30_i8];
  }

  for (c30_i9 = 0; c30_i9 < 4; c30_i9++) {
    c30_c_q[c30_i9] = c30_b_q[c30_i9];
  }

  c30_quatmultiply(chartInstance, c30_dv1, c30_c_q, c30_dv2);
  for (c30_i10 = 0; c30_i10 < 4; c30_i10++) {
    c30_d_q[c30_i10] = c30_q[c30_i10];
  }

  for (c30_i11 = 0; c30_i11 < 4; c30_i11++) {
    c30_dv3[c30_i11] = c30_dv2[c30_i11];
  }

  c30_quatmultiply(chartInstance, c30_d_q, c30_dv3, c30_b_q);
  for (c30_i12 = 0; c30_i12 < 4; c30_i12++) {
    c30_rwq[c30_i12] = c30_b_q[c30_i12];
  }

  _SFD_SCRIPT_CALL(0U, chartInstance->c30_sfEvent, 5);
  for (c30_i13 = 0; c30_i13 < 3; c30_i13++) {
    c30_rw[c30_i13] = c30_rwq[c30_i13 + 1];
  }

  _SFD_SCRIPT_CALL(0U, chartInstance->c30_sfEvent, -5);
  _SFD_SYMBOL_SCOPE_POP();
  for (c30_i14 = 0; c30_i14 < 3; c30_i14++) {
    c30_c_x[c30_i14] = c30_rw[c30_i14];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 4U, 4U, c30_c_debug_family_names,
    c30_c_debug_family_var_map);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c30_c_nargout, 1U, c30_d_sf_marshallOut,
    c30_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c30_c_x, 2U, c30_e_sf_marshallOut,
    c30_c_sf_marshallIn);
  ...
  for (c30_i17 = 0; c30_i17 < 3; c30_i17++) {
    for (c30_i18 = 0; c30_i18 < 3; c30_i18++) {
      c30_b_Ared[c30_i18 + c30_i15] = -c30_dv4[c30_i18 + c30_i16];
    }
  ...
  for (c30_i21 = 0; c30_i21 < 3; c30_i21++) {
    for (c30_i22 = 0; c30_i22 < 3; c30_i22++) {
      c30_b_Ared[(c30_i22 + c30_i19) + 18] = c30_X[c30_i22 + c30_i20];
    }
  ...
  for (c30_i25 = 0; c30_i25 < 3; c30_i25++) {
    for (c30_i26 = 0; c30_i26 < 3; c30_i26++) {
      c30_b_Ared[(c30_i26 + c30_i23) + 36] = c30_dv5[c30_i26 + c30_i24];
    }
  ...
  c30_i27 = 0;
  for (c30_i28 = 0; c30_i28 < 3; c30_i28++) {
    for (c30_i29 = 0; c30_i29 < 3; c30_i29++) {
      c30_b_Ared[(c30_i29 + c30_i27) + 54] = 0.0;
    }
  ...
  for (c30_i35 = 0; c30_i35 < 3; c30_i35++) {
    for (c30_i36 = 0; c30_i36 < 3; c30_i36++) {
      c30_b_Ared[(c30_i36 + c30_i33) + 21] = -c30_dv6[c30_i36 + c30_i34];
    }
  ...
  for (c30_i38 = 0; c30_i38 < 3; c30_i38++) {
    for (c30_i39 = 0; c30_i39 < 3; c30_i39++) {
      c30_b_Ared[(c30_i39 + c30_i37) + 39] = 0.0;
    }
  ...
  for (c30_i42 = 0; c30_i42 < 3; c30_i42++) {
    for (c30_i43 = 0; c30_i43 < 3; c30_i43++) {
      c30_b_Ared[(c30_i43 + c30_i40) + 57] = c30_dv7[c30_i43 + c30_i41];
    }
  ...
  _SFD_EML_CALL(0U, chartInstance->c30_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c30_i44 = 0; c30_i44 < 72; c30_i44++) {
    (*chartInstance->c30_Ared)[c30_i44] = c30_b_Ared[c30_i44];
  }

  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 12U, chartInstance->c30_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_dIPCMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c30_i45 = 0; c30_i45 < 72; c30_i45++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c30_Ared)[c30_i45], 1U);
  }

  for (c30_i46 = 0; c30_i46 < 14; c30_i46++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c30_x)[c30_i46], 2U);
  }
}
  ...
  *c30_inData)
{
  ...
  int32_T c30_i48;
  int32_T c30_i49;
  real_T c30_b_inData[72];
  int32_T c30_i50;
  int32_T c30_i51;
  int32_T c30_i52;
  real_T c30_u[72];
  const mxArray *c30_y = NULL;
  SFc30_dIPCInstanceStruct *chartInstance;
  chartInstance = (SFc30_dIPCInstanceStruct *)chartInstanceVoid;
  c30_mxArrayOutData = NULL;
  c30_i47 = 0;
  for (c30_i48 = 0; c30_i48 < 12; c30_i48++) {
    for (c30_i49 = 0; c30_i49 < 6; c30_i49++) {
      c30_b_inData[c30_i49 + c30_i47] = (*(real_T (*)[72])c30_inData)[c30_i49 +
        c30_i47];
    }
  ...
  c30_i50 = 0;
  for (c30_i51 = 0; c30_i51 < 12; c30_i51++) {
  ...
  c30_y = NULL;
  sf_mex_assign(&c30_y, sf_mex_create("y", c30_u, 0, 0U, 1U, 0U, 2, 6, 12),
                false);
  ...
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId, real_T c30_y[72])
{
  ...
  int32_T c30_i53;
  (void)chartInstance;
  sf_mex_import(c30_parentId, sf_mex_dup(c30_u), c30_dv8, 1, 0, 0U, 1, 0U, 2, 6,
                12);
  for (c30_i53 = 0; c30_i53 < 72; c30_i53++) {
    c30_y[c30_i53] = c30_dv8[c30_i53];
  }
  ...
  *c30_mxArrayInData, const char_T *c30_varName, void *c30_outData)
{
  ...
  sf_mex_destroy(&c30_b_Ared);
  c30_i54 = 0;
  for (c30_i55 = 0; c30_i55 < 12; c30_i55++) {
    for (c30_i56 = 0; c30_i56 < 6; c30_i56++) {
      (*(real_T (*)[72])c30_outData)[c30_i56 + c30_i54] = c30_y[c30_i56 +
        c30_i54];
    }
  ...
  *c30_inData)
{
  ...
  chartInstance = (SFc30_dIPCInstanceStruct *)chartInstanceVoid;
  c30_mxArrayOutData = NULL;
  for (c30_i57 = 0; c30_i57 < 14; c30_i57++) {
    c30_b_inData[c30_i57] = (*(real_T (*)[14])c30_inData)[c30_i57];
  }

  for (c30_i58 = 0; c30_i58 < 14; c30_i58++) {
    c30_u[c30_i58] = c30_b_inData[c30_i58];
  }

  c30_y = NULL;
  sf_mex_assign(&c30_y, sf_mex_create("y", c30_u, 0, 0U, 1U, 0U, 1, 14), false);
  sf_mex_assign(&c30_mxArrayOutData, c30_y, false);
  return c30_mxArrayOutData;
}
  ...
  *c30_inData)
{
  ...
  chartInstance = (SFc30_dIPCInstanceStruct *)chartInstanceVoid;
  c30_mxArrayOutData = NULL;
  for (c30_i59 = 0; c30_i59 < 6; c30_i59++) {
    c30_b_inData[c30_i59] = (*(real_T (*)[6])c30_inData)[c30_i59];
  }

  for (c30_i60 = 0; c30_i60 < 6; c30_i60++) {
    c30_u[c30_i60] = c30_b_inData[c30_i60];
  }
  ...
  *c30_inData)
{
  ...
  for (c30_i61 = 0; c30_i61 < 3; c30_i61++) {
    c30_b_inData[c30_i61] = (*(real_T (*)[3])c30_inData)[c30_i61];
  }

  for (c30_i62 = 0; c30_i62 < 3; c30_i62++) {
    c30_u[c30_i62] = c30_b_inData[c30_i62];
  }
  ...
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId, real_T c30_y[3])
{
  ...
  int32_T c30_i63;
  (void)chartInstance;
  sf_mex_import(c30_parentId, sf_mex_dup(c30_u), c30_dv9, 1, 0, 0U, 1, 0U, 1, 3);
  for (c30_i63 = 0; c30_i63 < 3; c30_i63++) {
    c30_y[c30_i63] = c30_dv9[c30_i63];
  }
  ...
  *c30_mxArrayInData, const char_T *c30_varName, void *c30_outData)
{
  ...
  c30_thisId.fIdentifier = c30_identifier;
  c30_thisId.fParent = NULL;
  c30_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c30_rw), &c30_thisId, c30_y);
  sf_mex_destroy(&c30_rw);
  for (c30_i64 = 0; c30_i64 < 3; c30_i64++) {
    (*(real_T (*)[3])c30_outData)[c30_i64] = c30_y[c30_i64];
  }
  ...
  *c30_inData)
{
  ...
  chartInstance = (SFc30_dIPCInstanceStruct *)chartInstanceVoid;
  c30_mxArrayOutData = NULL;
  for (c30_i65 = 0; c30_i65 < 4; c30_i65++) {
    c30_b_inData[c30_i65] = (*(real_T (*)[4])c30_inData)[c30_i65];
  }

  for (c30_i66 = 0; c30_i66 < 4; c30_i66++) {
    c30_u[c30_i66] = c30_b_inData[c30_i66];
  }
  ...
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId, real_T c30_y[4])
{
  ...
  int32_T c30_i67;
  (void)chartInstance;
  sf_mex_import(c30_parentId, sf_mex_dup(c30_u), c30_dv10, 1, 0, 0U, 1, 0U, 1, 4);
  for (c30_i67 = 0; c30_i67 < 4; c30_i67++) {
    c30_y[c30_i67] = c30_dv10[c30_i67];
  }
  ...
  *c30_mxArrayInData, const char_T *c30_varName, void *c30_outData)
{
  ...
  c30_thisId.fIdentifier = c30_identifier;
  c30_thisId.fParent = NULL;
  c30_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c30_q), &c30_thisId, c30_y);
  sf_mex_destroy(&c30_q);
  for (c30_i68 = 0; c30_i68 < 4; c30_i68++) {
    (*(real_T (*)[4])c30_outData)[c30_i68] = c30_y[c30_i68];
  }
  ...
  *c30_inData)
{
  ...
  for (c30_i70 = 0; c30_i70 < 3; c30_i70++) {
    for (c30_i71 = 0; c30_i71 < 3; c30_i71++) {
      c30_b_inData[c30_i71 + c30_i69] = (*(real_T (*)[9])c30_inData)[c30_i71 +
        c30_i69];
    }
  ...
  c30_i72 = 0;
  for (c30_i73 = 0; c30_i73 < 3; c30_i73++) {
    for (c30_i74 = 0; c30_i74 < 3; c30_i74++) {
      c30_u[c30_i74 + c30_i72] = c30_b_inData[c30_i74 + c30_i72];
    }
  ...
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId, real_T c30_y[9])
{
  ...
  int32_T c30_i75;
  (void)chartInstance;
  sf_mex_import(c30_parentId, sf_mex_dup(c30_u), c30_dv11, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c30_i75 = 0; c30_i75 < 9; c30_i75++) {
    c30_y[c30_i75] = c30_dv11[c30_i75];
  }
  ...
  *c30_mxArrayInData, const char_T *c30_varName, void *c30_outData)
{
  ...
  c30_thisId.fIdentifier = c30_identifier;
  c30_thisId.fParent = NULL;
  c30_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c30_X), &c30_thisId, c30_y);
  sf_mex_destroy(&c30_X);
  c30_i76 = 0;
  for (c30_i77 = 0; c30_i77 < 3; c30_i77++) {
    for (c30_i78 = 0; c30_i78 < 3; c30_i78++) {
      (*(real_T (*)[9])c30_outData)[c30_i78 + c30_i76] = c30_y[c30_i78 + c30_i76];
    }
...
const mxArray *sf_c30_dIPC_get_eml_resolved_functions_info(void)
{
...
static void c30_info_helper(const mxArray **c30_info)
{
  ...
  sf_mex_addfield(*c30_info, c30_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/IPC 2M/quatrot.m"), "resolved",
                  "resolved", 21);
  sf_mex_addfield(*c30_info, c30_b_emlrt_marshallOut(1460657806U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c30_info, c30_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c30_info, c30_b_emlrt_marshallOut(0U), "mFileTimeLo",
...
static void c30_eye(SFc30_dIPCInstanceStruct *chartInstance, real_T c30_I[9])
{
  ...
  int32_T c30_b_k;
  (void)chartInstance;
  for (c30_i79 = 0; c30_i79 < 9; c30_i79++) {
    c30_I[c30_i79] = 0.0;
  }
  ...
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId)
{
  ...
  int32_T c30_i80;
  (void)chartInstance;
  sf_mex_import(c30_parentId, sf_mex_dup(c30_u), &c30_i80, 1, 6, 0U, 0, 0U, 0);
  c30_y = c30_i80;
  sf_mex_destroy(&c30_u);
  return c30_y;
}
  ...
  *c30_mxArrayInData, const char_T *c30_varName, void *c30_outData)
{
  ...
  c30_thisId.fIdentifier = c30_identifier;
  c30_thisId.fParent = NULL;
  c30_y = c30_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c30_b_sfEvent),
    &c30_thisId);
  ...
  const mxArray *c30_b_is_active_c30_dIPC, const char_T *c30_identifier)
{
  ...
  c30_thisId.fIdentifier = c30_identifier;
  c30_thisId.fParent = NULL;
  c30_y = c30_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c30_b_is_active_c30_dIPC), &c30_thisId);
  sf_mex_destroy(&c30_b_is_active_c30_dIPC);
  return c30_y;
}
...
static void init_simulink_io_address(SFc30_dIPCInstanceStruct *chartInstance)
{
  chartInstance->c30_r = (real_T (*)[6])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c30_Ared = (real_T (*)[72])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c30_x = (real_T (*)[14])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
void sf_c30_dIPC_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3754022331U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4066643110U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2230038039U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1619717534U);
}

mxArray* sf_c30_dIPC_get_post_codegen_info(void);
mxArray *sf_c30_dIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("jlGJ7YDGGrlKMsgXURA5ID");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c30_dIPC_get_post_codegen_info();
...
mxArray *sf_c30_dIPC_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c30_dIPC_jit_fallback_info(void)
{
...
mxArray *sf_c30_dIPC_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c30_dIPC(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Ared\",},{M[8],M[0],T\"is_active_c30_dIPC\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c30_dIPC_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc30_dIPCInstanceStruct *) chartInfo->chartInstance;
...
{
  return "i3nMPoLMv2DMEo4PmxsaeC";
}

static void sf_opaque_initialize_c30_dIPC(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc30_dIPCInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c30_dIPC((SFc30_dIPCInstanceStruct*) chartInstanceVar);
  initialize_c30_dIPC((SFc30_dIPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c30_dIPC(void *chartInstanceVar)
{
  enable_c30_dIPC((SFc30_dIPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c30_dIPC(void *chartInstanceVar)
{
  disable_c30_dIPC((SFc30_dIPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c30_dIPC(void *chartInstanceVar)
{
  sf_gateway_c30_dIPC((SFc30_dIPCInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c30_dIPC(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c30_dIPC((SFc30_dIPCInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c30_dIPC(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c30_dIPC((SFc30_dIPCInstanceStruct*)chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c30_dIPC(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc30_dIPCInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c30_dIPC((SFc30_dIPCInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc30_dIPC((SFc30_dIPCInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c30_dIPC(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c30_dIPC((SFc30_dIPCInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c30_dIPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2870096411U));
  ssSetChecksum1(S,(1876792865U));
  ssSetChecksum2(S,(1479327053U));
  ssSetChecksum3(S,(3544837072U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c30_dIPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c30_dIPC(SimStruct *S)
{
  SFc30_dIPCInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc30_dIPCInstanceStruct *)utMalloc(sizeof
    (SFc30_dIPCInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc30_dIPCInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c30_dIPC;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c30_dIPC;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c30_dIPC;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c30_dIPC;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c30_dIPC;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c30_dIPC;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c30_dIPC;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c30_dIPC;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c30_dIPC;
  chartInstance->chartInfo.mdlStart = mdlStart_c30_dIPC;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c30_dIPC;
...
void c30_dIPC_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c30_dIPC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c30_dIPC(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c30_dIPC_method_dispatcher.\n"
