...
static void c37_emlrt_marshallIn(SFc37_dIPCInstanceStruct *chartInstance, const
  mxArray *c37_b_x, const char_T *c37_identifier, real_T c37_y[14]);
static void c37_b_emlrt_marshallIn(SFc37_dIPCInstanceStruct *chartInstance,
  const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId, real_T c37_y[14]);
...
static const mxArray *c37_e_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static real_T c37_c_emlrt_marshallIn(SFc37_dIPCInstanceStruct *chartInstance,
...
static void c37_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData);
static void c37_d_emlrt_marshallIn(SFc37_dIPCInstanceStruct *chartInstance,
...
static const mxArray *c37_f_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static int32_T c37_f_emlrt_marshallIn(SFc37_dIPCInstanceStruct *chartInstance,
  const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
static void c37_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData);
static uint8_T c37_g_emlrt_marshallIn(SFc37_dIPCInstanceStruct *chartInstance,
  ...
  *chartInstance)
{
  ...
  for (c37_i0 = 0; c37_i0 < 14; c37_i0++) {
    c37_u[c37_i0] = (*chartInstance->c37_x)[c37_i0];
  }

  c37_b_y = NULL;
  sf_mex_assign(&c37_b_y, sf_mex_create("y", c37_u, 0, 0U, 1U, 0U, 1, 14), false);
  ...
  const mxArray *c37_st)
{
  ...
  c37_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c37_u, 0)), "x",
                       c37_dv0);
  for (c37_i1 = 0; c37_i1 < 14; c37_i1++) {
    (*chartInstance->c37_x)[c37_i1] = c37_dv0[c37_i1];
  }

  chartInstance->c37_is_active_c37_dIPC = c37_g_emlrt_marshallIn(chartInstance,
...
static void sf_gateway_c37_dIPC(SFc37_dIPCInstanceStruct *chartInstance)
{
  ...
  for (c37_i2 = 0; c37_i2 < 3; c37_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c37_p_o)[c37_i2], 0U);
  }

  for (c37_i3 = 0; c37_i3 < 4; c37_i3++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c37_q_o)[c37_i3], 1U);
  }

  chartInstance->c37_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 15U, chartInstance->c37_sfEvent);
  for (c37_i4 = 0; c37_i4 < 3; c37_i4++) {
    c37_b_p_o[c37_i4] = (*chartInstance->c37_p_o)[c37_i4];
  }

  for (c37_i5 = 0; c37_i5 < 4; c37_i5++) {
    c37_b_q_o[c37_i5] = (*chartInstance->c37_q_o)[c37_i5];
  }

  for (c37_i6 = 0; c37_i6 < 6; c37_i6++) {
    c37_b_r[c37_i6] = (*chartInstance->c37_r)[c37_i6];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(c37_b_r, 4U, c37_b_sf_marshallOut);
  ...
  for (c37_i7 = 0; c37_i7 < 4; c37_i7++) {
    c37_c_q_o[c37_i7] = c37_b_q_o[c37_i7];
  }

  for (c37_i8 = 0; c37_i8 < 3; c37_i8++) {
    c37_c_r[c37_i8] = c37_b_r[c37_i8];
  }

  c37_quatrot(chartInstance, c37_c_q_o, c37_c_r, c37_dv1);
  for (c37_i9 = 0; c37_i9 < 4; c37_i9++) {
    c37_d_q_o[c37_i9] = c37_b_q_o[c37_i9];
  }

  for (c37_i10 = 0; c37_i10 < 3; c37_i10++) {
    c37_d_r[c37_i10] = c37_b_r[c37_i10 + 3];
  }

  c37_quatrot(chartInstance, c37_d_q_o, c37_d_r, c37_dv2);
  for (c37_i11 = 0; c37_i11 < 3; c37_i11++) {
    c37_b_x[c37_i11] = c37_b_p_o[c37_i11] + c37_dv1[c37_i11];
  }

  for (c37_i12 = 0; c37_i12 < 4; c37_i12++) {
    c37_b_x[c37_i12 + 3] = c37_b_q_o[c37_i12];
  }

  for (c37_i13 = 0; c37_i13 < 3; c37_i13++) {
    c37_b_x[c37_i13 + 7] = c37_b_p_o[c37_i13] + c37_dv2[c37_i13];
  }

  for (c37_i14 = 0; c37_i14 < 4; c37_i14++) {
    c37_b_x[c37_i14 + 10] = c37_b_q_o[c37_i14];
  }

  _SFD_EML_CALL(0U, chartInstance->c37_sfEvent, -3);
  _SFD_SYMBOL_SCOPE_POP();
  for (c37_i15 = 0; c37_i15 < 14; c37_i15++) {
    (*chartInstance->c37_x)[c37_i15] = c37_b_x[c37_i15];
  }
  ...
  for (c37_i16 = 0; c37_i16 < 14; c37_i16++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c37_x)[c37_i16], 2U);
  }

  for (c37_i17 = 0; c37_i17 < 6; c37_i17++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c37_r)[c37_i17], 3U);
  }
}
  ...
  real_T c37_b_r[3], real_T c37_rw[3])
{
  ...
  for (c37_i19 = 0; c37_i19 < 3; c37_i19++) {
    c37_dv3[c37_i19 + 1] = c37_b_r[c37_i19];
  }

  for (c37_i20 = 0; c37_i20 < 4; c37_i20++) {
    c37_c_q[c37_i20] = c37_b_q[c37_i20];
  }

  c37_quatmultiply(chartInstance, c37_dv3, c37_c_q, c37_dv4);
  for (c37_i21 = 0; c37_i21 < 4; c37_i21++) {
    c37_d_q[c37_i21] = c37_q[c37_i21];
  }

  for (c37_i22 = 0; c37_i22 < 4; c37_i22++) {
    c37_dv5[c37_i22] = c37_dv4[c37_i22];
  }

  c37_quatmultiply(chartInstance, c37_d_q, c37_dv5, c37_b_q);
  for (c37_i23 = 0; c37_i23 < 4; c37_i23++) {
    c37_rwq[c37_i23] = c37_b_q[c37_i23];
  }

  _SFD_SCRIPT_CALL(0U, chartInstance->c37_sfEvent, 5);
  for (c37_i24 = 0; c37_i24 < 3; c37_i24++) {
    c37_rw[c37_i24] = c37_rwq[c37_i24 + 1];
  }
  ...
  *c37_inData)
{
  ...
  for (c37_i25 = 0; c37_i25 < 14; c37_i25++) {
    c37_b_inData[c37_i25] = (*(real_T (*)[14])c37_inData)[c37_i25];
  }

  for (c37_i26 = 0; c37_i26 < 14; c37_i26++) {
    c37_u[c37_i26] = c37_b_inData[c37_i26];
  }

  c37_y = NULL;
  sf_mex_assign(&c37_y, sf_mex_create("y", c37_u, 0, 0U, 1U, 0U, 1, 14), false);
  ...
  const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId, real_T c37_y[14])
{
  ...
  int32_T c37_i27;
  (void)chartInstance;
  sf_mex_import(c37_parentId, sf_mex_dup(c37_u), c37_dv6, 1, 0, 0U, 1, 0U, 1, 14);
  for (c37_i27 = 0; c37_i27 < 14; c37_i27++) {
    c37_y[c37_i27] = c37_dv6[c37_i27];
  }
  ...
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData)
{
  ...
  c37_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c37_b_x), &c37_thisId, c37_y);
  sf_mex_destroy(&c37_b_x);
  for (c37_i28 = 0; c37_i28 < 14; c37_i28++) {
    (*(real_T (*)[14])c37_outData)[c37_i28] = c37_y[c37_i28];
  }
  ...
  *c37_inData)
{
  ...
  chartInstance = (SFc37_dIPCInstanceStruct *)chartInstanceVoid;
  c37_mxArrayOutData = NULL;
  for (c37_i29 = 0; c37_i29 < 6; c37_i29++) {
    c37_b_inData[c37_i29] = (*(real_T (*)[6])c37_inData)[c37_i29];
  }

  for (c37_i30 = 0; c37_i30 < 6; c37_i30++) {
    c37_u[c37_i30] = c37_b_inData[c37_i30];
  }
  ...
  *c37_inData)
{
  ...
  for (c37_i31 = 0; c37_i31 < 4; c37_i31++) {
    c37_b_inData[c37_i31] = (*(real_T (*)[4])c37_inData)[c37_i31];
  }

  for (c37_i32 = 0; c37_i32 < 4; c37_i32++) {
    c37_u[c37_i32] = c37_b_inData[c37_i32];
  }
  ...
  *c37_inData)
{
  ...
  for (c37_i33 = 0; c37_i33 < 3; c37_i33++) {
    c37_b_inData[c37_i33] = (*(real_T (*)[3])c37_inData)[c37_i33];
  }

  for (c37_i34 = 0; c37_i34 < 3; c37_i34++) {
    c37_u[c37_i34] = c37_b_inData[c37_i34];
  }
  ...
  const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId, real_T c37_y[3])
{
  ...
  int32_T c37_i35;
  (void)chartInstance;
  sf_mex_import(c37_parentId, sf_mex_dup(c37_u), c37_dv7, 1, 0, 0U, 1, 0U, 1, 3);
  for (c37_i35 = 0; c37_i35 < 3; c37_i35++) {
    c37_y[c37_i35] = c37_dv7[c37_i35];
  }
  ...
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData)
{
  ...
  c37_thisId.fIdentifier = c37_identifier;
  c37_thisId.fParent = NULL;
  c37_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c37_rw), &c37_thisId, c37_y);
  sf_mex_destroy(&c37_rw);
  for (c37_i36 = 0; c37_i36 < 3; c37_i36++) {
    (*(real_T (*)[3])c37_outData)[c37_i36] = c37_y[c37_i36];
  }
  ...
  const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId, real_T c37_y[4])
{
  ...
  int32_T c37_i37;
  (void)chartInstance;
  sf_mex_import(c37_parentId, sf_mex_dup(c37_u), c37_dv8, 1, 0, 0U, 1, 0U, 1, 4);
  for (c37_i37 = 0; c37_i37 < 4; c37_i37++) {
    c37_y[c37_i37] = c37_dv8[c37_i37];
  }
  ...
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData)
{
  ...
  c37_thisId.fIdentifier = c37_identifier;
  c37_thisId.fParent = NULL;
  c37_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c37_q), &c37_thisId, c37_y);
  sf_mex_destroy(&c37_q);
  for (c37_i38 = 0; c37_i38 < 4; c37_i38++) {
    (*(real_T (*)[4])c37_outData)[c37_i38] = c37_y[c37_i38];
  }
  ...
  const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId)
{
  ...
  int32_T c37_i39;
  (void)chartInstance;
  sf_mex_import(c37_parentId, sf_mex_dup(c37_u), &c37_i39, 1, 6, 0U, 0, 0U, 0);
  c37_y = c37_i39;
  sf_mex_destroy(&c37_u);
  return c37_y;
}
...
static void init_simulink_io_address(SFc37_dIPCInstanceStruct *chartInstance)
{
  ...
  chartInstance->c37_q_o = (real_T (*)[4])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c37_x = (real_T (*)[14])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c37_r = (real_T (*)[6])ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3291812174U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2481272514U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(87957173U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(966931424U);
}
...
mxArray *sf_c37_dIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("m1R0uDnXgmGfvbzc4KTuFF");
...
static void mdlSetWorkWidths_c37_dIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(366846361U));
  ssSetChecksum1(S,(1256351698U));
  ssSetChecksum2(S,(3991520348U));
  ssSetChecksum3(S,(2293786578U));
