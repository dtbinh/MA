...
static void initialize_c3_StramigioliIPC(SFc3_StramigioliIPCInstanceStruct
  *chartInstance);
static void initialize_params_c3_StramigioliIPC
  (SFc3_StramigioliIPCInstanceStruct *chartInstance);
static void enable_c3_StramigioliIPC(SFc3_StramigioliIPCInstanceStruct
  *chartInstance);
static void disable_c3_StramigioliIPC(SFc3_StramigioliIPCInstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_StramigioliIPC
  (SFc3_StramigioliIPCInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_StramigioliIPC
  (SFc3_StramigioliIPCInstanceStruct *chartInstance);
static void set_sim_state_c3_StramigioliIPC(SFc3_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c3_st);
static void finalize_c3_StramigioliIPC(SFc3_StramigioliIPCInstanceStruct
  *chartInstance);
static void sf_gateway_c3_StramigioliIPC(SFc3_StramigioliIPCInstanceStruct
  *chartInstance);
static void mdl_start_c3_StramigioliIPC(SFc3_StramigioliIPCInstanceStruct
  *chartInstance);
static void initSimStructsc3_StramigioliIPC(SFc3_StramigioliIPCInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_StramigioliIPCInstanceStruct *chartInstance,
  const mxArray *c3_b_qb3, const char_T *c3_identifier, real_T c3_y[4]);
static void c3_b_emlrt_marshallIn(SFc3_StramigioliIPCInstanceStruct
...
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_c_emlrt_marshallIn(SFc3_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c3_b_pb3, const char_T *c3_identifier, real_T
  c3_y[3]);
static void c3_d_emlrt_marshallIn(SFc3_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[3]);
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_e_emlrt_marshallIn(SFc3_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[12]);
...
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_f_emlrt_marshallIn(SFc3_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static void c3_quatmultiply(SFc3_StramigioliIPCInstanceStruct *chartInstance,
  real_T c3_q[4], real_T c3_r[4], real_T c3_qout[4]);
static const mxArray *c3_e_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_g_emlrt_marshallIn(SFc3_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_h_emlrt_marshallIn(SFc3_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_StramigioliIPC, const char_T *
  c3_identifier);
static uint8_T c3_i_emlrt_marshallIn(SFc3_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_StramigioliIPCInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc3_StramigioliIPCInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_StramigioliIPC = 0U;
}
  ...
  (SFc3_StramigioliIPCInstanceStruct *chartInstance)
{
  ...
  sf_mex_import_named("rv", sf_mex_get_sfun_param(chartInstance->S, 0, 0),
                      c3_dv0, 0, 0, 0U, 1, 0U, 1, 12);
  for (c3_i0 = 0; c3_i0 < 12; c3_i0++) {
    chartInstance->c3_rv[c3_i0] = c3_dv0[c3_i0];
  }
}
  ...
  (SFc3_StramigioliIPCInstanceStruct *chartInstance)
{
  ...
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_StramigioliIPC;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_StramigioliIPC = c3_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 2)),
     "is_active_c3_StramigioliIPC");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_StramigioliIPC(chartInstance);
  ...
  *chartInstance)
{
  ...
  for (c3_i9 = 0; c3_i9 < 12; c3_i9++) {
    c3_b_rv[c3_i9] = chartInstance->c3_rv[c3_i9];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_b_rv, 4U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_q, 3U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_r, 4U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  ...
  for (c3_i24 = 0; c3_i24 < 12; c3_i24++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c3_rv[c3_i24], 3U);
  }
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_StramigioliIPCInstanceStruct *chartInstance;
  chartInstance = (SFc3_StramigioliIPCInstanceStruct *)chartInstanceVoid;
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  SFc3_StramigioliIPCInstanceStruct *chartInstance;
  chartInstance = (SFc3_StramigioliIPCInstanceStruct *)chartInstanceVoid;
  c3_b_rv = sf_mex_dup(c3_mxArrayInData);
  c3_identifier = c3_varName;
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_rv), &c3_thisId, c3_y);
  sf_mex_destroy(&c3_b_rv);
...
const mxArray *sf_c3_StramigioliIPC_get_eml_resolved_functions_info(void)
{
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/Stramigioli IPC/quatrot.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1460657807U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  c3_identifier)
{
  ...
  c3_y = c3_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_StramigioliIPC), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_StramigioliIPC);
  return c3_y;
}
...
void sf_c3_StramigioliIPC_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1413760956U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4280777439U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(745425484U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3215701405U);
}

mxArray* sf_c3_StramigioliIPC_get_post_codegen_info(void);
mxArray *sf_c3_StramigioliIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("OxC09uHp2jeVWFyASf5sME");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c3_StramigioliIPC_get_post_codegen_info();
...
mxArray *sf_c3_StramigioliIPC_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_StramigioliIPC_jit_fallback_info(void)
{
...
mxArray *sf_c3_StramigioliIPC_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_StramigioliIPC(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"pb3\",},{M[1],M[8],T\"qb3\",},{M[8],M[0],T\"is_active_c3_StramigioliIPC\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_StramigioliIPC_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_StramigioliIPCInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c3_rv);
...
{
  return "ReLHav6fyDQEmFb2xQ9aqG";
}

static void sf_opaque_initialize_c3_StramigioliIPC(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_StramigioliIPCInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_StramigioliIPC((SFc3_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
  initialize_c3_StramigioliIPC((SFc3_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_StramigioliIPC(void *chartInstanceVar)
{
  enable_c3_StramigioliIPC((SFc3_StramigioliIPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_StramigioliIPC(void *chartInstanceVar)
{
  disable_c3_StramigioliIPC((SFc3_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_StramigioliIPC(void *chartInstanceVar)
{
  sf_gateway_c3_StramigioliIPC((SFc3_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c3_StramigioliIPC(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c3_StramigioliIPC((SFc3_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_StramigioliIPC(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c3_StramigioliIPC((SFc3_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c3_StramigioliIPC(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_StramigioliIPCInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_StramigioliIPC((SFc3_StramigioliIPCInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_StramigioliIPC((SFc3_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_StramigioliIPC(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_StramigioliIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4000675468U));
  ssSetChecksum1(S,(1651902629U));
  ssSetChecksum2(S,(3995562393U));
  ssSetChecksum3(S,(2588758151U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_StramigioliIPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_StramigioliIPC(SimStruct *S)
{
  SFc3_StramigioliIPCInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_StramigioliIPCInstanceStruct *)utMalloc(sizeof
    (SFc3_StramigioliIPCInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_StramigioliIPCInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_StramigioliIPC;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_StramigioliIPC;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_StramigioliIPC;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_StramigioliIPC;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_StramigioliIPC;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_StramigioliIPC;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_StramigioliIPC;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_StramigioliIPC;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_StramigioliIPC;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_StramigioliIPC;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_StramigioliIPC;
...
void c3_StramigioliIPC_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_StramigioliIPC(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_StramigioliIPC_method_dispatcher.\n"
