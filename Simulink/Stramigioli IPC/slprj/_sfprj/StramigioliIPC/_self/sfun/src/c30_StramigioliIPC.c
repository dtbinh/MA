...
static void initialize_c30_StramigioliIPC(SFc30_StramigioliIPCInstanceStruct
  *chartInstance);
static void initialize_params_c30_StramigioliIPC
  (SFc30_StramigioliIPCInstanceStruct *chartInstance);
static void enable_c30_StramigioliIPC(SFc30_StramigioliIPCInstanceStruct
  *chartInstance);
static void disable_c30_StramigioliIPC(SFc30_StramigioliIPCInstanceStruct
  *chartInstance);
static void c30_update_debugger_state_c30_StramigioliIPC
  (SFc30_StramigioliIPCInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c30_StramigioliIPC
  (SFc30_StramigioliIPCInstanceStruct *chartInstance);
static void set_sim_state_c30_StramigioliIPC(SFc30_StramigioliIPCInstanceStruct *
  chartInstance, const mxArray *c30_st);
static void finalize_c30_StramigioliIPC(SFc30_StramigioliIPCInstanceStruct
  *chartInstance);
static void sf_gateway_c30_StramigioliIPC(SFc30_StramigioliIPCInstanceStruct
  *chartInstance);
static void mdl_start_c30_StramigioliIPC(SFc30_StramigioliIPCInstanceStruct
  *chartInstance);
static void initSimStructsc30_StramigioliIPC(SFc30_StramigioliIPCInstanceStruct *
  chartInstance);
static void c30_quatrot(SFc30_StramigioliIPCInstanceStruct *chartInstance,
  real_T c30_q[4], real_T c30_b_r[3], real_T c30_rw[3]);
...
static const mxArray *c30_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static void c30_emlrt_marshallIn(SFc30_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c30_b_Ared, const char_T *c30_identifier,
  real_T c30_y[432]);
static void c30_b_emlrt_marshallIn(SFc30_StramigioliIPCInstanceStruct
...
static const mxArray *c30_c_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static void c30_c_emlrt_marshallIn(SFc30_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId,
  real_T c30_y[12]);
...
static const mxArray *c30_d_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static real_T c30_d_emlrt_marshallIn(SFc30_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId);
...
static const mxArray *c30_e_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static void c30_e_emlrt_marshallIn(SFc30_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId,
  real_T c30_y[3]);
...
static const mxArray *c30_f_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static void c30_f_emlrt_marshallIn(SFc30_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId,
  real_T c30_y[4]);
...
static const mxArray *c30_g_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static void c30_g_emlrt_marshallIn(SFc30_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId,
  real_T c30_y[9]);
...
static void c30_eye(SFc30_StramigioliIPCInstanceStruct *chartInstance, real_T
                    c30_I[9]);
static void c30_quatmultiply(SFc30_StramigioliIPCInstanceStruct *chartInstance,
  real_T c30_q[4], real_T c30_b_r[4], real_T c30_qout[4]);
static const mxArray *c30_h_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static int32_T c30_h_emlrt_marshallIn(SFc30_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId);
static void c30_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c30_mxArrayInData, const char_T *c30_varName, void *c30_outData);
static uint8_T c30_i_emlrt_marshallIn(SFc30_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c30_b_is_active_c30_StramigioliIPC, const
  char_T *c30_identifier);
static uint8_T c30_j_emlrt_marshallIn(SFc30_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId);
static void init_dsm_address_info(SFc30_StramigioliIPCInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc30_StramigioliIPCInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c30_is_active_c30_StramigioliIPC = 0U;
}
  ...
  (SFc30_StramigioliIPCInstanceStruct *chartInstance)
{
  ...
  c30_hoistedGlobal = chartInstance->c30_is_active_c30_StramigioliIPC;
  ...
  chartInstance, const mxArray *c30_st)
{
  ...
  chartInstance->c30_is_active_c30_StramigioliIPC = c30_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c30_u, 1)),
     "is_active_c30_StramigioliIPC");
  sf_mex_destroy(&c30_u);
  c30_update_debugger_state_c30_StramigioliIPC(chartInstance);
  ...
  *c30_inData)
{
  ...
  const mxArray *c30_y = NULL;
  SFc30_StramigioliIPCInstanceStruct *chartInstance;
  chartInstance = (SFc30_StramigioliIPCInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c30_StramigioliIPC_get_eml_resolved_functions_info(void)
{
...
static void c30_info_helper(const mxArray **c30_info)
{
  ...
  sf_mex_addfield(*c30_info, c30_b_emlrt_marshallOut(1460657807U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c30_info, c30_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c30_info, c30_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  char_T *c30_identifier)
{
  ...
  c30_y = c30_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c30_b_is_active_c30_StramigioliIPC), &c30_thisId);
  sf_mex_destroy(&c30_b_is_active_c30_StramigioliIPC);
  return c30_y;
}
...
void sf_c30_StramigioliIPC_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c30_StramigioliIPC_get_post_codegen_info(void);
mxArray *sf_c30_StramigioliIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c30_StramigioliIPC_get_post_codegen_info();
...
mxArray *sf_c30_StramigioliIPC_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c30_StramigioliIPC_jit_fallback_info(void)
{
...
mxArray *sf_c30_StramigioliIPC_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c30_StramigioliIPC(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Ared\",},{M[8],M[0],T\"is_active_c30_StramigioliIPC\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c30_StramigioliIPC_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc30_StramigioliIPCInstanceStruct *)
...
static void sf_opaque_initialize_c30_StramigioliIPC(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc30_StramigioliIPCInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c30_StramigioliIPC((SFc30_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
  initialize_c30_StramigioliIPC((SFc30_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c30_StramigioliIPC(void *chartInstanceVar)
{
  enable_c30_StramigioliIPC((SFc30_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c30_StramigioliIPC(void *chartInstanceVar)
{
  disable_c30_StramigioliIPC((SFc30_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c30_StramigioliIPC(void *chartInstanceVar)
{
  sf_gateway_c30_StramigioliIPC((SFc30_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c30_StramigioliIPC(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c30_StramigioliIPC((SFc30_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c30_StramigioliIPC(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c30_StramigioliIPC((SFc30_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c30_StramigioliIPC(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc30_StramigioliIPCInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c30_StramigioliIPC((SFc30_StramigioliIPCInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc30_StramigioliIPC((SFc30_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c30_StramigioliIPC(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c30_StramigioliIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(190616421U));
  ssSetChecksum1(S,(3826973146U));
  ssSetChecksum2(S,(1451045311U));
  ssSetChecksum3(S,(641897077U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c30_StramigioliIPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c30_StramigioliIPC(SimStruct *S)
{
  SFc30_StramigioliIPCInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc30_StramigioliIPCInstanceStruct *)utMalloc(sizeof
    (SFc30_StramigioliIPCInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc30_StramigioliIPCInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c30_StramigioliIPC;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c30_StramigioliIPC;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c30_StramigioliIPC;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c30_StramigioliIPC;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c30_StramigioliIPC;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c30_StramigioliIPC;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c30_StramigioliIPC;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c30_StramigioliIPC;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c30_StramigioliIPC;
  chartInstance->chartInfo.mdlStart = mdlStart_c30_StramigioliIPC;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c30_StramigioliIPC;
...
void c30_StramigioliIPC_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c30_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c30_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c30_StramigioliIPC(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c30_StramigioliIPC_method_dispatcher.\n"
