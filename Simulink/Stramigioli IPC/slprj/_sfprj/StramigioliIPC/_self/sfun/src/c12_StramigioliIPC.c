...
static void initialize_c12_StramigioliIPC(SFc12_StramigioliIPCInstanceStruct
  *chartInstance);
static void initialize_params_c12_StramigioliIPC
  (SFc12_StramigioliIPCInstanceStruct *chartInstance);
static void enable_c12_StramigioliIPC(SFc12_StramigioliIPCInstanceStruct
  *chartInstance);
static void disable_c12_StramigioliIPC(SFc12_StramigioliIPCInstanceStruct
  *chartInstance);
static void c12_update_debugger_state_c12_StramigioliIPC
  (SFc12_StramigioliIPCInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_StramigioliIPC
  (SFc12_StramigioliIPCInstanceStruct *chartInstance);
static void set_sim_state_c12_StramigioliIPC(SFc12_StramigioliIPCInstanceStruct *
  chartInstance, const mxArray *c12_st);
static void finalize_c12_StramigioliIPC(SFc12_StramigioliIPCInstanceStruct
  *chartInstance);
static void sf_gateway_c12_StramigioliIPC(SFc12_StramigioliIPCInstanceStruct
  *chartInstance);
static void mdl_start_c12_StramigioliIPC(SFc12_StramigioliIPCInstanceStruct
  *chartInstance);
static void initSimStructsc12_StramigioliIPC(SFc12_StramigioliIPCInstanceStruct *
  chartInstance);
static void c12_quatrot(SFc12_StramigioliIPCInstanceStruct *chartInstance,
  real_T c12_q[4], real_T c12_r[3], real_T c12_rw[3]);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber, uint32_T c12_instanceNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_emlrt_marshallIn(SFc12_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c12_b_G, const char_T *c12_identifier, real_T
  c12_y[144]);
static void c12_b_emlrt_marshallIn(SFc12_StramigioliIPCInstanceStruct
...
static const mxArray *c12_c_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_c_emlrt_marshallIn(SFc12_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId,
  real_T c12_y[12]);
...
static const mxArray *c12_d_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_d_emlrt_marshallIn(SFc12_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
...
static const mxArray *c12_e_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_e_emlrt_marshallIn(SFc12_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId,
  real_T c12_y[3]);
...
static const mxArray *c12_f_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_f_emlrt_marshallIn(SFc12_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId,
  real_T c12_y[4]);
...
static const mxArray *c12_g_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_g_emlrt_marshallIn(SFc12_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId,
  real_T c12_y[9]);
...
static void c12_eye(SFc12_StramigioliIPCInstanceStruct *chartInstance, real_T
                    c12_I[9]);
static void c12_quatmultiply(SFc12_StramigioliIPCInstanceStruct *chartInstance,
  real_T c12_q[4], real_T c12_r[4], real_T c12_qout[4]);
static const mxArray *c12_h_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_h_emlrt_marshallIn(SFc12_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static uint8_T c12_i_emlrt_marshallIn(SFc12_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c12_b_is_active_c12_StramigioliIPC, const
  char_T *c12_identifier);
static uint8_T c12_j_emlrt_marshallIn(SFc12_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void init_dsm_address_info(SFc12_StramigioliIPCInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc12_StramigioliIPCInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_StramigioliIPC = 0U;
}
  ...
  (SFc12_StramigioliIPCInstanceStruct *chartInstance)
{
  ...
  c12_hoistedGlobal = chartInstance->c12_is_active_c12_StramigioliIPC;
  ...
  chartInstance, const mxArray *c12_st)
{
  ...
  chartInstance->c12_is_active_c12_StramigioliIPC = c12_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 1)),
     "is_active_c12_StramigioliIPC");
  sf_mex_destroy(&c12_u);
  c12_update_debugger_state_c12_StramigioliIPC(chartInstance);
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_StramigioliIPCInstanceStruct *chartInstance;
  chartInstance = (SFc12_StramigioliIPCInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c12_StramigioliIPC_get_eml_resolved_functions_info(void)
{
...
static void c12_info_helper(const mxArray **c12_info)
{
  ...
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1460657807U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  char_T *c12_identifier)
{
  ...
  c12_y = c12_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_StramigioliIPC), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_StramigioliIPC);
  return c12_y;
}
...
void sf_c12_StramigioliIPC_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c12_StramigioliIPC_get_post_codegen_info(void);
mxArray *sf_c12_StramigioliIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c12_StramigioliIPC_get_post_codegen_info();
...
mxArray *sf_c12_StramigioliIPC_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c12_StramigioliIPC_jit_fallback_info(void)
{
...
mxArray *sf_c12_StramigioliIPC_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c12_StramigioliIPC(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"G\",},{M[8],M[0],T\"is_active_c12_StramigioliIPC\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_StramigioliIPC_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc12_StramigioliIPCInstanceStruct *)
...
static void sf_opaque_initialize_c12_StramigioliIPC(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_StramigioliIPCInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c12_StramigioliIPC((SFc12_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
  initialize_c12_StramigioliIPC((SFc12_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c12_StramigioliIPC(void *chartInstanceVar)
{
  enable_c12_StramigioliIPC((SFc12_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c12_StramigioliIPC(void *chartInstanceVar)
{
  disable_c12_StramigioliIPC((SFc12_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c12_StramigioliIPC(void *chartInstanceVar)
{
  sf_gateway_c12_StramigioliIPC((SFc12_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c12_StramigioliIPC(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c12_StramigioliIPC((SFc12_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c12_StramigioliIPC(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c12_StramigioliIPC((SFc12_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c12_StramigioliIPC(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_StramigioliIPCInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c12_StramigioliIPC((SFc12_StramigioliIPCInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc12_StramigioliIPC((SFc12_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_StramigioliIPC(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c12_StramigioliIPC(SimStruct *S)
{
...
static void mdlRTW_c12_StramigioliIPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_StramigioliIPC(SimStruct *S)
{
  SFc12_StramigioliIPCInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc12_StramigioliIPCInstanceStruct *)utMalloc(sizeof
    (SFc12_StramigioliIPCInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc12_StramigioliIPCInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c12_StramigioliIPC;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_StramigioliIPC;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c12_StramigioliIPC;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c12_StramigioliIPC;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c12_StramigioliIPC;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c12_StramigioliIPC;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c12_StramigioliIPC;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_StramigioliIPC;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_StramigioliIPC;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_StramigioliIPC;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c12_StramigioliIPC;
...
void c12_StramigioliIPC_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_StramigioliIPC(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_StramigioliIPC_method_dispatcher.\n"
