...
static void initialize_c31_StramigioliIPC(SFc31_StramigioliIPCInstanceStruct
  *chartInstance);
static void initialize_params_c31_StramigioliIPC
  (SFc31_StramigioliIPCInstanceStruct *chartInstance);
static void enable_c31_StramigioliIPC(SFc31_StramigioliIPCInstanceStruct
  *chartInstance);
static void disable_c31_StramigioliIPC(SFc31_StramigioliIPCInstanceStruct
  *chartInstance);
static void c31_update_debugger_state_c31_StramigioliIPC
  (SFc31_StramigioliIPCInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c31_StramigioliIPC
  (SFc31_StramigioliIPCInstanceStruct *chartInstance);
static void set_sim_state_c31_StramigioliIPC(SFc31_StramigioliIPCInstanceStruct *
  chartInstance, const mxArray *c31_st);
static void finalize_c31_StramigioliIPC(SFc31_StramigioliIPCInstanceStruct
  *chartInstance);
static void sf_gateway_c31_StramigioliIPC(SFc31_StramigioliIPCInstanceStruct
  *chartInstance);
static void mdl_start_c31_StramigioliIPC(SFc31_StramigioliIPCInstanceStruct
  *chartInstance);
static void c31_chartstep_c31_StramigioliIPC(SFc31_StramigioliIPCInstanceStruct *
  chartInstance);
static void initSimStructsc31_StramigioliIPC(SFc31_StramigioliIPCInstanceStruct *
  chartInstance);
static void c31_skew_sm(SFc31_StramigioliIPCInstanceStruct *chartInstance,
  real_T c31_b_x[3], real_T c31_X[9]);
static void c31_quatrot(SFc31_StramigioliIPCInstanceStruct *chartInstance,
...
static const mxArray *c31_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_emlrt_marshallIn(SFc31_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c31_b_bred, const char_T *c31_identifier,
  real_T c31_y[18]);
static void c31_b_emlrt_marshallIn(SFc31_StramigioliIPCInstanceStruct
...
static const mxArray *c31_d_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_c_emlrt_marshallIn(SFc31_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId,
  real_T c31_y[12]);
...
static const mxArray *c31_e_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static real_T c31_d_emlrt_marshallIn(SFc31_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
...
static const mxArray *c31_f_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_e_emlrt_marshallIn(SFc31_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId,
  real_T c31_y[9]);
...
static const mxArray *c31_g_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_f_emlrt_marshallIn(SFc31_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId,
  real_T c31_y[3]);
...
static const mxArray *c31_h_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_g_emlrt_marshallIn(SFc31_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId,
  real_T c31_y[4]);
...
static void c31_eml_scalar_eg(SFc31_StramigioliIPCInstanceStruct *chartInstance);
static void c31_threshold(SFc31_StramigioliIPCInstanceStruct *chartInstance);
static void c31_quatmultiply(SFc31_StramigioliIPCInstanceStruct *chartInstance,
  real_T c31_q[4], real_T c31_b_r[4], real_T c31_qout[4]);
static void c31_b_eml_scalar_eg(SFc31_StramigioliIPCInstanceStruct
  *chartInstance);
static const mxArray *c31_i_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static int32_T c31_h_emlrt_marshallIn(SFc31_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
static void c31_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData);
static uint8_T c31_i_emlrt_marshallIn(SFc31_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c31_b_is_active_c31_StramigioliIPC, const
  char_T *c31_identifier);
static uint8_T c31_j_emlrt_marshallIn(SFc31_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
static void init_dsm_address_info(SFc31_StramigioliIPCInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc31_StramigioliIPCInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c31_is_active_c31_StramigioliIPC = 0U;
}
  ...
  (SFc31_StramigioliIPCInstanceStruct *chartInstance)
{
  ...
  c31_hoistedGlobal = chartInstance->c31_is_active_c31_StramigioliIPC;
  ...
  chartInstance, const mxArray *c31_st)
{
  ...
  chartInstance->c31_is_active_c31_StramigioliIPC = c31_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c31_u, 1)),
     "is_active_c31_StramigioliIPC");
  sf_mex_destroy(&c31_u);
  c31_update_debugger_state_c31_StramigioliIPC(chartInstance);
  ...
  *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 17U, chartInstance->c31_sfEvent);
  ...
  chartInstance->c31_sfEvent = CALL_EVENT;
  c31_chartstep_c31_StramigioliIPC(chartInstance);
  ...
  chartInstance)
{
  ...
  int32_T c31_i52;
  int32_T c31_i53;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 17U, chartInstance->c31_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 17U, chartInstance->c31_sfEvent);
}
  ...
  *c31_inData)
{
  ...
  const mxArray *c31_y = NULL;
  SFc31_StramigioliIPCInstanceStruct *chartInstance;
  chartInstance = (SFc31_StramigioliIPCInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c31_StramigioliIPC_get_eml_resolved_functions_info(void)
{
...
static void c31_info_helper(const mxArray **c31_info)
{
  ...
  sf_mex_addfield(*c31_info, c31_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/Stramigioli IPC/skew_sm.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c31_info, c31_b_emlrt_marshallOut(1460657807U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  char_T *c31_identifier)
{
  ...
  c31_y = c31_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c31_b_is_active_c31_StramigioliIPC), &c31_thisId);
  sf_mex_destroy(&c31_b_is_active_c31_StramigioliIPC);
  return c31_y;
}
...
void sf_c31_StramigioliIPC_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c31_StramigioliIPC_get_post_codegen_info(void);
mxArray *sf_c31_StramigioliIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c31_StramigioliIPC_get_post_codegen_info();
...
mxArray *sf_c31_StramigioliIPC_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c31_StramigioliIPC_jit_fallback_info(void)
{
...
mxArray *sf_c31_StramigioliIPC_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c31_StramigioliIPC(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"bred\",},{M[8],M[0],T\"is_active_c31_StramigioliIPC\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c31_StramigioliIPC_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc31_StramigioliIPCInstanceStruct *)
...
static void sf_opaque_initialize_c31_StramigioliIPC(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc31_StramigioliIPCInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c31_StramigioliIPC((SFc31_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
  initialize_c31_StramigioliIPC((SFc31_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c31_StramigioliIPC(void *chartInstanceVar)
{
  enable_c31_StramigioliIPC((SFc31_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c31_StramigioliIPC(void *chartInstanceVar)
{
  disable_c31_StramigioliIPC((SFc31_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c31_StramigioliIPC(void *chartInstanceVar)
{
  sf_gateway_c31_StramigioliIPC((SFc31_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c31_StramigioliIPC(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c31_StramigioliIPC((SFc31_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c31_StramigioliIPC(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c31_StramigioliIPC((SFc31_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c31_StramigioliIPC(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc31_StramigioliIPCInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c31_StramigioliIPC((SFc31_StramigioliIPCInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc31_StramigioliIPC((SFc31_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c31_StramigioliIPC(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c31_StramigioliIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3371941822U));
  ssSetChecksum1(S,(3519636313U));
  ssSetChecksum2(S,(3465125972U));
  ssSetChecksum3(S,(2966462152U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c31_StramigioliIPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c31_StramigioliIPC(SimStruct *S)
{
  SFc31_StramigioliIPCInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc31_StramigioliIPCInstanceStruct *)utMalloc(sizeof
    (SFc31_StramigioliIPCInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc31_StramigioliIPCInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c31_StramigioliIPC;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c31_StramigioliIPC;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c31_StramigioliIPC;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c31_StramigioliIPC;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c31_StramigioliIPC;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c31_StramigioliIPC;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c31_StramigioliIPC;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c31_StramigioliIPC;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c31_StramigioliIPC;
  chartInstance->chartInfo.mdlStart = mdlStart_c31_StramigioliIPC;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c31_StramigioliIPC;
...
void c31_StramigioliIPC_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c31_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c31_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c31_StramigioliIPC(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c31_StramigioliIPC_method_dispatcher.\n"
