...
static void initialize_c4_StramigioliIPC(SFc4_StramigioliIPCInstanceStruct
  *chartInstance);
static void initialize_params_c4_StramigioliIPC
  (SFc4_StramigioliIPCInstanceStruct *chartInstance);
static void enable_c4_StramigioliIPC(SFc4_StramigioliIPCInstanceStruct
  *chartInstance);
static void disable_c4_StramigioliIPC(SFc4_StramigioliIPCInstanceStruct
  *chartInstance);
static void c4_update_debugger_state_c4_StramigioliIPC
  (SFc4_StramigioliIPCInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_StramigioliIPC
  (SFc4_StramigioliIPCInstanceStruct *chartInstance);
static void set_sim_state_c4_StramigioliIPC(SFc4_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c4_st);
static void finalize_c4_StramigioliIPC(SFc4_StramigioliIPCInstanceStruct
  *chartInstance);
static void sf_gateway_c4_StramigioliIPC(SFc4_StramigioliIPCInstanceStruct
  *chartInstance);
static void mdl_start_c4_StramigioliIPC(SFc4_StramigioliIPCInstanceStruct
  *chartInstance);
static void initSimStructsc4_StramigioliIPC(SFc4_StramigioliIPCInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static void c4_emlrt_marshallIn(SFc4_StramigioliIPCInstanceStruct *chartInstance,
  const mxArray *c4_b_qb4, const char_T *c4_identifier, real_T c4_y[4]);
static void c4_b_emlrt_marshallIn(SFc4_StramigioliIPCInstanceStruct
...
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_c_emlrt_marshallIn(SFc4_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c4_b_pb4, const char_T *c4_identifier, real_T
  c4_y[3]);
static void c4_d_emlrt_marshallIn(SFc4_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[3]);
...
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_e_emlrt_marshallIn(SFc4_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[12]);
...
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_f_emlrt_marshallIn(SFc4_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static void c4_quatmultiply(SFc4_StramigioliIPCInstanceStruct *chartInstance,
  real_T c4_q[4], real_T c4_r[4], real_T c4_qout[4]);
static const mxArray *c4_e_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_g_emlrt_marshallIn(SFc4_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_h_emlrt_marshallIn(SFc4_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_StramigioliIPC, const char_T *
  c4_identifier);
static uint8_T c4_i_emlrt_marshallIn(SFc4_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_StramigioliIPCInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc4_StramigioliIPCInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_StramigioliIPC = 0U;
}
  ...
  (SFc4_StramigioliIPCInstanceStruct *chartInstance)
{
  ...
  sf_mex_import_named("rv", sf_mex_get_sfun_param(chartInstance->S, 0, 0),
                      c4_dv0, 0, 0, 0U, 1, 0U, 1, 12);
  for (c4_i0 = 0; c4_i0 < 12; c4_i0++) {
    chartInstance->c4_rv[c4_i0] = c4_dv0[c4_i0];
  }
}
  ...
  (SFc4_StramigioliIPCInstanceStruct *chartInstance)
{
  ...
  c4_hoistedGlobal = chartInstance->c4_is_active_c4_StramigioliIPC;
  ...
  *chartInstance, const mxArray *c4_st)
{
  ...
  chartInstance->c4_is_active_c4_StramigioliIPC = c4_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 2)),
     "is_active_c4_StramigioliIPC");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_StramigioliIPC(chartInstance);
  ...
  *chartInstance)
{
  ...
  for (c4_i9 = 0; c4_i9 < 12; c4_i9++) {
    c4_b_rv[c4_i9] = chartInstance->c4_rv[c4_i9];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_b_rv, 4U, c4_c_sf_marshallOut,
    c4_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_q, 3U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_r, 4U, c4_b_sf_marshallOut,
    c4_b_sf_marshallIn);
  ...
  for (c4_i24 = 0; c4_i24 < 12; c4_i24++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c4_rv[c4_i24], 3U);
  }
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_StramigioliIPCInstanceStruct *chartInstance;
  chartInstance = (SFc4_StramigioliIPCInstanceStruct *)chartInstanceVoid;
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  SFc4_StramigioliIPCInstanceStruct *chartInstance;
  chartInstance = (SFc4_StramigioliIPCInstanceStruct *)chartInstanceVoid;
  c4_b_rv = sf_mex_dup(c4_mxArrayInData);
  c4_identifier = c4_varName;
  c4_thisId.fIdentifier = c4_identifier;
  c4_thisId.fParent = NULL;
  c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_b_rv), &c4_thisId, c4_y);
  sf_mex_destroy(&c4_b_rv);
...
const mxArray *sf_c4_StramigioliIPC_get_eml_resolved_functions_info(void)
{
...
static void c4_info_helper(const mxArray **c4_info)
{
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/Stramigioli IPC/quatrot.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1460657807U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  c4_identifier)
{
  ...
  c4_y = c4_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_StramigioliIPC), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_StramigioliIPC);
  return c4_y;
}
...
void sf_c4_StramigioliIPC_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(485390054U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1822394815U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3318626663U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(450663628U);
}

mxArray* sf_c4_StramigioliIPC_get_post_codegen_info(void);
mxArray *sf_c4_StramigioliIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("YaK5Cx0RcGvZaWkkbFhJVF");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c4_StramigioliIPC_get_post_codegen_info();
...
mxArray *sf_c4_StramigioliIPC_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_StramigioliIPC_jit_fallback_info(void)
{
...
mxArray *sf_c4_StramigioliIPC_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_StramigioliIPC(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"pb4\",},{M[1],M[8],T\"qb4\",},{M[8],M[0],T\"is_active_c4_StramigioliIPC\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_StramigioliIPC_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_StramigioliIPCInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c4_rv);
...
{
  return "Jhsw2VGRgNZzMUENcX5tkG";
}

static void sf_opaque_initialize_c4_StramigioliIPC(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_StramigioliIPCInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_StramigioliIPC((SFc4_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
  initialize_c4_StramigioliIPC((SFc4_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_StramigioliIPC(void *chartInstanceVar)
{
  enable_c4_StramigioliIPC((SFc4_StramigioliIPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_StramigioliIPC(void *chartInstanceVar)
{
  disable_c4_StramigioliIPC((SFc4_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_StramigioliIPC(void *chartInstanceVar)
{
  sf_gateway_c4_StramigioliIPC((SFc4_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c4_StramigioliIPC(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c4_StramigioliIPC((SFc4_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c4_StramigioliIPC(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c4_StramigioliIPC((SFc4_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c4_StramigioliIPC(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_StramigioliIPCInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_StramigioliIPC((SFc4_StramigioliIPCInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_StramigioliIPC((SFc4_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_StramigioliIPC(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_StramigioliIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2955875367U));
  ssSetChecksum1(S,(3007853250U));
  ssSetChecksum2(S,(957026293U));
  ssSetChecksum3(S,(4072817263U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c4_StramigioliIPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_StramigioliIPC(SimStruct *S)
{
  SFc4_StramigioliIPCInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_StramigioliIPCInstanceStruct *)utMalloc(sizeof
    (SFc4_StramigioliIPCInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_StramigioliIPCInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_StramigioliIPC;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_StramigioliIPC;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_StramigioliIPC;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_StramigioliIPC;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_StramigioliIPC;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_StramigioliIPC;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_StramigioliIPC;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_StramigioliIPC;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_StramigioliIPC;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_StramigioliIPC;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_StramigioliIPC;
...
void c4_StramigioliIPC_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_StramigioliIPC(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_StramigioliIPC_method_dispatcher.\n"
