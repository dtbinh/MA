...
static void initialize_c2_StramigioliIPC(SFc2_StramigioliIPCInstanceStruct
  *chartInstance);
static void initialize_params_c2_StramigioliIPC
  (SFc2_StramigioliIPCInstanceStruct *chartInstance);
static void enable_c2_StramigioliIPC(SFc2_StramigioliIPCInstanceStruct
  *chartInstance);
static void disable_c2_StramigioliIPC(SFc2_StramigioliIPCInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_StramigioliIPC
  (SFc2_StramigioliIPCInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_StramigioliIPC
  (SFc2_StramigioliIPCInstanceStruct *chartInstance);
static void set_sim_state_c2_StramigioliIPC(SFc2_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_StramigioliIPC(SFc2_StramigioliIPCInstanceStruct
  *chartInstance);
static void sf_gateway_c2_StramigioliIPC(SFc2_StramigioliIPCInstanceStruct
  *chartInstance);
static void mdl_start_c2_StramigioliIPC(SFc2_StramigioliIPCInstanceStruct
  *chartInstance);
static void initSimStructsc2_StramigioliIPC(SFc2_StramigioliIPCInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_StramigioliIPCInstanceStruct *chartInstance,
  const mxArray *c2_b_qb2, const char_T *c2_identifier, real_T c2_y[4]);
static void c2_b_emlrt_marshallIn(SFc2_StramigioliIPCInstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c2_b_pb2, const char_T *c2_identifier, real_T
  c2_y[3]);
static void c2_d_emlrt_marshallIn(SFc2_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[3]);
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[12]);
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_f_emlrt_marshallIn(SFc2_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static void c2_quatmultiply(SFc2_StramigioliIPCInstanceStruct *chartInstance,
  real_T c2_q[4], real_T c2_r[4], real_T c2_qout[4]);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_g_emlrt_marshallIn(SFc2_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_h_emlrt_marshallIn(SFc2_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_StramigioliIPC, const char_T *
  c2_identifier);
static uint8_T c2_i_emlrt_marshallIn(SFc2_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_StramigioliIPCInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_StramigioliIPCInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_StramigioliIPC = 0U;
}
  ...
  (SFc2_StramigioliIPCInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_StramigioliIPC;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_StramigioliIPC = c2_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
     "is_active_c2_StramigioliIPC");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_StramigioliIPC(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_StramigioliIPCInstanceStruct *chartInstance;
  chartInstance = (SFc2_StramigioliIPCInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_StramigioliIPC_get_eml_resolved_functions_info(void)
{
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/Stramigioli IPC/quatrot.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1460657807U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  c2_identifier)
{
  ...
  c2_y = c2_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_StramigioliIPC), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_StramigioliIPC);
  return c2_y;
}
...
void sf_c2_StramigioliIPC_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_StramigioliIPC_get_post_codegen_info(void);
mxArray *sf_c2_StramigioliIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_StramigioliIPC_get_post_codegen_info();
...
mxArray *sf_c2_StramigioliIPC_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_StramigioliIPC_jit_fallback_info(void)
{
...
mxArray *sf_c2_StramigioliIPC_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_StramigioliIPC(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"pb2\",},{M[1],M[8],T\"qb2\",},{M[8],M[0],T\"is_active_c2_StramigioliIPC\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_StramigioliIPC_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_StramigioliIPCInstanceStruct *)
...
static void sf_opaque_initialize_c2_StramigioliIPC(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_StramigioliIPCInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_StramigioliIPC((SFc2_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
  initialize_c2_StramigioliIPC((SFc2_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_StramigioliIPC(void *chartInstanceVar)
{
  enable_c2_StramigioliIPC((SFc2_StramigioliIPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_StramigioliIPC(void *chartInstanceVar)
{
  disable_c2_StramigioliIPC((SFc2_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_StramigioliIPC(void *chartInstanceVar)
{
  sf_gateway_c2_StramigioliIPC((SFc2_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_StramigioliIPC(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_StramigioliIPC((SFc2_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_StramigioliIPC(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_StramigioliIPC((SFc2_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c2_StramigioliIPC(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_StramigioliIPCInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_StramigioliIPC((SFc2_StramigioliIPCInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_StramigioliIPC((SFc2_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_StramigioliIPC(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_StramigioliIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3321161499U));
  ssSetChecksum1(S,(286717905U));
  ssSetChecksum2(S,(662562663U));
  ssSetChecksum3(S,(3422752624U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_StramigioliIPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_StramigioliIPC(SimStruct *S)
{
  SFc2_StramigioliIPCInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_StramigioliIPCInstanceStruct *)utMalloc(sizeof
    (SFc2_StramigioliIPCInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_StramigioliIPCInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_StramigioliIPC;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_StramigioliIPC;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_StramigioliIPC;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_StramigioliIPC;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_StramigioliIPC;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_StramigioliIPC;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_StramigioliIPC;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_StramigioliIPC;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_StramigioliIPC;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_StramigioliIPC;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_StramigioliIPC;
...
void c2_StramigioliIPC_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_StramigioliIPC(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_StramigioliIPC_method_dispatcher.\n"
