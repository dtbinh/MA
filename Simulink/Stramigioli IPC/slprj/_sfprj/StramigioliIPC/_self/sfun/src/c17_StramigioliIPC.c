...
static void initialize_c17_StramigioliIPC(SFc17_StramigioliIPCInstanceStruct
  *chartInstance);
static void initialize_params_c17_StramigioliIPC
  (SFc17_StramigioliIPCInstanceStruct *chartInstance);
static void enable_c17_StramigioliIPC(SFc17_StramigioliIPCInstanceStruct
  *chartInstance);
static void disable_c17_StramigioliIPC(SFc17_StramigioliIPCInstanceStruct
  *chartInstance);
static void c17_update_debugger_state_c17_StramigioliIPC
  (SFc17_StramigioliIPCInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c17_StramigioliIPC
  (SFc17_StramigioliIPCInstanceStruct *chartInstance);
static void set_sim_state_c17_StramigioliIPC(SFc17_StramigioliIPCInstanceStruct *
  chartInstance, const mxArray *c17_st);
static void finalize_c17_StramigioliIPC(SFc17_StramigioliIPCInstanceStruct
  *chartInstance);
static void sf_gateway_c17_StramigioliIPC(SFc17_StramigioliIPCInstanceStruct
  *chartInstance);
static void mdl_start_c17_StramigioliIPC(SFc17_StramigioliIPCInstanceStruct
  *chartInstance);
static void initSimStructsc17_StramigioliIPC(SFc17_StramigioliIPCInstanceStruct *
  chartInstance);
static void c17_quatrot(SFc17_StramigioliIPCInstanceStruct *chartInstance,
  real_T c17_q[4], real_T c17_r[3], real_T c17_rw[3]);
...
static const mxArray *c17_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static void c17_emlrt_marshallIn(SFc17_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c17_b_G, const char_T *c17_identifier, real_T
  c17_y[144]);
static void c17_b_emlrt_marshallIn(SFc17_StramigioliIPCInstanceStruct
...
static const mxArray *c17_c_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static void c17_c_emlrt_marshallIn(SFc17_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId,
  real_T c17_y[12]);
...
static const mxArray *c17_d_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static real_T c17_d_emlrt_marshallIn(SFc17_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
...
static const mxArray *c17_e_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static void c17_e_emlrt_marshallIn(SFc17_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId,
  real_T c17_y[3]);
...
static const mxArray *c17_f_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static void c17_f_emlrt_marshallIn(SFc17_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId,
  real_T c17_y[4]);
...
static const mxArray *c17_g_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static void c17_g_emlrt_marshallIn(SFc17_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId,
  real_T c17_y[9]);
...
static void c17_eye(SFc17_StramigioliIPCInstanceStruct *chartInstance, real_T
                    c17_I[9]);
static void c17_quatmultiply(SFc17_StramigioliIPCInstanceStruct *chartInstance,
  real_T c17_q[4], real_T c17_r[4], real_T c17_qout[4]);
static const mxArray *c17_h_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static int32_T c17_h_emlrt_marshallIn(SFc17_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void c17_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c17_mxArrayInData, const char_T *c17_varName, void *c17_outData);
static uint8_T c17_i_emlrt_marshallIn(SFc17_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c17_b_is_active_c17_StramigioliIPC, const
  char_T *c17_identifier);
static uint8_T c17_j_emlrt_marshallIn(SFc17_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void init_dsm_address_info(SFc17_StramigioliIPCInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc17_StramigioliIPCInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c17_is_active_c17_StramigioliIPC = 0U;
}
  ...
  (SFc17_StramigioliIPCInstanceStruct *chartInstance)
{
  ...
  c17_hoistedGlobal = chartInstance->c17_is_active_c17_StramigioliIPC;
  ...
  chartInstance, const mxArray *c17_st)
{
  ...
  chartInstance->c17_is_active_c17_StramigioliIPC = c17_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c17_u, 1)),
     "is_active_c17_StramigioliIPC");
  sf_mex_destroy(&c17_u);
  c17_update_debugger_state_c17_StramigioliIPC(chartInstance);
  ...
  c17_chartNumber, uint32_T c17_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c17_chartNumber, c17_instanceNumber, 0U,
    ...
    "C:\\Users\\Martin\\Documents\\Git\\Simulink\\Stramigioli IPC\\quatrot.m"));
  ...
  *c17_inData)
{
  ...
  const mxArray *c17_y = NULL;
  SFc17_StramigioliIPCInstanceStruct *chartInstance;
  chartInstance = (SFc17_StramigioliIPCInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c17_StramigioliIPC_get_eml_resolved_functions_info(void)
{
...
static void c17_info_helper(const mxArray **c17_info)
{
  ...
  sf_mex_addfield(*c17_info, c17_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 21);
  sf_mex_addfield(*c17_info, c17_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/Stramigioli IPC/quatrot.m"),
                  "resolved", "resolved", 21);
  sf_mex_addfield(*c17_info, c17_b_emlrt_marshallOut(1460657807U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c17_info, c17_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c17_info, c17_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  char_T *c17_identifier)
{
  ...
  c17_y = c17_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c17_b_is_active_c17_StramigioliIPC), &c17_thisId);
  sf_mex_destroy(&c17_b_is_active_c17_StramigioliIPC);
  return c17_y;
}
...
void sf_c17_StramigioliIPC_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c17_StramigioliIPC_get_post_codegen_info(void);
mxArray *sf_c17_StramigioliIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c17_StramigioliIPC_get_post_codegen_info();
...
mxArray *sf_c17_StramigioliIPC_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c17_StramigioliIPC_jit_fallback_info(void)
{
...
mxArray *sf_c17_StramigioliIPC_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c17_StramigioliIPC(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"G\",},{M[8],M[0],T\"is_active_c17_StramigioliIPC\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c17_StramigioliIPC_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc17_StramigioliIPCInstanceStruct *)
...
static void sf_opaque_initialize_c17_StramigioliIPC(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc17_StramigioliIPCInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c17_StramigioliIPC((SFc17_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
  initialize_c17_StramigioliIPC((SFc17_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c17_StramigioliIPC(void *chartInstanceVar)
{
  enable_c17_StramigioliIPC((SFc17_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c17_StramigioliIPC(void *chartInstanceVar)
{
  disable_c17_StramigioliIPC((SFc17_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c17_StramigioliIPC(void *chartInstanceVar)
{
  sf_gateway_c17_StramigioliIPC((SFc17_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c17_StramigioliIPC(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c17_StramigioliIPC((SFc17_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c17_StramigioliIPC(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c17_StramigioliIPC((SFc17_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c17_StramigioliIPC(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc17_StramigioliIPCInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c17_StramigioliIPC((SFc17_StramigioliIPCInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc17_StramigioliIPC((SFc17_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c17_StramigioliIPC(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c17_StramigioliIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1024617200U));
  ssSetChecksum1(S,(2337729924U));
  ssSetChecksum2(S,(2392789246U));
  ssSetChecksum3(S,(676042923U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c17_StramigioliIPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c17_StramigioliIPC(SimStruct *S)
{
  SFc17_StramigioliIPCInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc17_StramigioliIPCInstanceStruct *)utMalloc(sizeof
    (SFc17_StramigioliIPCInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc17_StramigioliIPCInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c17_StramigioliIPC;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c17_StramigioliIPC;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c17_StramigioliIPC;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c17_StramigioliIPC;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c17_StramigioliIPC;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c17_StramigioliIPC;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c17_StramigioliIPC;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c17_StramigioliIPC;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c17_StramigioliIPC;
  chartInstance->chartInfo.mdlStart = mdlStart_c17_StramigioliIPC;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c17_StramigioliIPC;
...
void c17_StramigioliIPC_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c17_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c17_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c17_StramigioliIPC(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c17_StramigioliIPC_method_dispatcher.\n"
