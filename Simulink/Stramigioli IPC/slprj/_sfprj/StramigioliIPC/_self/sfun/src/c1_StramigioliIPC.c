...
static void initialize_c1_StramigioliIPC(SFc1_StramigioliIPCInstanceStruct
  *chartInstance);
static void initialize_params_c1_StramigioliIPC
  (SFc1_StramigioliIPCInstanceStruct *chartInstance);
static void enable_c1_StramigioliIPC(SFc1_StramigioliIPCInstanceStruct
  *chartInstance);
static void disable_c1_StramigioliIPC(SFc1_StramigioliIPCInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_StramigioliIPC
  (SFc1_StramigioliIPCInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_StramigioliIPC
  (SFc1_StramigioliIPCInstanceStruct *chartInstance);
static void set_sim_state_c1_StramigioliIPC(SFc1_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_StramigioliIPC(SFc1_StramigioliIPCInstanceStruct
  *chartInstance);
static void sf_gateway_c1_StramigioliIPC(SFc1_StramigioliIPCInstanceStruct
  *chartInstance);
static void mdl_start_c1_StramigioliIPC(SFc1_StramigioliIPCInstanceStruct
  *chartInstance);
static void initSimStructsc1_StramigioliIPC(SFc1_StramigioliIPCInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_StramigioliIPCInstanceStruct *chartInstance,
  const mxArray *c1_b_qb1, const char_T *c1_identifier, real_T c1_y[4]);
static void c1_b_emlrt_marshallIn(SFc1_StramigioliIPCInstanceStruct
...
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c1_b_pb1, const char_T *c1_identifier, real_T
  c1_y[3]);
static void c1_d_emlrt_marshallIn(SFc1_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[3]);
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_e_emlrt_marshallIn(SFc1_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[12]);
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_f_emlrt_marshallIn(SFc1_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static void c1_quatmultiply(SFc1_StramigioliIPCInstanceStruct *chartInstance,
  real_T c1_q[4], real_T c1_r[4], real_T c1_qout[4]);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_g_emlrt_marshallIn(SFc1_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_h_emlrt_marshallIn(SFc1_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_StramigioliIPC, const char_T *
  c1_identifier);
static uint8_T c1_i_emlrt_marshallIn(SFc1_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_StramigioliIPCInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc1_StramigioliIPCInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_StramigioliIPC = 0U;
}
  ...
  (SFc1_StramigioliIPCInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_StramigioliIPC;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_StramigioliIPC = c1_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
     "is_active_c1_StramigioliIPC");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_StramigioliIPC(chartInstance);
  ...
  *chartInstance)
{
  ...
  for (c1_i9 = 0; c1_i9 < 12; c1_i9++) {
    c1_b_rv[c1_i9] = chartInstance->c1_rv[c1_i9];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_b_rv, 4U, c1_c_sf_marshallOut,
    c1_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_q, 3U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_r, 4U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  ...
  for (c1_i24 = 0; c1_i24 < 12; c1_i24++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c1_rv[c1_i24], 3U);
  }
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_StramigioliIPCInstanceStruct *chartInstance;
  chartInstance = (SFc1_StramigioliIPCInstanceStruct *)chartInstanceVoid;
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_rv), &c1_thisId, c1_y);
...
const mxArray *sf_c1_StramigioliIPC_get_eml_resolved_functions_info(void)
{
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/Stramigioli IPC/quatrot.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1460657807U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  c1_identifier)
{
  ...
  c1_y = c1_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_StramigioliIPC), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_StramigioliIPC);
  return c1_y;
}
...
void sf_c1_StramigioliIPC_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(176860393U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1835141703U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3871071961U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(158338918U);
}

mxArray* sf_c1_StramigioliIPC_get_post_codegen_info(void);
mxArray *sf_c1_StramigioliIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("IQv82vVfmNWymTo4hERJ8B");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c1_StramigioliIPC_get_post_codegen_info();
...
mxArray *sf_c1_StramigioliIPC_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_StramigioliIPC_jit_fallback_info(void)
{
...
mxArray *sf_c1_StramigioliIPC_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_StramigioliIPC(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"pb1\",},{M[1],M[8],T\"qb1\",},{M[8],M[0],T\"is_active_c1_StramigioliIPC\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_StramigioliIPC_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_StramigioliIPCInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c1_rv);
...
{
  return "bUPsLjjCvipU5rTFlLYueG";
}

static void sf_opaque_initialize_c1_StramigioliIPC(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_StramigioliIPCInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_StramigioliIPC((SFc1_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
  initialize_c1_StramigioliIPC((SFc1_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_StramigioliIPC(void *chartInstanceVar)
{
  enable_c1_StramigioliIPC((SFc1_StramigioliIPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_StramigioliIPC(void *chartInstanceVar)
{
  disable_c1_StramigioliIPC((SFc1_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_StramigioliIPC(void *chartInstanceVar)
{
  sf_gateway_c1_StramigioliIPC((SFc1_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c1_StramigioliIPC(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c1_StramigioliIPC((SFc1_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c1_StramigioliIPC(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c1_StramigioliIPC((SFc1_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c1_StramigioliIPC(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_StramigioliIPCInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_StramigioliIPC((SFc1_StramigioliIPCInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_StramigioliIPC((SFc1_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_StramigioliIPC(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_StramigioliIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1042115860U));
  ssSetChecksum1(S,(994209762U));
  ssSetChecksum2(S,(1846195933U));
  ssSetChecksum3(S,(3739868301U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_StramigioliIPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_StramigioliIPC(SimStruct *S)
{
  SFc1_StramigioliIPCInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_StramigioliIPCInstanceStruct *)utMalloc(sizeof
    (SFc1_StramigioliIPCInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_StramigioliIPCInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_StramigioliIPC;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_StramigioliIPC;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_StramigioliIPC;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_StramigioliIPC;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_StramigioliIPC;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_StramigioliIPC;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_StramigioliIPC;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_StramigioliIPC;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_StramigioliIPC;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_StramigioliIPC;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_StramigioliIPC;
...
void c1_StramigioliIPC_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_StramigioliIPC(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_StramigioliIPC_method_dispatcher.\n"
