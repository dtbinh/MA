...
static void initialize_c6_StramigioliIPC(SFc6_StramigioliIPCInstanceStruct
  *chartInstance);
static void initialize_params_c6_StramigioliIPC
  (SFc6_StramigioliIPCInstanceStruct *chartInstance);
static void enable_c6_StramigioliIPC(SFc6_StramigioliIPCInstanceStruct
  *chartInstance);
static void disable_c6_StramigioliIPC(SFc6_StramigioliIPCInstanceStruct
  *chartInstance);
static void c6_update_debugger_state_c6_StramigioliIPC
  (SFc6_StramigioliIPCInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_StramigioliIPC
  (SFc6_StramigioliIPCInstanceStruct *chartInstance);
static void set_sim_state_c6_StramigioliIPC(SFc6_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c6_st);
static void finalize_c6_StramigioliIPC(SFc6_StramigioliIPCInstanceStruct
  *chartInstance);
static void sf_gateway_c6_StramigioliIPC(SFc6_StramigioliIPCInstanceStruct
  *chartInstance);
static void mdl_start_c6_StramigioliIPC(SFc6_StramigioliIPCInstanceStruct
  *chartInstance);
static void c6_chartstep_c6_StramigioliIPC(SFc6_StramigioliIPCInstanceStruct
  *chartInstance);
static void initSimStructsc6_StramigioliIPC(SFc6_StramigioliIPCInstanceStruct
  *chartInstance);
static void c6_skew_sm(SFc6_StramigioliIPCInstanceStruct *chartInstance, real_T
  c6_b_x[3], real_T c6_X[9]);
static void c6_quatrot(SFc6_StramigioliIPCInstanceStruct *chartInstance, real_T
  c6_q[4], real_T c6_b_r[3], real_T c6_rw[3]);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static void c6_emlrt_marshallIn(SFc6_StramigioliIPCInstanceStruct *chartInstance,
  const mxArray *c6_b_b, const char_T *c6_identifier, real_T c6_y[24]);
static void c6_b_emlrt_marshallIn(SFc6_StramigioliIPCInstanceStruct
...
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_c_emlrt_marshallIn(SFc6_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  real_T c6_y[12]);
...
static const mxArray *c6_d_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real_T c6_d_emlrt_marshallIn(SFc6_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_e_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_e_emlrt_marshallIn(SFc6_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  real_T c6_y[9]);
...
static const mxArray *c6_f_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_f_emlrt_marshallIn(SFc6_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  real_T c6_y[3]);
...
static const mxArray *c6_g_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_g_emlrt_marshallIn(SFc6_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  real_T c6_y[4]);
...
static void c6_eml_scalar_eg(SFc6_StramigioliIPCInstanceStruct *chartInstance);
static void c6_threshold(SFc6_StramigioliIPCInstanceStruct *chartInstance);
static void c6_quatmultiply(SFc6_StramigioliIPCInstanceStruct *chartInstance,
  real_T c6_q[4], real_T c6_b_r[4], real_T c6_qout[4]);
static void c6_b_eml_scalar_eg(SFc6_StramigioliIPCInstanceStruct *chartInstance);
static const mxArray *c6_h_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_h_emlrt_marshallIn(SFc6_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_i_emlrt_marshallIn(SFc6_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c6_b_is_active_c6_StramigioliIPC, const char_T *
  c6_identifier);
static uint8_T c6_j_emlrt_marshallIn(SFc6_StramigioliIPCInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_StramigioliIPCInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc6_StramigioliIPCInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_StramigioliIPC = 0U;
}
  ...
  (SFc6_StramigioliIPCInstanceStruct *chartInstance)
{
  ...
  c6_hoistedGlobal = chartInstance->c6_is_active_c6_StramigioliIPC;
  ...
  *chartInstance, const mxArray *c6_st)
{
  ...
  chartInstance->c6_is_active_c6_StramigioliIPC = c6_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 1)),
     "is_active_c6_StramigioliIPC");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_StramigioliIPC(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c6_sfEvent = CALL_EVENT;
  c6_chartstep_c6_StramigioliIPC(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_StramigioliIPCInstanceStruct *chartInstance;
  chartInstance = (SFc6_StramigioliIPCInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c6_StramigioliIPC_get_eml_resolved_functions_info(void)
{
...
static void c6_info_helper(const mxArray **c6_info)
{
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/Stramigioli IPC/skew_sm.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1460657807U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  c6_identifier)
{
  ...
  c6_y = c6_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_StramigioliIPC), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_StramigioliIPC);
  return c6_y;
}
...
void sf_c6_StramigioliIPC_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c6_StramigioliIPC_get_post_codegen_info(void);
mxArray *sf_c6_StramigioliIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c6_StramigioliIPC_get_post_codegen_info();
...
mxArray *sf_c6_StramigioliIPC_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_StramigioliIPC_jit_fallback_info(void)
{
...
mxArray *sf_c6_StramigioliIPC_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c6_StramigioliIPC(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"b\",},{M[8],M[0],T\"is_active_c6_StramigioliIPC\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_StramigioliIPC_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_StramigioliIPCInstanceStruct *)
...
static void sf_opaque_initialize_c6_StramigioliIPC(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_StramigioliIPCInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_StramigioliIPC((SFc6_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
  initialize_c6_StramigioliIPC((SFc6_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c6_StramigioliIPC(void *chartInstanceVar)
{
  enable_c6_StramigioliIPC((SFc6_StramigioliIPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_StramigioliIPC(void *chartInstanceVar)
{
  disable_c6_StramigioliIPC((SFc6_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c6_StramigioliIPC(void *chartInstanceVar)
{
  sf_gateway_c6_StramigioliIPC((SFc6_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c6_StramigioliIPC(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c6_StramigioliIPC((SFc6_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c6_StramigioliIPC(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c6_StramigioliIPC((SFc6_StramigioliIPCInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c6_StramigioliIPC(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_StramigioliIPCInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_StramigioliIPC((SFc6_StramigioliIPCInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc6_StramigioliIPC((SFc6_StramigioliIPCInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_StramigioliIPC(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_StramigioliIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2979339313U));
  ssSetChecksum1(S,(1310211432U));
  ssSetChecksum2(S,(4155348379U));
  ssSetChecksum3(S,(2248829761U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c6_StramigioliIPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_StramigioliIPC(SimStruct *S)
{
  SFc6_StramigioliIPCInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_StramigioliIPCInstanceStruct *)utMalloc(sizeof
    (SFc6_StramigioliIPCInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_StramigioliIPCInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_StramigioliIPC;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_StramigioliIPC;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_StramigioliIPC;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_StramigioliIPC;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_StramigioliIPC;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_StramigioliIPC;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_StramigioliIPC;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_StramigioliIPC;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_StramigioliIPC;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_StramigioliIPC;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_StramigioliIPC;
...
void c6_StramigioliIPC_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_StramigioliIPC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_StramigioliIPC(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_StramigioliIPC_method_dispatcher.\n"
