...
static void initialize_c37_DIPCRT(SFc37_DIPCRTInstanceStruct *chartInstance);
static void initialize_params_c37_DIPCRT(SFc37_DIPCRTInstanceStruct
  *chartInstance);
static void enable_c37_DIPCRT(SFc37_DIPCRTInstanceStruct *chartInstance);
static void disable_c37_DIPCRT(SFc37_DIPCRTInstanceStruct *chartInstance);
static void c37_update_debugger_state_c37_DIPCRT(SFc37_DIPCRTInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c37_DIPCRT(SFc37_DIPCRTInstanceStruct
  *chartInstance);
static void set_sim_state_c37_DIPCRT(SFc37_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c37_st);
static void finalize_c37_DIPCRT(SFc37_DIPCRTInstanceStruct *chartInstance);
static void sf_gateway_c37_DIPCRT(SFc37_DIPCRTInstanceStruct *chartInstance);
static void mdl_start_c37_DIPCRT(SFc37_DIPCRTInstanceStruct *chartInstance);
static void initSimStructsc37_DIPCRT(SFc37_DIPCRTInstanceStruct *chartInstance);
static void c37_quatrot(SFc37_DIPCRTInstanceStruct *chartInstance, real_T c37_q
  [4], real_T c37_b_r[3], real_T c37_rw[3]);
...
static const mxArray *c37_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static void c37_emlrt_marshallIn(SFc37_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c37_b_x, const char_T *c37_identifier, real_T c37_y[28]);
static void c37_b_emlrt_marshallIn(SFc37_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c37_b_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static void c37_c_emlrt_marshallIn(SFc37_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c37_e_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static real_T c37_d_emlrt_marshallIn(SFc37_DIPCRTInstanceStruct *chartInstance,
...
static void c37_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData);
static void c37_e_emlrt_marshallIn(SFc37_DIPCRTInstanceStruct *chartInstance,
...
static void c37_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData);
static void c37_f_emlrt_marshallIn(SFc37_DIPCRTInstanceStruct *chartInstance,
...
static void c37_quatmultiply(SFc37_DIPCRTInstanceStruct *chartInstance, real_T
  c37_q[4], real_T c37_b_r[4], real_T c37_qout[4]);
static const mxArray *c37_f_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static int32_T c37_g_emlrt_marshallIn(SFc37_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
static void c37_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData);
static uint8_T c37_h_emlrt_marshallIn(SFc37_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c37_b_is_active_c37_DIPCRT, const char_T *c37_identifier);
static uint8_T c37_i_emlrt_marshallIn(SFc37_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
static void init_dsm_address_info(SFc37_DIPCRTInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc37_DIPCRTInstanceStruct *chartInstance);
...
static void initialize_c37_DIPCRT(SFc37_DIPCRTInstanceStruct *chartInstance)
{
  ...
  chartInstance->c37_is_active_c37_DIPCRT = 0U;
}
  ...
  *chartInstance)
{
  ...
  c37_hoistedGlobal = chartInstance->c37_is_active_c37_DIPCRT;
  ...
  const mxArray *c37_st)
{
  ...
  chartInstance->c37_is_active_c37_DIPCRT = c37_h_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c37_u, 1)), "is_active_c37_DIPCRT");
  sf_mex_destroy(&c37_u);
  c37_update_debugger_state_c37_DIPCRT(chartInstance);
...
static void sf_gateway_c37_DIPCRT(SFc37_DIPCRTInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 26U, chartInstance->c37_sfEvent);
  ...
  chartInstance->c37_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 26U, chartInstance->c37_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 26U, chartInstance->c37_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *c37_inData)
{
  ...
  real_T c37_u[28];
  const mxArray *c37_y = NULL;
  SFc37_DIPCRTInstanceStruct *chartInstance;
  chartInstance = (SFc37_DIPCRTInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c37_DIPCRT_get_eml_resolved_functions_info(void)
{
...
static void c37_info_helper(const mxArray **c37_info)
{
  ...
  sf_mex_addfield(*c37_info, c37_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPC - referencetrajectory/quatrot.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(1460657806U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  const mxArray *c37_b_is_active_c37_DIPCRT, const char_T *c37_identifier)
{
  ...
  c37_y = c37_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c37_b_is_active_c37_DIPCRT), &c37_thisId);
  sf_mex_destroy(&c37_b_is_active_c37_DIPCRT);
  return c37_y;
}
...
void sf_c37_DIPCRT_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c37_DIPCRT_get_post_codegen_info(void);
mxArray *sf_c37_DIPCRT_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c37_DIPCRT_get_post_codegen_info();
...
mxArray *sf_c37_DIPCRT_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c37_DIPCRT_jit_fallback_info(void)
{
...
mxArray *sf_c37_DIPCRT_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c37_DIPCRT(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"x\",},{M[8],M[0],T\"is_active_c37_DIPCRT\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c37_DIPCRT_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc37_DIPCRTInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c37_DIPCRT(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc37_DIPCRTInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c37_DIPCRT((SFc37_DIPCRTInstanceStruct*) chartInstanceVar);
  initialize_c37_DIPCRT((SFc37_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c37_DIPCRT(void *chartInstanceVar)
{
  enable_c37_DIPCRT((SFc37_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c37_DIPCRT(void *chartInstanceVar)
{
  disable_c37_DIPCRT((SFc37_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c37_DIPCRT(void *chartInstanceVar)
{
  sf_gateway_c37_DIPCRT((SFc37_DIPCRTInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c37_DIPCRT(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c37_DIPCRT((SFc37_DIPCRTInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c37_DIPCRT(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c37_DIPCRT((SFc37_DIPCRTInstanceStruct*)chartInfo->chartInstance,
    st);
}

static void sf_opaque_terminate_c37_DIPCRT(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc37_DIPCRTInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c37_DIPCRT((SFc37_DIPCRTInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc37_DIPCRT((SFc37_DIPCRTInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c37_DIPCRT(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c37_DIPCRT((SFc37_DIPCRTInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c37_DIPCRT(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1338158453U));
  ssSetChecksum1(S,(1452460620U));
  ssSetChecksum2(S,(3056456199U));
  ssSetChecksum3(S,(2648108690U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c37_DIPCRT(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c37_DIPCRT(SimStruct *S)
{
  SFc37_DIPCRTInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc37_DIPCRTInstanceStruct *)utMalloc(sizeof
    (SFc37_DIPCRTInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc37_DIPCRTInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c37_DIPCRT;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c37_DIPCRT;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c37_DIPCRT;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c37_DIPCRT;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c37_DIPCRT;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c37_DIPCRT;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c37_DIPCRT;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c37_DIPCRT;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c37_DIPCRT;
  chartInstance->chartInfo.mdlStart = mdlStart_c37_DIPCRT;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c37_DIPCRT;
...
void c37_DIPCRT_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c37_DIPCRT(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c37_DIPCRT(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c37_DIPCRT(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c37_DIPCRT_method_dispatcher.\n"
