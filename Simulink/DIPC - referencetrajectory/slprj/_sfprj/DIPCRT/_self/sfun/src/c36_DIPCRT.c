...
static void initialize_c36_DIPCRT(SFc36_DIPCRTInstanceStruct *chartInstance);
static void initialize_params_c36_DIPCRT(SFc36_DIPCRTInstanceStruct
  *chartInstance);
static void enable_c36_DIPCRT(SFc36_DIPCRTInstanceStruct *chartInstance);
static void disable_c36_DIPCRT(SFc36_DIPCRTInstanceStruct *chartInstance);
static void c36_update_debugger_state_c36_DIPCRT(SFc36_DIPCRTInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c36_DIPCRT(SFc36_DIPCRTInstanceStruct
  *chartInstance);
static void set_sim_state_c36_DIPCRT(SFc36_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c36_st);
static void finalize_c36_DIPCRT(SFc36_DIPCRTInstanceStruct *chartInstance);
static void sf_gateway_c36_DIPCRT(SFc36_DIPCRTInstanceStruct *chartInstance);
static void mdl_start_c36_DIPCRT(SFc36_DIPCRTInstanceStruct *chartInstance);
static void initSimStructsc36_DIPCRT(SFc36_DIPCRTInstanceStruct *chartInstance);
static void c36_quatrot(SFc36_DIPCRTInstanceStruct *chartInstance, real_T c36_q
  [4], real_T c36_b_r[3], real_T c36_rw[3]);
...
static const mxArray *c36_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_emlrt_marshallIn(SFc36_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c36_b_G, const char_T *c36_identifier, real_T c36_y[144]);
static void c36_b_emlrt_marshallIn(SFc36_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c36_c_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_c_emlrt_marshallIn(SFc36_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c36_d_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static real_T c36_d_emlrt_marshallIn(SFc36_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c36_e_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_e_emlrt_marshallIn(SFc36_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c36_f_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_f_emlrt_marshallIn(SFc36_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c36_g_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_g_emlrt_marshallIn(SFc36_DIPCRTInstanceStruct *chartInstance,
...
static void c36_eye(SFc36_DIPCRTInstanceStruct *chartInstance, real_T c36_I[9]);
static void c36_quatmultiply(SFc36_DIPCRTInstanceStruct *chartInstance, real_T
  c36_q[4], real_T c36_b_r[4], real_T c36_qout[4]);
static const mxArray *c36_h_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static int32_T c36_h_emlrt_marshallIn(SFc36_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void c36_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData);
static uint8_T c36_i_emlrt_marshallIn(SFc36_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c36_b_is_active_c36_DIPCRT, const char_T *c36_identifier);
static uint8_T c36_j_emlrt_marshallIn(SFc36_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void init_dsm_address_info(SFc36_DIPCRTInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc36_DIPCRTInstanceStruct *chartInstance);
...
static void initialize_c36_DIPCRT(SFc36_DIPCRTInstanceStruct *chartInstance)
{
  ...
  chartInstance->c36_is_active_c36_DIPCRT = 0U;
}
  ...
  *chartInstance)
{
  ...
  c36_hoistedGlobal = chartInstance->c36_is_active_c36_DIPCRT;
  ...
  const mxArray *c36_st)
{
  ...
  chartInstance->c36_is_active_c36_DIPCRT = c36_i_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c36_u, 1)), "is_active_c36_DIPCRT");
  sf_mex_destroy(&c36_u);
  c36_update_debugger_state_c36_DIPCRT(chartInstance);
...
static void sf_gateway_c36_DIPCRT(SFc36_DIPCRTInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 25U, chartInstance->c36_sfEvent);
  for (c36_i3 = 0; c36_i3 < 12; c36_i3++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c36_r[c36_i3], 0U);
  }

  chartInstance->c36_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 25U, chartInstance->c36_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 25U, chartInstance->c36_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *c36_inData)
{
  ...
  real_T c36_u[144];
  const mxArray *c36_y = NULL;
  SFc36_DIPCRTInstanceStruct *chartInstance;
  chartInstance = (SFc36_DIPCRTInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c36_DIPCRT_get_eml_resolved_functions_info(void)
{
...
static void c36_info_helper(const mxArray **c36_info)
{
  ...
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(1460657806U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  const mxArray *c36_b_is_active_c36_DIPCRT, const char_T *c36_identifier)
{
  ...
  c36_y = c36_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c36_b_is_active_c36_DIPCRT), &c36_thisId);
  sf_mex_destroy(&c36_b_is_active_c36_DIPCRT);
  return c36_y;
}
...
void sf_c36_DIPCRT_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c36_DIPCRT_get_post_codegen_info(void);
mxArray *sf_c36_DIPCRT_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c36_DIPCRT_get_post_codegen_info();
...
mxArray *sf_c36_DIPCRT_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c36_DIPCRT_jit_fallback_info(void)
{
...
mxArray *sf_c36_DIPCRT_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c36_DIPCRT(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"G\",},{M[8],M[0],T\"is_active_c36_DIPCRT\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c36_DIPCRT_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc36_DIPCRTInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c36_DIPCRT(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc36_DIPCRTInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c36_DIPCRT((SFc36_DIPCRTInstanceStruct*) chartInstanceVar);
  initialize_c36_DIPCRT((SFc36_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c36_DIPCRT(void *chartInstanceVar)
{
  enable_c36_DIPCRT((SFc36_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c36_DIPCRT(void *chartInstanceVar)
{
  disable_c36_DIPCRT((SFc36_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c36_DIPCRT(void *chartInstanceVar)
{
  sf_gateway_c36_DIPCRT((SFc36_DIPCRTInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c36_DIPCRT(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c36_DIPCRT((SFc36_DIPCRTInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c36_DIPCRT(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c36_DIPCRT((SFc36_DIPCRTInstanceStruct*)chartInfo->chartInstance,
    st);
}

static void sf_opaque_terminate_c36_DIPCRT(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc36_DIPCRTInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c36_DIPCRT((SFc36_DIPCRTInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc36_DIPCRT((SFc36_DIPCRTInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c36_DIPCRT(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c36_DIPCRT((SFc36_DIPCRTInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c36_DIPCRT(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3643602596U));
  ssSetChecksum1(S,(552067682U));
  ssSetChecksum2(S,(4072703918U));
  ssSetChecksum3(S,(3865320917U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c36_DIPCRT(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c36_DIPCRT(SimStruct *S)
{
  SFc36_DIPCRTInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc36_DIPCRTInstanceStruct *)utMalloc(sizeof
    (SFc36_DIPCRTInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc36_DIPCRTInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c36_DIPCRT;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c36_DIPCRT;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c36_DIPCRT;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c36_DIPCRT;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c36_DIPCRT;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c36_DIPCRT;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c36_DIPCRT;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c36_DIPCRT;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c36_DIPCRT;
  chartInstance->chartInfo.mdlStart = mdlStart_c36_DIPCRT;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c36_DIPCRT;
...
void c36_DIPCRT_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c36_DIPCRT(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c36_DIPCRT(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c36_DIPCRT(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c36_DIPCRT_method_dispatcher.\n"
