...
static void initialize_c23_DIPCRT(SFc23_DIPCRTInstanceStruct *chartInstance);
static void initialize_params_c23_DIPCRT(SFc23_DIPCRTInstanceStruct
  *chartInstance);
static void enable_c23_DIPCRT(SFc23_DIPCRTInstanceStruct *chartInstance);
static void disable_c23_DIPCRT(SFc23_DIPCRTInstanceStruct *chartInstance);
static void c23_update_debugger_state_c23_DIPCRT(SFc23_DIPCRTInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c23_DIPCRT(SFc23_DIPCRTInstanceStruct
  *chartInstance);
static void set_sim_state_c23_DIPCRT(SFc23_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c23_st);
static void finalize_c23_DIPCRT(SFc23_DIPCRTInstanceStruct *chartInstance);
static void sf_gateway_c23_DIPCRT(SFc23_DIPCRTInstanceStruct *chartInstance);
static void mdl_start_c23_DIPCRT(SFc23_DIPCRTInstanceStruct *chartInstance);
static void initSimStructsc23_DIPCRT(SFc23_DIPCRTInstanceStruct *chartInstance);
...
static const mxArray *c23_sf_marshallOut(void *chartInstanceVoid, void
  *c23_inData);
static void c23_emlrt_marshallIn(SFc23_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c23_b_hcoriolis, const char_T *c23_identifier, real_T c23_y[6]);
static void c23_b_emlrt_marshallIn(SFc23_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c23_b_sf_marshallOut(void *chartInstanceVoid, void
  *c23_inData);
static real_T c23_c_emlrt_marshallIn(SFc23_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c23_c_sf_marshallOut(void *chartInstanceVoid, void
  *c23_inData);
static void c23_d_emlrt_marshallIn(SFc23_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c23_d_sf_marshallOut(void *chartInstanceVoid, void
  *c23_inData);
static void c23_e_emlrt_marshallIn(SFc23_DIPCRTInstanceStruct *chartInstance,
...
static void c23_eml_scalar_eg(SFc23_DIPCRTInstanceStruct *chartInstance);
static void c23_eml_xgemm(SFc23_DIPCRTInstanceStruct *chartInstance, real_T
...
static const mxArray *c23_e_sf_marshallOut(void *chartInstanceVoid, void
  *c23_inData);
static int32_T c23_f_emlrt_marshallIn(SFc23_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c23_u, const emlrtMsgIdentifier *c23_parentId);
static void c23_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c23_mxArrayInData, const char_T *c23_varName, void *c23_outData);
static uint8_T c23_g_emlrt_marshallIn(SFc23_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c23_b_is_active_c23_DIPCRT, const char_T *c23_identifier);
static uint8_T c23_h_emlrt_marshallIn(SFc23_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c23_u, const emlrtMsgIdentifier *c23_parentId);
static void c23_b_eml_xgemm(SFc23_DIPCRTInstanceStruct *chartInstance, real_T
  c23_A[9], real_T c23_B[3], real_T c23_C[3]);
static void init_dsm_address_info(SFc23_DIPCRTInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc23_DIPCRTInstanceStruct *chartInstance);
...
static void initialize_c23_DIPCRT(SFc23_DIPCRTInstanceStruct *chartInstance)
{
  ...
  chartInstance->c23_is_active_c23_DIPCRT = 0U;
}
  ...
  *chartInstance)
{
  ...
  c23_hoistedGlobal = chartInstance->c23_is_active_c23_DIPCRT;
  ...
  const mxArray *c23_st)
{
  ...
  chartInstance->c23_is_active_c23_DIPCRT = c23_g_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c23_u, 1)), "is_active_c23_DIPCRT");
  sf_mex_destroy(&c23_u);
  c23_update_debugger_state_c23_DIPCRT(chartInstance);
  ...
  *c23_inData)
{
  ...
  real_T c23_u[6];
  const mxArray *c23_y = NULL;
  SFc23_DIPCRTInstanceStruct *chartInstance;
  chartInstance = (SFc23_DIPCRTInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c23_DIPCRT_get_eml_resolved_functions_info(void)
{
...
static void c23_info_helper(const mxArray **c23_info)
{
  ...
  sf_mex_addfield(*c23_info, c23_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPC - referencetrajectory/skew_sm.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c23_info, c23_b_emlrt_marshallOut(1460657806U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  const mxArray *c23_b_is_active_c23_DIPCRT, const char_T *c23_identifier)
{
  ...
  c23_y = c23_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c23_b_is_active_c23_DIPCRT), &c23_thisId);
  sf_mex_destroy(&c23_b_is_active_c23_DIPCRT);
  return c23_y;
}
...
void sf_c23_DIPCRT_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c23_DIPCRT_get_post_codegen_info(void);
mxArray *sf_c23_DIPCRT_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c23_DIPCRT_get_post_codegen_info();
...
mxArray *sf_c23_DIPCRT_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c23_DIPCRT_jit_fallback_info(void)
{
...
mxArray *sf_c23_DIPCRT_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c23_DIPCRT(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"hcoriolis\",},{M[8],M[0],T\"is_active_c23_DIPCRT\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c23_DIPCRT_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc23_DIPCRTInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c23_DIPCRT(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc23_DIPCRTInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c23_DIPCRT((SFc23_DIPCRTInstanceStruct*) chartInstanceVar);
  initialize_c23_DIPCRT((SFc23_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c23_DIPCRT(void *chartInstanceVar)
{
  enable_c23_DIPCRT((SFc23_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c23_DIPCRT(void *chartInstanceVar)
{
  disable_c23_DIPCRT((SFc23_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c23_DIPCRT(void *chartInstanceVar)
{
  sf_gateway_c23_DIPCRT((SFc23_DIPCRTInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c23_DIPCRT(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c23_DIPCRT((SFc23_DIPCRTInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c23_DIPCRT(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c23_DIPCRT((SFc23_DIPCRTInstanceStruct*)chartInfo->chartInstance,
    st);
}

static void sf_opaque_terminate_c23_DIPCRT(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc23_DIPCRTInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c23_DIPCRT((SFc23_DIPCRTInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc23_DIPCRT((SFc23_DIPCRTInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c23_DIPCRT(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c23_DIPCRT((SFc23_DIPCRTInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c23_DIPCRT(SimStruct *S)
{
...
static void mdlRTW_c23_DIPCRT(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c23_DIPCRT(SimStruct *S)
{
  SFc23_DIPCRTInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc23_DIPCRTInstanceStruct *)utMalloc(sizeof
    (SFc23_DIPCRTInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc23_DIPCRTInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c23_DIPCRT;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c23_DIPCRT;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c23_DIPCRT;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c23_DIPCRT;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c23_DIPCRT;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c23_DIPCRT;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c23_DIPCRT;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c23_DIPCRT;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c23_DIPCRT;
  chartInstance->chartInfo.mdlStart = mdlStart_c23_DIPCRT;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c23_DIPCRT;
...
void c23_DIPCRT_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c23_DIPCRT(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c23_DIPCRT(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c23_DIPCRT(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c23_DIPCRT_method_dispatcher.\n"
