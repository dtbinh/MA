...
static void initialize_c31_DIPCRT(SFc31_DIPCRTInstanceStruct *chartInstance);
static void initialize_params_c31_DIPCRT(SFc31_DIPCRTInstanceStruct
  *chartInstance);
static void enable_c31_DIPCRT(SFc31_DIPCRTInstanceStruct *chartInstance);
static void disable_c31_DIPCRT(SFc31_DIPCRTInstanceStruct *chartInstance);
static void c31_update_debugger_state_c31_DIPCRT(SFc31_DIPCRTInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c31_DIPCRT(SFc31_DIPCRTInstanceStruct
  *chartInstance);
static void set_sim_state_c31_DIPCRT(SFc31_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c31_st);
static void finalize_c31_DIPCRT(SFc31_DIPCRTInstanceStruct *chartInstance);
static void sf_gateway_c31_DIPCRT(SFc31_DIPCRTInstanceStruct *chartInstance);
static void mdl_start_c31_DIPCRT(SFc31_DIPCRTInstanceStruct *chartInstance);
static void c31_chartstep_c31_DIPCRT(SFc31_DIPCRTInstanceStruct *chartInstance);
static void initSimStructsc31_DIPCRT(SFc31_DIPCRTInstanceStruct *chartInstance);
static void c31_skew_sm(SFc31_DIPCRTInstanceStruct *chartInstance, real_T
  c31_b_x[3], real_T c31_X[9]);
static void c31_quatrot(SFc31_DIPCRTInstanceStruct *chartInstance, real_T c31_q
  [4], real_T c31_b_r[3], real_T c31_rw[3]);
...
static const mxArray *c31_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_emlrt_marshallIn(SFc31_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c31_b_bred, const char_T *c31_identifier, real_T c31_y[18]);
static void c31_b_emlrt_marshallIn(SFc31_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c31_d_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_c_emlrt_marshallIn(SFc31_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c31_e_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static real_T c31_d_emlrt_marshallIn(SFc31_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c31_f_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_e_emlrt_marshallIn(SFc31_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c31_g_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_f_emlrt_marshallIn(SFc31_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c31_h_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_g_emlrt_marshallIn(SFc31_DIPCRTInstanceStruct *chartInstance,
...
static void c31_eml_scalar_eg(SFc31_DIPCRTInstanceStruct *chartInstance);
static void c31_threshold(SFc31_DIPCRTInstanceStruct *chartInstance);
static void c31_quatmultiply(SFc31_DIPCRTInstanceStruct *chartInstance, real_T
  c31_q[4], real_T c31_b_r[4], real_T c31_qout[4]);
static void c31_b_eml_scalar_eg(SFc31_DIPCRTInstanceStruct *chartInstance);
static const mxArray *c31_i_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static int32_T c31_h_emlrt_marshallIn(SFc31_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
static void c31_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData);
static uint8_T c31_i_emlrt_marshallIn(SFc31_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c31_b_is_active_c31_DIPCRT, const char_T *c31_identifier);
static uint8_T c31_j_emlrt_marshallIn(SFc31_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
static void init_dsm_address_info(SFc31_DIPCRTInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc31_DIPCRTInstanceStruct *chartInstance);
...
static void initialize_c31_DIPCRT(SFc31_DIPCRTInstanceStruct *chartInstance)
{
  ...
  chartInstance->c31_is_active_c31_DIPCRT = 0U;
}
  ...
  *chartInstance)
{
  ...
  c31_hoistedGlobal = chartInstance->c31_is_active_c31_DIPCRT;
  ...
  const mxArray *c31_st)
{
  ...
  chartInstance->c31_is_active_c31_DIPCRT = c31_i_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c31_u, 1)), "is_active_c31_DIPCRT");
  sf_mex_destroy(&c31_u);
  c31_update_debugger_state_c31_DIPCRT(chartInstance);
...
static void sf_gateway_c31_DIPCRT(SFc31_DIPCRTInstanceStruct *chartInstance)
{
  ...
  chartInstance->c31_sfEvent = CALL_EVENT;
  c31_chartstep_c31_DIPCRT(chartInstance);
  ...
  *c31_inData)
{
  ...
  real_T c31_u[18];
  const mxArray *c31_y = NULL;
  SFc31_DIPCRTInstanceStruct *chartInstance;
  chartInstance = (SFc31_DIPCRTInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c31_DIPCRT_get_eml_resolved_functions_info(void)
{
...
static void c31_info_helper(const mxArray **c31_info)
{
  ...
  sf_mex_addfield(*c31_info, c31_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPC - referencetrajectory/skew_sm.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c31_info, c31_b_emlrt_marshallOut(1460657806U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  const mxArray *c31_b_is_active_c31_DIPCRT, const char_T *c31_identifier)
{
  ...
  c31_y = c31_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c31_b_is_active_c31_DIPCRT), &c31_thisId);
  sf_mex_destroy(&c31_b_is_active_c31_DIPCRT);
  return c31_y;
}
...
void sf_c31_DIPCRT_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c31_DIPCRT_get_post_codegen_info(void);
mxArray *sf_c31_DIPCRT_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c31_DIPCRT_get_post_codegen_info();
...
mxArray *sf_c31_DIPCRT_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c31_DIPCRT_jit_fallback_info(void)
{
...
mxArray *sf_c31_DIPCRT_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c31_DIPCRT(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"bred\",},{M[8],M[0],T\"is_active_c31_DIPCRT\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c31_DIPCRT_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc31_DIPCRTInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c31_DIPCRT(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc31_DIPCRTInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c31_DIPCRT((SFc31_DIPCRTInstanceStruct*) chartInstanceVar);
  initialize_c31_DIPCRT((SFc31_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c31_DIPCRT(void *chartInstanceVar)
{
  enable_c31_DIPCRT((SFc31_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c31_DIPCRT(void *chartInstanceVar)
{
  disable_c31_DIPCRT((SFc31_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c31_DIPCRT(void *chartInstanceVar)
{
  sf_gateway_c31_DIPCRT((SFc31_DIPCRTInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c31_DIPCRT(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c31_DIPCRT((SFc31_DIPCRTInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c31_DIPCRT(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c31_DIPCRT((SFc31_DIPCRTInstanceStruct*)chartInfo->chartInstance,
    st);
}

static void sf_opaque_terminate_c31_DIPCRT(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc31_DIPCRTInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c31_DIPCRT((SFc31_DIPCRTInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc31_DIPCRT((SFc31_DIPCRTInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c31_DIPCRT(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c31_DIPCRT((SFc31_DIPCRTInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c31_DIPCRT(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2688535339U));
  ssSetChecksum1(S,(1562765426U));
  ssSetChecksum2(S,(2022256773U));
  ssSetChecksum3(S,(3157708202U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c31_DIPCRT(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c31_DIPCRT(SimStruct *S)
{
  SFc31_DIPCRTInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc31_DIPCRTInstanceStruct *)utMalloc(sizeof
    (SFc31_DIPCRTInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc31_DIPCRTInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c31_DIPCRT;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c31_DIPCRT;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c31_DIPCRT;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c31_DIPCRT;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c31_DIPCRT;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c31_DIPCRT;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c31_DIPCRT;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c31_DIPCRT;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c31_DIPCRT;
  chartInstance->chartInfo.mdlStart = mdlStart_c31_DIPCRT;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c31_DIPCRT;
...
void c31_DIPCRT_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c31_DIPCRT(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c31_DIPCRT(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c31_DIPCRT(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c31_DIPCRT_method_dispatcher.\n"
