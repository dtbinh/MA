...
static void initialize_c12_DIPCRT(SFc12_DIPCRTInstanceStruct *chartInstance);
static void initialize_params_c12_DIPCRT(SFc12_DIPCRTInstanceStruct
  *chartInstance);
static void enable_c12_DIPCRT(SFc12_DIPCRTInstanceStruct *chartInstance);
static void disable_c12_DIPCRT(SFc12_DIPCRTInstanceStruct *chartInstance);
static void c12_update_debugger_state_c12_DIPCRT(SFc12_DIPCRTInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c12_DIPCRT(SFc12_DIPCRTInstanceStruct
  *chartInstance);
static void set_sim_state_c12_DIPCRT(SFc12_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c12_st);
static void finalize_c12_DIPCRT(SFc12_DIPCRTInstanceStruct *chartInstance);
static void sf_gateway_c12_DIPCRT(SFc12_DIPCRTInstanceStruct *chartInstance);
static void mdl_start_c12_DIPCRT(SFc12_DIPCRTInstanceStruct *chartInstance);
static void initSimStructsc12_DIPCRT(SFc12_DIPCRTInstanceStruct *chartInstance);
static void c12_quatrot(SFc12_DIPCRTInstanceStruct *chartInstance, real_T c12_q
  [4], real_T c12_r[3], real_T c12_rw[3]);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber, uint32_T c12_instanceNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_emlrt_marshallIn(SFc12_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c12_b_G, const char_T *c12_identifier, real_T c12_y[144]);
static void c12_b_emlrt_marshallIn(SFc12_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c12_c_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_c_emlrt_marshallIn(SFc12_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c12_d_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_d_emlrt_marshallIn(SFc12_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c12_e_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_e_emlrt_marshallIn(SFc12_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c12_f_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_f_emlrt_marshallIn(SFc12_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c12_g_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_g_emlrt_marshallIn(SFc12_DIPCRTInstanceStruct *chartInstance,
...
static void c12_eye(SFc12_DIPCRTInstanceStruct *chartInstance, real_T c12_I[9]);
static void c12_quatmultiply(SFc12_DIPCRTInstanceStruct *chartInstance, real_T
  c12_q[4], real_T c12_r[4], real_T c12_qout[4]);
static const mxArray *c12_h_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_h_emlrt_marshallIn(SFc12_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static uint8_T c12_i_emlrt_marshallIn(SFc12_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c12_b_is_active_c12_DIPCRT, const char_T *c12_identifier);
static uint8_T c12_j_emlrt_marshallIn(SFc12_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void init_dsm_address_info(SFc12_DIPCRTInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc12_DIPCRTInstanceStruct *chartInstance);
...
static void initialize_c12_DIPCRT(SFc12_DIPCRTInstanceStruct *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_DIPCRT = 0U;
}
  ...
  *chartInstance)
{
  ...
  c12_hoistedGlobal = chartInstance->c12_is_active_c12_DIPCRT;
  ...
  const mxArray *c12_st)
{
  ...
  chartInstance->c12_is_active_c12_DIPCRT = c12_i_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c12_u, 1)), "is_active_c12_DIPCRT");
  sf_mex_destroy(&c12_u);
  c12_update_debugger_state_c12_DIPCRT(chartInstance);
  ...
  *c12_inData)
{
  ...
  real_T c12_u[144];
  const mxArray *c12_y = NULL;
  SFc12_DIPCRTInstanceStruct *chartInstance;
  chartInstance = (SFc12_DIPCRTInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c12_DIPCRT_get_eml_resolved_functions_info(void)
{
...
static void c12_info_helper(const mxArray **c12_info)
{
  ...
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1460657806U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  const mxArray *c12_b_is_active_c12_DIPCRT, const char_T *c12_identifier)
{
  ...
  c12_y = c12_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_DIPCRT), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_DIPCRT);
  return c12_y;
}
...
void sf_c12_DIPCRT_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c12_DIPCRT_get_post_codegen_info(void);
mxArray *sf_c12_DIPCRT_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c12_DIPCRT_get_post_codegen_info();
...
mxArray *sf_c12_DIPCRT_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c12_DIPCRT_jit_fallback_info(void)
{
...
mxArray *sf_c12_DIPCRT_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c12_DIPCRT(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"G\",},{M[8],M[0],T\"is_active_c12_DIPCRT\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_DIPCRT_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc12_DIPCRTInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c12_DIPCRT(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_DIPCRTInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c12_DIPCRT((SFc12_DIPCRTInstanceStruct*) chartInstanceVar);
  initialize_c12_DIPCRT((SFc12_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c12_DIPCRT(void *chartInstanceVar)
{
  enable_c12_DIPCRT((SFc12_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_DIPCRT(void *chartInstanceVar)
{
  disable_c12_DIPCRT((SFc12_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c12_DIPCRT(void *chartInstanceVar)
{
  sf_gateway_c12_DIPCRT((SFc12_DIPCRTInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c12_DIPCRT(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c12_DIPCRT((SFc12_DIPCRTInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c12_DIPCRT(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c12_DIPCRT((SFc12_DIPCRTInstanceStruct*)chartInfo->chartInstance,
    st);
}

static void sf_opaque_terminate_c12_DIPCRT(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_DIPCRTInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c12_DIPCRT((SFc12_DIPCRTInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc12_DIPCRT((SFc12_DIPCRTInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_DIPCRT(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c12_DIPCRT((SFc12_DIPCRTInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c12_DIPCRT(SimStruct *S)
{
...
static void mdlRTW_c12_DIPCRT(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_DIPCRT(SimStruct *S)
{
  SFc12_DIPCRTInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc12_DIPCRTInstanceStruct *)utMalloc(sizeof
    (SFc12_DIPCRTInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc12_DIPCRTInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c12_DIPCRT;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c12_DIPCRT;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c12_DIPCRT;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c12_DIPCRT;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c12_DIPCRT;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c12_DIPCRT;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c12_DIPCRT;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c12_DIPCRT;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_DIPCRT;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_DIPCRT;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c12_DIPCRT;
...
void c12_DIPCRT_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_DIPCRT(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_DIPCRT(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_DIPCRT(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_DIPCRT_method_dispatcher.\n"
