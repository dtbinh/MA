...
static void initialize_c4_DIPCRT(SFc4_DIPCRTInstanceStruct *chartInstance);
static void initialize_params_c4_DIPCRT(SFc4_DIPCRTInstanceStruct *chartInstance);
static void enable_c4_DIPCRT(SFc4_DIPCRTInstanceStruct *chartInstance);
static void disable_c4_DIPCRT(SFc4_DIPCRTInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_DIPCRT(SFc4_DIPCRTInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c4_DIPCRT(SFc4_DIPCRTInstanceStruct
  *chartInstance);
static void set_sim_state_c4_DIPCRT(SFc4_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c4_st);
static void finalize_c4_DIPCRT(SFc4_DIPCRTInstanceStruct *chartInstance);
static void sf_gateway_c4_DIPCRT(SFc4_DIPCRTInstanceStruct *chartInstance);
static void mdl_start_c4_DIPCRT(SFc4_DIPCRTInstanceStruct *chartInstance);
static void initSimStructsc4_DIPCRT(SFc4_DIPCRTInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static void c4_emlrt_marshallIn(SFc4_DIPCRTInstanceStruct *chartInstance, const
  mxArray *c4_b_qb4, const char_T *c4_identifier, real_T c4_y[4]);
static void c4_b_emlrt_marshallIn(SFc4_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[4]);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_c_emlrt_marshallIn(SFc4_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c4_b_pb4, const char_T *c4_identifier, real_T c4_y[3]);
static void c4_d_emlrt_marshallIn(SFc4_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[3]);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_e_emlrt_marshallIn(SFc4_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[12]);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_f_emlrt_marshallIn(SFc4_DIPCRTInstanceStruct *chartInstance,
...
static void c4_quatmultiply(SFc4_DIPCRTInstanceStruct *chartInstance, real_T
  c4_q[4], real_T c4_r[4], real_T c4_qout[4]);
static const mxArray *c4_e_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_g_emlrt_marshallIn(SFc4_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_h_emlrt_marshallIn(SFc4_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c4_b_is_active_c4_DIPCRT, const char_T *c4_identifier);
static uint8_T c4_i_emlrt_marshallIn(SFc4_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_DIPCRTInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc4_DIPCRTInstanceStruct *chartInstance);
...
static void initialize_c4_DIPCRT(SFc4_DIPCRTInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_DIPCRT = 0U;
}
  ...
  *chartInstance)
{
  ...
  c4_hoistedGlobal = chartInstance->c4_is_active_c4_DIPCRT;
  ...
  const mxArray *c4_st)
{
  ...
  chartInstance->c4_is_active_c4_DIPCRT = c4_h_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c4_u, 2)), "is_active_c4_DIPCRT");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_DIPCRT(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  real_T c4_u[4];
  const mxArray *c4_y = NULL;
  SFc4_DIPCRTInstanceStruct *chartInstance;
  chartInstance = (SFc4_DIPCRTInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_DIPCRT_get_eml_resolved_functions_info(void)
{
...
static void c4_info_helper(const mxArray **c4_info)
{
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPC - referencetrajectory/quatrot.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1460657806U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  const mxArray *c4_b_is_active_c4_DIPCRT, const char_T *c4_identifier)
{
  ...
  c4_y = c4_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_DIPCRT), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_DIPCRT);
  return c4_y;
}
...
void sf_c4_DIPCRT_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c4_DIPCRT_get_post_codegen_info(void);
mxArray *sf_c4_DIPCRT_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c4_DIPCRT_get_post_codegen_info();
...
mxArray *sf_c4_DIPCRT_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_DIPCRT_jit_fallback_info(void)
{
...
mxArray *sf_c4_DIPCRT_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_DIPCRT(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"pb4\",},{M[1],M[8],T\"qb4\",},{M[8],M[0],T\"is_active_c4_DIPCRT\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_DIPCRT_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_DIPCRTInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c4_DIPCRT(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_DIPCRTInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c4_DIPCRT((SFc4_DIPCRTInstanceStruct*) chartInstanceVar);
  initialize_c4_DIPCRT((SFc4_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_DIPCRT(void *chartInstanceVar)
{
  enable_c4_DIPCRT((SFc4_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_DIPCRT(void *chartInstanceVar)
{
  disable_c4_DIPCRT((SFc4_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_DIPCRT(void *chartInstanceVar)
{
  sf_gateway_c4_DIPCRT((SFc4_DIPCRTInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c4_DIPCRT(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c4_DIPCRT((SFc4_DIPCRTInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c4_DIPCRT(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c4_DIPCRT((SFc4_DIPCRTInstanceStruct*)chartInfo->chartInstance,
    st);
}

static void sf_opaque_terminate_c4_DIPCRT(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_DIPCRTInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_DIPCRT((SFc4_DIPCRTInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_DIPCRT((SFc4_DIPCRTInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_DIPCRT(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c4_DIPCRT((SFc4_DIPCRTInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_DIPCRT(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(224220323U));
  ssSetChecksum1(S,(192839338U));
  ssSetChecksum2(S,(738557537U));
  ssSetChecksum3(S,(1783247203U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c4_DIPCRT(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_DIPCRT(SimStruct *S)
{
  SFc4_DIPCRTInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_DIPCRTInstanceStruct *)utMalloc(sizeof
    (SFc4_DIPCRTInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_DIPCRTInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_DIPCRT;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c4_DIPCRT;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c4_DIPCRT;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_DIPCRT;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_DIPCRT;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c4_DIPCRT;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c4_DIPCRT;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c4_DIPCRT;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_DIPCRT;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_DIPCRT;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_DIPCRT;
...
void c4_DIPCRT_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_DIPCRT(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_DIPCRT(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_DIPCRT(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_DIPCRT_method_dispatcher.\n"
