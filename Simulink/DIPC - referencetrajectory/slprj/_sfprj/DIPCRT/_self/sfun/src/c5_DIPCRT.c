...
static void initialize_c5_DIPCRT(SFc5_DIPCRTInstanceStruct *chartInstance);
static void initialize_params_c5_DIPCRT(SFc5_DIPCRTInstanceStruct *chartInstance);
static void enable_c5_DIPCRT(SFc5_DIPCRTInstanceStruct *chartInstance);
static void disable_c5_DIPCRT(SFc5_DIPCRTInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_DIPCRT(SFc5_DIPCRTInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c5_DIPCRT(SFc5_DIPCRTInstanceStruct
  *chartInstance);
static void set_sim_state_c5_DIPCRT(SFc5_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c5_st);
static void finalize_c5_DIPCRT(SFc5_DIPCRTInstanceStruct *chartInstance);
static void sf_gateway_c5_DIPCRT(SFc5_DIPCRTInstanceStruct *chartInstance);
static void mdl_start_c5_DIPCRT(SFc5_DIPCRTInstanceStruct *chartInstance);
static void initSimStructsc5_DIPCRT(SFc5_DIPCRTInstanceStruct *chartInstance);
static void c5_quatrot(SFc5_DIPCRTInstanceStruct *chartInstance, real_T c5_q[4],
  real_T c5_b_r[3], real_T c5_rw[3]);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static void c5_emlrt_marshallIn(SFc5_DIPCRTInstanceStruct *chartInstance, const
  mxArray *c5_b_A, const char_T *c5_identifier, real_T c5_y[720]);
static void c5_b_emlrt_marshallIn(SFc5_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_c_emlrt_marshallIn(SFc5_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[12]);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real_T c5_d_emlrt_marshallIn(SFc5_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_e_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_e_emlrt_marshallIn(SFc5_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c5_f_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_f_emlrt_marshallIn(SFc5_DIPCRTInstanceStruct *chartInstance,
...
static const mxArray *c5_g_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_g_emlrt_marshallIn(SFc5_DIPCRTInstanceStruct *chartInstance,
...
static void c5_eye(SFc5_DIPCRTInstanceStruct *chartInstance, real_T c5_I[9]);
static void c5_quatmultiply(SFc5_DIPCRTInstanceStruct *chartInstance, real_T
  c5_q[4], real_T c5_b_r[4], real_T c5_qout[4]);
static const mxArray *c5_h_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_h_emlrt_marshallIn(SFc5_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_i_emlrt_marshallIn(SFc5_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c5_b_is_active_c5_DIPCRT, const char_T *c5_identifier);
static uint8_T c5_j_emlrt_marshallIn(SFc5_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_DIPCRTInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc5_DIPCRTInstanceStruct *chartInstance);
...
static void initialize_c5_DIPCRT(SFc5_DIPCRTInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_DIPCRT = 0U;
}
  ...
  *chartInstance)
{
  ...
  c5_hoistedGlobal = chartInstance->c5_is_active_c5_DIPCRT;
  ...
  const mxArray *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_DIPCRT = c5_i_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 1)), "is_active_c5_DIPCRT");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_DIPCRT(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  real_T c5_u[720];
  const mxArray *c5_y = NULL;
  SFc5_DIPCRTInstanceStruct *chartInstance;
  chartInstance = (SFc5_DIPCRTInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_DIPCRT_get_eml_resolved_functions_info(void)
{
...
static void c5_info_helper(const mxArray **c5_info)
{
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1460657806U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  const mxArray *c5_b_is_active_c5_DIPCRT, const char_T *c5_identifier)
{
  ...
  c5_y = c5_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_DIPCRT), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_DIPCRT);
  return c5_y;
}
...
void sf_c5_DIPCRT_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c5_DIPCRT_get_post_codegen_info(void);
mxArray *sf_c5_DIPCRT_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c5_DIPCRT_get_post_codegen_info();
...
mxArray *sf_c5_DIPCRT_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_DIPCRT_jit_fallback_info(void)
{
...
mxArray *sf_c5_DIPCRT_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_DIPCRT(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"A\",},{M[8],M[0],T\"is_active_c5_DIPCRT\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_DIPCRT_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_DIPCRTInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c5_DIPCRT(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_DIPCRTInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c5_DIPCRT((SFc5_DIPCRTInstanceStruct*) chartInstanceVar);
  initialize_c5_DIPCRT((SFc5_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_DIPCRT(void *chartInstanceVar)
{
  enable_c5_DIPCRT((SFc5_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_DIPCRT(void *chartInstanceVar)
{
  disable_c5_DIPCRT((SFc5_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_DIPCRT(void *chartInstanceVar)
{
  sf_gateway_c5_DIPCRT((SFc5_DIPCRTInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c5_DIPCRT(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c5_DIPCRT((SFc5_DIPCRTInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c5_DIPCRT(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c5_DIPCRT((SFc5_DIPCRTInstanceStruct*)chartInfo->chartInstance,
    st);
}

static void sf_opaque_terminate_c5_DIPCRT(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_DIPCRTInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_DIPCRT((SFc5_DIPCRTInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_DIPCRT((SFc5_DIPCRTInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_DIPCRT(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c5_DIPCRT((SFc5_DIPCRTInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_DIPCRT(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4013990175U));
  ssSetChecksum1(S,(1132973996U));
  ssSetChecksum2(S,(1571021902U));
  ssSetChecksum3(S,(1642960253U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c5_DIPCRT(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_DIPCRT(SimStruct *S)
{
  SFc5_DIPCRTInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_DIPCRTInstanceStruct *)utMalloc(sizeof
    (SFc5_DIPCRTInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_DIPCRTInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_DIPCRT;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_DIPCRT;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_DIPCRT;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_DIPCRT;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_DIPCRT;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_DIPCRT;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_DIPCRT;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c5_DIPCRT;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_DIPCRT;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_DIPCRT;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_DIPCRT;
...
void c5_DIPCRT_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_DIPCRT(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_DIPCRT(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_DIPCRT(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_DIPCRT_method_dispatcher.\n"
