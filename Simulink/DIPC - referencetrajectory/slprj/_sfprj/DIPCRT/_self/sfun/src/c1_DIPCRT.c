...
static void initialize_c1_DIPCRT(SFc1_DIPCRTInstanceStruct *chartInstance);
static void initialize_params_c1_DIPCRT(SFc1_DIPCRTInstanceStruct *chartInstance);
static void enable_c1_DIPCRT(SFc1_DIPCRTInstanceStruct *chartInstance);
static void disable_c1_DIPCRT(SFc1_DIPCRTInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_DIPCRT(SFc1_DIPCRTInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_DIPCRT(SFc1_DIPCRTInstanceStruct
  *chartInstance);
static void set_sim_state_c1_DIPCRT(SFc1_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c1_st);
static void finalize_c1_DIPCRT(SFc1_DIPCRTInstanceStruct *chartInstance);
static void sf_gateway_c1_DIPCRT(SFc1_DIPCRTInstanceStruct *chartInstance);
static void mdl_start_c1_DIPCRT(SFc1_DIPCRTInstanceStruct *chartInstance);
static void initSimStructsc1_DIPCRT(SFc1_DIPCRTInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_DIPCRTInstanceStruct *chartInstance, const
  mxArray *c1_b_qb1, const char_T *c1_identifier, real_T c1_y[4]);
static void c1_b_emlrt_marshallIn(SFc1_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[4]);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c1_b_pb1, const char_T *c1_identifier, real_T c1_y[3]);
static void c1_d_emlrt_marshallIn(SFc1_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[3]);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_e_emlrt_marshallIn(SFc1_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[12]);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_f_emlrt_marshallIn(SFc1_DIPCRTInstanceStruct *chartInstance,
...
static void c1_quatmultiply(SFc1_DIPCRTInstanceStruct *chartInstance, real_T
  c1_q[4], real_T c1_r[4], real_T c1_qout[4]);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_g_emlrt_marshallIn(SFc1_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_h_emlrt_marshallIn(SFc1_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_DIPCRT, const char_T *c1_identifier);
static uint8_T c1_i_emlrt_marshallIn(SFc1_DIPCRTInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_DIPCRTInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc1_DIPCRTInstanceStruct *chartInstance);
...
static void initialize_c1_DIPCRT(SFc1_DIPCRTInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_DIPCRT = 0U;
}
  ...
  *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_DIPCRT;
  ...
  const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_DIPCRT = c1_h_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 2)), "is_active_c1_DIPCRT");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_DIPCRT(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  real_T c1_u[4];
  const mxArray *c1_y = NULL;
  SFc1_DIPCRTInstanceStruct *chartInstance;
  chartInstance = (SFc1_DIPCRTInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_DIPCRT_get_eml_resolved_functions_info(void)
{
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPC - referencetrajectory/quatrot.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1460657806U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  const mxArray *c1_b_is_active_c1_DIPCRT, const char_T *c1_identifier)
{
  ...
  c1_y = c1_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_DIPCRT), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_DIPCRT);
  return c1_y;
}
...
void sf_c1_DIPCRT_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c1_DIPCRT_get_post_codegen_info(void);
mxArray *sf_c1_DIPCRT_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c1_DIPCRT_get_post_codegen_info();
...
mxArray *sf_c1_DIPCRT_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_DIPCRT_jit_fallback_info(void)
{
...
mxArray *sf_c1_DIPCRT_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_DIPCRT(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"pb1\",},{M[1],M[8],T\"qb1\",},{M[8],M[0],T\"is_active_c1_DIPCRT\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_DIPCRT_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_DIPCRTInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c1_DIPCRT(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_DIPCRTInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c1_DIPCRT((SFc1_DIPCRTInstanceStruct*) chartInstanceVar);
  initialize_c1_DIPCRT((SFc1_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_DIPCRT(void *chartInstanceVar)
{
  enable_c1_DIPCRT((SFc1_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_DIPCRT(void *chartInstanceVar)
{
  disable_c1_DIPCRT((SFc1_DIPCRTInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_DIPCRT(void *chartInstanceVar)
{
  sf_gateway_c1_DIPCRT((SFc1_DIPCRTInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c1_DIPCRT(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c1_DIPCRT((SFc1_DIPCRTInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c1_DIPCRT(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c1_DIPCRT((SFc1_DIPCRTInstanceStruct*)chartInfo->chartInstance,
    st);
}

static void sf_opaque_terminate_c1_DIPCRT(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_DIPCRTInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_DIPCRT((SFc1_DIPCRTInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_DIPCRT((SFc1_DIPCRTInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_DIPCRT(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c1_DIPCRT((SFc1_DIPCRTInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_DIPCRT(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2212067946U));
  ssSetChecksum1(S,(1707263328U));
  ssSetChecksum2(S,(4048672315U));
  ssSetChecksum3(S,(1615038300U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_DIPCRT(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_DIPCRT(SimStruct *S)
{
  SFc1_DIPCRTInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_DIPCRTInstanceStruct *)utMalloc(sizeof
    (SFc1_DIPCRTInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_DIPCRTInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_DIPCRT;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_DIPCRT;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_DIPCRT;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_DIPCRT;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_DIPCRT;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_DIPCRT;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_DIPCRT;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_DIPCRT;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_DIPCRT;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_DIPCRT;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_DIPCRT;
...
void c1_DIPCRT_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_DIPCRT(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_DIPCRT(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_DIPCRT(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_DIPCRT_method_dispatcher.\n"
