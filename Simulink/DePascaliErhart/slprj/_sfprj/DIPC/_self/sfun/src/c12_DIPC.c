...
static const char * c12_debug_family_names[5] = { "nargin", "nargout", "r", "x",
  "G" };
...
static void initialize_c12_DIPC(SFc12_DIPCInstanceStruct *chartInstance);
static void initialize_params_c12_DIPC(SFc12_DIPCInstanceStruct *chartInstance);
static void enable_c12_DIPC(SFc12_DIPCInstanceStruct *chartInstance);
static void disable_c12_DIPC(SFc12_DIPCInstanceStruct *chartInstance);
static void c12_update_debugger_state_c12_DIPC(SFc12_DIPCInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c12_DIPC(SFc12_DIPCInstanceStruct
  *chartInstance);
static void set_sim_state_c12_DIPC(SFc12_DIPCInstanceStruct *chartInstance,
  const mxArray *c12_st);
static void finalize_c12_DIPC(SFc12_DIPCInstanceStruct *chartInstance);
static void sf_gateway_c12_DIPC(SFc12_DIPCInstanceStruct *chartInstance);
static void mdl_start_c12_DIPC(SFc12_DIPCInstanceStruct *chartInstance);
static void initSimStructsc12_DIPC(SFc12_DIPCInstanceStruct *chartInstance);
static void c12_quatrot(SFc12_DIPCInstanceStruct *chartInstance, real_T c12_q[4],
  real_T c12_b_r[3], real_T c12_rw[3]);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber, uint32_T c12_instanceNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_emlrt_marshallIn(SFc12_DIPCInstanceStruct *chartInstance, const
  mxArray *c12_b_G, const char_T *c12_identifier, real_T c12_y[144]);
static void c12_b_emlrt_marshallIn(SFc12_DIPCInstanceStruct *chartInstance,
...
static const mxArray *c12_c_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_c_emlrt_marshallIn(SFc12_DIPCInstanceStruct *chartInstance,
...
static const mxArray *c12_d_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_d_emlrt_marshallIn(SFc12_DIPCInstanceStruct *chartInstance,
...
static const mxArray *c12_e_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_e_emlrt_marshallIn(SFc12_DIPCInstanceStruct *chartInstance,
...
static const mxArray *c12_f_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_f_emlrt_marshallIn(SFc12_DIPCInstanceStruct *chartInstance,
...
static const mxArray *c12_g_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_g_emlrt_marshallIn(SFc12_DIPCInstanceStruct *chartInstance,
...
static void c12_eye(SFc12_DIPCInstanceStruct *chartInstance, real_T c12_I[9]);
static void c12_quatmultiply(SFc12_DIPCInstanceStruct *chartInstance, real_T
  c12_q[4], real_T c12_b_r[4], real_T c12_qout[4]);
static const mxArray *c12_h_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_h_emlrt_marshallIn(SFc12_DIPCInstanceStruct *chartInstance,
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static uint8_T c12_i_emlrt_marshallIn(SFc12_DIPCInstanceStruct *chartInstance,
  const mxArray *c12_b_is_active_c12_DIPC, const char_T *c12_identifier);
static uint8_T c12_j_emlrt_marshallIn(SFc12_DIPCInstanceStruct *chartInstance,
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void init_dsm_address_info(SFc12_DIPCInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc12_DIPCInstanceStruct *chartInstance);
...
static void initialize_c12_DIPC(SFc12_DIPCInstanceStruct *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_DIPC = 0U;
}
  ...
  *chartInstance)
{
  ...
  c12_hoistedGlobal = chartInstance->c12_is_active_c12_DIPC;
  ...
  const mxArray *c12_st)
{
  ...
  chartInstance->c12_is_active_c12_DIPC = c12_i_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c12_u, 1)), "is_active_c12_DIPC");
  sf_mex_destroy(&c12_u);
  c12_update_debugger_state_c12_DIPC(chartInstance);
...
static void sf_gateway_c12_DIPC(SFc12_DIPCInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_nargout, 1U, c12_d_sf_marshallOut,
    c12_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_b_r, 2U, c12_c_sf_marshallOut,
    c12_b_sf_marshallIn);
  ...
  for (c12_i7 = 0; c12_i7 < 3; c12_i7++) {
    c12_c_r[c12_i7] = c12_b_r[c12_i7];
  }

  c12_quatrot(chartInstance, c12_c_x, c12_c_r, c12_dv2);
  ...
  for (c12_i10 = 0; c12_i10 < 3; c12_i10++) {
    c12_d_r[c12_i10] = c12_b_r[c12_i10 + 3];
  }

  c12_quatrot(chartInstance, c12_e_x, c12_d_r, c12_dv3);
  ...
  for (c12_i13 = 0; c12_i13 < 3; c12_i13++) {
    c12_e_r[c12_i13] = c12_b_r[c12_i13 + 6];
  }

  c12_quatrot(chartInstance, c12_g_x, c12_e_r, c12_dv4);
  ...
  for (c12_i16 = 0; c12_i16 < 3; c12_i16++) {
    c12_f_r[c12_i16] = c12_b_r[c12_i16 + 9];
  }

  c12_quatrot(chartInstance, c12_i_x, c12_f_r, c12_dv5);
  ...
  real_T c12_b_r[3], real_T c12_rw[3])
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_q, 3U, c12_f_sf_marshallOut,
    c12_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c12_b_r, 4U, c12_e_sf_marshallOut,
    c12_d_sf_marshallIn);
  ...
  for (c12_i82 = 0; c12_i82 < 3; c12_i82++) {
    c12_dv14[c12_i82 + 1] = c12_b_r[c12_i82];
  }
  ...
  *c12_inData)
{
  ...
  real_T c12_u[144];
  const mxArray *c12_y = NULL;
  SFc12_DIPCInstanceStruct *chartInstance;
  chartInstance = (SFc12_DIPCInstanceStruct *)chartInstanceVoid;
  ...
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData)
{
  ...
  SFc12_DIPCInstanceStruct *chartInstance;
  chartInstance = (SFc12_DIPCInstanceStruct *)chartInstanceVoid;
  c12_b_r = sf_mex_dup(c12_mxArrayInData);
  c12_identifier = c12_varName;
  c12_thisId.fIdentifier = c12_identifier;
  c12_thisId.fParent = NULL;
  c12_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c12_b_r), &c12_thisId, c12_y);
  sf_mex_destroy(&c12_b_r);
...
const mxArray *sf_c12_DIPC_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c12_b_is_active_c12_DIPC, const char_T *c12_identifier)
{
  ...
  c12_y = c12_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_DIPC), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_DIPC);
  return c12_y;
}
...
void sf_c12_DIPC_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2423902643U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2294773863U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3577922197U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(230744465U);
}

mxArray* sf_c12_DIPC_get_post_codegen_info(void);
mxArray *sf_c12_DIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("5UuhKFdAvIqZJPy7UYRWAF");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c12_DIPC_get_post_codegen_info();
...
mxArray *sf_c12_DIPC_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c12_DIPC_jit_fallback_info(void)
{
...
mxArray *sf_c12_DIPC_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c12_DIPC(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"G\",},{M[8],M[0],T\"is_active_c12_DIPC\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_DIPC_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc12_DIPCInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c12_r);
...
{
  return "coFa2Vjt8nCXR08W3NyIAD";
}

static void sf_opaque_initialize_c12_DIPC(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_DIPCInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c12_DIPC((SFc12_DIPCInstanceStruct*) chartInstanceVar);
  initialize_c12_DIPC((SFc12_DIPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c12_DIPC(void *chartInstanceVar)
{
  enable_c12_DIPC((SFc12_DIPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_DIPC(void *chartInstanceVar)
{
  disable_c12_DIPC((SFc12_DIPCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c12_DIPC(void *chartInstanceVar)
{
  sf_gateway_c12_DIPC((SFc12_DIPCInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c12_DIPC(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c12_DIPC((SFc12_DIPCInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c12_DIPC(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c12_DIPC((SFc12_DIPCInstanceStruct*)chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c12_DIPC(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_DIPCInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c12_DIPC((SFc12_DIPCInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc12_DIPC((SFc12_DIPCInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_DIPC(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c12_DIPC((SFc12_DIPCInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c12_DIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1717044037U));
  ssSetChecksum1(S,(3273787857U));
  ssSetChecksum2(S,(2347220682U));
  ssSetChecksum3(S,(2664716782U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c12_DIPC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_DIPC(SimStruct *S)
{
  SFc12_DIPCInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc12_DIPCInstanceStruct *)utMalloc(sizeof
    (SFc12_DIPCInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc12_DIPCInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c12_DIPC;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c12_DIPC;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c12_DIPC;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c12_DIPC;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c12_DIPC;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c12_DIPC;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c12_DIPC;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c12_DIPC;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_DIPC;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_DIPC;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c12_DIPC;
...
void c12_DIPC_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_DIPC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_DIPC(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_DIPC_method_dispatcher.\n"
