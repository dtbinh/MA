...
static const char * c22_debug_family_names[10] = { "pq_d1", "pq_d2", "pq_d3",
  "pq_d4", "nargin", "nargout", "p_do", "q_do", "r", "x_d" };
...
static const mxArray *c22_f_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static int32_T c22_f_emlrt_marshallIn(SFc22_DePascali4MInstanceStruct
  *chartInstance, const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
static void c22_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c22_mxArrayInData, const char_T *c22_varName, void *c22_outData);
static uint8_T c22_g_emlrt_marshallIn(SFc22_DePascali4MInstanceStruct
  ...
  *chartInstance, const mxArray *c22_st)
{
  ...
  chartInstance->c22_is_active_c22_DePascali4M = c22_g_emlrt_marshallIn
  ...
  *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 1U, chartInstance->c22_sfEvent);
  ...
  chartInstance->c22_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, chartInstance->c22_sfEvent);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c22_pq_d1, 0U, c22_c_sf_marshallOut,
    c22_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c22_pq_d2, 1U, c22_c_sf_marshallOut,
    c22_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c22_pq_d3, 2U, c22_c_sf_marshallOut,
    c22_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c22_pq_d4, 3U, c22_c_sf_marshallOut,
    c22_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c22_nargin, 4U, c22_e_sf_marshallOut,
    c22_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c22_nargout, 5U, c22_e_sf_marshallOut,
    c22_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c22_b_p_do, 6U, c22_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c22_b_q_do, 7U, c22_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c22_b_r, 8U, c22_b_sf_marshallOut,
    c22_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c22_b_x_d, 9U, c22_sf_marshallOut,
    c22_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c22_sfEvent, 2);
  for (c22_i8 = 0; c22_i8 < 4; c22_i8++) {
    c22_q[c22_i8] = c22_b_q_do[c22_i8];
  }

  for (c22_k = 0; c22_k < 3; c22_k++) {
    c22_b_k = 2.0 + (real_T)c22_k;
    c22_q[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      c22_b_k), 1, 4, 1, 0) - 1] = -c22_q[_SFD_EML_ARRAY_BOUNDS_CHECK("",
      (int32_T)_SFD_INTEGER_CHECK("", c22_b_k), 1, 4, 1, 0) - 1];
  }

  c22_dv2[0] = 0.0;
  for (c22_i9 = 0; c22_i9 < 3; c22_i9++) {
    c22_dv2[c22_i9 + 1] = c22_b_r[c22_i9];
  }

  for (c22_i10 = 0; c22_i10 < 4; c22_i10++) {
    c22_c_q_do[c22_i10] = c22_b_q_do[c22_i10];
  }

  c22_quatmultiply(chartInstance, c22_dv2, c22_c_q_do, c22_dv3);
  for (c22_i11 = 0; c22_i11 < 4; c22_i11++) {
    c22_b_q[c22_i11] = c22_q[c22_i11];
  }

  for (c22_i12 = 0; c22_i12 < 4; c22_i12++) {
    c22_dv4[c22_i12] = c22_dv3[c22_i12];
  }

  c22_quatmultiply(chartInstance, c22_b_q, c22_dv4, c22_dv5);
  for (c22_i13 = 0; c22_i13 < 4; c22_i13++) {
    c22_pq_d1[c22_i13] = c22_dv5[c22_i13];
  }

  _SFD_EML_CALL(0U, chartInstance->c22_sfEvent, 3);
  for (c22_i14 = 0; c22_i14 < 4; c22_i14++) {
    c22_q[c22_i14] = c22_b_q_do[c22_i14];
  }

  for (c22_c_k = 0; c22_c_k < 3; c22_c_k++) {
    c22_d_k = 2.0 + (real_T)c22_c_k;
    c22_q[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      c22_d_k), 1, 4, 1, 0) - 1] = -c22_q[_SFD_EML_ARRAY_BOUNDS_CHECK("",
      (int32_T)_SFD_INTEGER_CHECK("", c22_d_k), 1, 4, 1, 0) - 1];
  }

  c22_dv6[0] = 0.0;
  for (c22_i15 = 0; c22_i15 < 3; c22_i15++) {
    c22_dv6[c22_i15 + 1] = c22_b_r[c22_i15 + 3];
  }

  for (c22_i16 = 0; c22_i16 < 4; c22_i16++) {
    c22_d_q_do[c22_i16] = c22_b_q_do[c22_i16];
  }

  c22_quatmultiply(chartInstance, c22_dv6, c22_d_q_do, c22_dv3);
  for (c22_i17 = 0; c22_i17 < 4; c22_i17++) {
    c22_c_q[c22_i17] = c22_q[c22_i17];
  }

  for (c22_i18 = 0; c22_i18 < 4; c22_i18++) {
    c22_dv7[c22_i18] = c22_dv3[c22_i18];
  }

  c22_quatmultiply(chartInstance, c22_c_q, c22_dv7, c22_dv5);
  for (c22_i19 = 0; c22_i19 < 4; c22_i19++) {
    c22_pq_d2[c22_i19] = c22_dv5[c22_i19];
  }

  _SFD_EML_CALL(0U, chartInstance->c22_sfEvent, 4);
  for (c22_i20 = 0; c22_i20 < 4; c22_i20++) {
    c22_q[c22_i20] = c22_b_q_do[c22_i20];
  }

  for (c22_e_k = 0; c22_e_k < 3; c22_e_k++) {
    c22_f_k = 2.0 + (real_T)c22_e_k;
    c22_q[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      c22_f_k), 1, 4, 1, 0) - 1] = -c22_q[_SFD_EML_ARRAY_BOUNDS_CHECK("",
      (int32_T)_SFD_INTEGER_CHECK("", c22_f_k), 1, 4, 1, 0) - 1];
  }

  c22_dv8[0] = 0.0;
  for (c22_i21 = 0; c22_i21 < 3; c22_i21++) {
    c22_dv8[c22_i21 + 1] = c22_b_r[c22_i21 + 6];
  }

  for (c22_i22 = 0; c22_i22 < 4; c22_i22++) {
    c22_e_q_do[c22_i22] = c22_b_q_do[c22_i22];
  }

  c22_quatmultiply(chartInstance, c22_dv8, c22_e_q_do, c22_dv3);
  for (c22_i23 = 0; c22_i23 < 4; c22_i23++) {
    c22_d_q[c22_i23] = c22_q[c22_i23];
  }

  for (c22_i24 = 0; c22_i24 < 4; c22_i24++) {
    c22_dv9[c22_i24] = c22_dv3[c22_i24];
  }

  c22_quatmultiply(chartInstance, c22_d_q, c22_dv9, c22_dv5);
  for (c22_i25 = 0; c22_i25 < 4; c22_i25++) {
    c22_pq_d3[c22_i25] = c22_dv5[c22_i25];
  }

  _SFD_EML_CALL(0U, chartInstance->c22_sfEvent, 5);
  for (c22_i26 = 0; c22_i26 < 4; c22_i26++) {
    c22_q[c22_i26] = c22_b_q_do[c22_i26];
  }

  for (c22_g_k = 0; c22_g_k < 3; c22_g_k++) {
    c22_h_k = 2.0 + (real_T)c22_g_k;
    c22_q[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      c22_h_k), 1, 4, 1, 0) - 1] = -c22_q[_SFD_EML_ARRAY_BOUNDS_CHECK("",
      (int32_T)_SFD_INTEGER_CHECK("", c22_h_k), 1, 4, 1, 0) - 1];
  }

  c22_dv10[0] = 0.0;
  for (c22_i27 = 0; c22_i27 < 3; c22_i27++) {
    c22_dv10[c22_i27 + 1] = c22_b_r[c22_i27 + 9];
  }

  for (c22_i28 = 0; c22_i28 < 4; c22_i28++) {
    c22_f_q_do[c22_i28] = c22_b_q_do[c22_i28];
  }

  c22_quatmultiply(chartInstance, c22_dv10, c22_f_q_do, c22_dv3);
  for (c22_i29 = 0; c22_i29 < 4; c22_i29++) {
    c22_e_q[c22_i29] = c22_q[c22_i29];
  }

  for (c22_i30 = 0; c22_i30 < 4; c22_i30++) {
    c22_dv11[c22_i30] = c22_dv3[c22_i30];
  }

  c22_quatmultiply(chartInstance, c22_e_q, c22_dv11, c22_dv5);
  for (c22_i31 = 0; c22_i31 < 4; c22_i31++) {
    c22_pq_d4[c22_i31] = c22_dv5[c22_i31];
  }

  _SFD_EML_CALL(0U, chartInstance->c22_sfEvent, 8);
  for (c22_i32 = 0; c22_i32 < 3; c22_i32++) {
    c22_b_x_d[c22_i32] = c22_b_p_do[c22_i32] + c22_pq_d1[c22_i32 + 1];
  }

  for (c22_i33 = 0; c22_i33 < 4; c22_i33++) {
    c22_b_x_d[c22_i33 + 3] = c22_b_q_do[c22_i33];
  }

  for (c22_i34 = 0; c22_i34 < 3; c22_i34++) {
    c22_b_x_d[c22_i34 + 7] = c22_b_p_do[c22_i34] + c22_pq_d2[c22_i34 + 1];
  }

  for (c22_i35 = 0; c22_i35 < 4; c22_i35++) {
    c22_b_x_d[c22_i35 + 10] = c22_b_q_do[c22_i35];
  }

  for (c22_i36 = 0; c22_i36 < 3; c22_i36++) {
    c22_b_x_d[c22_i36 + 14] = c22_b_p_do[c22_i36] + c22_pq_d3[c22_i36 + 1];
  }

  for (c22_i37 = 0; c22_i37 < 4; c22_i37++) {
    c22_b_x_d[c22_i37 + 17] = c22_b_q_do[c22_i37];
  }

  for (c22_i38 = 0; c22_i38 < 3; c22_i38++) {
    c22_b_x_d[c22_i38 + 21] = c22_b_p_do[c22_i38] + c22_pq_d4[c22_i38 + 1];
  }

  for (c22_i39 = 0; c22_i39 < 4; c22_i39++) {
    c22_b_x_d[c22_i39 + 24] = c22_b_q_do[c22_i39];
  }

  _SFD_EML_CALL(0U, chartInstance->c22_sfEvent, -8);
  _SFD_SYMBOL_SCOPE_POP();
  for (c22_i40 = 0; c22_i40 < 28; c22_i40++) {
    (*chartInstance->c22_x_d)[c22_i40] = c22_b_x_d[c22_i40];
  }

  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 1U, chartInstance->c22_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_DePascali4MMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c22_i41 = 0; c22_i41 < 28; c22_i41++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c22_x_d)[c22_i41], 2U);
  }

  for (c22_i42 = 0; c22_i42 < 12; c22_i42++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c22_r[c22_i42], 3U);
  }
}
  ...
  *c22_inData)
{
  ...
  for (c22_i43 = 0; c22_i43 < 28; c22_i43++) {
    c22_b_inData[c22_i43] = (*(real_T (*)[28])c22_inData)[c22_i43];
  }

  for (c22_i44 = 0; c22_i44 < 28; c22_i44++) {
    c22_u[c22_i44] = c22_b_inData[c22_i44];
  }
  ...
  real_T c22_y[28])
{
  ...
  int32_T c22_i45;
  (void)chartInstance;
  sf_mex_import(c22_parentId, sf_mex_dup(c22_u), c22_dv12, 1, 0, 0U, 1, 0U, 1,
                28);
  for (c22_i45 = 0; c22_i45 < 28; c22_i45++) {
    c22_y[c22_i45] = c22_dv12[c22_i45];
  }
  ...
  *c22_mxArrayInData, const char_T *c22_varName, void *c22_outData)
{
  ...
  c22_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c22_b_x_d), &c22_thisId,
    c22_y);
  sf_mex_destroy(&c22_b_x_d);
  for (c22_i46 = 0; c22_i46 < 28; c22_i46++) {
    (*(real_T (*)[28])c22_outData)[c22_i46] = c22_y[c22_i46];
  }
  ...
  *c22_inData)
{
  ...
  chartInstance = (SFc22_DePascali4MInstanceStruct *)chartInstanceVoid;
  c22_mxArrayOutData = NULL;
  for (c22_i47 = 0; c22_i47 < 12; c22_i47++) {
    c22_b_inData[c22_i47] = (*(real_T (*)[12])c22_inData)[c22_i47];
  }

  for (c22_i48 = 0; c22_i48 < 12; c22_i48++) {
    c22_u[c22_i48] = c22_b_inData[c22_i48];
  }
  ...
  real_T c22_y[12])
{
  ...
  int32_T c22_i49;
  (void)chartInstance;
  sf_mex_import(c22_parentId, sf_mex_dup(c22_u), c22_dv13, 1, 0, 0U, 1, 0U, 1,
                12);
  for (c22_i49 = 0; c22_i49 < 12; c22_i49++) {
    c22_y[c22_i49] = c22_dv13[c22_i49];
  }
  ...
  *c22_mxArrayInData, const char_T *c22_varName, void *c22_outData)
{
  ...
  for (c22_i50 = 0; c22_i50 < 12; c22_i50++) {
    (*(real_T (*)[12])c22_outData)[c22_i50] = c22_y[c22_i50];
  }
  ...
  *c22_inData)
{
  ...
  for (c22_i51 = 0; c22_i51 < 4; c22_i51++) {
    c22_b_inData[c22_i51] = (*(real_T (*)[4])c22_inData)[c22_i51];
  }

  for (c22_i52 = 0; c22_i52 < 4; c22_i52++) {
    c22_u[c22_i52] = c22_b_inData[c22_i52];
  }
  ...
  *c22_inData)
{
  ...
  chartInstance = (SFc22_DePascali4MInstanceStruct *)chartInstanceVoid;
  c22_mxArrayOutData = NULL;
  for (c22_i53 = 0; c22_i53 < 3; c22_i53++) {
    c22_b_inData[c22_i53] = (*(real_T (*)[3])c22_inData)[c22_i53];
  }

  for (c22_i54 = 0; c22_i54 < 3; c22_i54++) {
    c22_u[c22_i54] = c22_b_inData[c22_i54];
  }
  ...
  real_T c22_y[4])
{
  ...
  int32_T c22_i55;
  (void)chartInstance;
  sf_mex_import(c22_parentId, sf_mex_dup(c22_u), c22_dv14, 1, 0, 0U, 1, 0U, 1, 4);
  for (c22_i55 = 0; c22_i55 < 4; c22_i55++) {
    c22_y[c22_i55] = c22_dv14[c22_i55];
  }
  ...
  *c22_mxArrayInData, const char_T *c22_varName, void *c22_outData)
{
  ...
  SFc22_DePascali4MInstanceStruct *chartInstance;
  chartInstance = (SFc22_DePascali4MInstanceStruct *)chartInstanceVoid;
  c22_pq_d4 = sf_mex_dup(c22_mxArrayInData);
  c22_identifier = c22_varName;
  c22_thisId.fIdentifier = c22_identifier;
  c22_thisId.fParent = NULL;
  c22_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c22_pq_d4), &c22_thisId,
    c22_y);
  sf_mex_destroy(&c22_pq_d4);
  for (c22_i56 = 0; c22_i56 < 4; c22_i56++) {
    (*(real_T (*)[4])c22_outData)[c22_i56] = c22_y[c22_i56];
  }
...
const mxArray *sf_c22_DePascali4M_get_eml_resolved_functions_info(void)
{
  ...
  sf_mex_assign(&c22_nameCaptureInfo, sf_mex_createstruct("structure", 2, 11, 1),
                false);
...
static void c22_info_helper(const mxArray **c22_info)
{
  ...
  sf_mex_addfield(*c22_info, c22_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/aeroblks/eml/quatmultiply.p"), "context",
                  "context", 2);
  sf_mex_addfield(*c22_info, c22_emlrt_marshallOut("max"), "name", "name", 2);
  sf_mex_addfield(*c22_info, c22_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 2);
  sf_mex_addfield(*c22_info, c22_emlrt_marshallOut(
  ...
  *chartInstance, const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId)
{
  ...
  int32_T c22_i57;
  (void)chartInstance;
  sf_mex_import(c22_parentId, sf_mex_dup(c22_u), &c22_i57, 1, 6, 0U, 0, 0U, 0);
  c22_y = c22_i57;
  sf_mex_destroy(&c22_u);
  return c22_y;
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4235256980U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2852884288U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3301615864U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(969074013U);
}
...
mxArray *sf_c22_DePascali4M_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("uxoJUQw2ckfFG5OqGOe7sB");
...
static void mdlSetWorkWidths_c22_DePascali4M(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(517004762U));
  ssSetChecksum1(S,(2200629292U));
  ssSetChecksum2(S,(798431633U));
  ssSetChecksum3(S,(3655205882U));
