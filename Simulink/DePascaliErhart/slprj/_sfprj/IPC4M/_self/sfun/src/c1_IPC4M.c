  ...
  c1_chartNumber, uint32_T c1_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c1_chartNumber, c1_instanceNumber, 0U,
    ...
    "/home/mangerer/MAgit/MA/Simulink/DePascaliErhart/skew_sm.m"));
}
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[E]/home/mangerer/MAgit/MA/Simulink/DePascaliErhart/skew_sm.m"), "resolved",
                  "resolved", 0);
...
static void mdlSetWorkWidths_c1_IPC4M(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2437226800U));
  ssSetChecksum1(S,(3561207031U));
  ssSetChecksum2(S,(4177517768U));
  ssSetChecksum3(S,(2664410792U));
