...
static void initialize_c31_DIPCalt(SFc31_DIPCaltInstanceStruct *chartInstance);
static void initialize_params_c31_DIPCalt(SFc31_DIPCaltInstanceStruct
  *chartInstance);
static void enable_c31_DIPCalt(SFc31_DIPCaltInstanceStruct *chartInstance);
static void disable_c31_DIPCalt(SFc31_DIPCaltInstanceStruct *chartInstance);
static void c31_update_debugger_state_c31_DIPCalt(SFc31_DIPCaltInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c31_DIPCalt(SFc31_DIPCaltInstanceStruct
  *chartInstance);
static void set_sim_state_c31_DIPCalt(SFc31_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c31_st);
static void finalize_c31_DIPCalt(SFc31_DIPCaltInstanceStruct *chartInstance);
static void sf_gateway_c31_DIPCalt(SFc31_DIPCaltInstanceStruct *chartInstance);
static void mdl_start_c31_DIPCalt(SFc31_DIPCaltInstanceStruct *chartInstance);
static void c31_chartstep_c31_DIPCalt(SFc31_DIPCaltInstanceStruct *chartInstance);
static void initSimStructsc31_DIPCalt(SFc31_DIPCaltInstanceStruct *chartInstance);
static void c31_skew_sm(SFc31_DIPCaltInstanceStruct *chartInstance, real_T
  c31_b_x[3], real_T c31_X[9]);
static void c31_quatrot(SFc31_DIPCaltInstanceStruct *chartInstance, real_T
...
static const mxArray *c31_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_emlrt_marshallIn(SFc31_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c31_b_bred, const char_T *c31_identifier, real_T c31_y[18]);
static void c31_b_emlrt_marshallIn(SFc31_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c31_d_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_c_emlrt_marshallIn(SFc31_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c31_e_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static real_T c31_d_emlrt_marshallIn(SFc31_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c31_f_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_e_emlrt_marshallIn(SFc31_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c31_g_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_f_emlrt_marshallIn(SFc31_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c31_h_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_g_emlrt_marshallIn(SFc31_DIPCaltInstanceStruct *chartInstance,
...
static void c31_eml_scalar_eg(SFc31_DIPCaltInstanceStruct *chartInstance);
static void c31_threshold(SFc31_DIPCaltInstanceStruct *chartInstance);
static void c31_quatmultiply(SFc31_DIPCaltInstanceStruct *chartInstance, real_T
  c31_q[4], real_T c31_b_r[4], real_T c31_qout[4]);
static void c31_b_eml_scalar_eg(SFc31_DIPCaltInstanceStruct *chartInstance);
static const mxArray *c31_i_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static int32_T c31_h_emlrt_marshallIn(SFc31_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
static void c31_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData);
static uint8_T c31_i_emlrt_marshallIn(SFc31_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c31_b_is_active_c31_DIPCalt, const char_T *c31_identifier);
static uint8_T c31_j_emlrt_marshallIn(SFc31_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
static void init_dsm_address_info(SFc31_DIPCaltInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc31_DIPCaltInstanceStruct *chartInstance);
...
static void initialize_c31_DIPCalt(SFc31_DIPCaltInstanceStruct *chartInstance)
{
  ...
  chartInstance->c31_is_active_c31_DIPCalt = 0U;
}
  ...
  *chartInstance)
{
  ...
  c31_hoistedGlobal = chartInstance->c31_is_active_c31_DIPCalt;
  ...
  const mxArray *c31_st)
{
  ...
  chartInstance->c31_is_active_c31_DIPCalt = c31_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c31_u, 1)),
     "is_active_c31_DIPCalt");
  sf_mex_destroy(&c31_u);
  c31_update_debugger_state_c31_DIPCalt(chartInstance);
...
static void sf_gateway_c31_DIPCalt(SFc31_DIPCaltInstanceStruct *chartInstance)
{
  ...
  chartInstance->c31_sfEvent = CALL_EVENT;
  c31_chartstep_c31_DIPCalt(chartInstance);
  ...
  *c31_inData)
{
  ...
  real_T c31_u[18];
  const mxArray *c31_y = NULL;
  SFc31_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc31_DIPCaltInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c31_DIPCalt_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c31_b_is_active_c31_DIPCalt, const char_T *c31_identifier)
{
  ...
  c31_y = c31_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c31_b_is_active_c31_DIPCalt), &c31_thisId);
  sf_mex_destroy(&c31_b_is_active_c31_DIPCalt);
  return c31_y;
}
...
void sf_c31_DIPCalt_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c31_DIPCalt_get_post_codegen_info(void);
mxArray *sf_c31_DIPCalt_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c31_DIPCalt_get_post_codegen_info();
...
mxArray *sf_c31_DIPCalt_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c31_DIPCalt_jit_fallback_info(void)
{
...
mxArray *sf_c31_DIPCalt_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c31_DIPCalt(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"bred\",},{M[8],M[0],T\"is_active_c31_DIPCalt\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c31_DIPCalt_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc31_DIPCaltInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c31_DIPCalt(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc31_DIPCaltInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c31_DIPCalt((SFc31_DIPCaltInstanceStruct*) chartInstanceVar);
  initialize_c31_DIPCalt((SFc31_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c31_DIPCalt(void *chartInstanceVar)
{
  enable_c31_DIPCalt((SFc31_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c31_DIPCalt(void *chartInstanceVar)
{
  disable_c31_DIPCalt((SFc31_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c31_DIPCalt(void *chartInstanceVar)
{
  sf_gateway_c31_DIPCalt((SFc31_DIPCaltInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c31_DIPCalt(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c31_DIPCalt((SFc31_DIPCaltInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c31_DIPCalt(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c31_DIPCalt((SFc31_DIPCaltInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c31_DIPCalt(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc31_DIPCaltInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c31_DIPCalt((SFc31_DIPCaltInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc31_DIPCalt((SFc31_DIPCaltInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c31_DIPCalt(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c31_DIPCalt((SFc31_DIPCaltInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c31_DIPCalt(SimStruct *S)
{
...
static void mdlRTW_c31_DIPCalt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c31_DIPCalt(SimStruct *S)
{
  SFc31_DIPCaltInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc31_DIPCaltInstanceStruct *)utMalloc(sizeof
    (SFc31_DIPCaltInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc31_DIPCaltInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c31_DIPCalt;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c31_DIPCalt;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c31_DIPCalt;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c31_DIPCalt;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c31_DIPCalt;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c31_DIPCalt;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c31_DIPCalt;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c31_DIPCalt;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c31_DIPCalt;
  chartInstance->chartInfo.mdlStart = mdlStart_c31_DIPCalt;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c31_DIPCalt;
...
void c31_DIPCalt_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c31_DIPCalt(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c31_DIPCalt(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c31_DIPCalt(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c31_DIPCalt_method_dispatcher.\n"
