...
static void initialize_c7_DIPCalt(SFc7_DIPCaltInstanceStruct *chartInstance);
static void initialize_params_c7_DIPCalt(SFc7_DIPCaltInstanceStruct
  *chartInstance);
static void enable_c7_DIPCalt(SFc7_DIPCaltInstanceStruct *chartInstance);
static void disable_c7_DIPCalt(SFc7_DIPCaltInstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_DIPCalt(SFc7_DIPCaltInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c7_DIPCalt(SFc7_DIPCaltInstanceStruct
  *chartInstance);
static void set_sim_state_c7_DIPCalt(SFc7_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c7_st);
static void finalize_c7_DIPCalt(SFc7_DIPCaltInstanceStruct *chartInstance);
static void sf_gateway_c7_DIPCalt(SFc7_DIPCaltInstanceStruct *chartInstance);
static void mdl_start_c7_DIPCalt(SFc7_DIPCaltInstanceStruct *chartInstance);
static void initSimStructsc7_DIPCalt(SFc7_DIPCaltInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber, uint32_T c7_instanceNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static void c7_emlrt_marshallIn(SFc7_DIPCaltInstanceStruct *chartInstance, const
  mxArray *c7_b_hcoriolis, const char_T *c7_identifier, real_T c7_y[6]);
static void c7_b_emlrt_marshallIn(SFc7_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId, real_T c7_y[6]);
static void c7_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_b_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static real_T c7_c_emlrt_marshallIn(SFc7_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c7_d_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_d_emlrt_marshallIn(SFc7_DIPCaltInstanceStruct *chartInstance,
...
static const mxArray *c7_e_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_e_emlrt_marshallIn(SFc7_DIPCaltInstanceStruct *chartInstance,
...
static void c7_eml_scalar_eg(SFc7_DIPCaltInstanceStruct *chartInstance);
static void c7_eml_xgemm(SFc7_DIPCaltInstanceStruct *chartInstance, real_T c7_A
  [9], real_T c7_B[3], real_T c7_C[3], real_T c7_b_C[3]);
static const mxArray *c7_f_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_f_emlrt_marshallIn(SFc7_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint8_T c7_g_emlrt_marshallIn(SFc7_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c7_b_is_active_c7_DIPCalt, const char_T *c7_identifier);
static uint8_T c7_h_emlrt_marshallIn(SFc7_DIPCaltInstanceStruct *chartInstance,
  const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_eml_xgemm(SFc7_DIPCaltInstanceStruct *chartInstance, real_T
  c7_A[9], real_T c7_B[3], real_T c7_C[3]);
static void init_dsm_address_info(SFc7_DIPCaltInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc7_DIPCaltInstanceStruct *chartInstance);
...
static void initialize_c7_DIPCalt(SFc7_DIPCaltInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_DIPCalt = 0U;
}
  ...
  *chartInstance)
{
  ...
  c7_hoistedGlobal = chartInstance->c7_is_active_c7_DIPCalt;
  ...
  const mxArray *c7_st)
{
  ...
  chartInstance->c7_is_active_c7_DIPCalt = c7_g_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c7_u, 1)), "is_active_c7_DIPCalt");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_DIPCalt(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  real_T c7_u[6];
  const mxArray *c7_y = NULL;
  SFc7_DIPCaltInstanceStruct *chartInstance;
  chartInstance = (SFc7_DIPCaltInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c7_DIPCalt_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c7_b_is_active_c7_DIPCalt, const char_T *c7_identifier)
{
  ...
  c7_y = c7_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_DIPCalt), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_DIPCalt);
  return c7_y;
}
...
void sf_c7_DIPCalt_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c7_DIPCalt_get_post_codegen_info(void);
mxArray *sf_c7_DIPCalt_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c7_DIPCalt_get_post_codegen_info();
...
mxArray *sf_c7_DIPCalt_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c7_DIPCalt_jit_fallback_info(void)
{
...
mxArray *sf_c7_DIPCalt_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c7_DIPCalt(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"hcoriolis\",},{M[8],M[0],T\"is_active_c7_DIPCalt\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_DIPCalt_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc7_DIPCaltInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c7_DIPCalt(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_DIPCaltInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c7_DIPCalt((SFc7_DIPCaltInstanceStruct*) chartInstanceVar);
  initialize_c7_DIPCalt((SFc7_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_DIPCalt(void *chartInstanceVar)
{
  enable_c7_DIPCalt((SFc7_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c7_DIPCalt(void *chartInstanceVar)
{
  disable_c7_DIPCalt((SFc7_DIPCaltInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c7_DIPCalt(void *chartInstanceVar)
{
  sf_gateway_c7_DIPCalt((SFc7_DIPCaltInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c7_DIPCalt(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c7_DIPCalt((SFc7_DIPCaltInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c7_DIPCalt(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c7_DIPCalt((SFc7_DIPCaltInstanceStruct*)chartInfo->chartInstance,
    st);
}

static void sf_opaque_terminate_c7_DIPCalt(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_DIPCaltInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c7_DIPCalt((SFc7_DIPCaltInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc7_DIPCalt((SFc7_DIPCaltInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_DIPCalt(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c7_DIPCalt((SFc7_DIPCaltInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c7_DIPCalt(SimStruct *S)
{
...
static void mdlRTW_c7_DIPCalt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_DIPCalt(SimStruct *S)
{
  SFc7_DIPCaltInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc7_DIPCaltInstanceStruct *)utMalloc(sizeof
    (SFc7_DIPCaltInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_DIPCaltInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c7_DIPCalt;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c7_DIPCalt;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c7_DIPCalt;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_DIPCalt;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c7_DIPCalt;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c7_DIPCalt;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c7_DIPCalt;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c7_DIPCalt;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_DIPCalt;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_DIPCalt;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c7_DIPCalt;
...
void c7_DIPCalt_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_DIPCalt(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_DIPCalt(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_DIPCalt(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_DIPCalt_method_dispatcher.\n"
