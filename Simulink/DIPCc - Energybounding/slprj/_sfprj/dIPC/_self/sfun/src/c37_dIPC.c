...
static void c37_c_emlrt_marshallIn(SFc37_dIPCInstanceStruct *chartInstance,
  const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId, real_T c37_y[6]);
...
static void sf_gateway_c37_dIPC(SFc37_dIPCInstanceStruct *chartInstance)
{
  ...
  for (c37_i12 = 0; c37_i12 < 3; c37_i12++) {
    c37_b_x[c37_i12] = c37_b_p_o[c37_i12] + c37_dv2[c37_i12];
  }

  for (c37_i13 = 0; c37_i13 < 4; c37_i13++) {
    c37_b_x[c37_i13 + 3] = c37_b_q_o[c37_i13];
  }

  for (c37_i14 = 0; c37_i14 < 3; c37_i14++) {
    c37_b_x[c37_i14 + 7] = c37_b_p_o[c37_i14] + c37_dv3[c37_i14];
  }

  for (c37_i15 = 0; c37_i15 < 4; c37_i15++) {
    c37_b_x[c37_i15 + 10] = c37_b_q_o[c37_i15];
  }

  _SFD_EML_CALL(0U, chartInstance->c37_sfEvent, -3);
  _SFD_SYMBOL_SCOPE_POP();
  for (c37_i16 = 0; c37_i16 < 14; c37_i16++) {
    (*chartInstance->c37_x)[c37_i16] = c37_b_x[c37_i16];
  }
  ...
  for (c37_i17 = 0; c37_i17 < 14; c37_i17++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c37_x)[c37_i17], 2U);
  }

  for (c37_i18 = 0; c37_i18 < 6; c37_i18++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c37_r[c37_i18], 3U);
  }
}
  ...
  real_T c37_b_r[3], real_T c37_rw[3])
{
  ...
  for (c37_i20 = 0; c37_i20 < 3; c37_i20++) {
    c37_dv4[c37_i20 + 1] = c37_b_r[c37_i20];
  }

  for (c37_i21 = 0; c37_i21 < 4; c37_i21++) {
    c37_c_q[c37_i21] = c37_b_q[c37_i21];
  }

  c37_quatmultiply(chartInstance, c37_dv4, c37_c_q, c37_dv5);
  for (c37_i22 = 0; c37_i22 < 4; c37_i22++) {
    c37_d_q[c37_i22] = c37_q[c37_i22];
  }

  for (c37_i23 = 0; c37_i23 < 4; c37_i23++) {
    c37_dv6[c37_i23] = c37_dv5[c37_i23];
  }

  c37_quatmultiply(chartInstance, c37_d_q, c37_dv6, c37_b_q);
  for (c37_i24 = 0; c37_i24 < 4; c37_i24++) {
    c37_rwq[c37_i24] = c37_b_q[c37_i24];
  }

  _SFD_SCRIPT_CALL(0U, chartInstance->c37_sfEvent, 5);
  for (c37_i25 = 0; c37_i25 < 3; c37_i25++) {
    c37_rw[c37_i25] = c37_rwq[c37_i25 + 1];
  }
  ...
  *c37_inData)
{
  ...
  for (c37_i26 = 0; c37_i26 < 14; c37_i26++) {
    c37_b_inData[c37_i26] = (*(real_T (*)[14])c37_inData)[c37_i26];
  }

  for (c37_i27 = 0; c37_i27 < 14; c37_i27++) {
    c37_u[c37_i27] = c37_b_inData[c37_i27];
  }
  ...
  const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId, real_T c37_y[14])
{
  ...
  int32_T c37_i28;
  (void)chartInstance;
  sf_mex_import(c37_parentId, sf_mex_dup(c37_u), c37_dv7, 1, 0, 0U, 1, 0U, 1, 14);
  for (c37_i28 = 0; c37_i28 < 14; c37_i28++) {
    c37_y[c37_i28] = c37_dv7[c37_i28];
  }
  ...
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData)
{
  ...
  c37_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c37_b_x), &c37_thisId, c37_y);
  sf_mex_destroy(&c37_b_x);
  for (c37_i29 = 0; c37_i29 < 14; c37_i29++) {
    (*(real_T (*)[14])c37_outData)[c37_i29] = c37_y[c37_i29];
  }
  ...
  *c37_inData)
{
  ...
  for (c37_i30 = 0; c37_i30 < 6; c37_i30++) {
    c37_b_inData[c37_i30] = (*(real_T (*)[6])c37_inData)[c37_i30];
  }

  for (c37_i31 = 0; c37_i31 < 6; c37_i31++) {
    c37_u[c37_i31] = c37_b_inData[c37_i31];
  }
  ...
  const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId, real_T c37_y[6])
{
  ...
  int32_T c37_i32;
  (void)chartInstance;
  sf_mex_import(c37_parentId, sf_mex_dup(c37_u), c37_dv8, 1, 0, 0U, 1, 0U, 1, 6);
  for (c37_i32 = 0; c37_i32 < 6; c37_i32++) {
    c37_y[c37_i32] = c37_dv8[c37_i32];
  }
  ...
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData)
{
  ...
  for (c37_i33 = 0; c37_i33 < 6; c37_i33++) {
    (*(real_T (*)[6])c37_outData)[c37_i33] = c37_y[c37_i33];
  }
  ...
  *c37_inData)
{
  ...
  for (c37_i34 = 0; c37_i34 < 4; c37_i34++) {
    c37_b_inData[c37_i34] = (*(real_T (*)[4])c37_inData)[c37_i34];
  }
  ...
  *c37_inData)
{
  ...
  for (c37_i36 = 0; c37_i36 < 3; c37_i36++) {
    c37_b_inData[c37_i36] = (*(real_T (*)[3])c37_inData)[c37_i36];
  }

  for (c37_i37 = 0; c37_i37 < 3; c37_i37++) {
    c37_u[c37_i37] = c37_b_inData[c37_i37];
  }
  ...
  const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId, real_T c37_y[3])
{
  ...
  int32_T c37_i38;
  (void)chartInstance;
  sf_mex_import(c37_parentId, sf_mex_dup(c37_u), c37_dv9, 1, 0, 0U, 1, 0U, 1, 3);
  for (c37_i38 = 0; c37_i38 < 3; c37_i38++) {
    c37_y[c37_i38] = c37_dv9[c37_i38];
  }
  ...
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData)
{
  ...
  for (c37_i39 = 0; c37_i39 < 3; c37_i39++) {
    (*(real_T (*)[3])c37_outData)[c37_i39] = c37_y[c37_i39];
  }
  ...
  const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId, real_T c37_y[4])
{
  ...
  int32_T c37_i40;
  (void)chartInstance;
  sf_mex_import(c37_parentId, sf_mex_dup(c37_u), c37_dv10, 1, 0, 0U, 1, 0U, 1, 4);
  ...
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData)
{
  ...
  for (c37_i41 = 0; c37_i41 < 4; c37_i41++) {
    (*(real_T (*)[4])c37_outData)[c37_i41] = c37_y[c37_i41];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2976009846U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(151805046U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1063671694U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1281431046U);
}
...
mxArray *sf_c37_dIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("UHZaAEoMdoRDINBr92iwhG");
...
static void mdlSetWorkWidths_c37_dIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3157184424U));
  ssSetChecksum1(S,(1372690649U));
  ssSetChecksum2(S,(1206653419U));
  ssSetChecksum3(S,(2698465786U));
