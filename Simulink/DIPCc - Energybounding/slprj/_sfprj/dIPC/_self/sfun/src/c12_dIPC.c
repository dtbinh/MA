...
static void c12_emlrt_marshallIn(SFc12_dIPCInstanceStruct *chartInstance, const
  mxArray *c12_b_G, const char_T *c12_identifier, real_T c12_y[72]);
static void c12_b_emlrt_marshallIn(SFc12_dIPCInstanceStruct *chartInstance,
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[72]);
  ...
  *chartInstance)
{
  ...
  for (c12_i1 = 0; c12_i1 < 72; c12_i1++) {
    c12_u[c12_i1] = (*chartInstance->c12_G)[c12_i1];
  }

  c12_b_y = NULL;
  sf_mex_assign(&c12_b_y, sf_mex_create("y", c12_u, 0, 0U, 1U, 0U, 2, 6, 12),
                false);
...
static void sf_gateway_c12_dIPC(SFc12_dIPCInstanceStruct *chartInstance)
{
  ...
  _SFD_SCRIPT_CALL(1U, chartInstance->c12_sfEvent, -3);
  _SFD_SYMBOL_SCOPE_POP();
  c12_eye(chartInstance, c12_dv4);
  c12_eye(chartInstance, c12_dv5);
  ...
  for (c12_i14 = 0; c12_i14 < 3; c12_i14++) {
    for (c12_i15 = 0; c12_i15 < 3; c12_i15++) {
      c12_b_G[c12_i15 + c12_i12] = c12_dv4[c12_i15 + c12_i13];
    }
  ...
  for (c12_i17 = 0; c12_i17 < 3; c12_i17++) {
    for (c12_i18 = 0; c12_i18 < 3; c12_i18++) {
      c12_b_G[(c12_i18 + c12_i16) + 18] = 0.0;
    }
  ...
  for (c12_i21 = 0; c12_i21 < 3; c12_i21++) {
    for (c12_i22 = 0; c12_i22 < 3; c12_i22++) {
      c12_b_G[(c12_i22 + c12_i19) + 36] = c12_dv5[c12_i22 + c12_i20];
    }
  ...
  for (c12_i24 = 0; c12_i24 < 3; c12_i24++) {
    for (c12_i25 = 0; c12_i25 < 3; c12_i25++) {
      c12_b_G[(c12_i25 + c12_i23) + 54] = 0.0;
    }
  ...
  for (c12_i28 = 0; c12_i28 < 3; c12_i28++) {
    for (c12_i29 = 0; c12_i29 < 3; c12_i29++) {
      c12_b_G[(c12_i29 + c12_i26) + 3] = c12_X[c12_i29 + c12_i27];
    }
  ...
  for (c12_i32 = 0; c12_i32 < 3; c12_i32++) {
    for (c12_i33 = 0; c12_i33 < 3; c12_i33++) {
      c12_b_G[(c12_i33 + c12_i30) + 21] = c12_dv6[c12_i33 + c12_i31];
    }
  ...
  for (c12_i36 = 0; c12_i36 < 3; c12_i36++) {
    for (c12_i37 = 0; c12_i37 < 3; c12_i37++) {
      c12_b_G[(c12_i37 + c12_i34) + 39] = c12_b_X[c12_i37 + c12_i35];
    }
  ...
  for (c12_i40 = 0; c12_i40 < 3; c12_i40++) {
    for (c12_i41 = 0; c12_i41 < 3; c12_i41++) {
      c12_b_G[(c12_i41 + c12_i38) + 57] = c12_dv7[c12_i41 + c12_i39];
    }
  ...
  _SFD_EML_CALL(0U, chartInstance->c12_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c12_i42 = 0; c12_i42 < 72; c12_i42++) {
    (*chartInstance->c12_G)[c12_i42] = c12_b_G[c12_i42];
  }
  ...
  for (c12_i43 = 0; c12_i43 < 72; c12_i43++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c12_G)[c12_i43], 1U);
  }

  for (c12_i44 = 0; c12_i44 < 7; c12_i44++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c12_x)[c12_i44], 2U);
  }
}
  ...
  real_T c12_r[3], real_T c12_rw[3])
{
  ...
  for (c12_i46 = 0; c12_i46 < 3; c12_i46++) {
    c12_dv8[c12_i46 + 1] = c12_r[c12_i46];
  }

  for (c12_i47 = 0; c12_i47 < 4; c12_i47++) {
    c12_c_q[c12_i47] = c12_b_q[c12_i47];
  }

  c12_quatmultiply(chartInstance, c12_dv8, c12_c_q, c12_dv9);
  for (c12_i48 = 0; c12_i48 < 4; c12_i48++) {
    c12_d_q[c12_i48] = c12_q[c12_i48];
  }

  for (c12_i49 = 0; c12_i49 < 4; c12_i49++) {
    c12_dv10[c12_i49] = c12_dv9[c12_i49];
  }

  c12_quatmultiply(chartInstance, c12_d_q, c12_dv10, c12_b_q);
  for (c12_i50 = 0; c12_i50 < 4; c12_i50++) {
    c12_rwq[c12_i50] = c12_b_q[c12_i50];
  }

  _SFD_SCRIPT_CALL(0U, chartInstance->c12_sfEvent, 5);
  for (c12_i51 = 0; c12_i51 < 3; c12_i51++) {
    c12_rw[c12_i51] = c12_rwq[c12_i51 + 1];
  }
  ...
  *c12_inData)
{
  ...
  c12_i52 = 0;
  for (c12_i53 = 0; c12_i53 < 12; c12_i53++) {
    for (c12_i54 = 0; c12_i54 < 6; c12_i54++) {
      c12_b_inData[c12_i54 + c12_i52] = (*(real_T (*)[72])c12_inData)[c12_i54 +
        c12_i52];
    }
  ...
  c12_i55 = 0;
  for (c12_i56 = 0; c12_i56 < 12; c12_i56++) {
    for (c12_i57 = 0; c12_i57 < 6; c12_i57++) {
      c12_u[c12_i57 + c12_i55] = c12_b_inData[c12_i57 + c12_i55];
    }
  ...
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[72])
{
  ...
  int32_T c12_i58;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), c12_dv11, 1, 0, 0U, 1, 0U, 2, 6,
                12);
  for (c12_i58 = 0; c12_i58 < 72; c12_i58++) {
    c12_y[c12_i58] = c12_dv11[c12_i58];
  }
  ...
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData)
{
  ...
  sf_mex_destroy(&c12_b_G);
  c12_i59 = 0;
  for (c12_i60 = 0; c12_i60 < 12; c12_i60++) {
    for (c12_i61 = 0; c12_i61 < 6; c12_i61++) {
      (*(real_T (*)[72])c12_outData)[c12_i61 + c12_i59] = c12_y[c12_i61 +
        c12_i59];
    }
  ...
  *c12_inData)
{
  ...
  chartInstance = (SFc12_dIPCInstanceStruct *)chartInstanceVoid;
  c12_mxArrayOutData = NULL;
  for (c12_i62 = 0; c12_i62 < 7; c12_i62++) {
    c12_b_inData[c12_i62] = (*(real_T (*)[7])c12_inData)[c12_i62];
  }

  for (c12_i63 = 0; c12_i63 < 7; c12_i63++) {
    c12_u[c12_i63] = c12_b_inData[c12_i63];
  }
  ...
  *c12_inData)
{
  ...
  for (c12_i64 = 0; c12_i64 < 6; c12_i64++) {
    c12_b_inData[c12_i64] = (*(real_T (*)[6])c12_inData)[c12_i64];
  }
  ...
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[6])
{
  ...
  int32_T c12_i66;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), c12_dv12, 1, 0, 0U, 1, 0U, 1, 6);
  for (c12_i66 = 0; c12_i66 < 6; c12_i66++) {
    c12_y[c12_i66] = c12_dv12[c12_i66];
  }
  ...
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData)
{
  ...
  for (c12_i67 = 0; c12_i67 < 6; c12_i67++) {
    (*(real_T (*)[6])c12_outData)[c12_i67] = c12_y[c12_i67];
  }
  ...
  *c12_inData)
{
  ...
  for (c12_i68 = 0; c12_i68 < 3; c12_i68++) {
    c12_b_inData[c12_i68] = (*(real_T (*)[3])c12_inData)[c12_i68];
  }
  ...
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[3])
{
  ...
  int32_T c12_i70;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), c12_dv13, 1, 0, 0U, 1, 0U, 1, 3);
  for (c12_i70 = 0; c12_i70 < 3; c12_i70++) {
    c12_y[c12_i70] = c12_dv13[c12_i70];
  }
  ...
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData)
{
  ...
  for (c12_i71 = 0; c12_i71 < 3; c12_i71++) {
    (*(real_T (*)[3])c12_outData)[c12_i71] = c12_y[c12_i71];
  }
  ...
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[4])
{
  ...
  int32_T c12_i74;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), c12_dv14, 1, 0, 0U, 1, 0U, 1, 4);
  for (c12_i74 = 0; c12_i74 < 4; c12_i74++) {
    c12_y[c12_i74] = c12_dv14[c12_i74];
  }
  ...
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData)
{
  ...
  for (c12_i75 = 0; c12_i75 < 4; c12_i75++) {
    (*(real_T (*)[4])c12_outData)[c12_i75] = c12_y[c12_i75];
  }
  ...
  *c12_inData)
{
  ...
  for (c12_i77 = 0; c12_i77 < 3; c12_i77++) {
    for (c12_i78 = 0; c12_i78 < 3; c12_i78++) {
      c12_b_inData[c12_i78 + c12_i76] = (*(real_T (*)[9])c12_inData)[c12_i78 +
        c12_i76];
    }
  ...
  c12_i79 = 0;
  for (c12_i80 = 0; c12_i80 < 3; c12_i80++) {
    for (c12_i81 = 0; c12_i81 < 3; c12_i81++) {
      c12_u[c12_i81 + c12_i79] = c12_b_inData[c12_i81 + c12_i79];
    }
  ...
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[9])
{
  ...
  int32_T c12_i82;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), c12_dv15, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c12_i82 = 0; c12_i82 < 9; c12_i82++) {
    c12_y[c12_i82] = c12_dv15[c12_i82];
  }
  ...
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData)
{
  ...
  c12_i83 = 0;
  for (c12_i84 = 0; c12_i84 < 3; c12_i84++) {
    for (c12_i85 = 0; c12_i85 < 3; c12_i85++) {
      (*(real_T (*)[9])c12_outData)[c12_i85 + c12_i83] = c12_y[c12_i85 + c12_i83];
    }
...
static void c12_info_helper(const mxArray **c12_info)
{
  ...
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(1462213506U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c12_info, c12_b_emlrt_marshallOut(0U), "mFileTimeLo",
...
static void c12_eye(SFc12_dIPCInstanceStruct *chartInstance, real_T c12_I[9])
{
  ...
  int32_T c12_b_k;
  (void)chartInstance;
  for (c12_i86 = 0; c12_i86 < 9; c12_i86++) {
    c12_I[c12_i86] = 0.0;
  }
  ...
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId)
{
  ...
  int32_T c12_i87;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), &c12_i87, 1, 6, 0U, 0, 0U, 0);
  c12_y = c12_i87;
  sf_mex_destroy(&c12_u);
  return c12_y;
}
...
static void init_simulink_io_address(SFc12_dIPCInstanceStruct *chartInstance)
{
  chartInstance->c12_G = (real_T (*)[72])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
