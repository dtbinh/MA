  ...
  *c2_inData)
{
  ...
  for (c2_i34 = 0; c2_i34 < 6; c2_i34++) {
    c2_b_inData[c2_i34] = (*(real_T (*)[6])c2_inData)[c2_i34];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i37 = 0; c2_i37 < 6; c2_i37++) {
    (*(real_T (*)[6])c2_outData)[c2_i37] = c2_y[c2_i37];
  }
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPCc - Energybounding/quatrot.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1462213506U), "fileTimeLo",
                  "fileTimeLo", 0);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3690957559U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2982285384U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(539292112U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2659515567U);
}
...
mxArray *sf_c2_dIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("HdvsC8dOgiqL3YcerOwDt");
...
static void mdlSetWorkWidths_c2_dIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(751992477U));
  ssSetChecksum1(S,(1111668225U));
  ssSetChecksum2(S,(318582142U));
  ssSetChecksum3(S,(3211024583U));
