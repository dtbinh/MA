...
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_c_emlrt_marshallIn(SFc6_dIPCInstanceStruct *chartInstance, const
  mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[6]);
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_d_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real_T c6_d_emlrt_marshallIn(SFc6_dIPCInstanceStruct *chartInstance,
...
static const mxArray *c6_g_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_g_emlrt_marshallIn(SFc6_dIPCInstanceStruct *chartInstance, const
...
static const mxArray *c6_h_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_h_emlrt_marshallIn(SFc6_dIPCInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
...
static uint8_T c6_j_emlrt_marshallIn(SFc6_dIPCInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
  ...
  mxArray *c6_st)
{
  ...
  chartInstance->c6_is_active_c6_dIPC = c6_i_emlrt_marshallIn(chartInstance,
...
static void c6_chartstep_c6_dIPC(SFc6_dIPCInstanceStruct *chartInstance)
{
  ...
  for (c6_i22 = 0; c6_i22 < 3; c6_i22++) {
    c6_d_x[c6_i22] = c6_b_dx[c6_i22 + 3];
  }
  ...
  for (c6_i25 = 0; c6_i25 < 3; c6_i25++) {
    ...
    for (c6_i27 = 0; c6_i27 < 3; c6_i27++) {
      c6_y[c6_i26 + c6_i25] = 0.0;
      c6_i28 = 0;
      for (c6_i29 = 0; c6_i29 < 3; c6_i29++) {
        c6_y[c6_i26 + c6_i25] += c6_a[c6_i28 + c6_i25] * c6_c_b[c6_i29 + c6_i26];
        c6_i28 += 3;
      }
  ...
  for (c6_i30 = 0; c6_i30 < 4; c6_i30++) {
    c6_e_x[c6_i30] = c6_b_x[c6_i30 + 3];
  }

  for (c6_i31 = 0; c6_i31 < 3; c6_i31++) {
    c6_d_r[c6_i31] = c6_b_r[c6_i31 + 3];
  }
  ...
  for (c6_i32 = 0; c6_i32 < 3; c6_i32++) {
    ...
    for (c6_i34 = 0; c6_i34 < 3; c6_i34++) {
      c6_c_y[c6_i32] += c6_y[c6_i33 + c6_i32] * c6_d_b[c6_i34];
      c6_i33 += 3;
    }
  }

  for (c6_i35 = 0; c6_i35 < 3; c6_i35++) {
    c6_b_b[c6_i35] = c6_b_y[c6_i35];
  }
  ...
  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c6_i39 = 0; c6_i39 < 12; c6_i39++) {
    (*chartInstance->c6_b)[c6_i39] = c6_b_b[c6_i39];
  }
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  for (c6_i47 = 0; c6_i47 < 12; c6_i47++) {
    c6_b_inData[c6_i47] = (*(real_T (*)[12])c6_inData)[c6_i47];
  }
  ...
  mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[12])
{
  ...
  int32_T c6_i49;
  (void)chartInstance;
  sf_mex_import(c6_parentId, sf_mex_dup(c6_u), c6_dv5, 1, 0, 0U, 1, 0U, 1, 12);
  for (c6_i49 = 0; c6_i49 < 12; c6_i49++) {
    c6_y[c6_i49] = c6_dv5[c6_i49];
  }
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  for (c6_i50 = 0; c6_i50 < 12; c6_i50++) {
    (*(real_T (*)[12])c6_outData)[c6_i50] = c6_y[c6_i50];
  }
  ...
  *c6_inData)
{
  ...
  chartInstance = (SFc6_dIPCInstanceStruct *)chartInstanceVoid;
  c6_mxArrayOutData = NULL;
  for (c6_i51 = 0; c6_i51 < 14; c6_i51++) {
    c6_b_inData[c6_i51] = (*(real_T (*)[14])c6_inData)[c6_i51];
  }
  ...
  mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[6])
{
  ...
  int32_T c6_i55;
  (void)chartInstance;
  sf_mex_import(c6_parentId, sf_mex_dup(c6_u), c6_dv6, 1, 0, 0U, 1, 0U, 1, 6);
  for (c6_i55 = 0; c6_i55 < 6; c6_i55++) {
    c6_y[c6_i55] = c6_dv6[c6_i55];
  }
  ...
  *c6_inData)
{
  ...
  for (c6_i58 = 0; c6_i58 < 3; c6_i58++) {
    for (c6_i59 = 0; c6_i59 < 3; c6_i59++) {
      c6_b_inData[c6_i59 + c6_i57] = (*(real_T (*)[9])c6_inData)[c6_i59 + c6_i57];
    }
  ...
  for (c6_i61 = 0; c6_i61 < 3; c6_i61++) {
    for (c6_i62 = 0; c6_i62 < 3; c6_i62++) {
      c6_u[c6_i62 + c6_i60] = c6_b_inData[c6_i62 + c6_i60];
    }
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  for (c6_i65 = 0; c6_i65 < 3; c6_i65++) {
    for (c6_i66 = 0; c6_i66 < 3; c6_i66++) {
      (*(real_T (*)[9])c6_outData)[c6_i66 + c6_i64] = c6_y[c6_i66 + c6_i64];
    }
  ...
  *c6_inData)
{
  ...
  for (c6_i67 = 0; c6_i67 < 3; c6_i67++) {
    c6_b_inData[c6_i67] = (*(real_T (*)[3])c6_inData)[c6_i67];
  }

  for (c6_i68 = 0; c6_i68 < 3; c6_i68++) {
    c6_u[c6_i68] = c6_b_inData[c6_i68];
  }
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  for (c6_i70 = 0; c6_i70 < 3; c6_i70++) {
    (*(real_T (*)[3])c6_outData)[c6_i70] = c6_y[c6_i70];
  }
  ...
  *c6_inData)
{
  ...
  for (c6_i71 = 0; c6_i71 < 4; c6_i71++) {
    c6_b_inData[c6_i71] = (*(real_T (*)[4])c6_inData)[c6_i71];
  }
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  for (c6_i74 = 0; c6_i74 < 4; c6_i74++) {
    (*(real_T (*)[4])c6_outData)[c6_i74] = c6_y[c6_i74];
  }
...
static void c6_info_helper(const mxArray **c6_info)
{
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPCc - Energybounding/skew_sm.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1462213506U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  const mxArray *c6_b_is_active_c6_dIPC, const char_T *c6_identifier)
{
  ...
  c6_thisId.fIdentifier = c6_identifier;
  c6_thisId.fParent = NULL;
  c6_y = c6_j_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_b_is_active_c6_dIPC),
    &c6_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2269340446U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(892118608U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3126570812U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(524739796U);
}
...
mxArray *sf_c6_dIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Z8mAHuTnGf7zF0Va8oxzZG");
...
static void mdlSetWorkWidths_c6_dIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2927808411U));
  ssSetChecksum1(S,(1871135017U));
  ssSetChecksum2(S,(1098213486U));
  ssSetChecksum3(S,(2526944197U));
