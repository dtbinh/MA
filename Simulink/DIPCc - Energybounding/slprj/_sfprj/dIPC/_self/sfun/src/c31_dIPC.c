...
static void sf_gateway_c31_dIPC(SFc31_dIPCInstanceStruct *chartInstance)
{
  ...
  for (c31_i5 = 0; c31_i5 < 6; c31_i5++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c31_bred)[c31_i5], 2U);
  }

  for (c31_i6 = 0; c31_i6 < 12; c31_i6++) {
...
static void c31_chartstep_c31_dIPC(SFc31_dIPCInstanceStruct *chartInstance)
{
  ...
  for (c31_i7 = 0; c31_i7 < 6; c31_i7++) {
    c31_b_r[c31_i7] = chartInstance->c31_r[c31_i7];
  }

  for (c31_i8 = 0; c31_i8 < 14; c31_i8++) {
    c31_b_x[c31_i8] = (*chartInstance->c31_x)[c31_i8];
  }

  for (c31_i9 = 0; c31_i9 < 12; c31_i9++) {
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c31_nargout, 1U, c31_d_sf_marshallOut,
    c31_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c31_b_r, 2U, c31_sf_marshallOut,
    c31_sf_marshallIn);
  ...
  for (c31_i17 = 0; c31_i17 < 4; c31_i17++) {
    c31_q[c31_i17] = c31_b_x[c31_i17 + 3];
  }
  ...
  for (c31_i27 = 0; c31_i27 < 3; c31_i27++) {
    ...
    for (c31_i29 = 0; c31_i29 < 3; c31_i29++) {
      c31_b_y[c31_i27] += c31_y[c31_i28 + c31_i27] * c31_b_b[c31_i29];
      c31_i28 += 3;
    }
  }

  for (c31_i30 = 0; c31_i30 < 3; c31_i30++) {
    c31_b_bred[c31_i30] = c31_b_y[c31_i30];
  }

  for (c31_i31 = 0; c31_i31 < 3; c31_i31++) {
    c31_b_bred[c31_i31 + 3] = 0.0;
  }

  _SFD_EML_CALL(0U, chartInstance->c31_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c31_i32 = 0; c31_i32 < 6; c31_i32++) {
    (*chartInstance->c31_bred)[c31_i32] = c31_b_bred[c31_i32];
  }
  ...
  *c31_inData)
{
  ...
  for (c31_i33 = 0; c31_i33 < 6; c31_i33++) {
    c31_b_inData[c31_i33] = (*(real_T (*)[6])c31_inData)[c31_i33];
  }

  for (c31_i34 = 0; c31_i34 < 6; c31_i34++) {
    c31_u[c31_i34] = c31_b_inData[c31_i34];
  }
  ...
  const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId, real_T c31_y[6])
{
  ...
  int32_T c31_i35;
  (void)chartInstance;
  sf_mex_import(c31_parentId, sf_mex_dup(c31_u), c31_dv5, 1, 0, 0U, 1, 0U, 1, 6);
  for (c31_i35 = 0; c31_i35 < 6; c31_i35++) {
    c31_y[c31_i35] = c31_dv5[c31_i35];
  }
  ...
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData)
{
  ...
  c31_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c31_b_bred), &c31_thisId,
    c31_y);
  sf_mex_destroy(&c31_b_bred);
  for (c31_i36 = 0; c31_i36 < 6; c31_i36++) {
    (*(real_T (*)[6])c31_outData)[c31_i36] = c31_y[c31_i36];
  }
  ...
  *c31_inData)
{
  ...
  for (c31_i37 = 0; c31_i37 < 12; c31_i37++) {
    c31_b_inData[c31_i37] = (*(real_T (*)[12])c31_inData)[c31_i37];
  }

  for (c31_i38 = 0; c31_i38 < 12; c31_i38++) {
    c31_u[c31_i38] = c31_b_inData[c31_i38];
  }
  ...
  *c31_inData)
{
  ...
  for (c31_i39 = 0; c31_i39 < 14; c31_i39++) {
    c31_b_inData[c31_i39] = (*(real_T (*)[14])c31_inData)[c31_i39];
  }

  for (c31_i40 = 0; c31_i40 < 14; c31_i40++) {
    c31_u[c31_i40] = c31_b_inData[c31_i40];
  }
  ...
  *c31_inData)
{
  ...
  for (c31_i42 = 0; c31_i42 < 3; c31_i42++) {
    for (c31_i43 = 0; c31_i43 < 3; c31_i43++) {
      c31_b_inData[c31_i43 + c31_i41] = (*(real_T (*)[9])c31_inData)[c31_i43 +
        c31_i41];
    }
  ...
  for (c31_i45 = 0; c31_i45 < 3; c31_i45++) {
    for (c31_i46 = 0; c31_i46 < 3; c31_i46++) {
      c31_u[c31_i46 + c31_i44] = c31_b_inData[c31_i46 + c31_i44];
    }
  ...
  const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId, real_T c31_y[9])
{
  ...
  int32_T c31_i47;
  (void)chartInstance;
  sf_mex_import(c31_parentId, sf_mex_dup(c31_u), c31_dv6, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c31_i47 = 0; c31_i47 < 9; c31_i47++) {
    c31_y[c31_i47] = c31_dv6[c31_i47];
  }
  ...
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData)
{
  ...
  for (c31_i49 = 0; c31_i49 < 3; c31_i49++) {
    for (c31_i50 = 0; c31_i50 < 3; c31_i50++) {
      (*(real_T (*)[9])c31_outData)[c31_i50 + c31_i48] = c31_y[c31_i50 + c31_i48];
    }
  ...
  *c31_inData)
{
  ...
  for (c31_i51 = 0; c31_i51 < 3; c31_i51++) {
    c31_b_inData[c31_i51] = (*(real_T (*)[3])c31_inData)[c31_i51];
  }

  for (c31_i52 = 0; c31_i52 < 3; c31_i52++) {
    c31_u[c31_i52] = c31_b_inData[c31_i52];
  }
  ...
  const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId, real_T c31_y[3])
{
  ...
  int32_T c31_i53;
  (void)chartInstance;
  sf_mex_import(c31_parentId, sf_mex_dup(c31_u), c31_dv7, 1, 0, 0U, 1, 0U, 1, 3);
  for (c31_i53 = 0; c31_i53 < 3; c31_i53++) {
    c31_y[c31_i53] = c31_dv7[c31_i53];
  }
  ...
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData)
{
  ...
  for (c31_i54 = 0; c31_i54 < 3; c31_i54++) {
    (*(real_T (*)[3])c31_outData)[c31_i54] = c31_y[c31_i54];
  }
  ...
  *c31_inData)
{
  ...
  for (c31_i55 = 0; c31_i55 < 4; c31_i55++) {
    c31_b_inData[c31_i55] = (*(real_T (*)[4])c31_inData)[c31_i55];
  }

  for (c31_i56 = 0; c31_i56 < 4; c31_i56++) {
    c31_u[c31_i56] = c31_b_inData[c31_i56];
  }
  ...
  const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId, real_T c31_y[4])
{
  ...
  int32_T c31_i57;
  (void)chartInstance;
  sf_mex_import(c31_parentId, sf_mex_dup(c31_u), c31_dv8, 1, 0, 0U, 1, 0U, 1, 4);
  for (c31_i57 = 0; c31_i57 < 4; c31_i57++) {
    c31_y[c31_i57] = c31_dv8[c31_i57];
  }
  ...
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData)
{
  ...
  for (c31_i58 = 0; c31_i58 < 4; c31_i58++) {
    (*(real_T (*)[4])c31_outData)[c31_i58] = c31_y[c31_i58];
  }
  ...
  const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId)
{
  ...
  int32_T c31_i59;
  (void)chartInstance;
  sf_mex_import(c31_parentId, sf_mex_dup(c31_u), &c31_i59, 1, 6, 0U, 0, 0U, 0);
  c31_y = c31_i59;
  sf_mex_destroy(&c31_u);
  return c31_y;
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3317905623U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3811196753U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(199574231U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(242125538U);
}
...
mxArray *sf_c31_dIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("asyZ5s3s4TN5xDIuT1NnhC");
...
static void mdlSetWorkWidths_c31_dIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3137161739U));
  ssSetChecksum1(S,(1989061936U));
  ssSetChecksum2(S,(2584745458U));
  ssSetChecksum3(S,(762115130U));
