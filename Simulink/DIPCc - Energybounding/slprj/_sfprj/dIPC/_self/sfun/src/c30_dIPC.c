...
static const mxArray *c30_c_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static void c30_c_emlrt_marshallIn(SFc30_dIPCInstanceStruct *chartInstance,
...
static const mxArray *c30_d_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static real_T c30_d_emlrt_marshallIn(SFc30_dIPCInstanceStruct *chartInstance,
...
static const mxArray *c30_g_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static void c30_g_emlrt_marshallIn(SFc30_dIPCInstanceStruct *chartInstance,
...
static const mxArray *c30_h_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static int32_T c30_h_emlrt_marshallIn(SFc30_dIPCInstanceStruct *chartInstance,
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId);
...
static uint8_T c30_j_emlrt_marshallIn(SFc30_dIPCInstanceStruct *chartInstance,
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId);
  ...
  const mxArray *c30_st)
{
  ...
  c30_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c30_u, 0)),
                       "Ared", c30_dv1);
  for (c30_i2 = 0; c30_i2 < 72; c30_i2++) {
    (*chartInstance->c30_Ared)[c30_i2] = c30_dv1[c30_i2];
  }

  chartInstance->c30_is_active_c30_dIPC = c30_i_emlrt_marshallIn(chartInstance,
...
static void sf_gateway_c30_dIPC(SFc30_dIPCInstanceStruct *chartInstance)
{
  ...
  for (c30_i9 = 0; c30_i9 < 3; c30_i9++) {
    c30_dv2[c30_i9 + 1] = c30_c_r[c30_i9];
  }

  for (c30_i10 = 0; c30_i10 < 4; c30_i10++) {
    c30_c_q[c30_i10] = c30_b_q[c30_i10];
  }

  c30_quatmultiply(chartInstance, c30_dv2, c30_c_q, c30_dv3);
  for (c30_i11 = 0; c30_i11 < 4; c30_i11++) {
    c30_d_q[c30_i11] = c30_q[c30_i11];
  }

  for (c30_i12 = 0; c30_i12 < 4; c30_i12++) {
    c30_dv4[c30_i12] = c30_dv3[c30_i12];
  }

  c30_quatmultiply(chartInstance, c30_d_q, c30_dv4, c30_b_q);
  for (c30_i13 = 0; c30_i13 < 4; c30_i13++) {
    c30_rwq[c30_i13] = c30_b_q[c30_i13];
  }

  _SFD_SCRIPT_CALL(0U, chartInstance->c30_sfEvent, 5);
  for (c30_i14 = 0; c30_i14 < 3; c30_i14++) {
    c30_rw[c30_i14] = c30_rwq[c30_i14 + 1];
  }

  _SFD_SCRIPT_CALL(0U, chartInstance->c30_sfEvent, -5);
  _SFD_SYMBOL_SCOPE_POP();
  for (c30_i15 = 0; c30_i15 < 3; c30_i15++) {
    c30_c_x[c30_i15] = c30_rw[c30_i15];
  }
  ...
  for (c30_i18 = 0; c30_i18 < 3; c30_i18++) {
    for (c30_i19 = 0; c30_i19 < 3; c30_i19++) {
      c30_b_Ared[c30_i19 + c30_i16] = -c30_dv5[c30_i19 + c30_i17];
    }
  ...
  for (c30_i22 = 0; c30_i22 < 3; c30_i22++) {
    for (c30_i23 = 0; c30_i23 < 3; c30_i23++) {
      c30_b_Ared[(c30_i23 + c30_i20) + 18] = c30_X[c30_i23 + c30_i21];
    }
  ...
  for (c30_i26 = 0; c30_i26 < 3; c30_i26++) {
    for (c30_i27 = 0; c30_i27 < 3; c30_i27++) {
      c30_b_Ared[(c30_i27 + c30_i24) + 36] = c30_dv6[c30_i27 + c30_i25];
    }
  ...
  for (c30_i29 = 0; c30_i29 < 3; c30_i29++) {
    for (c30_i30 = 0; c30_i30 < 3; c30_i30++) {
      c30_b_Ared[(c30_i30 + c30_i28) + 54] = 0.0;
    }
  ...
  for (c30_i32 = 0; c30_i32 < 3; c30_i32++) {
    for (c30_i33 = 0; c30_i33 < 3; c30_i33++) {
      c30_b_Ared[(c30_i33 + c30_i31) + 3] = 0.0;
    }
  ...
  for (c30_i36 = 0; c30_i36 < 3; c30_i36++) {
    for (c30_i37 = 0; c30_i37 < 3; c30_i37++) {
      c30_b_Ared[(c30_i37 + c30_i34) + 21] = -c30_dv7[c30_i37 + c30_i35];
    }
  ...
  for (c30_i39 = 0; c30_i39 < 3; c30_i39++) {
    for (c30_i40 = 0; c30_i40 < 3; c30_i40++) {
      c30_b_Ared[(c30_i40 + c30_i38) + 39] = 0.0;
    }
  ...
  for (c30_i43 = 0; c30_i43 < 3; c30_i43++) {
    for (c30_i44 = 0; c30_i44 < 3; c30_i44++) {
      c30_b_Ared[(c30_i44 + c30_i41) + 57] = c30_dv8[c30_i44 + c30_i42];
    }
  ...
  for (c30_i45 = 0; c30_i45 < 72; c30_i45++) {
    (*chartInstance->c30_Ared)[c30_i45] = c30_b_Ared[c30_i45];
  }
  ...
  for (c30_i46 = 0; c30_i46 < 72; c30_i46++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c30_Ared)[c30_i46], 1U);
  }

  for (c30_i47 = 0; c30_i47 < 14; c30_i47++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c30_x)[c30_i47], 2U);
  }
}
  ...
  *c30_inData)
{
  ...
  c30_i48 = 0;
  for (c30_i49 = 0; c30_i49 < 12; c30_i49++) {
    for (c30_i50 = 0; c30_i50 < 6; c30_i50++) {
      c30_b_inData[c30_i50 + c30_i48] = (*(real_T (*)[72])c30_inData)[c30_i50 +
        c30_i48];
    }
  ...
  c30_i51 = 0;
  for (c30_i52 = 0; c30_i52 < 12; c30_i52++) {
    for (c30_i53 = 0; c30_i53 < 6; c30_i53++) {
      c30_u[c30_i53 + c30_i51] = c30_b_inData[c30_i53 + c30_i51];
    }
  ...
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId, real_T c30_y[72])
{
  ...
  int32_T c30_i54;
  (void)chartInstance;
  sf_mex_import(c30_parentId, sf_mex_dup(c30_u), c30_dv9, 1, 0, 0U, 1, 0U, 2, 6,
                12);
  for (c30_i54 = 0; c30_i54 < 72; c30_i54++) {
    c30_y[c30_i54] = c30_dv9[c30_i54];
  }
  ...
  *c30_mxArrayInData, const char_T *c30_varName, void *c30_outData)
{
  ...
  sf_mex_destroy(&c30_b_Ared);
  c30_i55 = 0;
  for (c30_i56 = 0; c30_i56 < 12; c30_i56++) {
    for (c30_i57 = 0; c30_i57 < 6; c30_i57++) {
      (*(real_T (*)[72])c30_outData)[c30_i57 + c30_i55] = c30_y[c30_i57 +
        c30_i55];
    }
  ...
  *c30_inData)
{
  ...
  for (c30_i58 = 0; c30_i58 < 14; c30_i58++) {
    c30_b_inData[c30_i58] = (*(real_T (*)[14])c30_inData)[c30_i58];
  }

  for (c30_i59 = 0; c30_i59 < 14; c30_i59++) {
    c30_u[c30_i59] = c30_b_inData[c30_i59];
  }
  ...
  *c30_inData)
{
  ...
  for (c30_i60 = 0; c30_i60 < 6; c30_i60++) {
    c30_b_inData[c30_i60] = (*(real_T (*)[6])c30_inData)[c30_i60];
  }

  for (c30_i61 = 0; c30_i61 < 6; c30_i61++) {
    c30_u[c30_i61] = c30_b_inData[c30_i61];
  }
  ...
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId, real_T c30_y[6])
{
  ...
  int32_T c30_i62;
  (void)chartInstance;
  sf_mex_import(c30_parentId, sf_mex_dup(c30_u), c30_dv10, 1, 0, 0U, 1, 0U, 1, 6);
  for (c30_i62 = 0; c30_i62 < 6; c30_i62++) {
    c30_y[c30_i62] = c30_dv10[c30_i62];
  }
  ...
  *c30_mxArrayInData, const char_T *c30_varName, void *c30_outData)
{
  ...
  for (c30_i63 = 0; c30_i63 < 6; c30_i63++) {
    (*(real_T (*)[6])c30_outData)[c30_i63] = c30_y[c30_i63];
  }
  ...
  *c30_inData)
{
  ...
  for (c30_i64 = 0; c30_i64 < 3; c30_i64++) {
    c30_b_inData[c30_i64] = (*(real_T (*)[3])c30_inData)[c30_i64];
  }

  for (c30_i65 = 0; c30_i65 < 3; c30_i65++) {
    c30_u[c30_i65] = c30_b_inData[c30_i65];
  }
  ...
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId, real_T c30_y[3])
{
  ...
  int32_T c30_i66;
  (void)chartInstance;
  sf_mex_import(c30_parentId, sf_mex_dup(c30_u), c30_dv11, 1, 0, 0U, 1, 0U, 1, 3);
  for (c30_i66 = 0; c30_i66 < 3; c30_i66++) {
    c30_y[c30_i66] = c30_dv11[c30_i66];
  }
  ...
  *c30_mxArrayInData, const char_T *c30_varName, void *c30_outData)
{
  ...
  for (c30_i67 = 0; c30_i67 < 3; c30_i67++) {
    (*(real_T (*)[3])c30_outData)[c30_i67] = c30_y[c30_i67];
  }
  ...
  *c30_inData)
{
  ...
  for (c30_i68 = 0; c30_i68 < 4; c30_i68++) {
    c30_b_inData[c30_i68] = (*(real_T (*)[4])c30_inData)[c30_i68];
  }

  for (c30_i69 = 0; c30_i69 < 4; c30_i69++) {
    c30_u[c30_i69] = c30_b_inData[c30_i69];
  }
  ...
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId, real_T c30_y[4])
{
  ...
  int32_T c30_i70;
  (void)chartInstance;
  sf_mex_import(c30_parentId, sf_mex_dup(c30_u), c30_dv12, 1, 0, 0U, 1, 0U, 1, 4);
  for (c30_i70 = 0; c30_i70 < 4; c30_i70++) {
    c30_y[c30_i70] = c30_dv12[c30_i70];
  }
  ...
  *c30_mxArrayInData, const char_T *c30_varName, void *c30_outData)
{
  ...
  for (c30_i71 = 0; c30_i71 < 4; c30_i71++) {
    (*(real_T (*)[4])c30_outData)[c30_i71] = c30_y[c30_i71];
  }
  ...
  *c30_inData)
{
  ...
  for (c30_i73 = 0; c30_i73 < 3; c30_i73++) {
    for (c30_i74 = 0; c30_i74 < 3; c30_i74++) {
      c30_b_inData[c30_i74 + c30_i72] = (*(real_T (*)[9])c30_inData)[c30_i74 +
        c30_i72];
    }
  ...
  c30_i75 = 0;
  for (c30_i76 = 0; c30_i76 < 3; c30_i76++) {
    for (c30_i77 = 0; c30_i77 < 3; c30_i77++) {
      c30_u[c30_i77 + c30_i75] = c30_b_inData[c30_i77 + c30_i75];
    }
  ...
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId, real_T c30_y[9])
{
  ...
  int32_T c30_i78;
  (void)chartInstance;
  sf_mex_import(c30_parentId, sf_mex_dup(c30_u), c30_dv13, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c30_i78 = 0; c30_i78 < 9; c30_i78++) {
    c30_y[c30_i78] = c30_dv13[c30_i78];
  }
  ...
  *c30_mxArrayInData, const char_T *c30_varName, void *c30_outData)
{
  ...
  c30_i79 = 0;
  for (c30_i80 = 0; c30_i80 < 3; c30_i80++) {
    for (c30_i81 = 0; c30_i81 < 3; c30_i81++) {
      (*(real_T (*)[9])c30_outData)[c30_i81 + c30_i79] = c30_y[c30_i81 + c30_i79];
    }
...
static void c30_info_helper(const mxArray **c30_info)
{
  ...
  sf_mex_addfield(*c30_info, c30_b_emlrt_marshallOut(1462213506U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c30_info, c30_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c30_info, c30_b_emlrt_marshallOut(0U), "mFileTimeLo",
...
static void c30_eye(SFc30_dIPCInstanceStruct *chartInstance, real_T c30_I[9])
{
  ...
  int32_T c30_b_k;
  (void)chartInstance;
  for (c30_i82 = 0; c30_i82 < 9; c30_i82++) {
    c30_I[c30_i82] = 0.0;
  }
  ...
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId)
{
  ...
  int32_T c30_i83;
  (void)chartInstance;
  sf_mex_import(c30_parentId, sf_mex_dup(c30_u), &c30_i83, 1, 6, 0U, 0, 0U, 0);
  c30_y = c30_i83;
  sf_mex_destroy(&c30_u);
  return c30_y;
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1417596576U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(721732030U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2152346149U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3627789904U);
}
...
mxArray *sf_c30_dIPC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("fONrs1U73NGtX6JxQXVWgB");
...
static void mdlSetWorkWidths_c30_dIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1139465492U));
  ssSetChecksum1(S,(720592746U));
  ssSetChecksum2(S,(3611858882U));
  ssSetChecksum3(S,(1458240584U));
