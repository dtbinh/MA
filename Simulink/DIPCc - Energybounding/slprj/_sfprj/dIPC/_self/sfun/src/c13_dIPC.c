...
static void c13_info_helper(const mxArray **c13_info)
{
  ...
  sf_mex_addfield(*c13_info, c13_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPCc - Energybounding/skew_sm.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(1462213506U), "fileTimeLo",
                  "fileTimeLo", 0);
...
static void mdlSetWorkWidths_c13_dIPC(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4122253250U));
  ssSetChecksum1(S,(90610508U));
  ssSetChecksum2(S,(822810641U));
  ssSetChecksum3(S,(857447343U));
