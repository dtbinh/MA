...
static void initialize_c7_cdIPCbounding(SFc7_cdIPCboundingInstanceStruct
  *chartInstance);
static void initialize_params_c7_cdIPCbounding(SFc7_cdIPCboundingInstanceStruct *
  chartInstance);
static void enable_c7_cdIPCbounding(SFc7_cdIPCboundingInstanceStruct
  *chartInstance);
static void disable_c7_cdIPCbounding(SFc7_cdIPCboundingInstanceStruct
  *chartInstance);
static void c7_update_debugger_state_c7_cdIPCbounding
  (SFc7_cdIPCboundingInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_cdIPCbounding
  (SFc7_cdIPCboundingInstanceStruct *chartInstance);
static void set_sim_state_c7_cdIPCbounding(SFc7_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c7_st);
static void finalize_c7_cdIPCbounding(SFc7_cdIPCboundingInstanceStruct
  *chartInstance);
static void sf_gateway_c7_cdIPCbounding(SFc7_cdIPCboundingInstanceStruct
  *chartInstance);
static void mdl_start_c7_cdIPCbounding(SFc7_cdIPCboundingInstanceStruct
  *chartInstance);
static void initSimStructsc7_cdIPCbounding(SFc7_cdIPCboundingInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber, uint32_T c7_instanceNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static void c7_emlrt_marshallIn(SFc7_cdIPCboundingInstanceStruct *chartInstance,
  const mxArray *c7_b_hcoriolis, const char_T *c7_identifier, real_T c7_y[6]);
static void c7_b_emlrt_marshallIn(SFc7_cdIPCboundingInstanceStruct
...
static const mxArray *c7_b_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static real_T c7_c_emlrt_marshallIn(SFc7_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
...
static const mxArray *c7_d_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_d_emlrt_marshallIn(SFc7_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[9]);
...
static const mxArray *c7_e_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_e_emlrt_marshallIn(SFc7_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[3]);
...
static void c7_eml_scalar_eg(SFc7_cdIPCboundingInstanceStruct *chartInstance);
static void c7_eml_xgemm(SFc7_cdIPCboundingInstanceStruct *chartInstance, real_T
  c7_A[9], real_T c7_B[3], real_T c7_C[3], real_T c7_b_C[3]);
static const mxArray *c7_f_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_f_emlrt_marshallIn(SFc7_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint8_T c7_g_emlrt_marshallIn(SFc7_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c7_b_is_active_c7_cdIPCbounding, const char_T
  *c7_identifier);
static uint8_T c7_h_emlrt_marshallIn(SFc7_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_eml_xgemm(SFc7_cdIPCboundingInstanceStruct *chartInstance,
  real_T c7_A[9], real_T c7_B[3], real_T c7_C[3]);
static void init_dsm_address_info(SFc7_cdIPCboundingInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc7_cdIPCboundingInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_cdIPCbounding = 0U;
}
  ...
  (SFc7_cdIPCboundingInstanceStruct *chartInstance)
{
  ...
  c7_hoistedGlobal = chartInstance->c7_is_active_c7_cdIPCbounding;
  ...
  *chartInstance, const mxArray *c7_st)
{
  ...
  chartInstance->c7_is_active_c7_cdIPCbounding = c7_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 1)),
     "is_active_c7_cdIPCbounding");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_cdIPCbounding(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_cdIPCboundingInstanceStruct *chartInstance;
  chartInstance = (SFc7_cdIPCboundingInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c7_cdIPCbounding_get_eml_resolved_functions_info(void)
{
...
static void c7_info_helper(const mxArray **c7_info)
{
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPCc - Energybounding/skew_sm.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c7_info, c7_b_emlrt_marshallOut(1462213506U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  *c7_identifier)
{
  ...
  c7_y = c7_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_cdIPCbounding), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_cdIPCbounding);
  return c7_y;
}
...
void sf_c7_cdIPCbounding_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c7_cdIPCbounding_get_post_codegen_info(void);
mxArray *sf_c7_cdIPCbounding_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c7_cdIPCbounding_get_post_codegen_info();
...
mxArray *sf_c7_cdIPCbounding_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c7_cdIPCbounding_jit_fallback_info(void)
{
...
mxArray *sf_c7_cdIPCbounding_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c7_cdIPCbounding(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"hcoriolis\",},{M[8],M[0],T\"is_active_c7_cdIPCbounding\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_cdIPCbounding_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc7_cdIPCboundingInstanceStruct *)
...
static void sf_opaque_initialize_c7_cdIPCbounding(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_cdIPCboundingInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_cdIPCbounding((SFc7_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
  initialize_c7_cdIPCbounding((SFc7_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c7_cdIPCbounding(void *chartInstanceVar)
{
  enable_c7_cdIPCbounding((SFc7_cdIPCboundingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c7_cdIPCbounding(void *chartInstanceVar)
{
  disable_c7_cdIPCbounding((SFc7_cdIPCboundingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c7_cdIPCbounding(void *chartInstanceVar)
{
  sf_gateway_c7_cdIPCbounding((SFc7_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c7_cdIPCbounding(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c7_cdIPCbounding((SFc7_cdIPCboundingInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c7_cdIPCbounding(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c7_cdIPCbounding((SFc7_cdIPCboundingInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c7_cdIPCbounding(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_cdIPCboundingInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c7_cdIPCbounding((SFc7_cdIPCboundingInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc7_cdIPCbounding((SFc7_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_cdIPCbounding(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c7_cdIPCbounding(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2734802781U));
  ssSetChecksum1(S,(4169400314U));
  ssSetChecksum2(S,(701399542U));
  ssSetChecksum3(S,(1577548002U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c7_cdIPCbounding(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_cdIPCbounding(SimStruct *S)
{
  SFc7_cdIPCboundingInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc7_cdIPCboundingInstanceStruct *)utMalloc(sizeof
    (SFc7_cdIPCboundingInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_cdIPCboundingInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c7_cdIPCbounding;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_cdIPCbounding;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c7_cdIPCbounding;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_cdIPCbounding;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c7_cdIPCbounding;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_cdIPCbounding;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_cdIPCbounding;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_cdIPCbounding;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_cdIPCbounding;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_cdIPCbounding;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c7_cdIPCbounding;
...
void c7_cdIPCbounding_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_cdIPCbounding(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_cdIPCbounding(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_cdIPCbounding(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_cdIPCbounding_method_dispatcher.\n"
