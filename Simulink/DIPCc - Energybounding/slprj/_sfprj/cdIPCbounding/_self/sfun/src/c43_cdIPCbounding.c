...
static void initialize_c43_cdIPCbounding(SFc43_cdIPCboundingInstanceStruct
  *chartInstance);
static void initialize_params_c43_cdIPCbounding
  (SFc43_cdIPCboundingInstanceStruct *chartInstance);
static void enable_c43_cdIPCbounding(SFc43_cdIPCboundingInstanceStruct
  *chartInstance);
static void disable_c43_cdIPCbounding(SFc43_cdIPCboundingInstanceStruct
  *chartInstance);
static void c43_update_debugger_state_c43_cdIPCbounding
  (SFc43_cdIPCboundingInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c43_cdIPCbounding
  (SFc43_cdIPCboundingInstanceStruct *chartInstance);
static void set_sim_state_c43_cdIPCbounding(SFc43_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c43_st);
static void finalize_c43_cdIPCbounding(SFc43_cdIPCboundingInstanceStruct
  *chartInstance);
static void sf_gateway_c43_cdIPCbounding(SFc43_cdIPCboundingInstanceStruct
  *chartInstance);
static void mdl_start_c43_cdIPCbounding(SFc43_cdIPCboundingInstanceStruct
  *chartInstance);
static void initSimStructsc43_cdIPCbounding(SFc43_cdIPCboundingInstanceStruct
  *chartInstance);
static void c43_quatrot(SFc43_cdIPCboundingInstanceStruct *chartInstance, real_T
...
static const mxArray *c43_sf_marshallOut(void *chartInstanceVoid, void
  *c43_inData);
static void c43_emlrt_marshallIn(SFc43_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c43_b_h_int, const char_T *c43_identifier,
  real_T c43_y[24]);
static void c43_b_emlrt_marshallIn(SFc43_cdIPCboundingInstanceStruct
...
static const mxArray *c43_c_sf_marshallOut(void *chartInstanceVoid, void
  *c43_inData);
static real_T c43_c_emlrt_marshallIn(SFc43_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c43_u, const emlrtMsgIdentifier *c43_parentId);
...
static const mxArray *c43_d_sf_marshallOut(void *chartInstanceVoid, void
  *c43_inData);
static void c43_d_emlrt_marshallIn(SFc43_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c43_u, const emlrtMsgIdentifier *c43_parentId,
  real_T c43_y[3]);
...
static const mxArray *c43_e_sf_marshallOut(void *chartInstanceVoid, void
  *c43_inData);
static void c43_e_emlrt_marshallIn(SFc43_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c43_u, const emlrtMsgIdentifier *c43_parentId,
  real_T c43_y[4]);
...
static void c43_quatmultiply(SFc43_cdIPCboundingInstanceStruct *chartInstance,
  real_T c43_q[4], real_T c43_r[4], real_T c43_qout[4]);
static const mxArray *c43_f_sf_marshallOut(void *chartInstanceVoid, void
  *c43_inData);
static int32_T c43_f_emlrt_marshallIn(SFc43_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c43_u, const emlrtMsgIdentifier *c43_parentId);
static void c43_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c43_mxArrayInData, const char_T *c43_varName, void *c43_outData);
static uint8_T c43_g_emlrt_marshallIn(SFc43_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c43_b_is_active_c43_cdIPCbounding, const char_T
  *c43_identifier);
static uint8_T c43_h_emlrt_marshallIn(SFc43_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c43_u, const emlrtMsgIdentifier *c43_parentId);
static void init_dsm_address_info(SFc43_cdIPCboundingInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc43_cdIPCboundingInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c43_is_active_c43_cdIPCbounding = 0U;
}
  ...
  (SFc43_cdIPCboundingInstanceStruct *chartInstance)
{
  ...
  c43_hoistedGlobal = chartInstance->c43_is_active_c43_cdIPCbounding;
  ...
  *chartInstance, const mxArray *c43_st)
{
  ...
  chartInstance->c43_is_active_c43_cdIPCbounding = c43_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c43_u, 1)),
     "is_active_c43_cdIPCbounding");
  sf_mex_destroy(&c43_u);
  c43_update_debugger_state_c43_cdIPCbounding(chartInstance);
  ...
  *c43_inData)
{
  ...
  const mxArray *c43_y = NULL;
  SFc43_cdIPCboundingInstanceStruct *chartInstance;
  chartInstance = (SFc43_cdIPCboundingInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c43_cdIPCbounding_get_eml_resolved_functions_info(void)
{
  ...
  *c43_identifier)
{
  ...
  c43_y = c43_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c43_b_is_active_c43_cdIPCbounding), &c43_thisId);
  sf_mex_destroy(&c43_b_is_active_c43_cdIPCbounding);
  return c43_y;
}
...
void sf_c43_cdIPCbounding_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c43_cdIPCbounding_get_post_codegen_info(void);
mxArray *sf_c43_cdIPCbounding_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c43_cdIPCbounding_get_post_codegen_info();
...
mxArray *sf_c43_cdIPCbounding_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c43_cdIPCbounding_jit_fallback_info(void)
{
...
mxArray *sf_c43_cdIPCbounding_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c43_cdIPCbounding(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"h_int\",},{M[8],M[0],T\"is_active_c43_cdIPCbounding\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c43_cdIPCbounding_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc43_cdIPCboundingInstanceStruct *)
...
static void sf_opaque_initialize_c43_cdIPCbounding(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc43_cdIPCboundingInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c43_cdIPCbounding((SFc43_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
  initialize_c43_cdIPCbounding((SFc43_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c43_cdIPCbounding(void *chartInstanceVar)
{
  enable_c43_cdIPCbounding((SFc43_cdIPCboundingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c43_cdIPCbounding(void *chartInstanceVar)
{
  disable_c43_cdIPCbounding((SFc43_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c43_cdIPCbounding(void *chartInstanceVar)
{
  sf_gateway_c43_cdIPCbounding((SFc43_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c43_cdIPCbounding(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c43_cdIPCbounding((SFc43_cdIPCboundingInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c43_cdIPCbounding(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c43_cdIPCbounding((SFc43_cdIPCboundingInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c43_cdIPCbounding(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc43_cdIPCboundingInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c43_cdIPCbounding((SFc43_cdIPCboundingInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc43_cdIPCbounding((SFc43_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c43_cdIPCbounding(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c43_cdIPCbounding(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3385783427U));
  ssSetChecksum1(S,(123376093U));
  ssSetChecksum2(S,(1265548657U));
  ssSetChecksum3(S,(3577258890U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c43_cdIPCbounding(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c43_cdIPCbounding(SimStruct *S)
{
  SFc43_cdIPCboundingInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc43_cdIPCboundingInstanceStruct *)utMalloc(sizeof
    (SFc43_cdIPCboundingInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc43_cdIPCboundingInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c43_cdIPCbounding;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c43_cdIPCbounding;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c43_cdIPCbounding;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c43_cdIPCbounding;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c43_cdIPCbounding;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c43_cdIPCbounding;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c43_cdIPCbounding;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c43_cdIPCbounding;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c43_cdIPCbounding;
  chartInstance->chartInfo.mdlStart = mdlStart_c43_cdIPCbounding;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c43_cdIPCbounding;
...
void c43_cdIPCbounding_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c43_cdIPCbounding(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c43_cdIPCbounding(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c43_cdIPCbounding(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c43_cdIPCbounding_method_dispatcher.\n"
