...
static void initialize_c29_cdIPCbounding(SFc29_cdIPCboundingInstanceStruct
  *chartInstance);
static void initialize_params_c29_cdIPCbounding
  (SFc29_cdIPCboundingInstanceStruct *chartInstance);
static void enable_c29_cdIPCbounding(SFc29_cdIPCboundingInstanceStruct
  *chartInstance);
static void disable_c29_cdIPCbounding(SFc29_cdIPCboundingInstanceStruct
  *chartInstance);
static void c29_update_debugger_state_c29_cdIPCbounding
  (SFc29_cdIPCboundingInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c29_cdIPCbounding
  (SFc29_cdIPCboundingInstanceStruct *chartInstance);
static void set_sim_state_c29_cdIPCbounding(SFc29_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c29_st);
static void finalize_c29_cdIPCbounding(SFc29_cdIPCboundingInstanceStruct
  *chartInstance);
static void sf_gateway_c29_cdIPCbounding(SFc29_cdIPCboundingInstanceStruct
  *chartInstance);
static void mdl_start_c29_cdIPCbounding(SFc29_cdIPCboundingInstanceStruct
  *chartInstance);
static void initSimStructsc29_cdIPCbounding(SFc29_cdIPCboundingInstanceStruct
  *chartInstance);
static void c29_quatrot(SFc29_cdIPCboundingInstanceStruct *chartInstance, real_T
...
static const mxArray *c29_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static void c29_emlrt_marshallIn(SFc29_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c29_b_A, const char_T *c29_identifier, real_T
  c29_y[720]);
static void c29_b_emlrt_marshallIn(SFc29_cdIPCboundingInstanceStruct
...
static const mxArray *c29_c_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static void c29_c_emlrt_marshallIn(SFc29_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId,
  real_T c29_y[12]);
...
static const mxArray *c29_d_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static real_T c29_d_emlrt_marshallIn(SFc29_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId);
...
static const mxArray *c29_e_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static void c29_e_emlrt_marshallIn(SFc29_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId,
  real_T c29_y[3]);
...
static const mxArray *c29_f_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static void c29_f_emlrt_marshallIn(SFc29_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId,
  real_T c29_y[4]);
...
static const mxArray *c29_g_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static void c29_g_emlrt_marshallIn(SFc29_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId,
  real_T c29_y[9]);
...
static void c29_eye(SFc29_cdIPCboundingInstanceStruct *chartInstance, real_T
                    c29_I[9]);
static void c29_quatmultiply(SFc29_cdIPCboundingInstanceStruct *chartInstance,
  real_T c29_q[4], real_T c29_r[4], real_T c29_qout[4]);
static const mxArray *c29_h_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static int32_T c29_h_emlrt_marshallIn(SFc29_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId);
static void c29_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c29_mxArrayInData, const char_T *c29_varName, void *c29_outData);
static uint8_T c29_i_emlrt_marshallIn(SFc29_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c29_b_is_active_c29_cdIPCbounding, const char_T
  *c29_identifier);
static uint8_T c29_j_emlrt_marshallIn(SFc29_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId);
static void init_dsm_address_info(SFc29_cdIPCboundingInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc29_cdIPCboundingInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c29_is_active_c29_cdIPCbounding = 0U;
}
  ...
  (SFc29_cdIPCboundingInstanceStruct *chartInstance)
{
  ...
  c29_hoistedGlobal = chartInstance->c29_is_active_c29_cdIPCbounding;
  ...
  *chartInstance, const mxArray *c29_st)
{
  ...
  chartInstance->c29_is_active_c29_cdIPCbounding = c29_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c29_u, 1)),
     "is_active_c29_cdIPCbounding");
  sf_mex_destroy(&c29_u);
  c29_update_debugger_state_c29_cdIPCbounding(chartInstance);
  ...
  *c29_inData)
{
  ...
  const mxArray *c29_y = NULL;
  SFc29_cdIPCboundingInstanceStruct *chartInstance;
  chartInstance = (SFc29_cdIPCboundingInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c29_cdIPCbounding_get_eml_resolved_functions_info(void)
{
  ...
  *c29_identifier)
{
  ...
  c29_y = c29_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c29_b_is_active_c29_cdIPCbounding), &c29_thisId);
  sf_mex_destroy(&c29_b_is_active_c29_cdIPCbounding);
  return c29_y;
}
...
void sf_c29_cdIPCbounding_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c29_cdIPCbounding_get_post_codegen_info(void);
mxArray *sf_c29_cdIPCbounding_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c29_cdIPCbounding_get_post_codegen_info();
...
mxArray *sf_c29_cdIPCbounding_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c29_cdIPCbounding_jit_fallback_info(void)
{
...
mxArray *sf_c29_cdIPCbounding_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c29_cdIPCbounding(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"A\",},{M[8],M[0],T\"is_active_c29_cdIPCbounding\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c29_cdIPCbounding_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc29_cdIPCboundingInstanceStruct *)
...
static void sf_opaque_initialize_c29_cdIPCbounding(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc29_cdIPCboundingInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c29_cdIPCbounding((SFc29_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
  initialize_c29_cdIPCbounding((SFc29_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c29_cdIPCbounding(void *chartInstanceVar)
{
  enable_c29_cdIPCbounding((SFc29_cdIPCboundingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c29_cdIPCbounding(void *chartInstanceVar)
{
  disable_c29_cdIPCbounding((SFc29_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c29_cdIPCbounding(void *chartInstanceVar)
{
  sf_gateway_c29_cdIPCbounding((SFc29_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c29_cdIPCbounding(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c29_cdIPCbounding((SFc29_cdIPCboundingInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c29_cdIPCbounding(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c29_cdIPCbounding((SFc29_cdIPCboundingInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c29_cdIPCbounding(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc29_cdIPCboundingInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c29_cdIPCbounding((SFc29_cdIPCboundingInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc29_cdIPCbounding((SFc29_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c29_cdIPCbounding(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c29_cdIPCbounding(SimStruct *S)
{
...
static void mdlRTW_c29_cdIPCbounding(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c29_cdIPCbounding(SimStruct *S)
{
  SFc29_cdIPCboundingInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc29_cdIPCboundingInstanceStruct *)utMalloc(sizeof
    (SFc29_cdIPCboundingInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc29_cdIPCboundingInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c29_cdIPCbounding;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c29_cdIPCbounding;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c29_cdIPCbounding;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c29_cdIPCbounding;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c29_cdIPCbounding;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c29_cdIPCbounding;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c29_cdIPCbounding;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c29_cdIPCbounding;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c29_cdIPCbounding;
  chartInstance->chartInfo.mdlStart = mdlStart_c29_cdIPCbounding;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c29_cdIPCbounding;
...
void c29_cdIPCbounding_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c29_cdIPCbounding(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c29_cdIPCbounding(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c29_cdIPCbounding(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c29_cdIPCbounding_method_dispatcher.\n"
