...
static void initialize_c31_cdIPCbounding(SFc31_cdIPCboundingInstanceStruct
  *chartInstance);
static void initialize_params_c31_cdIPCbounding
  (SFc31_cdIPCboundingInstanceStruct *chartInstance);
static void enable_c31_cdIPCbounding(SFc31_cdIPCboundingInstanceStruct
  *chartInstance);
static void disable_c31_cdIPCbounding(SFc31_cdIPCboundingInstanceStruct
  *chartInstance);
static void c31_update_debugger_state_c31_cdIPCbounding
  (SFc31_cdIPCboundingInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c31_cdIPCbounding
  (SFc31_cdIPCboundingInstanceStruct *chartInstance);
static void set_sim_state_c31_cdIPCbounding(SFc31_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c31_st);
static void finalize_c31_cdIPCbounding(SFc31_cdIPCboundingInstanceStruct
  *chartInstance);
static void sf_gateway_c31_cdIPCbounding(SFc31_cdIPCboundingInstanceStruct
  *chartInstance);
static void mdl_start_c31_cdIPCbounding(SFc31_cdIPCboundingInstanceStruct
  *chartInstance);
static void c31_chartstep_c31_cdIPCbounding(SFc31_cdIPCboundingInstanceStruct
  *chartInstance);
static void initSimStructsc31_cdIPCbounding(SFc31_cdIPCboundingInstanceStruct
  *chartInstance);
static void c31_skew_sm(SFc31_cdIPCboundingInstanceStruct *chartInstance, real_T
  c31_b_x[3], real_T c31_X[9]);
static void c31_quatrot(SFc31_cdIPCboundingInstanceStruct *chartInstance, real_T
  c31_q[4], real_T c31_b_r[3], real_T c31_rw[3]);
...
static const mxArray *c31_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_emlrt_marshallIn(SFc31_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c31_b_bred, const char_T *c31_identifier,
  real_T c31_y[18]);
static void c31_b_emlrt_marshallIn(SFc31_cdIPCboundingInstanceStruct
...
static const mxArray *c31_d_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_c_emlrt_marshallIn(SFc31_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId,
  real_T c31_y[12]);
...
static const mxArray *c31_e_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static real_T c31_d_emlrt_marshallIn(SFc31_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
...
static const mxArray *c31_f_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_e_emlrt_marshallIn(SFc31_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId,
  real_T c31_y[9]);
...
static const mxArray *c31_g_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_f_emlrt_marshallIn(SFc31_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId,
  real_T c31_y[3]);
...
static const mxArray *c31_h_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_g_emlrt_marshallIn(SFc31_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId,
  real_T c31_y[4]);
...
static void c31_eml_scalar_eg(SFc31_cdIPCboundingInstanceStruct *chartInstance);
static void c31_threshold(SFc31_cdIPCboundingInstanceStruct *chartInstance);
static void c31_quatmultiply(SFc31_cdIPCboundingInstanceStruct *chartInstance,
  real_T c31_q[4], real_T c31_b_r[4], real_T c31_qout[4]);
static void c31_b_eml_scalar_eg(SFc31_cdIPCboundingInstanceStruct *chartInstance);
static const mxArray *c31_i_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static int32_T c31_h_emlrt_marshallIn(SFc31_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
static void c31_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData);
static uint8_T c31_i_emlrt_marshallIn(SFc31_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c31_b_is_active_c31_cdIPCbounding, const char_T
  *c31_identifier);
static uint8_T c31_j_emlrt_marshallIn(SFc31_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
static void init_dsm_address_info(SFc31_cdIPCboundingInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc31_cdIPCboundingInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c31_is_active_c31_cdIPCbounding = 0U;
}
  ...
  (SFc31_cdIPCboundingInstanceStruct *chartInstance)
{
  ...
  c31_hoistedGlobal = chartInstance->c31_is_active_c31_cdIPCbounding;
  ...
  *chartInstance, const mxArray *c31_st)
{
  ...
  chartInstance->c31_is_active_c31_cdIPCbounding = c31_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c31_u, 1)),
     "is_active_c31_cdIPCbounding");
  sf_mex_destroy(&c31_u);
  c31_update_debugger_state_c31_cdIPCbounding(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c31_sfEvent = CALL_EVENT;
  c31_chartstep_c31_cdIPCbounding(chartInstance);
  ...
  *chartInstance)
{
  ...
  for (c31_i35 = 0; c31_i35 < 3; c31_i35++) {
    c31_f_x[c31_i35] = c31_b_dx[c31_i35 + 3];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 4U, 4U, c31_b_debug_family_names,
    c31_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c31_c_nargin, 0U, c31_e_sf_marshallOut,
    c31_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c31_c_nargout, 1U, c31_e_sf_marshallOut,
    c31_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c31_f_x, 2U, c31_g_sf_marshallOut,
    c31_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c31_b_X, 3U, c31_f_sf_marshallOut,
    c31_d_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  _SFD_SCRIPT_CALL(0U, chartInstance->c31_sfEvent, 3);
  c31_b_X[0] = 0.0;
  ...
  for (c31_i36 = 0; c31_i36 < 9; c31_i36++) {
    c31_a[c31_i36] = c31_X[c31_i36];
  }

  for (c31_i37 = 0; c31_i37 < 9; c31_i37++) {
    c31_b[c31_i37] = c31_b_X[c31_i37];
  }
  ...
  for (c31_i38 = 0; c31_i38 < 3; c31_i38++) {
    c31_i39 = 0;
    for (c31_i40 = 0; c31_i40 < 3; c31_i40++) {
      c31_y[c31_i39 + c31_i38] = 0.0;
      c31_i41 = 0;
      for (c31_i42 = 0; c31_i42 < 3; c31_i42++) {
        c31_y[c31_i39 + c31_i38] += c31_a[c31_i41 + c31_i38] * c31_b[c31_i42 +
          c31_i39];
        c31_i41 += 3;
      }
  ...
  for (c31_i43 = 0; c31_i43 < 4; c31_i43++) {
    c31_g_x[c31_i43] = c31_b_x[c31_i43 + 3];
  }

  for (c31_i44 = 0; c31_i44 < 3; c31_i44++) {
    c31_e_r[c31_i44] = c31_b_r[c31_i44 + 9] - c31_b_r[c31_i44];
  }

  c31_quatrot(chartInstance, c31_g_x, c31_e_r, c31_b_b);
  c31_b_eml_scalar_eg(chartInstance);
  c31_b_eml_scalar_eg(chartInstance);
  c31_threshold(chartInstance);
  for (c31_i45 = 0; c31_i45 < 3; c31_i45++) {
    c31_d_y[c31_i45] = 0.0;
    c31_i46 = 0;
    for (c31_i47 = 0; c31_i47 < 3; c31_i47++) {
      c31_d_y[c31_i45] += c31_y[c31_i46 + c31_i45] * c31_b_b[c31_i47];
      c31_i46 += 3;
    }
  }

  for (c31_i48 = 0; c31_i48 < 3; c31_i48++) {
    c31_b_bred[c31_i48] = c31_b_y[c31_i48];
  }

  for (c31_i49 = 0; c31_i49 < 3; c31_i49++) {
    c31_b_bred[c31_i49 + 3] = 0.0;
  }

  for (c31_i50 = 0; c31_i50 < 3; c31_i50++) {
    c31_b_bred[c31_i50 + 6] = c31_c_y[c31_i50];
  }

  for (c31_i51 = 0; c31_i51 < 3; c31_i51++) {
    c31_b_bred[c31_i51 + 9] = 0.0;
  }

  for (c31_i52 = 0; c31_i52 < 3; c31_i52++) {
    c31_b_bred[c31_i52 + 12] = c31_d_y[c31_i52];
  }

  for (c31_i53 = 0; c31_i53 < 3; c31_i53++) {
    c31_b_bred[c31_i53 + 15] = 0.0;
  }

  _SFD_EML_CALL(0U, chartInstance->c31_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c31_i54 = 0; c31_i54 < 18; c31_i54++) {
  ...
  c31_q[4], real_T c31_b_r[3], real_T c31_rw[3])
{
  ...
  for (c31_i55 = 0; c31_i55 < 4; c31_i55++) {
    c31_b_q[c31_i55] = c31_q[c31_i55];
  }
  ...
  c31_dv2[0] = 0.0;
  for (c31_i56 = 0; c31_i56 < 3; c31_i56++) {
    c31_dv2[c31_i56 + 1] = c31_b_r[c31_i56];
  }
  ...
  for (c31_i61 = 0; c31_i61 < 3; c31_i61++) {
    c31_rw[c31_i61] = c31_rwq[c31_i61 + 1];
  }
  ...
  *c31_inData)
{
  ...
  const mxArray *c31_y = NULL;
  SFc31_cdIPCboundingInstanceStruct *chartInstance;
  chartInstance = (SFc31_cdIPCboundingInstanceStruct *)chartInstanceVoid;
  c31_mxArrayOutData = NULL;
  for (c31_i62 = 0; c31_i62 < 18; c31_i62++) {
    c31_b_inData[c31_i62] = (*(real_T (*)[18])c31_inData)[c31_i62];
  }

  for (c31_i63 = 0; c31_i63 < 18; c31_i63++) {
    c31_u[c31_i63] = c31_b_inData[c31_i63];
  }
  ...
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData)
{
  ...
  c31_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c31_b_bred), &c31_thisId,
    c31_y);
  sf_mex_destroy(&c31_b_bred);
  for (c31_i65 = 0; c31_i65 < 18; c31_i65++) {
    (*(real_T (*)[18])c31_outData)[c31_i65] = c31_y[c31_i65];
  }
  ...
  *c31_inData)
{
  ...
  for (c31_i66 = 0; c31_i66 < 24; c31_i66++) {
    c31_b_inData[c31_i66] = (*(real_T (*)[24])c31_inData)[c31_i66];
  }

  for (c31_i67 = 0; c31_i67 < 24; c31_i67++) {
    c31_u[c31_i67] = c31_b_inData[c31_i67];
  }
  ...
  *c31_inData)
{
  ...
  for (c31_i68 = 0; c31_i68 < 28; c31_i68++) {
    c31_b_inData[c31_i68] = (*(real_T (*)[28])c31_inData)[c31_i68];
  }

  for (c31_i69 = 0; c31_i69 < 28; c31_i69++) {
    c31_u[c31_i69] = c31_b_inData[c31_i69];
  }
  ...
  *c31_inData)
{
  ...
  for (c31_i70 = 0; c31_i70 < 12; c31_i70++) {
    c31_b_inData[c31_i70] = (*(real_T (*)[12])c31_inData)[c31_i70];
  }

  for (c31_i71 = 0; c31_i71 < 12; c31_i71++) {
    c31_u[c31_i71] = c31_b_inData[c31_i71];
  }
  ...
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData)
{
  ...
  for (c31_i73 = 0; c31_i73 < 12; c31_i73++) {
    (*(real_T (*)[12])c31_outData)[c31_i73] = c31_y[c31_i73];
  }
  ...
  *c31_inData)
{
  ...
  for (c31_i75 = 0; c31_i75 < 3; c31_i75++) {
    for (c31_i76 = 0; c31_i76 < 3; c31_i76++) {
      c31_b_inData[c31_i76 + c31_i74] = (*(real_T (*)[9])c31_inData)[c31_i76 +
        c31_i74];
    }
  ...
  for (c31_i78 = 0; c31_i78 < 3; c31_i78++) {
    for (c31_i79 = 0; c31_i79 < 3; c31_i79++) {
      c31_u[c31_i79 + c31_i77] = c31_b_inData[c31_i79 + c31_i77];
    }
  ...
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData)
{
  ...
  for (c31_i82 = 0; c31_i82 < 3; c31_i82++) {
    for (c31_i83 = 0; c31_i83 < 3; c31_i83++) {
      (*(real_T (*)[9])c31_outData)[c31_i83 + c31_i81] = c31_y[c31_i83 + c31_i81];
    }
  ...
  *c31_inData)
{
  ...
  for (c31_i84 = 0; c31_i84 < 3; c31_i84++) {
    c31_b_inData[c31_i84] = (*(real_T (*)[3])c31_inData)[c31_i84];
  }

  for (c31_i85 = 0; c31_i85 < 3; c31_i85++) {
    c31_u[c31_i85] = c31_b_inData[c31_i85];
  }
  ...
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData)
{
  ...
  for (c31_i87 = 0; c31_i87 < 3; c31_i87++) {
    (*(real_T (*)[3])c31_outData)[c31_i87] = c31_y[c31_i87];
  }
  ...
  *c31_inData)
{
  ...
  for (c31_i88 = 0; c31_i88 < 4; c31_i88++) {
    c31_b_inData[c31_i88] = (*(real_T (*)[4])c31_inData)[c31_i88];
  }

  for (c31_i89 = 0; c31_i89 < 4; c31_i89++) {
    c31_u[c31_i89] = c31_b_inData[c31_i89];
  }
  ...
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData)
{
  ...
  for (c31_i91 = 0; c31_i91 < 4; c31_i91++) {
    (*(real_T (*)[4])c31_outData)[c31_i91] = c31_y[c31_i91];
  }

  sf_mex_destroy(&c31_mxArrayInData);
}

const mxArray *sf_c31_cdIPCbounding_get_eml_resolved_functions_info(void)
{
...
static void c31_info_helper(const mxArray **c31_info)
{
  ...
  sf_mex_addfield(*c31_info, c31_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPCc - Energybounding/skew_sm.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c31_info, c31_b_emlrt_marshallOut(1462213506U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId)
{
  ...
  int32_T c31_i92;
  (void)chartInstance;
  sf_mex_import(c31_parentId, sf_mex_dup(c31_u), &c31_i92, 1, 6, 0U, 0, 0U, 0);
  c31_y = c31_i92;
  sf_mex_destroy(&c31_u);
  return c31_y;
}
  ...
  *c31_identifier)
{
  ...
  c31_y = c31_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c31_b_is_active_c31_cdIPCbounding), &c31_thisId);
  sf_mex_destroy(&c31_b_is_active_c31_cdIPCbounding);
  return c31_y;
}
...
void sf_c31_cdIPCbounding_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c31_cdIPCbounding_get_post_codegen_info(void);
mxArray *sf_c31_cdIPCbounding_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c31_cdIPCbounding_get_post_codegen_info();
...
mxArray *sf_c31_cdIPCbounding_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c31_cdIPCbounding_jit_fallback_info(void)
{
...
mxArray *sf_c31_cdIPCbounding_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c31_cdIPCbounding(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"bred\",},{M[8],M[0],T\"is_active_c31_cdIPCbounding\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c31_cdIPCbounding_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc31_cdIPCboundingInstanceStruct *)
...
static void sf_opaque_initialize_c31_cdIPCbounding(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc31_cdIPCboundingInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c31_cdIPCbounding((SFc31_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
  initialize_c31_cdIPCbounding((SFc31_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c31_cdIPCbounding(void *chartInstanceVar)
{
  enable_c31_cdIPCbounding((SFc31_cdIPCboundingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c31_cdIPCbounding(void *chartInstanceVar)
{
  disable_c31_cdIPCbounding((SFc31_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c31_cdIPCbounding(void *chartInstanceVar)
{
  sf_gateway_c31_cdIPCbounding((SFc31_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c31_cdIPCbounding(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c31_cdIPCbounding((SFc31_cdIPCboundingInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c31_cdIPCbounding(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c31_cdIPCbounding((SFc31_cdIPCboundingInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c31_cdIPCbounding(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc31_cdIPCboundingInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c31_cdIPCbounding((SFc31_cdIPCboundingInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc31_cdIPCbounding((SFc31_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c31_cdIPCbounding(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c31_cdIPCbounding(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3019998722U));
  ssSetChecksum1(S,(3958294472U));
  ssSetChecksum2(S,(2929546836U));
  ssSetChecksum3(S,(40915101U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c31_cdIPCbounding(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c31_cdIPCbounding(SimStruct *S)
{
  SFc31_cdIPCboundingInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc31_cdIPCboundingInstanceStruct *)utMalloc(sizeof
    (SFc31_cdIPCboundingInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc31_cdIPCboundingInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c31_cdIPCbounding;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c31_cdIPCbounding;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c31_cdIPCbounding;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c31_cdIPCbounding;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c31_cdIPCbounding;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c31_cdIPCbounding;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c31_cdIPCbounding;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c31_cdIPCbounding;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c31_cdIPCbounding;
  chartInstance->chartInfo.mdlStart = mdlStart_c31_cdIPCbounding;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c31_cdIPCbounding;
...
void c31_cdIPCbounding_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c31_cdIPCbounding(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c31_cdIPCbounding(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c31_cdIPCbounding(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c31_cdIPCbounding_method_dispatcher.\n"
