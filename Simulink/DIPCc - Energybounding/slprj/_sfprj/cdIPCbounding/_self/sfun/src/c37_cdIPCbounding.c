...
static void initialize_c37_cdIPCbounding(SFc37_cdIPCboundingInstanceStruct
  *chartInstance);
static void initialize_params_c37_cdIPCbounding
  (SFc37_cdIPCboundingInstanceStruct *chartInstance);
static void enable_c37_cdIPCbounding(SFc37_cdIPCboundingInstanceStruct
  *chartInstance);
static void disable_c37_cdIPCbounding(SFc37_cdIPCboundingInstanceStruct
  *chartInstance);
static void c37_update_debugger_state_c37_cdIPCbounding
  (SFc37_cdIPCboundingInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c37_cdIPCbounding
  (SFc37_cdIPCboundingInstanceStruct *chartInstance);
static void set_sim_state_c37_cdIPCbounding(SFc37_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c37_st);
static void finalize_c37_cdIPCbounding(SFc37_cdIPCboundingInstanceStruct
  *chartInstance);
static void sf_gateway_c37_cdIPCbounding(SFc37_cdIPCboundingInstanceStruct
  *chartInstance);
static void mdl_start_c37_cdIPCbounding(SFc37_cdIPCboundingInstanceStruct
  *chartInstance);
static void initSimStructsc37_cdIPCbounding(SFc37_cdIPCboundingInstanceStruct
  *chartInstance);
static void c37_quatrot(SFc37_cdIPCboundingInstanceStruct *chartInstance, real_T
  c37_q[4], real_T c37_b_r[3], real_T c37_rw[3]);
...
static const mxArray *c37_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static void c37_emlrt_marshallIn(SFc37_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c37_b_x, const char_T *c37_identifier, real_T
  c37_y[28]);
static void c37_b_emlrt_marshallIn(SFc37_cdIPCboundingInstanceStruct
...
static const mxArray *c37_b_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static void c37_c_emlrt_marshallIn(SFc37_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId,
  real_T c37_y[12]);
...
static const mxArray *c37_e_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static real_T c37_d_emlrt_marshallIn(SFc37_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
static void c37_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData);
static void c37_e_emlrt_marshallIn(SFc37_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId,
  real_T c37_y[3]);
static void c37_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData);
static void c37_f_emlrt_marshallIn(SFc37_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId,
  real_T c37_y[4]);
...
static void c37_quatmultiply(SFc37_cdIPCboundingInstanceStruct *chartInstance,
  real_T c37_q[4], real_T c37_b_r[4], real_T c37_qout[4]);
static const mxArray *c37_f_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static int32_T c37_g_emlrt_marshallIn(SFc37_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
static void c37_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData);
static uint8_T c37_h_emlrt_marshallIn(SFc37_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c37_b_is_active_c37_cdIPCbounding, const char_T
  *c37_identifier);
static uint8_T c37_i_emlrt_marshallIn(SFc37_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
static void init_dsm_address_info(SFc37_cdIPCboundingInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc37_cdIPCboundingInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c37_is_active_c37_cdIPCbounding = 0U;
}
  ...
  (SFc37_cdIPCboundingInstanceStruct *chartInstance)
{
  ...
  c37_hoistedGlobal = chartInstance->c37_is_active_c37_cdIPCbounding;
  ...
  *chartInstance, const mxArray *c37_st)
{
  ...
  chartInstance->c37_is_active_c37_cdIPCbounding = c37_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c37_u, 1)),
     "is_active_c37_cdIPCbounding");
  sf_mex_destroy(&c37_u);
  c37_update_debugger_state_c37_cdIPCbounding(chartInstance);
  ...
  *c37_inData)
{
  ...
  const mxArray *c37_y = NULL;
  SFc37_cdIPCboundingInstanceStruct *chartInstance;
  chartInstance = (SFc37_cdIPCboundingInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c37_cdIPCbounding_get_eml_resolved_functions_info(void)
{
...
static void c37_info_helper(const mxArray **c37_info)
{
  ...
  sf_mex_addfield(*c37_info, c37_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/DIPCc - Energybounding/quatrot.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(1462213506U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  *c37_identifier)
{
  ...
  c37_y = c37_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c37_b_is_active_c37_cdIPCbounding), &c37_thisId);
  sf_mex_destroy(&c37_b_is_active_c37_cdIPCbounding);
  return c37_y;
}
...
void sf_c37_cdIPCbounding_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c37_cdIPCbounding_get_post_codegen_info(void);
mxArray *sf_c37_cdIPCbounding_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c37_cdIPCbounding_get_post_codegen_info();
...
mxArray *sf_c37_cdIPCbounding_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c37_cdIPCbounding_jit_fallback_info(void)
{
...
mxArray *sf_c37_cdIPCbounding_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c37_cdIPCbounding(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"x\",},{M[8],M[0],T\"is_active_c37_cdIPCbounding\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c37_cdIPCbounding_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc37_cdIPCboundingInstanceStruct *)
...
static void sf_opaque_initialize_c37_cdIPCbounding(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc37_cdIPCboundingInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c37_cdIPCbounding((SFc37_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
  initialize_c37_cdIPCbounding((SFc37_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c37_cdIPCbounding(void *chartInstanceVar)
{
  enable_c37_cdIPCbounding((SFc37_cdIPCboundingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c37_cdIPCbounding(void *chartInstanceVar)
{
  disable_c37_cdIPCbounding((SFc37_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c37_cdIPCbounding(void *chartInstanceVar)
{
  sf_gateway_c37_cdIPCbounding((SFc37_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c37_cdIPCbounding(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c37_cdIPCbounding((SFc37_cdIPCboundingInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c37_cdIPCbounding(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c37_cdIPCbounding((SFc37_cdIPCboundingInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c37_cdIPCbounding(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc37_cdIPCboundingInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c37_cdIPCbounding((SFc37_cdIPCboundingInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc37_cdIPCbounding((SFc37_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c37_cdIPCbounding(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c37_cdIPCbounding(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(243512451U));
  ssSetChecksum1(S,(1039091591U));
  ssSetChecksum2(S,(2063675392U));
  ssSetChecksum3(S,(2942437021U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c37_cdIPCbounding(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c37_cdIPCbounding(SimStruct *S)
{
  SFc37_cdIPCboundingInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc37_cdIPCboundingInstanceStruct *)utMalloc(sizeof
    (SFc37_cdIPCboundingInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc37_cdIPCboundingInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c37_cdIPCbounding;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c37_cdIPCbounding;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c37_cdIPCbounding;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c37_cdIPCbounding;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c37_cdIPCbounding;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c37_cdIPCbounding;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c37_cdIPCbounding;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c37_cdIPCbounding;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c37_cdIPCbounding;
  chartInstance->chartInfo.mdlStart = mdlStart_c37_cdIPCbounding;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c37_cdIPCbounding;
...
void c37_cdIPCbounding_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c37_cdIPCbounding(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c37_cdIPCbounding(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c37_cdIPCbounding(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c37_cdIPCbounding_method_dispatcher.\n"
