...
static void initialize_c36_cdIPCbounding(SFc36_cdIPCboundingInstanceStruct
  *chartInstance);
static void initialize_params_c36_cdIPCbounding
  (SFc36_cdIPCboundingInstanceStruct *chartInstance);
static void enable_c36_cdIPCbounding(SFc36_cdIPCboundingInstanceStruct
  *chartInstance);
static void disable_c36_cdIPCbounding(SFc36_cdIPCboundingInstanceStruct
  *chartInstance);
static void c36_update_debugger_state_c36_cdIPCbounding
  (SFc36_cdIPCboundingInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c36_cdIPCbounding
  (SFc36_cdIPCboundingInstanceStruct *chartInstance);
static void set_sim_state_c36_cdIPCbounding(SFc36_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c36_st);
static void finalize_c36_cdIPCbounding(SFc36_cdIPCboundingInstanceStruct
  *chartInstance);
static void sf_gateway_c36_cdIPCbounding(SFc36_cdIPCboundingInstanceStruct
  *chartInstance);
static void mdl_start_c36_cdIPCbounding(SFc36_cdIPCboundingInstanceStruct
  *chartInstance);
static void initSimStructsc36_cdIPCbounding(SFc36_cdIPCboundingInstanceStruct
  *chartInstance);
static void c36_quatrot(SFc36_cdIPCboundingInstanceStruct *chartInstance, real_T
...
static const mxArray *c36_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_emlrt_marshallIn(SFc36_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c36_b_G, const char_T *c36_identifier, real_T
  c36_y[144]);
static void c36_b_emlrt_marshallIn(SFc36_cdIPCboundingInstanceStruct
...
static const mxArray *c36_c_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_c_emlrt_marshallIn(SFc36_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId,
  real_T c36_y[12]);
...
static const mxArray *c36_d_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static real_T c36_d_emlrt_marshallIn(SFc36_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
...
static const mxArray *c36_e_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_e_emlrt_marshallIn(SFc36_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId,
  real_T c36_y[3]);
...
static const mxArray *c36_f_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_f_emlrt_marshallIn(SFc36_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId,
  real_T c36_y[4]);
...
static const mxArray *c36_g_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_g_emlrt_marshallIn(SFc36_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId,
  real_T c36_y[9]);
...
static void c36_eye(SFc36_cdIPCboundingInstanceStruct *chartInstance, real_T
                    c36_I[9]);
static void c36_quatmultiply(SFc36_cdIPCboundingInstanceStruct *chartInstance,
  real_T c36_q[4], real_T c36_b_r[4], real_T c36_qout[4]);
static const mxArray *c36_h_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static int32_T c36_h_emlrt_marshallIn(SFc36_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void c36_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData);
static uint8_T c36_i_emlrt_marshallIn(SFc36_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c36_b_is_active_c36_cdIPCbounding, const char_T
  *c36_identifier);
static uint8_T c36_j_emlrt_marshallIn(SFc36_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void init_dsm_address_info(SFc36_cdIPCboundingInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc36_cdIPCboundingInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c36_is_active_c36_cdIPCbounding = 0U;
}
  ...
  (SFc36_cdIPCboundingInstanceStruct *chartInstance)
{
  ...
  c36_hoistedGlobal = chartInstance->c36_is_active_c36_cdIPCbounding;
  ...
  *chartInstance, const mxArray *c36_st)
{
  ...
  chartInstance->c36_is_active_c36_cdIPCbounding = c36_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c36_u, 1)),
     "is_active_c36_cdIPCbounding");
  sf_mex_destroy(&c36_u);
  c36_update_debugger_state_c36_cdIPCbounding(chartInstance);
  ...
  *c36_inData)
{
  ...
  const mxArray *c36_y = NULL;
  SFc36_cdIPCboundingInstanceStruct *chartInstance;
  chartInstance = (SFc36_cdIPCboundingInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c36_cdIPCbounding_get_eml_resolved_functions_info(void)
{
  ...
  *c36_identifier)
{
  ...
  c36_y = c36_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c36_b_is_active_c36_cdIPCbounding), &c36_thisId);
  sf_mex_destroy(&c36_b_is_active_c36_cdIPCbounding);
  return c36_y;
}
...
void sf_c36_cdIPCbounding_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c36_cdIPCbounding_get_post_codegen_info(void);
mxArray *sf_c36_cdIPCbounding_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c36_cdIPCbounding_get_post_codegen_info();
...
mxArray *sf_c36_cdIPCbounding_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c36_cdIPCbounding_jit_fallback_info(void)
{
...
mxArray *sf_c36_cdIPCbounding_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c36_cdIPCbounding(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"G\",},{M[8],M[0],T\"is_active_c36_cdIPCbounding\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c36_cdIPCbounding_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc36_cdIPCboundingInstanceStruct *)
...
static void sf_opaque_initialize_c36_cdIPCbounding(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc36_cdIPCboundingInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c36_cdIPCbounding((SFc36_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
  initialize_c36_cdIPCbounding((SFc36_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c36_cdIPCbounding(void *chartInstanceVar)
{
  enable_c36_cdIPCbounding((SFc36_cdIPCboundingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c36_cdIPCbounding(void *chartInstanceVar)
{
  disable_c36_cdIPCbounding((SFc36_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c36_cdIPCbounding(void *chartInstanceVar)
{
  sf_gateway_c36_cdIPCbounding((SFc36_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c36_cdIPCbounding(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c36_cdIPCbounding((SFc36_cdIPCboundingInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c36_cdIPCbounding(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c36_cdIPCbounding((SFc36_cdIPCboundingInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c36_cdIPCbounding(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc36_cdIPCboundingInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c36_cdIPCbounding((SFc36_cdIPCboundingInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc36_cdIPCbounding((SFc36_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c36_cdIPCbounding(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c36_cdIPCbounding(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(299811128U));
  ssSetChecksum1(S,(3735870619U));
  ssSetChecksum2(S,(2904028785U));
  ssSetChecksum3(S,(2423545415U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c36_cdIPCbounding(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c36_cdIPCbounding(SimStruct *S)
{
  SFc36_cdIPCboundingInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc36_cdIPCboundingInstanceStruct *)utMalloc(sizeof
    (SFc36_cdIPCboundingInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc36_cdIPCboundingInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c36_cdIPCbounding;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c36_cdIPCbounding;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c36_cdIPCbounding;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c36_cdIPCbounding;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c36_cdIPCbounding;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c36_cdIPCbounding;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c36_cdIPCbounding;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c36_cdIPCbounding;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c36_cdIPCbounding;
  chartInstance->chartInfo.mdlStart = mdlStart_c36_cdIPCbounding;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c36_cdIPCbounding;
...
void c36_cdIPCbounding_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c36_cdIPCbounding(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c36_cdIPCbounding(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c36_cdIPCbounding(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c36_cdIPCbounding_method_dispatcher.\n"
