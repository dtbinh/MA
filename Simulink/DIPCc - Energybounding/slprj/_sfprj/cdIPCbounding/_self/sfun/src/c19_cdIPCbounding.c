...
static void initialize_c19_cdIPCbounding(SFc19_cdIPCboundingInstanceStruct
  *chartInstance);
static void initialize_params_c19_cdIPCbounding
  (SFc19_cdIPCboundingInstanceStruct *chartInstance);
static void enable_c19_cdIPCbounding(SFc19_cdIPCboundingInstanceStruct
  *chartInstance);
static void disable_c19_cdIPCbounding(SFc19_cdIPCboundingInstanceStruct
  *chartInstance);
static void c19_update_debugger_state_c19_cdIPCbounding
  (SFc19_cdIPCboundingInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c19_cdIPCbounding
  (SFc19_cdIPCboundingInstanceStruct *chartInstance);
static void set_sim_state_c19_cdIPCbounding(SFc19_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c19_st);
static void finalize_c19_cdIPCbounding(SFc19_cdIPCboundingInstanceStruct
  *chartInstance);
static void sf_gateway_c19_cdIPCbounding(SFc19_cdIPCboundingInstanceStruct
  *chartInstance);
static void mdl_start_c19_cdIPCbounding(SFc19_cdIPCboundingInstanceStruct
  *chartInstance);
static void initSimStructsc19_cdIPCbounding(SFc19_cdIPCboundingInstanceStruct
  *chartInstance);
...
static const mxArray *c19_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static void c19_emlrt_marshallIn(SFc19_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c19_b_dxv, const char_T *c19_identifier, real_T
  c19_y[6]);
static void c19_b_emlrt_marshallIn(SFc19_cdIPCboundingInstanceStruct
...
static const mxArray *c19_b_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static real_T c19_c_emlrt_marshallIn(SFc19_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
...
static const mxArray *c19_c_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static int32_T c19_d_emlrt_marshallIn(SFc19_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void c19_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c19_mxArrayInData, const char_T *c19_varName, void *c19_outData);
static uint8_T c19_e_emlrt_marshallIn(SFc19_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c19_b_is_active_c19_cdIPCbounding, const char_T
  *c19_identifier);
static uint8_T c19_f_emlrt_marshallIn(SFc19_cdIPCboundingInstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void init_dsm_address_info(SFc19_cdIPCboundingInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc19_cdIPCboundingInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c19_is_active_c19_cdIPCbounding = 0U;
}
  ...
  (SFc19_cdIPCboundingInstanceStruct *chartInstance)
{
  ...
  c19_hoistedGlobal = chartInstance->c19_is_active_c19_cdIPCbounding;
  ...
  *chartInstance, const mxArray *c19_st)
{
  ...
  chartInstance->c19_is_active_c19_cdIPCbounding = c19_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c19_u, 1)),
     "is_active_c19_cdIPCbounding");
  sf_mex_destroy(&c19_u);
  c19_update_debugger_state_c19_cdIPCbounding(chartInstance);
  ...
  *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 8U, chartInstance->c19_sfEvent);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c19_energy, 0U);
  chartInstance->c19_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 8U, chartInstance->c19_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 8U, chartInstance->c19_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *c19_inData)
{
  ...
  const mxArray *c19_y = NULL;
  SFc19_cdIPCboundingInstanceStruct *chartInstance;
  chartInstance = (SFc19_cdIPCboundingInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c19_cdIPCbounding_get_eml_resolved_functions_info(void)
{
  ...
  *c19_identifier)
{
  ...
  c19_y = c19_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c19_b_is_active_c19_cdIPCbounding), &c19_thisId);
  sf_mex_destroy(&c19_b_is_active_c19_cdIPCbounding);
  return c19_y;
}
...
void sf_c19_cdIPCbounding_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c19_cdIPCbounding_get_post_codegen_info(void);
mxArray *sf_c19_cdIPCbounding_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c19_cdIPCbounding_get_post_codegen_info();
...
mxArray *sf_c19_cdIPCbounding_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c19_cdIPCbounding_jit_fallback_info(void)
{
...
mxArray *sf_c19_cdIPCbounding_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c19_cdIPCbounding(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"dxv\",},{M[8],M[0],T\"is_active_c19_cdIPCbounding\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c19_cdIPCbounding_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc19_cdIPCboundingInstanceStruct *)
...
static void sf_opaque_initialize_c19_cdIPCbounding(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc19_cdIPCboundingInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c19_cdIPCbounding((SFc19_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
  initialize_c19_cdIPCbounding((SFc19_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c19_cdIPCbounding(void *chartInstanceVar)
{
  enable_c19_cdIPCbounding((SFc19_cdIPCboundingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c19_cdIPCbounding(void *chartInstanceVar)
{
  disable_c19_cdIPCbounding((SFc19_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c19_cdIPCbounding(void *chartInstanceVar)
{
  sf_gateway_c19_cdIPCbounding((SFc19_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c19_cdIPCbounding(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c19_cdIPCbounding((SFc19_cdIPCboundingInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c19_cdIPCbounding(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c19_cdIPCbounding((SFc19_cdIPCboundingInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c19_cdIPCbounding(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc19_cdIPCboundingInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c19_cdIPCbounding((SFc19_cdIPCboundingInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc19_cdIPCbounding((SFc19_cdIPCboundingInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c19_cdIPCbounding(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c19_cdIPCbounding(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c19_cdIPCbounding(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c19_cdIPCbounding(SimStruct *S)
{
  SFc19_cdIPCboundingInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc19_cdIPCboundingInstanceStruct *)utMalloc(sizeof
    (SFc19_cdIPCboundingInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc19_cdIPCboundingInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c19_cdIPCbounding;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c19_cdIPCbounding;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c19_cdIPCbounding;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c19_cdIPCbounding;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c19_cdIPCbounding;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c19_cdIPCbounding;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c19_cdIPCbounding;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c19_cdIPCbounding;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c19_cdIPCbounding;
  chartInstance->chartInfo.mdlStart = mdlStart_c19_cdIPCbounding;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c19_cdIPCbounding;
...
void c19_cdIPCbounding_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c19_cdIPCbounding(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c19_cdIPCbounding(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c19_cdIPCbounding(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c19_cdIPCbounding_method_dispatcher.\n"
