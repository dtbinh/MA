...
static void initialize_c37_CaccavaleVillani(SFc37_CaccavaleVillaniInstanceStruct
  *chartInstance);
static void initialize_params_c37_CaccavaleVillani
  (SFc37_CaccavaleVillaniInstanceStruct *chartInstance);
static void enable_c37_CaccavaleVillani(SFc37_CaccavaleVillaniInstanceStruct
  *chartInstance);
static void disable_c37_CaccavaleVillani(SFc37_CaccavaleVillaniInstanceStruct
  *chartInstance);
static void c37_update_debugger_state_c37_CaccavaleVillani
  (SFc37_CaccavaleVillaniInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c37_CaccavaleVillani
  (SFc37_CaccavaleVillaniInstanceStruct *chartInstance);
static void set_sim_state_c37_CaccavaleVillani
  (SFc37_CaccavaleVillaniInstanceStruct *chartInstance, const mxArray *c37_st);
static void finalize_c37_CaccavaleVillani(SFc37_CaccavaleVillaniInstanceStruct
  *chartInstance);
static void sf_gateway_c37_CaccavaleVillani(SFc37_CaccavaleVillaniInstanceStruct
  *chartInstance);
static void mdl_start_c37_CaccavaleVillani(SFc37_CaccavaleVillaniInstanceStruct *
  chartInstance);
static void initSimStructsc37_CaccavaleVillani
  (SFc37_CaccavaleVillaniInstanceStruct *chartInstance);
static void c37_quatrot(SFc37_CaccavaleVillaniInstanceStruct *chartInstance,
  real_T c37_q[4], real_T c37_b_r[3], real_T c37_rw[3]);
...
static const mxArray *c37_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static void c37_emlrt_marshallIn(SFc37_CaccavaleVillaniInstanceStruct
  *chartInstance, const mxArray *c37_b_x, const char_T *c37_identifier, real_T
  c37_y[28]);
static void c37_b_emlrt_marshallIn(SFc37_CaccavaleVillaniInstanceStruct
...
static const mxArray *c37_b_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static void c37_c_emlrt_marshallIn(SFc37_CaccavaleVillaniInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId,
  real_T c37_y[12]);
...
static const mxArray *c37_e_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static real_T c37_d_emlrt_marshallIn(SFc37_CaccavaleVillaniInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
static void c37_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData);
static void c37_e_emlrt_marshallIn(SFc37_CaccavaleVillaniInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId,
  real_T c37_y[3]);
static void c37_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData);
static void c37_f_emlrt_marshallIn(SFc37_CaccavaleVillaniInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId,
  real_T c37_y[4]);
...
static void c37_quatmultiply(SFc37_CaccavaleVillaniInstanceStruct *chartInstance,
  real_T c37_q[4], real_T c37_b_r[4], real_T c37_qout[4]);
static const mxArray *c37_f_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static int32_T c37_g_emlrt_marshallIn(SFc37_CaccavaleVillaniInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
static void c37_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData);
static uint8_T c37_h_emlrt_marshallIn(SFc37_CaccavaleVillaniInstanceStruct
  *chartInstance, const mxArray *c37_b_is_active_c37_CaccavaleVillani, const
  char_T *c37_identifier);
static uint8_T c37_i_emlrt_marshallIn(SFc37_CaccavaleVillaniInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
static void init_dsm_address_info(SFc37_CaccavaleVillaniInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc37_CaccavaleVillaniInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c37_is_active_c37_CaccavaleVillani = 0U;
}
  ...
  (SFc37_CaccavaleVillaniInstanceStruct *chartInstance)
{
  ...
  c37_hoistedGlobal = chartInstance->c37_is_active_c37_CaccavaleVillani;
  ...
  (SFc37_CaccavaleVillaniInstanceStruct *chartInstance, const mxArray *c37_st)
{
  ...
  chartInstance->c37_is_active_c37_CaccavaleVillani = c37_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c37_u, 1)),
     "is_active_c37_CaccavaleVillani");
  sf_mex_destroy(&c37_u);
  c37_update_debugger_state_c37_CaccavaleVillani(chartInstance);
  ...
  *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 21U, chartInstance->c37_sfEvent);
  ...
  chartInstance->c37_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 21U, chartInstance->c37_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 21U, chartInstance->c37_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *c37_inData)
{
  ...
  const mxArray *c37_y = NULL;
  SFc37_CaccavaleVillaniInstanceStruct *chartInstance;
  chartInstance = (SFc37_CaccavaleVillaniInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c37_CaccavaleVillani_get_eml_resolved_functions_info(void)
{
...
static void c37_info_helper(const mxArray **c37_info)
{
  ...
  sf_mex_addfield(*c37_info, c37_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/CaccavaleVillani/quatrot.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(1450360966U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  char_T *c37_identifier)
{
  ...
  c37_y = c37_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c37_b_is_active_c37_CaccavaleVillani), &c37_thisId);
  sf_mex_destroy(&c37_b_is_active_c37_CaccavaleVillani);
  return c37_y;
}
...
void sf_c37_CaccavaleVillani_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c37_CaccavaleVillani_get_post_codegen_info(void);
mxArray *sf_c37_CaccavaleVillani_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c37_CaccavaleVillani_get_post_codegen_info();
...
mxArray *sf_c37_CaccavaleVillani_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c37_CaccavaleVillani_jit_fallback_info(void)
{
...
mxArray *sf_c37_CaccavaleVillani_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c37_CaccavaleVillani(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"x\",},{M[8],M[0],T\"is_active_c37_CaccavaleVillani\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c37_CaccavaleVillani_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc37_CaccavaleVillaniInstanceStruct *)
...
static void sf_opaque_initialize_c37_CaccavaleVillani(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc37_CaccavaleVillaniInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c37_CaccavaleVillani((SFc37_CaccavaleVillaniInstanceStruct*)
    chartInstanceVar);
  initialize_c37_CaccavaleVillani((SFc37_CaccavaleVillaniInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c37_CaccavaleVillani(void *chartInstanceVar)
{
  enable_c37_CaccavaleVillani((SFc37_CaccavaleVillaniInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c37_CaccavaleVillani(void *chartInstanceVar)
{
  disable_c37_CaccavaleVillani((SFc37_CaccavaleVillaniInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c37_CaccavaleVillani(void *chartInstanceVar)
{
  sf_gateway_c37_CaccavaleVillani((SFc37_CaccavaleVillaniInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c37_CaccavaleVillani(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c37_CaccavaleVillani
    ((SFc37_CaccavaleVillaniInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c37_CaccavaleVillani(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c37_CaccavaleVillani((SFc37_CaccavaleVillaniInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c37_CaccavaleVillani(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc37_CaccavaleVillaniInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c37_CaccavaleVillani((SFc37_CaccavaleVillaniInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc37_CaccavaleVillani((SFc37_CaccavaleVillaniInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c37_CaccavaleVillani(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c37_CaccavaleVillani(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(71718928U));
  ssSetChecksum1(S,(882634435U));
  ssSetChecksum2(S,(2281255026U));
  ssSetChecksum3(S,(1436610049U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c37_CaccavaleVillani(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c37_CaccavaleVillani(SimStruct *S)
{
  SFc37_CaccavaleVillaniInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc37_CaccavaleVillaniInstanceStruct *)utMalloc(sizeof
    (SFc37_CaccavaleVillaniInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc37_CaccavaleVillaniInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c37_CaccavaleVillani;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c37_CaccavaleVillani;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c37_CaccavaleVillani;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c37_CaccavaleVillani;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c37_CaccavaleVillani;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c37_CaccavaleVillani;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c37_CaccavaleVillani;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c37_CaccavaleVillani;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c37_CaccavaleVillani;
  chartInstance->chartInfo.mdlStart = mdlStart_c37_CaccavaleVillani;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c37_CaccavaleVillani;
...
void c37_CaccavaleVillani_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c37_CaccavaleVillani(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c37_CaccavaleVillani(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c37_CaccavaleVillani(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c37_CaccavaleVillani_method_dispatcher.\n"
