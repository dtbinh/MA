...
static void initialize_c31_CaccavaleVillani(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance);
static void initialize_params_c31_CaccavaleVillani
  (SFc31_CaccavaleVillaniInstanceStruct *chartInstance);
static void enable_c31_CaccavaleVillani(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance);
static void disable_c31_CaccavaleVillani(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance);
static void c31_update_debugger_state_c31_CaccavaleVillani
  (SFc31_CaccavaleVillaniInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c31_CaccavaleVillani
  (SFc31_CaccavaleVillaniInstanceStruct *chartInstance);
static void set_sim_state_c31_CaccavaleVillani
  (SFc31_CaccavaleVillaniInstanceStruct *chartInstance, const mxArray *c31_st);
static void finalize_c31_CaccavaleVillani(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance);
static void sf_gateway_c31_CaccavaleVillani(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance);
static void mdl_start_c31_CaccavaleVillani(SFc31_CaccavaleVillaniInstanceStruct *
  chartInstance);
static void c31_chartstep_c31_CaccavaleVillani
  (SFc31_CaccavaleVillaniInstanceStruct *chartInstance);
static void initSimStructsc31_CaccavaleVillani
  (SFc31_CaccavaleVillaniInstanceStruct *chartInstance);
static void c31_skew_sm(SFc31_CaccavaleVillaniInstanceStruct *chartInstance,
  real_T c31_b_x[3], real_T c31_X[9]);
static void c31_quatrot(SFc31_CaccavaleVillaniInstanceStruct *chartInstance,
  real_T c31_q[4], real_T c31_b_r[3], real_T c31_rw[3]);
...
static const mxArray *c31_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_emlrt_marshallIn(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance, const mxArray *c31_b_bred, const char_T *c31_identifier,
  real_T c31_y[18]);
static void c31_b_emlrt_marshallIn(SFc31_CaccavaleVillaniInstanceStruct
...
static const mxArray *c31_d_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_c_emlrt_marshallIn(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId,
  real_T c31_y[12]);
...
static const mxArray *c31_e_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static real_T c31_d_emlrt_marshallIn(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
...
static const mxArray *c31_f_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_e_emlrt_marshallIn(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId,
  real_T c31_y[9]);
...
static const mxArray *c31_g_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_f_emlrt_marshallIn(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId,
  real_T c31_y[3]);
...
static const mxArray *c31_h_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static void c31_g_emlrt_marshallIn(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId,
  real_T c31_y[4]);
...
static void c31_eml_scalar_eg(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance);
static void c31_threshold(SFc31_CaccavaleVillaniInstanceStruct *chartInstance);
static void c31_quatmultiply(SFc31_CaccavaleVillaniInstanceStruct *chartInstance,
  real_T c31_q[4], real_T c31_b_r[4], real_T c31_qout[4]);
static void c31_b_eml_scalar_eg(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance);
static const mxArray *c31_i_sf_marshallOut(void *chartInstanceVoid, void
  *c31_inData);
static int32_T c31_h_emlrt_marshallIn(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
static void c31_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c31_mxArrayInData, const char_T *c31_varName, void *c31_outData);
static uint8_T c31_i_emlrt_marshallIn(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance, const mxArray *c31_b_is_active_c31_CaccavaleVillani, const
  char_T *c31_identifier);
static uint8_T c31_j_emlrt_marshallIn(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance, const mxArray *c31_u, const emlrtMsgIdentifier *c31_parentId);
static void init_dsm_address_info(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc31_CaccavaleVillaniInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c31_is_active_c31_CaccavaleVillani = 0U;
}
  ...
  (SFc31_CaccavaleVillaniInstanceStruct *chartInstance)
{
  ...
  c31_hoistedGlobal = chartInstance->c31_is_active_c31_CaccavaleVillani;
  ...
  (SFc31_CaccavaleVillaniInstanceStruct *chartInstance, const mxArray *c31_st)
{
  ...
  chartInstance->c31_is_active_c31_CaccavaleVillani = c31_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c31_u, 1)),
     "is_active_c31_CaccavaleVillani");
  sf_mex_destroy(&c31_u);
  c31_update_debugger_state_c31_CaccavaleVillani(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c31_sfEvent = CALL_EVENT;
  c31_chartstep_c31_CaccavaleVillani(chartInstance);
  ...
  *c31_inData)
{
  ...
  const mxArray *c31_y = NULL;
  SFc31_CaccavaleVillaniInstanceStruct *chartInstance;
  chartInstance = (SFc31_CaccavaleVillaniInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c31_CaccavaleVillani_get_eml_resolved_functions_info(void)
{
...
static void c31_info_helper(const mxArray **c31_info)
{
  ...
  sf_mex_addfield(*c31_info, c31_emlrt_marshallOut(
    "[E]C:/Users/Martin/Documents/Git/Simulink/CaccavaleVillani/skew_sm.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c31_info, c31_b_emlrt_marshallOut(1450360966U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  char_T *c31_identifier)
{
  ...
  c31_y = c31_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c31_b_is_active_c31_CaccavaleVillani), &c31_thisId);
  sf_mex_destroy(&c31_b_is_active_c31_CaccavaleVillani);
  return c31_y;
}
...
void sf_c31_CaccavaleVillani_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1178718401U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4196587682U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2855655759U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3786856888U);
}

mxArray* sf_c31_CaccavaleVillani_get_post_codegen_info(void);
mxArray *sf_c31_CaccavaleVillani_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("hsoK28yDSgt1aAj8beAQjG");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c31_CaccavaleVillani_get_post_codegen_info();
...
mxArray *sf_c31_CaccavaleVillani_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c31_CaccavaleVillani_jit_fallback_info(void)
{
...
mxArray *sf_c31_CaccavaleVillani_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c31_CaccavaleVillani(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"bred\",},{M[8],M[0],T\"is_active_c31_CaccavaleVillani\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c31_CaccavaleVillani_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc31_CaccavaleVillaniInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,621);
...
{
  return "dZWQ3fDfJ3SbBdRH1PhKx";
}

static void sf_opaque_initialize_c31_CaccavaleVillani(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc31_CaccavaleVillaniInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c31_CaccavaleVillani((SFc31_CaccavaleVillaniInstanceStruct*)
    chartInstanceVar);
  initialize_c31_CaccavaleVillani((SFc31_CaccavaleVillaniInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c31_CaccavaleVillani(void *chartInstanceVar)
{
  enable_c31_CaccavaleVillani((SFc31_CaccavaleVillaniInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c31_CaccavaleVillani(void *chartInstanceVar)
{
  disable_c31_CaccavaleVillani((SFc31_CaccavaleVillaniInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c31_CaccavaleVillani(void *chartInstanceVar)
{
  sf_gateway_c31_CaccavaleVillani((SFc31_CaccavaleVillaniInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c31_CaccavaleVillani(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c31_CaccavaleVillani
    ((SFc31_CaccavaleVillaniInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c31_CaccavaleVillani(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c31_CaccavaleVillani((SFc31_CaccavaleVillaniInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c31_CaccavaleVillani(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc31_CaccavaleVillaniInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c31_CaccavaleVillani((SFc31_CaccavaleVillaniInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc31_CaccavaleVillani((SFc31_CaccavaleVillaniInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c31_CaccavaleVillani(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c31_CaccavaleVillani(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2623354838U));
  ssSetChecksum1(S,(2050094423U));
  ssSetChecksum2(S,(2232781062U));
  ssSetChecksum3(S,(1660710746U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c31_CaccavaleVillani(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c31_CaccavaleVillani(SimStruct *S)
{
  SFc31_CaccavaleVillaniInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc31_CaccavaleVillaniInstanceStruct *)utMalloc(sizeof
    (SFc31_CaccavaleVillaniInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc31_CaccavaleVillaniInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c31_CaccavaleVillani;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c31_CaccavaleVillani;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c31_CaccavaleVillani;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c31_CaccavaleVillani;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c31_CaccavaleVillani;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c31_CaccavaleVillani;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c31_CaccavaleVillani;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c31_CaccavaleVillani;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c31_CaccavaleVillani;
  chartInstance->chartInfo.mdlStart = mdlStart_c31_CaccavaleVillani;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c31_CaccavaleVillani;
...
void c31_CaccavaleVillani_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c31_CaccavaleVillani(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c31_CaccavaleVillani(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c31_CaccavaleVillani(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c31_CaccavaleVillani_method_dispatcher.\n"
